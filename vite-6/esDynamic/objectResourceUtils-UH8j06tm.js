import{a as ti}from"./devEnvironmentUtils-Dc_oIuhN.js";import{ct as Zr,qT as ri,qU as oi,bL as Kr,cu as ai,kE as ii,bS as Qr,aH as De,dE as Ct,jf as sr,aG as C,je as ni,hQ as eo,dG as Se,h$ as ue,aD as lr,fL as U,dJ as he,dI as me,qV as si,en as ye,fq as li,D as cr,s as dt,da as ci,eA as to,lR as di,gm as ut,mK as ht,dK as ro,qW as ui,jQ as hi,ma as mi,fE as Ot,mc as fi,hP as mt,iz as Fe,eX as pi,og as vi,aN as oo,qX as gi,bB as xi,eq as ke,qY as _i,qZ as Ti,dF as Rt,aF as It,i0 as $e,h_ as Pt,q_ as ao,q$ as io,a5 as bi,cC as Lt,mG as dr,O as m,cx as no,as as ae,hM as ur,j9 as hr,P as V,Q as mr,e2 as so,r0 as lo,S as co,T as Ei,fH as Be,fD as Nt,ja as Si,b0 as Dt,hC as fr,aC as yi,cA as wi,a9 as Ai,r1 as Mi,iC as uo,$ as Ci,_ as ho,mI as mo,r2 as fo,jB as Ft,cy as po,cz as Oi,cI as Ri,oi as vo}from"./main-CQd9Cxe2.js";import{t as pr,e as ft,o as Ye}from"./mat3f64-Dh9_zhFu.js";import{o as Bt,r as Ii,e as zt}from"./mat4f64-Dn1WEGBx.js";import{x as Gt,c as vr,y as Pi,u as Li,q as Ni,i as Vt,L as Di,O as Fi,E as Bi}from"./BufferView-JT7rbtSB.js";import{e as zi,f as Gi,l as go,o as xo}from"./vec3-CfZQ-E4u.js";import{n as Vi,s as _o}from"./vec4-BBoc231t.js";import{l as Ui,n as Hi,g as Xe,o as ji,h as Wi,t as qi,i as ki}from"./DefaultMaterial_COLOR_GAMMA-EPk7dkOp.js";import{r as gr}from"./resourceUtils-BuVraL8s.js";import{t as $i}from"./NestedMap-CJlcHrNH.js";import{t as Yi,l as To}from"./Indices-DPqB7mtk.js";import{t as bo}from"./requestImageUtils-CNGaTfDq.js";import{I as Xi,L as Ji,t as Je}from"./orientedBoundingBox-CeszOMpo.js";import{t as Zi,u as pt,a as xr,i as Ki,N as we,s as Y,O as Eo,e as Ae,n as vt}from"./basicInterfaces-Dnf5pTeQ.js";import{s as j}from"./Util-BtHJneoJ.js";import{s as So,_ as yo,V as Me}from"./sphere--whkQTtF.js";import{v as Qi}from"./lineSegment-ra7c5gcb.js";import"./plane-ChKcdaEf.js";import{e as f}from"./VertexAttribute-CAkzp1tV.js";import{c as ge,G as ze,L as Ze,D as Ge,R as Ce,O as fe,X as wo,E as en,I as ie,t as tn,_ as rn,f as on}from"./enums-DDkmfb-t.js";import{c as Ke,a as an,e as Ao,d as nn}from"./Texture-BbX7K1XZ.js";import{H as sn}from"./InterleavedLayout-BGkOt2ox.js";import{n as xe,a as Z,t as Ut,o as z,b as _r,r as Tr}from"./NormalAttribute.glsl-BIdU9kch.js";import{o as s,n as gt}from"./interfaces-Aq8q9x0N.js";import{l as Mo,S as br,_ as Er,h as ln,o as cn}from"./renderState-DjM_esgh.js";import{a as B}from"./BindType-9iOk18Ed.js";import{o as dn,r as un}from"./doublePrecisionUtils-BJbYwoii.js";function Ht(e,t=!1){return e<=Zr?t?new Array(e).fill(0):new Array(e):new Float32Array(e)}function hn(e){e.vertex.code.add(s`
...
vec4 vvLocalNormal(vec3 _normal) { return vec4(_normal, 1.0); }`),t.vvColor?(r.constants.add("vvColorNumber","int",Nr),r.uniforms.add(new wl("vvColorValues",a=>a.vvColor.values,Nr),new yl("vvColorColors",a=>a.vvColor.colors,Nr)),r.code.add(s`
...
float evaluateAmbientOcclusion() { return 0.0; }`)}function Kl(e,t){const r=e.fragment,o=t.lightingSphericalHarmonicsOrder!==void 0?t.lightingSphericalHarmonicsOrder:2;o===0?(r.uniforms.add(new X("lightingAmbientSH0",(a,i)=>U(Na,i.lighting.sh.r[0],i.lighting.sh.g[0],i.lighting.sh.b[0]))),r.code.add(s`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
...
}`))}const Na=C(),be=ur();function Gr(e){e.uniforms.add(new X("mainLightDirection",(t,r)=>r.lighting.mainLight.direction))}function tr(e){e.uniforms.add(new X("mainLightIntensity",(t,r)=>r.lighting.mainLight.intensity))}function Da(e){Gr(e.fragment),tr(e.fragment),e.fragment.code.add(s`vec3 evaluateMainLighting(vec3 normal_global, float shadowing) {
