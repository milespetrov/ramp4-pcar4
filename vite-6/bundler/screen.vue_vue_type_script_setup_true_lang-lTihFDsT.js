...
import { a as W, h as L } from "./main-DD4M6ybf.js";
const G = ["onClick", "aria-label"], J = { class: "md-icon-small inline" }, K = /* @__PURE__ */ $({
  ...
  setup(v) {
    const { t: x } = z(), s = W(), u = L(), g = h(() => s.mobileView ? "top-end" : "left-end"), l = (a) => {
      a.selectable && u.toggleSelected({
        name: a.name
      });
    };
    return (a, n) => {
      const f = C("dropdown-menu"), p = O("focus-item");
      return R((i(), k(f, {
        position: g.value,
        tooltip: r(x)("export.menu"),
            ...
            e("div", J, [
              ...
              e("span", {
                class: y(`inline ${o.selectable ? "" : "text-gray-300"}
                    `)
              }, _(r(x)(`export.menu.component.${o.name}`)), 3)
            ])
          ], 10, G))), 128))
        ]),
        _: 1
  ...
  setup(v) {
    const x = v, { t: s } = z(), u = q("iApi"), g = L(), l = b(), a = b(void 0), n = b(void 0), f = b([]), p = A("componentEl"), o = h(() => g.componentSelectedState), S = h(() => {
      let c = {};
    ...
    return N(() => {
      x.panel.exportMake = d, f.value.push(
      ...
      a.value.disconnect(), n.value.disconnect(), f.value.forEach((c) => c());
    }), (c, t) => {
