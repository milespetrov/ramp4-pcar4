...
import "tiny-emitter";
import { F as x, p as s, S as A, q as g, r as $, s as c, L as w, b as _, d as S } from "./main-DD4M6ybf.js";
...
import "svg.js";
import { _ as M } from "./screen.vue_vue_type_script_setup_true_lang-CQeKKp4A.js";
class T extends x {
  /**
  ...
  _parseConfig(e) {
    ...
    const l = this.getLayerFixtureConfigs();
    e.root.children.forEach((i) => {
      i.layerLegendConfigs = l, this.addItem(i);
    }), this.$iApi.geo.layer.allLayers().forEach((i) => {
      this.updateLegend(i);
    });
  }
  // Create
  ...
  createItem(e, t) {
    ...
    return l && l.forEach((i) => {
      e.layerLegendConfigs !== void 0 && (i.layerLegendConfigs = e.layerLegendConfigs), r.children.push(this.createItem(i, r));
    }), r;
  }
  /**
  ...
  getItem(e) {
    ...
    let r;
    return t.some((l) => (r = this.searchTreeFirst(l, (i) => i.uid === e), r !== void 0)), r;
  }
  /**
  ...
  getLayerItem(e) {
    let t, r, l;
    return typeof e == "string" ? (r = e, t = e) : (r = e.id, t = e.uid), this.getLegend().some((n) => (l = this.searchTreeFirst(
      n,
  ...
  getLayerBoundItems(e) {
    let t = "";
    const r = e instanceof c ? e : this.$iApi.geo.layer.getLayer(e);
    if (r)
      t = r.isSublayer ? r.parentLayer?.id || "" : r.id;
    else
      return [];
    return this.searchLegend(
      (l) => l instanceof g && (l.layerId === t || l.parentLayerId === t)
    );
  }
  // Update
  /**
  ...
  updateLegend(e) {
    const t = (r, l) => {
      const i = this.getLayerItem(r);
      l ? (i && r instanceof c && (i.layer = r), i?.error()) : i?.load(r instanceof c ? r : void 0);
    };
    e.loadPromise().then(() => {
      let r = this.getLayerItem(e);
      if (e.layerType === w.MAPIMAGE) {
        const l = (i) => {
          if (i.isLayerRoot && !i.isLogicalLayer)
            r = this.getLayerItem(e), t(e, !1), r && !r.treeGrown && (i.children.map((n) => this._treeWalker(e, n)).map((n) => this.addItem(n, r)), r.treeGrown = !0), i.children.forEach((n) => l(n));
          else if (!i.isLayerRoot && !i.isLogicalLayer) {
            if (r = this.getLayerItem(`${e.id}-${i.layerIdx}`), r) {
              const n = r.getConfig();
   ...
   */
  expandItems(e, t) {
    const r = this.getLegend(), l = t === void 0 ? r : t.children;
    t !== void 0 && this._toggleState(t, { expanded: e }), l.forEach((i) => {
      this._toggleState(i, { expanded: e });
    });
  }
  /**
  ...
  showItems(e, t) {
    const r = this.getLegend(), l = t === void 0 ? r : t.children;
    t !== void 0 && this._toggleState(t, { visibility: e }), l.forEach((i) => {
      this._toggleState(i, { visibility: e });
    });
  }
  /**
  ...
  searchTreeFirst(e, t) {
    ...
    {
      let r;
      return e.children.some((l) => (r = this.searchTreeFirst(l, t), r !== void 0)), r;
    }
  }
  /**
  ...
  searchTreeAll(e, t) {
    ...
    for (; l.length > 0; ) {
      const i = l.shift();
      i && t(i) && r.push(i), i && l.push(...i.children);
    }
    return r;
  }
  /**
   ...
   */
  _toggleState(e, t) {
    const r = t.visibility, l = t.expanded;
    r !== void 0 && e.toggleVisibility(r), l !== void 0 && e.children.length > 0 && e.toggleExpanded(l), e.children && e.children.length > 0 && e.children.forEach((i) => {
      this._toggleState(i, t);
    });
  }
  /**
   ...
   */
  _deleteItem(e) {
    const t = s(this.$vApp.$pinia), r = (l) => {
      l.children.length > 0 && l.children.forEach((i) => {
        r(i);
      }), l instanceof g && l.handlers.forEach((i) => this.$iApi.event.off(i)), t.removeItem(l);
    };
    return r(e), !0;
  }
  _replaceItem(e, t) {
  ...
  _treeWalker(e, t, r) {
    ...
    return t.isLayerRoot && !t.isLogicalLayer ? (n.layer = i, n.name = i.name, n.children = t.children.map((o) => this._treeWalker(e, o, r))) : !t.isLayerRoot && !t.isLogicalLayer ? (n.name = t.name, n.children = t.children.map((o) => this._treeWalker(e, o, r))) : t.isLogicalLayer && (n.layer = i, n.name = i.name, n.layerId = i.id, n.sublayerIndex = e.isSublayer ? e.layerIdx : void 0), { ...n, ...r };
  }
}
const C = /* @__PURE__ */ m({
  __name: "nav-button",
...
class Je extends T {
  added() {
    ...
    this.removed = () => {
      e(), this.$iApi.fixture.exists("appbar") && _(this.$vApp.$pinia).removeButton("legend"), this.$iApi.fixture.exists("mapnav") && S(this.$vApp.$pinia).removeItem("legend"), s().$reset(), this.$iApi.panel.remove("legend");
    };
  }
}
export {
