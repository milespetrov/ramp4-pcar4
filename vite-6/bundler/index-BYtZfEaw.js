import { F as h, i as p, G as n, E as f } from "./main-DD4M6ybf.js";
...
function c(s, t, i, e) {
  const r = s - t, o = t + r / 2, m = Math.min(r, i - e);
  return o > i ? {
    min: i - m,
    max: i,
    changed: !0
...
class Ot extends A {
   ...
   */
  enforceBoundary(t, i) {
    const e = this.$iApi.geo.map.getExtentSet().maximumExtent, r = c(t.xmax, t.xmin, e.xmax, e.xmin), o = c(t.ymax, t.ymin, e.ymax, e.ymin);
    if (o.changed || r.changed) {
