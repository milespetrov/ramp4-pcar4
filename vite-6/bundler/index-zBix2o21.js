import "tiny-emitter";
import { m as g, C as u, G as l, n as f, L as y, T as L, o as w, F as A } from "./main-DD4M6ybf.js";
    ...
    if (i)
      switch (i.mode) {
        case h.NONE:
          ...
          break;
        case h.GLOW:
          this.hilightMode = new m(i, this.$iApi);
          break;
        case h.LIFT:
      ...
      this.hilightMode = new m(H, this.$iApi);
  }
  /**
