...
import { E, _ as N, c as D } from "./main-DD4M6ybf.js";
...
const K = { class: "mt-10" }, q = ["aria-label"], F = ["alt", "src"], H = ["alt"], L = { class: "absolute flex w-full bg-black opacity-75 text-white h-30 bottom-6 items-center" }, G = { class: "pl-5" }, J = { class: "ml-auto pr-5" }, P = ["content"], Q = /* @__PURE__ */ _({
  ...
  setup(t) {
    const { t: m } = y(), c = C("iApi"), a = (n) => {
      if (!n.extent) {
        console.error("selected area of interest doesn't have an extent specified.");
        return;
      }
      c?.geo.map.zoomMapTo(E.fromConfig("area-of-interest-extent", n.extent));
    };
    return (n, e) => {
      ...
      return i(), r("div", K, [
        s((i(), r("button", {
          ...
          "aria-label": h(m)("areas-of-interest.select"),
...
}), R = /* @__PURE__ */ N(Q, [["__scopeId", "data-v-06be115a"]]), U = { class: "h-600 overflow-y-auto" }, W = { class: "mx-5" }, X = { key: 0 }, Pt = /* @__PURE__ */ _({
  __name: "screen",
  props: {
    panel: {
      type: Object
  ...
  setup(t) {
    ...
    return A(() => {
      ...
      return i(), M(p, { panel: t.panel }, {
        header: w(() => [
          O(x(h(m)("areas-of-interest.title")), 1)
        ]),
        content: w(() => [
          o("div", U, [
            o("div", W, [
