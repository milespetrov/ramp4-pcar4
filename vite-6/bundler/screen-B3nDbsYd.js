import { defineComponent as I, inject as ne, resolveComponent as Ge, openBlock as _, createBlock as Ve, unref as y, withCtx as re, createElementVNode as o, createElementBlock as E, Fragment as Ye, renderList as Ze, createTextVNode as N, toDisplayString as $, createCommentVNode as R, ref as C, onBeforeMount as me, withDirectives as k, normalizeClass as O, withModifiers as P, withKeys as H, vModelText as se, vModelSelect as Ct, onMounted as oe, nextTick as Ce, onBeforeUnmount as Q, resolveDirective as K, computed as U, watch as Re, vShow as le, createVNode as Ie, getCurrentInstance as Lt, markRaw as Se } from "vue";
import "tiny-emitter";
import { a as ve, _ as fe, G as Z, Q as _t, f as Et, L as Mt, g as kt, V as Qe, X as ae, k as Xe, Y as je, Z as xe, $ as At } from "./main-DD4M6ybf.js";
...
import { AgGridVue as $t } from "ag-grid-vue3";
import { T as Tt, C as Rt } from "./table-state-manager-CQv-OGS1.js";
  ...
  setup(L) {
    ...
    return oe(() => {
      ...
      return c.value ? k((_(), E("button", {
        ...
        ]))) : n.value === "error" ? (_(), E("svg", $l, v[1] || (v[1] = [
          o("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
  ...
  setup(L) {
    const n = [ae.OID, ae.DOUBLE, ae.SINGLE, ae.INTEGER], e = ne("iApi"), a = Xe(), l = ve(), r = U(() => l.mobileView), u = C(!r.value), c = C(), { t: d, locale: M } = B(), w = () => Lt()?.proxy?.$forceUpdate(), v = L, i = C({
      ...
      const f = i.value.state.searchFilter.replace(/'/g, "''").split(" "), p = x.value.rowModel.rowsToDisplay, m = G.value.getAllDisplayedColumns().filter(
        (b) => (b.colDef.filter === "agTextColumnFilter" || b.colDef.filter === "agNumberColumnFilter") && $e(s, b.getColId())
      );
      let g = [];
      return p.forEach((b) => {
        let S = !0, h = "";
        for (let T of f) {
          const pe = new RegExp(`.*${T.split(" ").join(".*").toUpperCase()}`), Ue = `%${T.replace(/\*/g, "%").split(" ").join("%").toUpperCase()}`;
          let te = !1;
          for (let Te of m) {
            const ce = Te.getColId(), we = $e(s, Te.getColId())?.origAttr, Ke = Te.getColDef();
            if (b.data[ce] === void 0)
              te = !1;
    ...
    ), $e = (s, t) => de.value[s].find((f) => (f.mappedAttr ?? f.origAttr) === t), Oe = () => {
          ...
          f.forEach((m, g) => {
            ...
            m.columns.forEach((h) => {
              i.value.fieldMap && i.value.fieldMap[h.data] ? (b.push({
                ...
                origAttr: h.data,
                mappedAttr: void 0
              }), p.columns.map((T) => T.data).includes(h.data) || p.columns.push(h);
            }), p.rows = p.rows.concat(
              m.rows.map((h) => {
                if (i.value.fieldMap)
                  for (const [T, pe] of Object.entries(i.value.fieldMap))
                    h[T] !== void 0 && h[pe] === void 0 && (h[pe] = h[T], delete h[T]);
                return h;
              })
            );
            for (let h = 0; h < p.rows.length; h++)
              for (const [T] of Object.entries(p.rows[h]))
                e.ui.isPlainText(p.rows[h][T]) && (p.rows[h][T] = e.ui.escapeHtml(p.rows[h][T]));
            ...
            let g = i.value.state?.columns[m.data], b = {
              ...
              suppressHeaderKeyboardEvent: (h) => {
                const T = h.event;
                return h.headerRowIndex === 0 && (T.key === "Enter" || !T.target.classList.contains("ag-header-cell") && T.key === "Tab");
              }
    ...
    return me(() => {
      ...
      return _(), E("div", {
        ...
        k(o("div", null, [
          o("p", Pl, $(y(d)("grid.splash.error")), 1)
        ], 512), [
          [le, J.value]
        ]),
        k(o("div", Hl, [
          o("div", Nl, [
            o("span", Bl, $(ie.value.reduce((g, b) => g + b, 0)), 1),
            t[12] || (t[12] = o("svg", {
            ...
            o("span", zl, $(Le.value), 1)
          ]),
          o("div", Ol, [
            o("span", Ul, $(ie.value.reduce((g, b) => g + b, 0) < Le.value ? y(d)("grid.splash.loading") : y(d)("grid.splash.building")), 1)
          ]),
          o("div", null, [
            o("button", {
              type: "button",
        ...
        k(o("div", jl, [
          o("div", ql, [
            ...
            k((_(), E("div", Yl, [
              N($(y(d)("grid.filters.label.info", {
                range: j.value.visibleRows !== 0 ? `${j.value.firstRow} - ${j.value.lastRow}` : "0",
                total: j.value.visibleRows
              })) + " ", 1),
              j.value.visibleRows !== ue.value.length ? (_(), E("span", Zl, $(y(d)("grid.filters.label.filtered", {
                max: ue.value.length
              })), 1)) : R("", !0)
            ])), [
              [p]
                ...
                default: re(() => [
                  o("a", {
                    ...
                    o("div", sa, [
                      ...
                      N(" " + $(y(d)("grid.label.filters.apply")) + " ", 1),
                  ...
                  o("a", {
                    ...
                    o("div", ia, [
                      ...
                      N(" " + $(y(d)("grid.label.filters.show")) + " ", 1),
                  ...
                  o("a", {
                    ...
                    o("div", pa, [
                      ...
                      N(" " + $(y(d)("grid.filters.label.extent")) + " ", 1),
...
}), Pr = /* @__PURE__ */ fe(wa, [["__scopeId", "data-v-904e67ef"]]);
export {
  Pr as default
};
