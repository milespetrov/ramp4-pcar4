import { defineComponent as c, inject as m, resolveComponent as n, openBlock as h, createBlock as l, unref as g, withCtx as v, createElementVNode as o, markRaw as f } from "vue";
import { _ as u } from "./screen.vue_vue_type_script_setup_true_lang-BvOo92gV.js";
import "tiny-emitter";
import { F as d, j as s, b as S, d as b } from "./main-DD4M6ybf.js";
...
const w = /* @__PURE__ */ c({
  __name: "nav-button",
  setup(t) {
    const { t: e } = x(), r = m("iApi"), p = () => {
      r?.panel.toggle("geosearch");
    };
    return (_, i) => {
      const a = n("mapnav-button");
      return h(), l(a, {
        onClickFunction: p,
...
class Ie extends $ {
  ...
  removed() {
    this.$iApi.fixture.exists("appbar") && S(this.$vApp.$pinia).removeButton("geosearch"), this.$iApi.fixture.exists("mapnav") && b(this.$vApp.$pinia).removeItem("geosearch"), s(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("geosearch");
  }
}
export {
  Ie as default
