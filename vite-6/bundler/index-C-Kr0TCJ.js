...
import { _ as y, d, F as D, G as H } from "./main-DD4M6ybf.js";
...
const z = /* @__PURE__ */ y(P, [["render", j]]), T = /* @__PURE__ */ x({
  __name: "zoom-nav",
  setup(v) {
    const { t: n } = $(), e = E("iApi"), t = w(400, !0, () => e.geo.map.zoomIn()), i = w(400, !0, () => e.geo.map.zoomOut());
    return (m, o) => {
  ...
  setup(v) {
    ...
    const o = F(() => n.order.map((r) => n.items[r]).filter((r) => r.componentId));
    return (r, c) => {
      const k = _("focus-list"), C = _("tippy");
      return s(), p("div", G, [
        N((s(), p("div", {
          class: "flex flex-col",
          content: l(e)("panels.controls.items"),
          ref_key: "el",
          ref: t
        }, [
          ...
          a("div", q, [
            (s(!0), p(g, null, V(o.value, (h, I) => (s(), p(g, {
              key: h.id + "button"
            }, [
              (s(), b(B(h.id + "-nav-button"))),
              I !== o.value.length - 1 ? (s(), b(z, {
                key: 0,
...
class J extends D {
  ...
  _parseConfig(n) {
    if (!n)
      return;
    const e = n.items.map((t) => ({
      id: t
    }));
    this.mapnavStore.items = e.reduce((t, i) => (t[i.id] = i, t), {}), this.mapnavStore.order = e.map((t) => t.id), this._validateItems();
  }
  /**
  ...
  _validateItems() {
    ...
    this.mapnavStore.order.forEach((e) => {
      (this.$iApi.fixture.exists(e) || n.includes(e)) && (this.mapnavStore.items[e].componentId = `${e}-nav-button`);
    });
  }
}
...
class po extends J {
  async added() {
    Object.entries(K).forEach((o) => this.$iApi.$i18n.mergeLocaleMessage(...o));
    const { destroy: n, el: e } = this.mount(W, {
      app: this.$element
    });
    ...
    this.removed = () => {
      ...
      const o = d(this.$vApp.$pinia), r = { ...o.items };
      Object.keys(r).forEach((c) => o.removeItem(c)), o.$reset(), n();
    };
  }
}
export {
