import { defineComponent as a, inject as n, ref as s, onMounted as h, onBeforeUnmount as d, openBlock as c, createElementBlock as u, normalizeClass as v, createElementVNode as i } from "vue";
import { G as e, _ as f, F as _ } from "./main-DD4M6ybf.js";
import "pinia";
import "vue-i18n";
import "screenfull";
...
const w = /* @__PURE__ */ a({
  __name: "crosshairs",
  setup(l) {
    const t = n("iApi"), o = s(!1), r = s([]);
    return h(() => {
      r.value.push(
        t.event.on(e.MAP_EXTENTCHANGE, () => {
          t.geo.map.keysActive && (o.value = !0);
        })
      ), r.value.push(
        t.event.on(e.MAP_FOCUS, () => {
          t.geo.map.mouseFocus || (o.value = !0);
        })
      ), r.value.push(
        t.event.on(e.MAP_MOUSEDOWN, () => {
          o.value = !1;
        })
      ), r.value.push(
        t.event.on(e.MAP_BLUR, () => {
          o.value = !1;
        })
      );
    }), d(() => {
      r.value.forEach((p) => t.event.off(p));
    }), (p, m) => (c(), u("div", {
