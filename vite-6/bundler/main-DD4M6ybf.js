...
import { ref as f, computed as M, markRaw as ie, defineComponent as C, inject as be, reactive as ye, watch as xt, onBeforeUnmount as pt, resolveDirective as O, withDirectives as k, openBlock as v, createElementBlock as b, withKeys as as, withModifiers as Zt, onMounted as He, normalizeClass as re, normalizeStyle as Ti, createVNode as se, Transition as Li, withCtx as X, createBlock as V, resolveDynamicComponent as ls, mergeProps as cs, TransitionGroup as $i, Fragment as je, renderList as ut, unref as _, nextTick as Rt, renderSlot as Ce, createElementVNode as m, vShow as ps, resolveComponent as Z, createTextVNode as st, toDisplayString as D, createCommentVNode as F, onUpdated as us, Teleport as ds, getCurrentInstance as hs, createApp as Ri, toRaw as Ee, h as fs, render as Dt, defineAsyncComponent as ms } from "vue";
...
import { fromJSON as lt } from "@arcgis/core/renderers/support/jsonUtils";
...
import { debounce as _t, throttle as mt } from "throttle-debounce";
...
class ve {
  ...
  id;
  constructor(e, t, i) {
    this.geometry = e, t ? this.id = t : this.id = at.sharedUtils.generateUUID(), i ? this.attributes = i : this.attributes = {};
  }
  _hover;
...
class gt extends Re {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new St(this.fillColour.rgba), i = new Rs();
...
class Qs {
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), s = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), o = at.geom.geomGeoJsonToRamp(s, t.id);
  ...
  async projectExtent(e, t) {
    const i = (g, w, A) => {
      if (A === 0)
        return [g, w];
      const q = [(g[0] + w[0]) / 2, (g[1] + w[1]) / 2];
      if (A === 1)
        return [g, q, w];
      if (A > 1) {
        const L = i(g, q, A - 1), $ = i(q, w, A - 1);
    ...
    const n = new te("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, n), a = l.toArray().pop() || [], c = a.map((g) => g[0]), p = a.map((g) => g[1]), u = Math.min.apply(null, c), d = Math.max.apply(null, c), y = Math.min.apply(null, p), h = Math.max.apply(null, p);
    return N.fromParams(t.id + "_projected", u, y, d, h, l.sr);
  }
}
class Xs {
  // useful functions
...
const Lt = G("appbar", () => {
  ...
  function a(u, d) {
    ...
    const y = t.value.findIndex((h) => h === u.id);
    y !== -1 && y !== d && (t.value.splice(y, 1), t.value.splice(d, 0, u.id), t.value = [...t.value]);
  }
  function c(u) {
    const d = r.value.filter((y) => y.id !== u.id || y.uid !== u.uid);
    if (r.value = d, u.mapLayer) {
      const y = t.value.filter((h) => h !== u.id);
      t.value = y;
    }
  }
  function p(u) {
    const d = e.value.filter((y) => y.id !== u);
    e.value = d;
  }
  return {
    /**
  ...
  const r = f([]), e = f({}), t = f({}), i = f(), s = f(0), o = f(0), n = f(!0), l = f();
  function a(p) {
...
const $t = G("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = $t(), t = be("iApi"), i = M(() => e.maptipPoint), s = M(() => e.maptipInstance), o = M(() => e.content), n = ye([]);
    n.push(
      xt(i, () => {
        if (i.value) {
          let a, c;
...
const cr = ["data-cy"], Wi = /* @__PURE__ */ C({
    ...
    return (a, c) => {
      ...
      return v(), b("div", {
        ...
        se(Li, {
          ...
          default: X(() => [
            k((v(), V(ls(r.panel.route.screen), cs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [p]
            ])
          ]),
          _: 1
  ...
  const r = f(void 0), e = f(void 0), t = f(0), i = f(0), s = f(!1), o = f(!0), n = f({}), l = f({}), a = f([]), c = f([]), p = f([]), u = M(() => i.value);
  function d(S) {
    return S === "xs" && p.value.length > 0 ? [p.value.slice().pop()] : p.value;
  }
  function y(S) {
    const R = [];
    return S.forEach((de) => {
  ...
  function $() {
    let S = t.value;
    const R = [], de = 350, Ke = 12, ni = 600;
    for (let Pe = a.value.length - 1; Pe >= 0; Pe--) {
      const Qe = a.value[Pe];
      let Ie = Qe.width || de;
      if (s.value ? Ie = S : Ie += Ke, Qe.id === "grid" && (Ie = Math.max(Math.min(Ie, S), ni)), (S >= Ie && !s.value || R.length === 0) && (S -= Ie, R.unshift(Qe)), Qe.id === "grid" && S < ni)
        break;
    }
    if (r.value && //@ts-ignore
    !R.includes(r.value) && !s.value) {
      let Pe;
      for (let ai = 0; ai < R.length - 1 && S < (r.value.width || de) + Ke; ai++)
        Pe = R.shift(), S += Pe.width || de;
      S >= (r.value.width || de) ? R.unshift(r.value) : e.value || (Pe = R.shift(), R.unshift(r.value));
      const Qe = a.value.indexOf(r.value), Ie = a.value.indexOf(Pe), Ft = a.value.slice();
      Ie > -1 && (Ft.splice(Qe, 1), Ft.splice(Ie, 0, r.value)), a.value = Ft;
    }
    i.value = S, p.value = R;
  }
  function W(S) {
  ...
  function dt(S) {
    if (S.teleport) {
      ...
      const R = a.value.indexOf(S);
      R !== -1 && (a.value = [...a.value.slice(0, R), ...a.value.slice(R + 1)]);
    }
  }
  function Pt(S, R) {
    const de = a.value.indexOf(S), Ke = R === "right" ? 1 : -1;
    p.value.includes(a.value[de + Ke]) && ([a.value[de], a.value[de + Ke]] = [
      a.value[de + Ke],
      a.value[de]
    ]);
  }
  function Nt(S) {
    ...
    const R = p.value.indexOf(S);
    R !== -1 && (p.value = [...p.value.slice(0, R), ...p.value.slice(R + 1)]), r.value && r.value.id == S.id && (r.value = void 0);
  }
  function Me(S) {
    l.value = {
      ...l.value,
  ...
  __name: "panel-stack",
  setup(r) {
    const e = We(), t = be("iApi"), i = f(), s = M(() => e.mobileView);
    He(() => {
      new ResizeObserver((p) => {
        const u = !(t?.$vApp.$root?.$refs["app-size"]).classList.contains("sm");
        s.value !== u && (e.mobileView = u, t?.event.emit(E.RAMP_MOBILEVIEW_CHANGE, u)), e.setStackWidth(p[0].contentRect.width);
      }).observe(i.value?.$el);
    });
    const o = (c) => (
      //@ts-ignore
    ...
    return (c, p) => (v(), V($i, {
      ...
      default: X(() => [
        (v(!0), b(je, null, ut(o(_(t).screenSize), (u) => (v(), V(Wi, {
          key: `${u.id}`,
          panel: u
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, ur = /* @__PURE__ */ ke(pr, [["__scopeId", "data-v-11f38702"]]), dr = ["content", "aria-label"], Xt = /* @__PURE__ */ C({
  ...
  setup(r) {
    const e = f(!1), t = f(null), i = ye([]), s = f(), o = f(), n = f(), l = r;
    i.push(
      xt(e, () => {
        t.value.update();
      })
    ...
    return He(() => {
      window.addEventListener(
        ...
        (!s.value || !s.value.contains(u.target)) && (e.value = !1);
      }), n.value.addEventListener("focus", c), n.value.addEventListener("blur", p), n.value.addEventListener("mouseover", c), n.value.addEventListener("mouseleave", p), Rt(() => {
        const u = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
          fn({ state: d }) {
            const { bottom: y } = zs(d);
            y > 0 ? (d.styles.popper.overflowY = y > 100 ? "auto" : void 0, d.styles.popper.overflowX = "hidden", d.styles.popper.height = `${d.rects.popper.height - y - 8}px`) : d.styles.popper.height = "auto";
          }
        };
  ...
  const r = f([]), e = f({}), t = M(() => r.value.length >= 99 ? 99 : r.value.length);
  function i(c) {
    r.value = [c, ...r.value];
  }
  function s(c) {
...
}), hr = { class: "h-full flex flex-col" }, fr = { class: "w-full flex mb-6" }, mr = ["content", "aria-label"], gr = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    ...
    return (o, n) => {
      ...
      return v(), V(l, { panel: r.panel }, {
        header: X(() => [
          st(D(_(t)("notifications.title")), 1)
        ]),
        content: X(() => [
          m("div", hr, [
            m("div", fr, [
...
const vr = ["content"], br = { class: "flex items-center text-left" }, Ar = { class: "select-text cursor-text" }, wr = ["content"], Er = {
  ...
  setup(r) {
    ...
    return (a, c) => {
      ...
      return k((v(), b("li", {
        ...
        m("div", br, [
          m("span", null, [
            st(D(o[r.notification.type]) + " ", 1),
            m("span", Ar, D(r.notification.message), 1)
          ]),
          c[4] || (c[4] = m("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (v(), b("div", {
            key: 0,
        ...
        r.notification.messageList && s.value ? (v(), b("div", Er, [
          (v(!0), b(je, null, ut(r.notification.messageList, (u, d) => (v(), b("p", {
  ...
  setup(r) {
    ...
    return (l, a) => {
      ...
      return v(), b("div", null, [
        n.value.length > 0 ? k((v(), b("ul", {
          key: 0,
          content: _(t)("panels.controls.items"),
          ref_key: "el",
          ref: i
        }, [
          (v(!0), b(je, null, ut(n.value, (d, y) => (v(), b(je, {
            key: d.message + y
          }, [
            y > 0 ? (v(), b("div", _r)) : F("", !0),
            k(se(xr, {
          ...
          m("span", null, D(_(t)("notifications.empty")), 1),
...
}, Rr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Cr = { class: "pb-8 border-b border-gray-600" }, Or = { class: "absolute flex right-3 top-3" }, kr = ["content", "aria-label"], Mr = /* @__PURE__ */ C({
      ...
      return v(), V(Xt, {
        ...
        header: X(() => [
          m("div", Tr, [
            ...
            i.value && i.value > 0 ? (v(), b("span", $r, D(i.value), 1)) : F("", !0)
          ])
        ]),
        default: X((c) => [
          m("div", Rr, [
            m("div", null, [
              m("h4", Cr, D(_(t)("notifications.title")), 1),
              m("div", Or, [
                k((v(), b("button", {
                  type: "button",
                  onClick: s,
...
}), Pr = /* @__PURE__ */ ke(Mr, [["__scopeId", "data-v-3623a7d2"]]), Nr = { class: "flex hover:text-white" }, Fr = ["aria-label"], Dr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Gr = { class: "pb-8 border-b border-gray-600 mb-10" }, Ur = { class: "absolute right-5 top-5" }, Br = { class: "select-text" }, zr = { class: "font-bold cursor-text" }, Vr = { class: "text-sm cursor-text" }, jr = { class: "text-sm cursor-text" }, qr = /* @__PURE__ */ C({
  ...
  setup(r) {
    const { t: e } = j(), t = M(() => `${ft.major}.${ft.minor}.${ft.patch}`), i = M(() => ft.hash.slice(0, 9)), s = M(() => {
        ...
        default: X((p) => [
          m("div", Dr, [
            m("div", null, [
              ...
              m("div", Br, [
                m("div", null, [
                  m("span", zr, D(t.value), 1),
                  m("span", Vr, " [" + D(i.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", jr, D(s.value), 1)
                ]),
  ...
  __name: "map-caption",
  setup(r) {
    const e = De(), t = ce(), { t: i } = j(), s = be("iApi"), o = M(() => e.scale), n = M(() => e.attribution), l = M(() => e.coords), a = M(() => e.langtoggle), c = M(() => t.config.map), p = f([]), u = ye([]);
    u.push(
      xt(c, (g) => {
        g && s.geo.map.caption.createCaption(c.value?.caption);
      })
    ), pt(() => {
      u.forEach((g) => g());
    }), us(() => {
    ...
    const d = (g) => {
      s.$i18n.locale.value != g && s.setLanguage(g);
    }, y = () => {
      e.toggleScale(), s.geo.map.caption.updateScale();
    }, h = (g = !1) => i(g ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (g, w) => {
      ...
      return v(), b("div", Hr, [
        ...
        se(Pr, { class: "sm:block display-none" }),
        n.value?.logo.disabled ? F("", !0) : (v(), b("span", Yr, [
          m("a", {
        ...
        n.value?.text.disabled ? F("", !0) : k((v(), b("span", Kr, [
          st(D(n.value?.text.value), 1)
        ])), [
          [q, {
            options: {
              placement: "top",
        ...
        m("div", Qr, [
          l.value?.disabled ? F("", !0) : k((v(), b("div", Xr, [
            st(D(l.value?.formattedString), 1)
          ])), [
            [q, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? F("", !0) : k((v(), b("button", {
            key: 1,
            type: "button",
          ...
          a.value?.disabled ? F("", !0) : (v(), V(A, {
            ...
            header: X(() => [
              m("span", io, D(_(i)("map.language.short")), 1)
            ]),
            default: X(() => [
              (v(!0), b(je, null, ut(p.value, ($, W) => (v(), b("a", {
                key: `${$}-${W}`,
                class: re(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": $ === _(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (ue) => d($)
              }, [
                st(D(_(i)("map.language." + $)) + " ", 1),
                $ === _(s).$i18n.locale.value ? (v(), b("span", ro, D(_(i)("map.language.curr")), 1)) : F("", !0)
              ], 10, so))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, n) => {
      ...
      return k((v(), b("button", {
        ...
        s.value && s.value > 0 ? (v(), b("span", ao, D(s.value), 1)) : F("", !0)
      ], 8, no)), [
        [l]
      ]);
    };
  }
}), co = /* @__PURE__ */ ke(lo, [["__scopeId", "data-v-b03e7e33"]]), po = { class: "flex items-center mb-20" }, uo = { class: "text-xl" }, ho = /* @__PURE__ */ C({
  __name: "keyboard-instructions",
  setup(r) {
    const e = be("iApi"), { t } = j(), i = f(!1), s = f(["app", "lists", "map"]), o = f([]), n = f(null), l = f(null);
    He(() => {
      o.value.push(
    ...
    return (c, p) => {
      ...
      return i.value ? (v(), b("div", {
        ...
        m("div", {
          ...
          m("div", po, [
            m("h2", uo, D(_(t)("keyboardInstructions.title")), 1),
            se(u, {
              class: "ml-auto",
              onClick: p[0] || (p[0] = (d) => i.value = !1)
            })
          ]),
          (v(!0), b(je, null, ut(s.value, (d) => (v(), b("p", {
...
}), et = G("instance", () => ({ started: f(!1) })), fo = { class: "h-full relative" }, mo = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, go = { class: "absolute top-8 w-full flex justify-center" }, yo = {
  key: 1,
  class: "w-full h-full"
}, vo = /* @__PURE__ */ C({
  __name: "shell",
  setup(r) {
    const e = be("iApi"), t = et(), i = me(), s = We(), { t: o } = j(), n = M(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, a = () => (
      // @ts-ignore
      s.teleported
    );
    return (c, p) => (v(), b("div", fo, [
      m("div", mo, [
        p[0] || (p[0] = m("div", { class: "sr-only screen-reader-alert" }, null, -1)),
        m("div", go, [
          m("button", {
            type: "button",
        ...
        se(ho),
        se(ur, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        n.value ? F("", !0) : (v(), V(co, { key: 0 })),
        se(oo, { class: "z-30" })
      ]),
      _(t).started ? (v(), V(lr, { key: 0 })) : (v(), b("div", yo, p[1] || (p[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), b(je, null, ut(a(), (u) => (v(), V(ds, {
...
}), bo = /* @__PURE__ */ ke(vo, [["__scopeId", "data-v-6c131943"]]), Ao = C({
  name: "App",
  components: { Shell: bo },
  setup() {
    const r = hs();
...
const So = /* @__PURE__ */ ke(Ao, [["render", xo]]), we = "focus-list", ze = "focus-item", _o = "focus-icon", Io = "focus-container", nt = `[${we}],[${Io}]`, bt = "truncate-text", At = "show-truncate", it = "focused", Ht = `button,input,select,a,textarea,[contenteditable],[${we}],[${_o}],[tabIndex]`, To = {
  mounted(r, e) {
...
function Ji(r) {
  r.querySelectorAll(Ht).forEach((t) => {
    if (t.closest(nt) === r || t.closest(nt) === t && t.parentElement.closest(nt) === r)
      if (t.closest(`[${we}],.${it}`).classList.contains(it))
...
class Lo {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Ht).forEach((s) => {
      (e === -1 || s.closest(nt) === this.element || s.closest(nt) === s && s.parentElement.closest(nt) === this.element || s.closest(`[${we}],.${it}`).classList.contains(it)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(it), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(ze) === At && e.querySelector(`[${bt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(it), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(ze) === At && e.querySelector(`[${bt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onClick(e) {
    ...
    this.highlightedItem = t.closest(`[${ze}]`) || t.closest(`[${we}]`) || this.highlightedItem, t.hasAttribute(`${ze}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(ze) === At && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Ji(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(ze) === At && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.hide());
  }
  /**
...
const hi = "focus-item", $o = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", Ro()), e.value ? r.setAttribute(hi, e.value) : r.toggleAttribute(hi, !0);
  }
};
function Ro() {
  let r;
...
const ei = "focus-container", Zi = "focus-list", Co = "focus-icon", Ut = `[${Zi}],[${ei}]`, fi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${ei}],[${Co}],[tabIndex]`;
let Bt = [];
const Oo = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Bt.push(new ko(r));
  },
  beforeUnmount(r) {
...
class ko {
   ...
   */
  constructor(e) {
    this.element = e, this.element.toggleAttribute(ei, !0), this.element.tabIndex = 0, this.disableTabbing();
    const t = this;
...
const Mo = "truncate-text", Po = "truncate-trigger", No = {
  ...
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Po}]`)), Gs(r, {
...
const Do = ["content"], Go = {
  ...
  setup(r) {
    const { t: e } = j(), t = We(), i = Lt(), s = be("iApi"), o = f(), n = r, l = M(() => s?.fixture.get("appbar") ? i.temporary : []), a = M(() => t.mobileView), c = M(() => t.reorderable), p = () => !a.value && !n.panel.teleport, u = (y) => {
      n.panel.move(y), y === "left" && Rt(() => {
        (o.value?.querySelector(".move-left")).focus();
      });
    }, d = M(() => n.screenId ? n.panel.screens[n.screenId][s?.$i18n.locale.value ?? "en"] : null);
    return He(() => {
      o.value?.addEventListener("blur", () => {
        o.value._tippy.hide();
      }), o.value?.addEventListener("keyup", (y) => {
        y.key === "Tab" && o.value?.matches(":focus") && o.value._tippy.show();
      });
    }), pt(() => {
      o.value?.removeEventListener("blur", () => {
        o.value._tippy.hide();
      }), o.value?.removeEventListener("keyup", (y) => {
        y.key === "Tab" && o.value?.matches(":focus") && o.value._tippy.show();
      });
    }), (y, h) => {
      const g = Z("back"), w = Z("panel-options-menu"), A = Z("left"), q = Z("right"), L = Z("pin"), $ = Z("expand"), W = Z("minimize"), ue = Z("close"), dt = O("truncate"), Pt = O("focus-item"), Nt = O("tippy");
      return k((v(), b("div", {
        class: "h-full flex flex-col items-stretch",
        content: `<div style='word-break: break-word;'>${_(e)(r.panel.alertName) + ". " + _(e)("panels.access")}</div>`,
        ref_key: "el",
        ref: o
      }, [
        r.header ? (v(), b("header", Go, [
          se(g, {
            class: re(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: h[0] || (h[0] = (Me) => r.panel.close())
          }, null, 8, ["class"]),
          k((v(), b("h2", Uo, [
            y.$slots.header ? Ce(y.$slots, "header", { key: 0 }) : (v(), b("div", Bo, D(_(e)(r.panel.alertName)), 1))
          ])), [
            [dt]
          ]),
          y.$slots.controls ? (v(), V(w, { key: 0 }, {
            default: X(() => [
              Ce(y.$slots, "controls")
            ]),
            _: 3
          ...
          m("div", {
            ...
            r.panel.teleport ? F("", !0) : (v(), b("div", zo, [
              c.value ? (v(), V(A, {
                key: 0,
                onClick: h[1] || (h[1] = (Me) => u("left")),
                active: !r.panel.isLeftMostPanel
              }, null, 8, ["active"])) : F("", !0),
              c.value ? (v(), V(q, {
                key: 1,
                onClick: h[2] || (h[2] = (Me) => u("right")),
                active: !r.panel.isRightMostPanel
              }, null, 8, ["active"])) : F("", !0),
              se(L, {
                onClick: h[3] || (h[3] = (Me) => r.panel.pin()),
                active: r.panel.isPinned
              }, null, 8, ["active"]),
              r.panel.controls && r.panel.controls.expand ? (v(), V($, {
                key: 2,
                onClick: h[4] || (h[4] = (Me) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : F("", !0)
            ])),
            r.panel.button && l.value?.includes(r.panel.id) ? (v(), V(W, {
              key: 1,
              onClick: h[5] || (h[5] = (Me) => r.panel.minimize())
            })) : F("", !0),
            se(ue, {
              onClick: h[6] || (h[6] = (Me) => r.panel.close())
            })
          ], 2)
        ])) : F("", !0),
        r.content ? (v(), b("div", Vo, [
          y.$slots.content ? Ce(y.$slots, "content", { key: 0 }) : d.value ? (v(), b("div", {
            key: 1,
            innerHTML: d.value.innerHTML
          }, null, 8, jo)) : F("", !0)
        ])) : F("", !0),
        r.footer ? k((v(), b("div", qo, [
          Ce(y.$slots, "footer")
        ])), [
          [Pt]
        ]) : F("", !0)
...
}), Ho = { class: "relative" }, Yo = ["content", "aria-label"], Jo = ["transform"], Zo = /* @__PURE__ */ C({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Ko = { class: "relative" }, Qo = ["content", "aria-label"], Xo = /* @__PURE__ */ C({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), en = { class: "relative" }, tn = ["content", "aria-label"], sn = /* @__PURE__ */ C({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), rn = { class: "w-32 h-32" }, on = ["content"], nn = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), cn = { class: "relative" }, pn = ["content", "aria-label"], un = /* @__PURE__ */ C({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), dn = { class: "relative" }, hn = ["content", "aria-label"], fn = /* @__PURE__ */ C({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), mn = { class: "relative" }, gn = ["content", "aria-label"], yn = /* @__PURE__ */ C({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), bn = /* @__PURE__ */ ke(vn, [["__scopeId", "data-v-51e22a4a"]]), An = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return v(), V(n, {
        ...
        default: X(() => [
          _(t).isFullscreen ? (v(), b("svg", An, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, In = ["content", "aria-label"], Tn = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, $n = ["aria-label", "content"], Rn = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), Cn = /* @__PURE__ */ ke(Rn, [["__scopeId", "data-v-457cd2d4"]]), On = G("areas-of-interest", () => ({ areas: f([]) })), kn = G("export", () => {
  const r = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Nn {
  ...
  fsaToProvinces(e) {
    const t = {};
    let i = Pn[e.substring(0, 1).toUpperCase()];
...
function Un(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new Bn(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new zn(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new Vn(r, e.substring(0, 6).toUpperCase()) : new jn(r, e);
}
class kt {
  config;
  query;
...
const gi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", yi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", vi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", bi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", qn = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Ai {
  ...
  constructor(e, t) {
    ...
    const a = t?.settings;
    let c, p, u, d, y;
    a ? (c = a.categories ? a.categories : [], p = a.sortOrder ? a.sortOrder : [], u = a.disabledSearchTypes ? a.disabledSearchTypes : [], d = a.maxResults > 0 ? a.maxResults : 100, y = !!a.officialOnly) : (c = [], p = [], u = [], d = 100, y = !1), this.config = {
      language: e,
      geoNameUrl: s,
      geoLocateUrl: i,
      types: Gn(e, n),
   ...
   */
  query(e) {
    return Un(this.config, e.toUpperCase()).onComplete.then((t) => {
      let i = [];
...
const Wn = G("geosearch", () => {
  const r = f(new Ai("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), s = f(""), o = f(""), n = f([]), l = f([]), a = f(!1), c = f([]), p = M(
    () => new Promise((L) => {
  ...
  function h(L) {
    e.value.province = typeof L.province > "u" ? "" : L.province, y(L.forceReRun);
  }
  function g(L) {
    e.value.type = typeof L.type > "u" ? "" : L.type, y(L.forceReRun);
  }
  function w(L) {
    o.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = L, y();
  }
  function A(L) {
    const $ = {
...
class Qi extends J {
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = at.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new Y(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof Ne) || this._lastVisible.layerControlAvailable(z.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (s) => !(s instanceof Ne) || s.layerControlAvailable(z.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof Ne && !this.layerControlAvailable(z.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
...
var Yn = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(Yn || {});
class Ei extends Qi {
  _infoType;
...
const Jn = G("legend", () => {
  ...
  function o(a) {
    if (a.parent === void 0)
      ...
      if (!(a.item instanceof Ei) && !(a.item instanceof Ne)) {
  ...
  const r = f({
    ...
    tileSchemas: [],
    initialBasemapId: ""
  }), e = f({}), t = f(!0), i = f(1.5), s = f("#FF0000"), o = f(1), n = f("#000000"), l = f(0.25);
  function a(c) {
...
const ta = G("wizard", () => {
  const r = {
    ...
    layerType: x.UNKNOWN,
    url: ""
  }, e = f(), t = f(""), i = f(""), s = f(!0), o = f(null), n = f({
    config: r,
    configOptions: []
  }), l = f(ee.UPLOAD);
  function a(c) {
...
class ia {
  ...
  constructor(e, t, i) {
    ...
    const s = sa(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.fixture = new Ka(this), this.panel = new Qa(this), this.geo = new Ja(this), this.ui = {
   ...
   */
  initialize(e, t, i) {
    const s = ce(this.$vApp.$pinia), o = We(this.$vApp.$pinia), n = $t(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      const p = setInterval(() => {
        ...
        if (h && (clearInterval(p), this.geo.map.createMap(c.map, h), h._tippy.hide(0), n.setMaptipInstance(h._tippy), c.layers && c.layers.length > 0)) {
          let g = 0;
          c.layers.forEach((w) => {
            const A = this.geo.layer.createLayer(w);
            this.geo.map.addLayer(A, g).catch(() => {
            }), A.mapLayer && g++;
          });
        }
      }, 100);
      if (c.panels) {
        if (c.panels.open && c.panels.open.length > 0) {
          const h = c.panels.open.map((g) => g.id);
      ...
      }, d = c.system?.zoomIcon || "globe", y = u[d] || d;
      this.ui.getZoomIcon = () => y, this.ui.formatNumber = (h) => this.ui.suppressNumberLocalization ? h.toString() : this.$i18n.n(h, "number"), this.ui.escapeHtml = (h) => {
        const g = {
          "<": "&lt;",
          ">": "&gt;",
          '"': "&quot;",
   ...
   */
  reload(e, t) {
    const i = et(this.$vApp.$pinia), s = _e(this.$vApp.$pinia), o = ce(this.$vApp.$pinia), n = me(this.$vApp.$pinia), l = xe(this.$vApp.$pinia), a = qt(this.$vApp.$pinia), c = !!e;
...
function sa(r, e) {
  ...
  const i = ar(), s = Ri(So).use(i).use(Fs, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", Oo), s.directive("focus-list", To), s.directive("focus-item", $o), s.directive("truncate", No), s.component("panel-screen", Wo), s.component("pin", Zo), s.component("close", Xo), s.component("back", sn), s.component("expand", ln), s.component("panel-options-menu", bn), s.component("dropdown-menu", Xt), s.component("minimize", un), s.component("right", fn), s.component("left", yn), s.component("fullscreen-nav-button", En), s.component("geolocator-nav-button", xn), s.component("home-nav-button", Sn), s.component("mapnav-button", Tn), s.component("appbar-button", Cn), s.component("transition", Li), s.component("transition-group", $i), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
...
class na extends J {
   ...
   */
  constructor(e) {
    super(e), this.maptipStore = $t(this.$vApp.$pinia);
  }
  ...
  updateAttribution(e) {
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, De(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      const n = 5e3, l = 20, a = this.$iApi.geo.map.esriMap.basemap.baseLayers.map((c) => new Promise((p) => {
        let u = 0;
        const d = n / l, y = setInterval(function() {
          c.loaded && !c.loadError ? (clearInterval(y), p(c)) : u > d && (clearInterval(y), p(null)), u++;
        }, l);
      })).toArray();
      Promise.all(a).then((c) => {
        o = c.filter((u) => u?.copyright).map((u) => u.copyright).join(" | "), s.text.value = o || s.text.value || t.value, De(this.$vApp.$pinia).setAttribution(s);
      });
    }
  }
  /**
...
class la extends oa {
   ...
   */
  constructor(e) {
    super(e), this.maptip = new na(e), this.caption = new aa(e), this.mapMouseThrottle = 0;
  }
  /**
   * Will generate the actual Map control objects and construct it on the page
   * @param {RampMapConfig} config the config for the map
  ...
  createMapView(e) {
    ...
    this._rampExtentSet = yt.fromConfig(n), this._rampSR = this._rampExtentSet.sr.clone();
      ...
      if (this.esriMap || (this.noMapErr(), s()), e.initiationState !== P.INITIATING && e.initiationState !== P.INITIATED && e.layerState !== B.ERROR && e.initiate(), e.mapLayer && t === void 0) {
        ...
        if (e.isCosmetic)
          ...
          for (let d = c.length - 1; d >= 0 && u; d--) {
            const y = p.find((h) => h.id === c[d]);
            y && !y.isCosmetic && (t = d + 1, u = !1);
          }
          u && (t = 0);
        }
      }
  ...
  removeLayer(e) {
    ...
    i.removeLayer(t), i.removeLayerConfig(t.id), t.removeEsriLayer(), t.initiationState === P.INITIATED && t.terminate(), t.isRemoved = !0, this.$iApi.event.emit(E.LAYER_REMOVE, t);
  }
  /**
...
const ca = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, pa = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, ua = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, da = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, ha = {
  circlePoint: ca,
  solidLine: pa,
  outlinedPoly: ua,
  boundingBoxPoly: da
...
class ba extends J {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    ma(e);
    const l = e.features[0].geometry.type, a = fa[l], c = JSON.parse(
      // @ts-ignore
      JSON.stringify(ha[a])
    );
    if (t) {
    ...
    const y = n.fields.map((g) => g.name);
    for (let g = 0; g < d.length; g++) {
      const w = d[g];
      w.geometry.spatialReference = u, w.geometry.type = n.geometryType, Object.keys(w.attributes).forEach((A) => {
        y.includes(A) ? (Array.isArray(w.attributes[A]) || typeof w.attributes[A] == "object") && w.attributes[A] != null && (w.attributes[A] = JSON.stringify(w.attributes[A])) : delete w.attributes[A];
      });
    }
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((g) => g.trim && y.includes(g.name)).map((g) => g.name) : []).forEach((g) => {
      for (let w = 0; w < d.length; w++) {
        const A = d[w].attributes;
        typeof A[g] == "string" && (A[g] = A[g].trim());
      }
  ...
  fgbToGeoJson(e, t) {
    return new Promise((s) => {
      let o = !1, n = null;
      const l = Hs.deserialize(new Uint8Array(e), void 0, (p) => {
        n = p.crs, o = !0;
      });
      let a = 0;
      const c = setInterval(() => {
        if (l && o) {
          clearInterval(c);
          let p;
          n && (n.code && n.code !== 4326 && n.org === "EPSG" ? p = new I(n.code) : n.wkt ? p = new I(n.wkt) : console.error("Encountered FlatGeobuf with non-EPSG org: ", n)), p && (l.crs = p.toGeoJSON()), s(l);
        } else
          a += 60, a > t && (clearInterval(c), s({}));
      }, 60);
    });
  }
  /**
  ...
  async unzipSingleFile(e) {
    const i = await new Ws().loadAsync(e), s = Object.keys(i.files)[0];
    if (s && i.file(s))
      return await i.file(s).async("arraybuffer");
...
class wa extends J {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    const c = new Tt(e).updateQuery(l), [p, u] = await qe(Ct.get(c));
    if (!u)
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      const y = Math.min(s, t - i - d.features.length);
      ...
      return n && o.features.length > 0 && o.features[0].geometry.type === U.POINT && o.features.forEach((y) => {
        const h = y.geometry.coordinates;
        y.properties.rvInternalCoordX = h[0], y.properties.rvInternalCoordY = h[1];
      }), o;
  }
  /**
  ...
  parseCapabilities(e) {
    const t = () => {
      ...
      return l ? (Array.isArray(l) || (l = [l]), l.map((a) => {
        ...
        let u = a.Style;
        const d = [], y = {};
        return u && (Array.isArray(u) || (u = [u]), u.forEach((h) => {
          const g = h.Name;
          if (d.push(g), h.LegendURL) {
            const A = h.LegendURL.OnlineResource["@_xlink:href"];
            y[g] = A.replaceAll("&amp;", "&");
          }
        })), {
    ...
    return i.then((n) => {
      if (!n)
        return [];
      const l = new XMLSerializer().serializeToString(n), a = {
        ignoreAttributes: !1
        // check for tag attributes
      }, c = new Ys(a).parse(l);
      if ("ServiceExceptionReport" in c)
        return console.error(c.ServiceExceptionReport.ServiceException), [];
      const p = c.WMS_Capabilities.Capability;
      return {
        layers: s(p),
...
class Ea extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new ba(e), this.ogc = new wa(e);
  }
  /**
...
class ti extends J {
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new ve(new Be()));
  }
  /**
...
class Xi extends ti {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = T.NONE, this.dataFormat = Q.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = fe.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = K.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = B.NEW, this.initiationState = P.NEW, this.drawState = le.NOT_LOADED, this.loadDefProm = new Y(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.layerTree = new It(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new ve(new Be()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
...
class Ze extends ii {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === K.HYBRID || this.identifyMode === K.SYMBOLIC) && (s = o.then(async () => {
      ...
      n.forEach((a) => {
        i.items.push(vt.makeRawItem(rt.ESRI, a.attributes));
      }), l.forEach((a) => {
...
class Ca extends ii {
  tooltipField;
  constructor(e, t) {
    super(e, t), this.dataFormat = Q.ESRI_FEATURE, this.tooltipField = "", this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = fe.FEATURE, e.identifyMode && e.identifyMode !== K.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = K.HYBRID;
  }
  async onInitiate() {
  ...
  onLoadActions() {
    ...
    i && (this.esriLayer.renderer = lt(this.origRampConfig.customRenderer));
...
class Oa extends Je {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = x.MAPIMAGE, this.layerFormat = fe.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = K.GEOMETRIC;
  }
  async onInitiate() {
  ...
  onLoadActions() {
    ...
    const o = [], n = (a, c) => {
      ...
      if (a.sublayers && a.sublayers.length > 0) {
        const d = (u ? u.name : "") || a.title || "", y = new It(p, "", d, !1);
        c.findChildByIdx(p) || c.children.push(y), a.sublayers.reverse().forEach((h) => {
          n(h, y);
        });
      } else {
        this._sublayers[p] || (this._sublayers[p] = new ka(
          {
            id: `${this.id}-${p}`,
            index: p,
        ...
        if (d.isRemoved)
          return;
        if (d.name = u?.name || a.title || "", o.push(d), !c.children.map((y) => y.layerIdx).includes(p)) {
          const y = new It(p, d.uid, d.name, !1);
          c.children.push(y);
        }
        d.esriWatches.push(
          a.watch("visible", () => {
    ...
    const l = o.map(async (a) => {
      ...
      if (u && (a.esriSubLayer.renderer = lt(p.customRenderer)), await a.loadLayerMetadata(u ? { customRenderer: a.esriSubLayer?.renderer } : {}), t < this.lastCancel)
        return;
      ...
      if (d ? (a.visibility = a.isRemoved ? !1 : d.state?.visibility ?? (this.origState.visibility ? a._serverVisibility ?? this.origState.visibility : this.origState.visibility ?? a._serverVisibility) ?? !0, a.opacity = d.state?.opacity ?? this.origState.opacity ?? 1, a.nameField = d.nameField || a.nameField || "", this.$iApi.geo.attributes.applyFieldMetadata(a, d.fieldMetadata), a.canModifyLayer || this.$iApi.notify.show(
        ...
        const y = await this.$iApi.geo.layer.loadFeatureCount(
          a.serviceUrl,
          a.getSqlFilter(ne.PERMANENT)
        );
        t > this.lastCancel && (a.featureCount = y);
      }
    });
...
class ka extends ii {
  tooltipField;
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = fe.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = Q.ESRI_FEATURE, this.supportsFeatures = !0, this.tooltipField = "", this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class Ma extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.OSM, this.layerFormat = fe.OSM, this.dataFormat = Q.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
...
class Pa extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERY, this.layerFormat = fe.IMAGERY, this.dataFormat = Q.ESRI_RASTER;
  }
  async onInitiate() {
...
class Na extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.TILE, this.layerFormat = fe.TILE, this.dataFormat = Q.ESRI_TILE;
  }
  async onInitiate() {
...
class Fa extends Je {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = fe.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = Q.OGC_RASTER, this.identifyMode = K.GEOMETRIC;
  }
  async onInitiate() {
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((s) => {
      if (s) {
        let o = !0, n;
        typeof s != "string" ? n = rt.JSON : s.indexOf("Search returned no results") === -1 && s !== "" ? n = rt.TEXT : (o = !1, n = rt.UNKNOWN), o && i.items.push(vt.makeRawItem(n, s));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    let n, l;
    const a = s.getExtent(), c = o.spatialReferences, p = e.join(","), u = s.esriView.toScreen(t.toESRI()), d = Math.floor(u.x), y = Math.floor(u.y), g = {
    ...
    }, this.$iApi.geo.layer.ogc.reversedAxisWKIDs().indexOf(n) > -1 && (l.BBOX = `${a.ymin},${a.xmin},${a.ymax},${a.xmax}`)) : l = { SRS: "EPSG:" + n, X: d, Y: y }, Object.prototype.hasOwnProperty.call(l, "BBOX") || (l.BBOX = `${a.xmin},${a.ymin},${a.xmax},${a.ymax}`);
    const A = {
      SERVICE: "WMS",
    ...
    }), Object.keys(A).forEach((L) => l[L] = A[L]), Ue(o.url.split("?")[0], {
      query: l,
      responseType: g
    });
  }
...
class es extends Xi {
  ...
  async reload() {
    this.$iApi.event.emit(E.LAYER_RELOAD_START, this), await this.terminate(), await this.initiate(), this.layerState !== B.ERROR && this.onLoad(), setTimeout(() => {
...
class Ha extends J {
  ...
  async symbolToSvg(e) {
    ...
    const o = Xe(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), n = {
      // @ts-ignore
      path({ size: h, path: g }) {
        return o.path(g).size(h * i);
      },
      // @ts-ignore
      circle({ size: h }) {
        return o.circle(h * i);
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (h, g) => o.pattern(5, 5, (A) => A.line(0, 5 / 2, 5, 5 / 2)).stroke(g),
      vertical: (h, g) => o.pattern(5, 5, (A) => A.line(5 / 2, 0, 5 / 2, 5)).stroke(g),
      "forward-diagonal": (h, g) => o.pattern(5, 5, (A) => {
        A.line(0, 0, 5, 5).stroke(g), A.line(0, 0, 5, 5).move(0, 5).stroke(g), A.line(0, 0, 5, 5).move(5, 0).stroke(g);
      }),
      "backward-diagonal": (h, g) => o.pattern(5, 5, (A) => {
        A.line(5, 0, 0, 5).stroke(g), A.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(g), A.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(g);
      }),
      cross: (h, g) => o.pattern(5, 5, (A) => {
        A.line(5 / 2, 0, 5 / 2, 5).stroke(g), A.line(0, 5 / 2, 5, 5 / 2).stroke(g);
      }),
      "diagonal-cross": (h, g) => o.pattern(7, 7, (A) => {
        A.line(0, 0, 7, 7).stroke(g), A.line(7, 0, 0, 7).stroke(g);
      })
    }, u = {
      "simple-marker"() {
        const h = y(e.color);
        e.outline = e.outline || c;
        const g = y(e.outline.color), w = d({
          color: g.colour,
          opacity: g.opacity,
      ...
      "picture-fill"() {
        const h = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, g = e.width * e.xscale, w = e.height * e.yscale;
        e.outline = e.outline || c;
        const A = y(e.outline.color), q = d({
          color: A.colour,
          opacity: A.opacity,
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then(($) => {
          const W = o.pattern(
            g,
            w,
            (ue) => (
      ...
      "picture-marker"() {
        const h = e.source, g = h && h.imageData ? `data:${h.contentType};base64,${h.imageData}` : e.url;
        return t.$iApi.geo.shared.convertImagetoDataURL(g).then((A) => t.svgDrawImage(o, A)).then(({ image: A }) => {
  ...
  mapServerLegendToRendererAll(e) {
    ...
    return this.makeRenderer(lt(i), [], !0);
  }
  /**
...
class Ya extends J {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, o) => {
      let n;
      return t.returnGeometry ? n = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${o}`) : n = new Be(), new ve(n, "", s.attributes);
    });
  }
  /**
...
class Ja extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = at.geom, this.proj = at.proj, this.shared = at.sharedUtils, this.map = new la(e), this.layer = new Ea(e), this.attributes = new Ba(e), this.query = new Ya(e), this.symbology = new Ha(e), Array.isArray(ht.request.interceptors) || (ht.request.interceptors = []), ht.request.interceptors.push({
      before: (t) => {
...
const Za = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BM9ddELm.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DvgUVyQc.js"), "../fixtures/basemap/index.ts": () => import("./index-DNNLC1SS.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BubUg905.js"), "../fixtures/details/index.ts": () => import("./index-p3f4iQV6.js"), "../fixtures/export-footnote/index.ts": () => import("./index-tEl5zavN.js"), "../fixtures/export-legend/index.ts": () => import("./index-B7V3WDL9.js"), "../fixtures/export-map/index.ts": () => import("./index-C-gedqHW.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-DYiC4ZXt.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-BUXFhnxi.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BEipeVed.js"), "../fixtures/export-title/index.ts": () => import("./index-BWIRemqL.js"), "../fixtures/export/index.ts": () => import("./index-BiuCbSS_.js"), "../fixtures/extentguard/index.ts": () => import("./index-BYtZfEaw.js"), "../fixtures/gazebo/index.ts": () => import("./index-CZEpYh5D.js"), "../fixtures/geosearch/index.ts": () => import("./index-D0HYTecG.js"), "../fixtures/grid/index.ts": () => import("./index-BxMWViYk.js"), "../fixtures/help/index.ts": () => import("./index-BkVXcv7j.js"), "../fixtures/hilight/index.ts": () => import("./index-zBix2o21.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CDVl5xYp.js"), "../fixtures/legend/index.ts": () => import("./index-Ci3P6eDT.js"), "../fixtures/mapnav/index.ts": () => import("./index-C-Kr0TCJ.js"), "../fixtures/metadata/index.ts": () => import("./index-Bs6B_Vgy.js"), "../fixtures/northarrow/index.ts": () => import("./index-Bcp0-Cks.js"), "../fixtures/overviewmap/index.ts": () => import("./index-B5O5mJ-J.js"), "../fixtures/panguard/index.ts": () => import("./index-I0glPk-8.js"), "../fixtures/scrollguard/index.ts": () => import("./index-B3iutb_m.js"), "../fixtures/settings/index.ts": () => import("./index-NQo7gvaN.js"), "../fixtures/snowman/index.ts": () => import("./index-JKBk4VXa.js"), "../fixtures/wizard/index.ts": () => import("./index-ZTajJ5v1.js") });
class Ka extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const s = (await Za[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
...
const il = /* @__PURE__ */ ke(el, [["render", tl], ["__scopeId", "data-v-a3c61802"]]), sl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DI4P0hgc.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DUhWmopY.js"), "../fixtures/export/screen.vue": () => import("./screen-DmONhYKM.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-xv2AAjGm.js"), "../fixtures/grid/screen.vue": () => import("./screen-B3nDbsYd.js"), "../fixtures/help/screen.vue": () => import("./screen-CDqYxVWY.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-C2Tc2Vj2.js"), "../fixtures/legend/screen.vue": () => import("./screen-p1ga6I4M.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CgTxE9Cv.js"), "../fixtures/settings/screen.vue": () => import("./screen-Bo76l22r.js"), "../fixtures/wizard/screen.vue": () => import("./screen-C_OYYzAX.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (tr(t) || er(t))
      ...
      let s;
      typeof t == "string" ? s = sl[`../fixtures/${t}`]() : s = t();
...
function ol(r) {
  ...
  return al(r.services, e), nl(r.map, e), ll(r.ui, e), r.plugins && cl(r.plugins, e), e;
}
function nl(r, e) {
...
function Vt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), pl(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var tt = { major: "4", minor: "10", patch: "0-beta", timestamp: "Tue Dec 3 16:58:03 2024 -0500", hash: "aa4028af73ce5b45e8590dc98b3282cbefbcea83" };
console.info(
...
const _c = (r, e, t) => new ia(r, e, t), at = new Xs();
export {
  Y as $,
  Wr as A,
  Xn as B,
