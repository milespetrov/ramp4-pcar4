...
import { n as M, _ as R } from "./main-DD4M6ybf.js";
const W = { class: "mb-10" }, G = ["aria-label"], J = {
  ...
  setup(e) {
    const { t: v } = $(), y = I("iApi"), n = M(), c = N(() => n.activeBasemapConfig), u = (r) => {
      r.id !== c.value.id && y?.geo.map.setBasemap(r.id);
    };
    return (r, s) => {
      const g = m("truncate"), i = m("tippy"), d = m("focus-item");
      return t(), a("div", W, [
        p((t(), a("button", {
...
}), se = /* @__PURE__ */ R(ae, [["__scopeId", "data-v-7cf27f80"]]), le = ["content"], ne = { class: "h-600 overflow-y-auto" }, ie = { class: "font-bold text-xl" }, oe = {
  key: 0,
  ...
  setup(e) {
    const { t: v } = $(), y = M(), n = O("el"), c = S([]), u = S([]), r = (i) => {
    ...
    const g = (i) => u.value.filter((d) => d.tileSchemaId === i);
    return (i, d) => {
