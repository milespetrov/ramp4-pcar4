import "tiny-emitter";
import { F as C, v as y, n as G, G as T, P as W, w as z, L as B, x as H, y as R } from "./main-DD4M6ybf.js";
...
const Q = "path", Z = 12, ee = "M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6z", te = "#ff0000ff", oe = 5, re = 6, ie = {
  ...
  setup(S) {
    ...
    const x = async (i) => {
      ...
      const p = e.$vApp.$el.querySelector(".inner-shell"), h = f.value.querySelector(".northarrow").getBoundingClientRect().width, u = e.$vApp.$el.querySelector(".appbar")?.clientWidth || 0, I = i.sr;
      if (m || typeof m > "u" && !I.isWebMercator()) {
