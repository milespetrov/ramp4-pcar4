...
import "tiny-emitter";
import { F as _ } from "./main-DD4M6ybf.js";
...
const G = /* @__PURE__ */ m({
      ...
      return u(), b(n, { panel: o.panel }, {
        ...
        content: p(() => [
          e("div", $, [
            e("button", {
              type: "button",
              onClick: t[0] || (t[0] = (i) => o.panel.show({ screen: "p-1-screen-2" })),
      ...
      return u(), b(n, { panel: o.panel }, {
        ...
        content: p(() => [
          e("div", S, [
            e("button", {
              type: "button",
              onClick: t[0] || (t[0] = (i) => o.panel.show({ screen: "p-1-screen-1" })),
              class: "bg-blue-500 hover:bg-blue-700 text-white font-bold py-8 px-16"
            }, " See Gazebo 1 "),
      ...
      return u(), b(y, { panel: o.panel }, {
        ...
        content: p(() => [
          ...
          e("div", j, [
            e("button", {
              type: "button",
              onClick: l[0] || (l[0] = (w) => o.panel.show({
                screen: "p-2-screen-1",
  ...
  setup(o) {
    ...
    return (t, n) => {
      const i = c("panel-screen");
      return u(), b(i, { panel: o.panel }, {
        header: p(() => n[1] || (n[1] = [
