import{H as He,o as B,s as Vt,A as Ht,c as we,r as Wt,g as We,P as Ut,N as Yt}from"./vec32-C2FCiZmk.js";import{f1 as Me,gs as ye,gu as X,ao as N,D as s,G as Se,O as qt,dP as oe,ai as Jt,fx as Zt,am as kt,ct as Xt,aD as $t}from"./main-W1WhlPr3.js";import{l as Ue}from"./ViewingMode-CyR_b1T8.js";import{H as Kt}from"./InterleavedLayout-dPuW8IW9.js";import{n as g,u as $,t as Ye,o as Ce,r as Qt}from"./ShaderOutput-C_OqLoo1.js";import{n as E,a as b,t as re}from"./NormalAttribute.glsl-BIhxBvM9.js";import{r as ea,u as A,v as ta,F as aa,x as oa,y as ra,z as ie,p as ia,B as na,l as sa,b as L,C as F,a as V,D as H,E as W,G as K,H as O,I as U,J as la,K as ca,L as da,M as P,P as ua,Q as qe,R as Je,S as Ze,T as ke,U as ma,V as Oe,W as ne,X as Xe,Y as ha,e as se,Z as pa,_ as va,$ as Ne,a0 as le,i as $e,o as z,a1 as m,a2 as ze,a3 as fa,a4 as Ee,a5 as ce,h as ga,a6 as xa,a7 as Ke,a8 as ba,a9 as Ta,aa as Qe,ab as et,d as de,ac as tt,ad as at,ae as ot,af as rt,ag as it,ah as ue,ai as nt,aj as wa,ak as st,al as Ma,am as ya,an as Sa,ao as Ca,ap as Oa,aq as Na,ar as za,as as Ea,at as d,au as D,av as _a,aw as Ga,A as _e,ax as Ia,ay as Aa,az as La,aA as Ra,aB as Fa,aC as Pa,aD as Da}from"./Geometry-B4ulSPoy.js";import{n as r,t as f}from"./glsl-o28TenZV.js";import{i as _,a as lt,e as Q,n as me}from"./basicInterfaces-Dsf65ICa.js";import{e as T}from"./VertexAttribute-DFC3a3eR.js";import{n as ct,r as ja}from"./vec4f64-CjUMzAyX.js";import{e as Ge,o as Y}from"./mat3f64-Dh9_zhFu.js";import{j as Ba}from"./mat3-DOnW3DjW.js";import{o as dt}from"./mat4f64-BaJwL7tQ.js";import{o as Va,r as Ha}from"./doublePrecisionUtils-BJbYwoii.js";import{a as Ie}from"./BindType-CKbZk6AG.js";import{s as Wa,n as ut}from"./vec2f64-CEUyUoff.js";import{o as he}from"./vec2-BnynUbeJ.js";import{i as pe}from"./ShaderBuilder-S2yNqWbv.js";import{B as Ae,g as Le,f as Ua}from"./renderState-eEtyJpmy.js";import{D as mt,G as Ya,t as qa,_ as Ja,f as Za,O as ht}from"./enums-DBi1-Mm2.js";import{p as ka,w as Xa}from"./Texture-CfN_xOmF.js";import{s as G}from"./vec42-D8CJyqHG.js";function $a(e){e.vertex.code.add(r`
...
}`);break;case b.ScreenDerivative:e.vertex.code.add(r`void forwardNormal() {}`);break;default:Me(t.normalType);case b.COUNT:}}let Ka=class extends aa{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Ge()}},vt=class extends ta{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Ge(),this.toMapSpace=ct()}};function Qa({normalTexture:e,metallicRoughnessTexture:t,metallicFactor:a,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return e==null&&t==null&&i==null&&(n==null||He(n,ye))&&c==null&&(o==null||o===1)&&(a==null||a===1)}const ft=X(1,1,.5),eo=X(0,.6,.2),to=X(0,1,.2);function gt(e){e.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
}`),t.textureCoordinateType!==P.None&&(e.include(ua,t),a.uniforms.add(t.bindType===Ie.Pass?new O("normalTexture",o=>o.textureNormal):new qe("normalTexture",o=>o.textureNormal)),t.hasNormalTextureTransform&&(a.uniforms.add(new Je("scale",o=>o.scale??Wa)),a.uniforms.add(new A("normalTextureTransformMatrix",o=>o.normalTextureTransformMatrix??Y))),a.code.add(r`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`))}const At=N(),I=ct();function ho(e){const t=e.fragment.code;t.add(r`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG)
{
...
}`)}function xe(e){e.constants.add("ambientBoostFactor","float",fa)}function be(e){e.uniforms.add(new se("lightingGlobalFactor",t=>t.lighting.globalFactor))}function De(e,t){const a=e.fragment;switch(e.include(ge,t),t.pbrMode!==m.Disabled&&e.include(Pe,t),e.include(It,t),e.include(ze),a.code.add(r`
