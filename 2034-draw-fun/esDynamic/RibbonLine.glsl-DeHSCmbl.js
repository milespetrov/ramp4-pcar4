...
}`),n.uniforms.add(new fi("stipplePatternTexture",a=>a.stippleTexture),new q("stipplePatternSDFNormalizer",a=>Or(a.stipplePattern)),new q("stipplePatternPixelSizeInv",a=>1/Pt(a))),t.stippleOffColorEnabled&&n.uniforms.add(new Me("stippleOffColor",a=>Tr(a.stippleOffColor))),n.code.add(p`float getStippleSDF(out bool isClamped) {
...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function Or(e){return e?(Math.floor(.5*(Sr(e)-1))+.5)/e.pixelRatio:1}function Pt(e){const t=e.stipplePattern;return t?gr(e.stipplePattern)/t.pixelRatio:1}const yr=.4,Ye=64,wt=Ye/2,Er=wt/5,Ar=Ye/Er,Rr=.25;function Nt(e,t){const i=e.vertex;We(i),i.uniforms.get("markerScale")==null&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",Ar).code.add(p`float getLineWidth() {
