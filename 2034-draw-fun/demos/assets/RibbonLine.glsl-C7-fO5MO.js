...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function vr(t){return t?(Math.floor(.5*(hr(t)-1))+.5)/t.pixelRatio:1}function Lt(t){const e=t.stipplePattern;return e?pr(t.stipplePattern)/e.pixelRatio:1}const gr=.4,It=64,Sr=It/2,_r=Sr/5,Tr=It/_r,Pn=.25;function br(t,e){const i=t.vertex;qe(i),i.uniforms.get("markerScale")==null&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",Tr).code.add(p`float getLineWidth() {
