import{bk as j,aP as ve,E as Ee,n as Se,dH as Oe,s as Te,aq as ft}from"./main-DvRWqUGe.js";import{w as Ae,a as ue,f as dt,g as _t,h as mt,i as vt,Z as F,_ as $e,$ as Pe}from"./definitions-C0Jy3zs7.js";import{e as pt,b as gt,h as Ze,f as L,n as re,s as le,r as ht}from"./LabelMetric-BiqvnRP-.js";import{E as k}from"./BufferObject-Bbf2B4_P.js";import{C as P,F as W,E as A,L as B,R as N,O as U,I as Q,N as xt,D as yt}from"./enums-D9v74xTE.js";import{o as Z}from"./VertexArrayObject-DiRvHQgL.js";import{t as ne}from"./VertexElementDescriptor-BOD-G50G.js";import{e as St,a as ce}from"./ProgramTemplate-BjDcvbjf.js";import{n as pe}from"./mat2df32-orApM5a3.js";import{r as Tt,e as bt}from"./mat2d-D9DBP-jx.js";import{r as Ke,i as ge,s as It}from"./mat3-OSHnlxii.js";import{e as ie,N as he,S as Ce,o as Et,q as Ot,E as ee}from"./MapView-BaoCSXvJ.js";import{o as At,N as Pt}from"./vec32-D8MUmfTD.js";import{n as Ct}from"./vec3f32-nZdmKIgz.js";import{e as qe,n as Dt}from"./Container-8b8j-XB9.js";import{e as Rt}from"./TileKey-DUjRwnXV.js";import{p as Lt,m as Mt}from"./Texture-DzKvHVRH.js";import{r as J,l as G,n as De}from"./StyleDefinition-BTt_i6C1.js";import{n as zt,t as Vt}from"./vec2f32-BbH2jxlN.js";import{e as Re}from"./config-MDUrh2eL.js";import{e as Nt}from"./earcut-Lltz9D9k.js";import{o as wt}from"./vec2-maR1OrZI.js";import{n as Le}from"./vec2f64-HfuIyxwA.js";import{Q as Ft,K as Bt}from"./featureConversionUtils-BI5de3CT.js";import{s as Me}from"./OptimizedGeometry-BF8iz5FO.js";let Ut=class{constructor(e,t){this._rctx=e,this._attributes=[{name:"position",offset:0,type:P.SHORT,count:2}],this.layout={hash:pt(this._attributes),attributes:this._attributes,stride:4},this._vertexBuffer=k.createVertex(e,W.STATIC_DRAW,new Uint16Array(t)),this._vao=new Z(e,new Map([["a_position",0]]),new Map([["geometry",[new ne("a_position",2,P.SHORT,0,4)]]]),new Map([["geometry",this._vertexBuffer]])),this._count=t.length/2}bind(){this._rctx.bindVAO(this._vao)}unbind(){this._rctx.bindVAO(null)}dispose(){this._vao.dispose()}draw(){this._rctx.bindVAO(this._vao),this._rctx.drawArrays(A.TRIANGLE_STRIP,0,this._count)}},$=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const de={nearest:{defines:[],samplingMode:B.NEAREST,mips:!1},bilinear:{defines:[],samplingMode:B.LINEAR,mips:!1},bicubic:{defines:["bicubic"],samplingMode:B.LINEAR,mips:!1},trilinear:{defines:[],samplingMode:B.LINEAR_MIPMAP_LINEAR,mips:!0}},Gt=(u,e,t)=>{if(t.samplingMode==="dynamic"){const{state:n}=u,i=e.resolution/e.pixelRatio/n.resolution,o=Math.round(u.pixelRatio)!==u.pixelRatio,a=i>1.05||i<.95;return n.rotation||a||o||e.isSourceScaled||e.rotation?de.bilinear:de.nearest}return de[t.samplingMode]};let Yt=class extends ${constructor(){super(...arguments),this._desc={vsPath:"raster/bitmap",fsPath:"raster/bitmap",attributes:new Map([["a_pos",0]])}}dispose(){this._quad&&this._quad.dispose()}prepareState({context:e}){e.setBlendingEnabled(!0),e.setColorMask(!0,!0,!0,!0),e.setStencilWriteMask(0),e.setStencilTestEnabled(!0)}draw(e,t){const{context:n,renderingOptions:i,painter:o,requestRender:a,allowDelayedRender:r}=e;if(!t.source||!t.isReady)return;const l=Gt(e,t,i),s=o.materialManager.getProgram(this._desc,l.defines);if(r&&a!=null&&!s.compiled)return void a();e.timeline.begin(this.name),t.blendFunction==="additive"?n.setBlendFunctionSeparate(N.ONE,N.ONE,N.ONE,N.ONE):n.setBlendFunctionSeparate(N.ONE,N.ONE_MINUS_SRC_ALPHA,N.ONE,N.ONE_MINUS_SRC_ALPHA),n.setStencilFunction(U.EQUAL,t.stencilRef,255),this._quad||(this._quad=new Ut(n,[0,0,1,0,0,1,1,1]));const{coordScale:c,computedOpacity:_,transforms:f}=t;t.setSamplingProfile(l),t.bind(e.context,Ae),n.useProgram(s),s.setUniformMatrix3fv("u_dvsMat3",f.displayViewScreenMat3),s.setUniform1i("u_texture",Ae),s.setUniform2fv("u_coordScale",c),s.setUniform1f("u_opacity",_),this._quad.draw(),e.timeline.end(this.name)}};function je(){return new Float32Array(4)}function kt(u){const e=new Float32Array(4);return e[0]=u[0],e[1]=u[1],e[2]=u[2],e[3]=u[3],e}function H(u,e,t,n){const i=new Float32Array(4);return i[0]=u,i[1]=e,i[2]=t,i[3]=n,i}function Ht(u,e){return new Float32Array(u,e,4)}function Xe(){return je()}function Qe(){return H(1,1,1,1)}function Je(){return H(1,0,0,0)}function et(){return H(0,1,0,0)}function tt(){return H(0,0,1,0)}function nt(){return H(0,0,0,1)}const Wt=Xe(),$t=Qe(),Zt=Je(),Kt=et(),qt=tt(),jt=nt();Object.freeze(Object.defineProperty({__proto__:null,ONES:$t,UNIT_W:jt,UNIT_X:Zt,UNIT_Y:Kt,UNIT_Z:qt,ZEROS:Wt,clone:kt,create:je,createView:Ht,fromValues:H,ones:Qe,unitW:nt,unitX:Je,unitY:et,unitZ:tt,zeros:Xe},Symbol.toStringTag,{value:"Module"}));const Xt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
