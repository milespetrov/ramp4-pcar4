import { p as s$1, c as s$2, aa as u, fM as x, aj as c$1, t as t$1 } from './main-9d6c9b53.js';
import { v, n } from './timeSupport-d05d56e3.js';
import { J } from './utils-0b43d38a.js';
import { p as p$1 } from './FeatureStore2D-e14cb3f5.js';
...
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await __vitePreload(() => import('./WhereClause-b52ce065.js').then(n => n.W),true?["./WhereClause-b52ce065.js","./main-9d6c9b53.js","./preload-helper-a4975f27.js","./main-2af48127.css","./executionError-ed2c63c0.js"]:void 0,import.meta.url);try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
