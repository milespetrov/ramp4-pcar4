...
}), An = { class: "flex items-center hover:text-white" }, jn = ["aria-label"], Mn = {
	key: 0,
...
}), [["__scopeId", "data-v-3623a7d2"]]), Rn = { class: "flex hover:text-white" }, zn = ["aria-label"], Bn = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Vn = ["aria-label", "content"], Hn = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Un = { class: "absolute right-5 top-5" }, Wn = { class: "select-text" }, Gn = { class: "font-bold cursor-text" }, Kn = { class: "text-sm cursor-text" }, qn = { class: "font-bold cursor-text" }, Jn = { class: "ml-5 cursor-text" }, Yn = { class: "mt-5" }, Xn = ["href"], Zn = /* @__PURE__ */ te(/* @__PURE__ */ D({
...
}), [["__scopeId", "data-v-cf71f458"]]), Qn = "__HELP__", $n = b("keyboardnav", () => {
...
var uo = class extends Z {
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-CyLhTyDc.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-CxGfLXPV.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-Dzq5aKS8.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-CK4OSbs5.js"),
	"../fixtures/details/index.ts": () => import("./details-qxB5AN0e.js"),
	"../fixtures/draw/index.ts": () => import("./draw-WtLulvJw.js"),
	"../fixtures/export/index.ts": () => import("./export-BUuBCuLy.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-DNYBWX1U.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-DUbt1ivy.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-D_B2QqJ-.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-I_7K3Lzo.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-DBdTPbIP.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-ukNVHr_3.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-BSMEUibc.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-C3BQB77S.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-CETgU8xp.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-DbTcuOlP.js"),
	"../fixtures/grid/index.ts": () => import("./grid-DuVL8VR_.js"),
	"../fixtures/help/index.ts": () => import("./help-BExXth5V.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-CJE9ulGw.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-C4aaIbVH.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-BJ6-xZ1d.js"),
	"../fixtures/legend/index.ts": () => import("./legend-B3INfSV2.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-CdiQdJEe.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-CHyCWDPO.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-DVxpUa9l.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-Mzkqajqa.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-BiUX6m8u.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-EYjimaL2.js"),
	"../fixtures/settings/index.ts": () => import("./settings-DLM_iHKS.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-CyRkTqjl.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-RhFNp8gw.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-DEjGed_V.js")
}), ds = class extends Z {
	constructor(e) {
		super(e);
	}
...
var _s = /* @__PURE__ */ te(hs, [["render", gs], ["__scopeId", "data-v-a3c61802"]]), vs = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-CVMO92XK.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-CecNqNOc.js"),
	"../fixtures/export/screen.vue": () => import("./screen-DAiDG20g.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-MmYIRah2.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-C42IgDuE.js"),
	"../fixtures/help/screen.vue": () => import("./screen-CYkky8X1.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-DhcU3DRJ.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-Ccgxt5nX.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-B1f9Os_y.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-D3guR4vz.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-BQqAICxB.js")
}), ys = class extends Z {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "21",
	patch: "0-beta",
	timestamp: "Thu May 14 11:36:22 2026 -0400",
	hash: "a2cfde6579db7449037ecc93fbd3e0c09c93ac9b"
}.major}.${{
	major: "4",
	minor: "21",
	patch: "0-beta",
