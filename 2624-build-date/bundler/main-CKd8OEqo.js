...
class Gs {
  ...
  async projectExtent(e, t) {
    ...
    const o = new se("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return v(), W(l, { panel: s.panel }, {
        header: te(() => [
          ot(G(S(t)("notifications.title")), 1)
        ]),
        content: te(() => [
          m("div", tr, [
            m("div", ir, [
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return P((v(), w("li", {
        ...
        m("div", nr, [
          m("span", null, [
            ot(G(a[s.notification.type]) + " ", 1),
            m("span", lr, G(s.notification.message), 1)
          ]),
    ...
    return (l, n) => {
      ...
      return v(), w("div", null, [
        o.value.length > 0 ? P((v(), w("ul", {
          ...
          m("span", null, G(S(t)("notifications.empty")), 1),
      ...
      return v(), W(ei, {
        ...
        header: te(() => [
          m("div", mr, [
            ...
            i.value && i.value > 0 ? (v(), w("span", gr, G(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          m("div", vr, [
            m("div", null, [
              m("h4", br, G(S(t)("notifications.title")), 1),
              m("div", Ar, [
                P((v(), w("button", {
                  type: "button",
                  onClick: r,
...
}), xr = /* @__PURE__ */ Fe(Er, [["__scopeId", "data-v-3623a7d2"]]), Sr = { class: "flex hover:text-white" }, Ir = ["aria-label"], _r = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Tr = ["aria-label", "content"], Lr = { class: "pb-8 border-b border-gray-600 mb-10" }, Rr = { class: "absolute right-5 top-5" }, $r = { class: "select-text" }, Cr = { class: "font-bold cursor-text" }, Or = { class: "text-sm cursor-text" }, kr = { class: "font-bold cursor-text" }, Mr = { class: "ml-5 cursor-text" }, Pr = /* @__PURE__ */ O({
        ...
        default: te((g) => [
          m("div", _r, [
            m("div", null, [
              ...
              m("div", $r, [
                m("div", null, [
                  m("span", Cr, G(r.value), 1),
                  m("span", Or, " [" + G(a.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", kr, G(o.value[0]), 1),
                  m("span", Mr, G(o.value[1]), 1)
                ]),
...
}), Nr = /* @__PURE__ */ Fe(Pr, [["__scopeId", "data-v-3f1e3715"]]), Fr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Dr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Gr = ["href", "aria-label"], Ur = ["src", "alt"], Br = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Vr = { class: "flex min-w-fit justify-end" }, zr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, qr = ["aria-pressed", "aria-label", "content"], jr = { class: "relative top-1 text-sm sm:text-base" }, Wr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Hr = ["onClick"], Yr = {
  key: 0,
  class: "sr-only"
}, Jr = /* @__PURE__ */ O({
  __name: "map-caption",
  setup(s) {
    ...
    return (A, b) => {
      ...
      return v(), w("div", Fr, [
        ...
        o.value?.text.disabled ? U("", !0) : P((v(), w("span", Br, [
          ot(G(o.value?.text.value), 1)
        ])), [
          [L, {
            options: {
              placement: "top",
        ...
        m("div", Vr, [
          l.value?.disabled ? U("", !0) : P((v(), w("div", zr, [
            ot(G(l.value?.formattedString), 1)
          ])), [
            [L, {
              options: {
                hideOnClick: !1,
          ...
          a.value?.disabled ? U("", !0) : P((v(), w("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? U("", !0) : (v(), W($, {
            ...
            header: te(() => [
              m("span", Wr, G(S(i)("map.language.short")), 1)
            ]),
            default: te(() => [
              (v(!0), w(He, null, ht(u.value, (V, ye) => (v(), w("a", {
                ...
                ot(G(S(i)("map.language." + V)) + " ", 1),
                V === S(r).$i18n.locale.value ? (v(), w("span", Yr, G(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, Hr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return P((v(), w("button", {
        ...
        r.value && r.value > 0 ? (v(), w("span", Zr, G(r.value), 1)) : U("", !0)
      ], 8, Kr)), [
        [l]
      ]);
    };
  }
}), Qr = /* @__PURE__ */ Fe(Xr, [["__scopeId", "data-v-a451db5c"]]), ea = { class: "flex items-center mb-20" }, ta = { class: "text-xl" }, ia = /* @__PURE__ */ O({
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        m("div", {
          ...
          m("div", ea, [
            m("h2", ta, G(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
          ...
          (v(!0), w(He, null, ht(r.value, (d) => (v(), w("p", {
            ...
            key: d
          }, G(S(t)(`keyboardInstructions.${d}`)), 1))), 128)),
          m("button", {
            type: "button",
            ...
            ref_key: "lastEl",
            ref: l
          }, G(S(t)("keyboardInstructions.OK")), 513)
        ], 512)
      ], 32)) : U("", !0);
    };
  }
}), st = B("instance", () => ({ started: f(!1) })), sa = { class: "h-full relative" }, ra = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, aa = { class: "absolute top-8 w-full flex justify-center" }, oa = {
  key: 1,
  class: "w-full h-full"
}, na = /* @__PURE__ */ O({
  __name: "shell",
      ...
      m("div", ra, [
        ...
        m("div", aa, [
          m("button", {
            ...
            onClick: l
          }, G(S(a)("keyboardInstructions.open")), 1)
        ]),
        re(ia),
        ...
        o.value ? U("", !0) : (v(), W(Qr, { key: 0 })),
        re(Jr, { class: "z-30" })
      ]),
      S(t).started ? (v(), W(Js, { key: 0 })) : (v(), w("div", oa, u[1] || (u[1] = [
...
}), la = /* @__PURE__ */ Fe(na, [["__scopeId", "data-v-7a1e48c2"]]), ca = O({
  name: "App",
  components: { Shell: la },
  setup() {
    const s = ms();
...
const ha = /* @__PURE__ */ Fe(ca, [["render", da]]), Ie = "focus-list", je = "focus-item", fa = "focus-icon", ma = "focus-container", ct = `[${Ie}],[${ma}]`, At = "truncate-text", wt = "show-truncate", at = "focused", Yt = `button,input,select,a,textarea,[contenteditable],[${Ie}],[${fa}],[tabIndex]`, ya = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Ie, !0), new ga(s, e.value);
  },
  updated(s) {
    Ki(s);
  }
...
const vi = "focus-item", va = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", ba()), e.value ? s.setAttribute(vi, e.value) : s.toggleAttribute(vi, !0);
  }
};
function ba() {
  let s;
...
const ti = "focus-container", Zi = "focus-list", Aa = "focus-icon", Vt = `[${Zi}],[${ti}]`, bi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${ti}],[${Aa}],[tabIndex]`;
let zt = [];
const wa = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && zt.push(new Ea(s));
  },
  beforeUnmount(s) {
...
const xa = "truncate-text", Sa = "truncate-trigger", Ia = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(xa, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${Sa}]`)), $s(s, {
...
const Ta = ["content"], La = {
  ...
  setup(s, { expose: e }) {
    ...
    e({ el: o });
    const c = s, u = N(() => a?.fixture.get("appbar") ? r.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, y = (b) => {
    ...
    return Je(() => {
      ...
      return P((v(), w("div", {
        ...
        s.header ? (v(), w("header", La, [
          re(L, {
            class: ae(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (he) => s.panel.close())
          }, null, 8, ["class"]),
          P((v(), w("h2", Ra, [
            b.$slots.header ? Pe(b.$slots, "header", { key: 0 }) : (v(), w("div", $a, G(S(t)(s.panel.alertName)), 1))
          ])), [
            [I]
          ]),
          ...
          m("div", {
            ...
            s.panel.teleport ? U("", !0) : (v(), w("div", Ca, [
              d.value ? (v(), W(V, {
                key: 0,
                onClick: $[1] || ($[1] = (he) => y("left")),
                active: !s.panel.isLeftMostPanel
              }, null, 8, ["active"])) : U("", !0),
              d.value ? (v(), W(ye, {
                key: 1,
                onClick: $[2] || ($[2] = (he) => y("right")),
...
}), Pa = { class: "relative" }, Na = ["content", "aria-label"], Fa = ["transform"], Da = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Ga = { class: "relative" }, Ua = ["content", "aria-label"], Ba = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), ja = { class: "w-32 h-32" }, Wa = ["content", "aria-label"], Ha = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), Ka = { class: "relative" }, Za = ["content", "aria-label"], Xa = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), oo = /* @__PURE__ */ Fe(ao, [["__scopeId", "data-v-51e22a4a"]]), no = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, a) => {
      ...
      return v(), W(o, {
        ...
        default: te(() => [
          S(t).isFullscreen ? (v(), w("svg", no, a[0] || (a[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, fo = ["content", "aria-label"], mo = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, go = ["aria-label", "content"], vo = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), bo = /* @__PURE__ */ Fe(vo, [["__scopeId", "data-v-f0341fec"]]), Ao = B("areas-of-interest", () => ({ areas: f([]) })), wo = B("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Io {
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = xo[r], this.codeToProvince(t);
  }
}
function _o(s) {
  return new Io(s);
...
async function Ro(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new xt(s, i), await Oo(t)) : o.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new xt(s, i), await ko(t)) : a.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new xt(s, i), await Mo(t)) : (i = encodeURIComponent(e.trim()), t = new xt(s, i), await Po(t)), t;
}
const ii = async (s) => {
  ...
  const e = s.config;
  if (await $o(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
...
}, No = "~FSA~", wi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", xi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Si = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ii {
  config;
  constructor(e, t) {
    let i, r, a, o;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${A}%3D'${No}'&outFields=${A}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, y;
   ...
   */
  async query(e) {
    const t = await Ro(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), a = t.results.filter((n) => n.order >= i);
...
var Go = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(Go || {});
class Ti extends es {
  _infoType;
...
class Ho {
  ...
  constructor(e, t, i) {
    ...
    const r = Yo(e, this);
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new zn(this), this.panel = new qn(this), this.geo = new Bn(this), this.dev = new Kn(this), this.ui = {
...
function Yo(s, e) {
  ...
  const i = Ys(), r = Pi(ha).use(i).use(Ls, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", wa), r.directive("focus-list", ya), r.directive("focus-item", va), r.directive("truncate", Ia), r.component("panel-screen", Ma), r.component("pin", Da), r.component("close", Ba), r.component("back", qa), r.component("expand", Ja), r.component("panel-options-menu", oo), r.component("dropdown-menu", ei), r.component("minimize", Xa), r.component("right", to), r.component("left", ro), r.component("fullscreen-nav-button", co), r.component("geolocator-nav-button", uo), r.component("home-nav-button", po), r.component("mapnav-button", mo), r.component("appbar-button", bo), r.component("transition", ki), r.component("transition-group", Mi), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || e.geo.shared.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class Xo extends Jo {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new Ko(e), this.caption = new Zo(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
...
const Qo = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, en = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, tn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, sn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, rn = {
  circlePoint: Qo,
  solidLine: en,
  outlinedPoly: tn,
  boundingBoxPoly: sn
...
class hn extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new un(e), this.ogc = new dn(e);
  }
  /**
...
class Xe extends ni {
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new Mn(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
  ...
  onLoadActions() {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new Sn(
          {
...
class is extends ts {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Pn(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class Bn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new Xo(e), this.layer = new hn(e), this.attributes = new kn(e), this.query = new Un(e), this.symbology = new Gn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Vn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BKG0XQLn.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CD6ihmUy.js"), "../fixtures/basemap/index.ts": () => import("./index-DuNw--0m.js"), "../fixtures/crosshairs/index.ts": () => import("./index-Co1ouXjE.js"), "../fixtures/details/index.ts": () => import("./index-pPau_nA_.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CdEKCkSV.js"), "../fixtures/export-legend/index.ts": () => import("./index-Co8xEjIz.js"), "../fixtures/export-map/index.ts": () => import("./index-X_CdunaF.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Bt6eNeDG.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CpufCE3d.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BzzPqzkX.js"), "../fixtures/export-title/index.ts": () => import("./index-B5BWCRXE.js"), "../fixtures/export/index.ts": () => import("./index-D4EEuwsW.js"), "../fixtures/extentguard/index.ts": () => import("./index-B5e_qwpu.js"), "../fixtures/gazebo/index.ts": () => import("./index-D501UBMZ.js"), "../fixtures/geosearch/index.ts": () => import("./index-DDRkS0wr.js"), "../fixtures/grid/index.ts": () => import("./index-B23PXlVw.js"), "../fixtures/help/index.ts": () => import("./index-DAiWKffK.js"), "../fixtures/hilight/index.ts": () => import("./index-Cd38WtY6.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DVu89l0-.js"), "../fixtures/legend/index.ts": () => import("./index-CGJE_caN.js"), "../fixtures/mapnav/index.ts": () => import("./index-Du0emWzO.js"), "../fixtures/metadata/index.ts": () => import("./index-B0NL5cEv.js"), "../fixtures/northarrow/index.ts": () => import("./index-RgARLVLp.js"), "../fixtures/overviewmap/index.ts": () => import("./index-R0oKgO9z.js"), "../fixtures/panguard/index.ts": () => import("./index-2yy4CVCG.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BMvVdqEF.js"), "../fixtures/settings/index.ts": () => import("./index-DW9kKDdq.js"), "../fixtures/snowman/index.ts": () => import("./index-C_zBPZY5.js"), "../fixtures/wizard/index.ts": () => import("./index-CjM8UKVK.js") });
class zn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const r = (await Vn[`../fixtures/${e}/index.ts`]()).default;
      i = new r(e, this.$iApi);
    }
...
const Yn = /* @__PURE__ */ Fe(Wn, [["render", Hn], ["__scopeId", "data-v-a3c61802"]]), Jn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-EZ6Ibh81.js"), "../fixtures/basemap/screen.vue": () => import("./screen-iSJRMz8G.js"), "../fixtures/export/screen.vue": () => import("./screen-DmbpUDwE.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-8dxONRIT.js"), "../fixtures/grid/screen.vue": () => import("./screen-CvLclKax.js"), "../fixtures/help/screen.vue": () => import("./screen-jOfeA6gF.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-Cv8FymD_.js"), "../fixtures/legend/screen.vue": () => import("./screen-Bdth-rtl.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BfXplJKb.js"), "../fixtures/settings/screen.vue": () => import("./screen-DQxsFdXj.js"), "../fixtures/wizard/screen.vue": () => import("./screen-PpEDEGEw.js") });
class St extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Vs(t) || Bs(t))
      ...
      let r;
      typeof t == "string" ? r = Jn[`../fixtures/${t}`]() : r = t();
...
function Xn(s) {
  ...
  return el(s.services, e), Qn(s.map, e), tl(s.ui, e), s.plugins && il(s.plugins, e), e;
}
function Qn(s, e) {
...
function qt(s) {
  ...
  )), typeof s.stateOnly < "u" && (e.cosmetic = s.stateOnly), s.initialFilteredQuery && (e.initialFilteredQuery = s.initialFilteredQuery), sl(s, e), (typeof s.toggleSymbology < "u" || s.table) && (e.fixtures = {}, typeof s.toggleSymbology < "u" && (e.fixtures.legend = {
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Fri May 30 13:44:45 2025 -0400", hash: "e20d0ba98c62d05ef9d284d2ce77131747c829f2" };
console.info(
...
const zl = (s, e, t) => new Ho(s, e, t), ut = new Us();
export {
  H as $,
  Nr as A,
  yt as B,
