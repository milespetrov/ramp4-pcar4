import{n as e}from"./glsl-BA5tVIOE.js";import{t}from"./FloatPassUniform-D0bpBuhc.js";import{t as n}from"./Float4BindUniform-BSRgN4fD.js";import{t as r}from"./Texture2DBindUniform-CSjQ7NAG.js";import{t as i}from"./FloatBindUniform-C6PGX8Bu.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-CSZy8WQ4.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-CFGUrj3r.js";import{n as d}from"./VerticalOffset.glsl-4QHeM2L7.js";import{t as f}from"./BooleanBindUniform-Bk6s7rTb.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
