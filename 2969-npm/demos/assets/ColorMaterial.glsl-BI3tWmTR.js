import{n as e}from"./glsl-BA5tVIOE.js";import{t}from"./ShaderBuilder-CuzWnUzO.js";import{t as n}from"./Float4PassUniform-BJ7-L335.js";import{a as r,i}from"./AlphaCutoff-hQN3eBUG.js";import{t as a}from"./ObjectAndLayerIdColor.glsl-BcCWSIVy.js";import{t as o}from"./VisualVariables.glsl-D4wKTnLB.js";import{n as s}from"./View.glsl-CFGUrj3r.js";import{t as c}from"./TerrainDepthTest.glsl-DAWmjE4k.js";import{t as l}from"./OutputColorHighlightOLID.glsl-C4EiYIXi.js";import{t as u}from"./Transform.glsl-syFtr9f1.js";import{t as d}from"./VertexColor.glsl-DurYlaRO.js";function f(f){let p=new t,{vertex:m,fragment:h,attributes:g,varyings:_}=p,{hasVVColor:v,hasVertexColors:y}=f;return s(m,f),p.include(u),p.include(d,f),p.include(o,f),p.include(a,f),h.include(r,f),p.include(l,f),p.include(c,f),g.add(`position`,`vec3`),v&&g.add(`colorFeatureAttribute`,`float`),y||_.add(`vColor`,`vec4`),_.add(`vpos`,`vec3`,{invariant:!0}),m.uniforms.add(new n(`uColor`,e=>e.color)),m.main.add(e`
      vpos = position;
      forwardVertexColor();
