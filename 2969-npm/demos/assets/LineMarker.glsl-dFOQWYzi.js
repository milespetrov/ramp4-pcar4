import{n as e,t}from"./glsl-BA5tVIOE.js";import{t as n}from"./Texture2DPassUniform-Dm0cJMRM.js";import{t as r}from"./ShaderBuilder-CuzWnUzO.js";import{t as i}from"./Float2BindUniform-BUaQDEJh.js";import{t as a}from"./Float4BindUniform-BSRgN4fD.js";import{t as o}from"./Float4PassUniform-BJ7-L335.js";import{t as s}from"./FloatBindUniform-C6PGX8Bu.js";import{a as c,i as l,n as u}from"./AlphaCutoff-hQN3eBUG.js";import{t as d}from"./Matrix4BindUniform-JkmvNusp.js";import{i as f,n as p,r as m}from"./View.glsl-CFGUrj3r.js";import{c as h,l as g,s as _,t as v}from"./MarkerSizing.glsl-B3JcpTPo.js";import{t as y}from"./PositionOutsideClipSpace-BCpBuzxc.js";import{t as b}from"./TerrainDepthTest.glsl-DAWmjE4k.js";import{t as x}from"./OutputColorHighlightOLID.glsl-C4EiYIXi.js";function S(S){let C=new r,{space:w,anchor:T,hasTip:E,hasScreenSizePerspective:D}=S,O=w===2,k=w===1;C.include(g,S),C.include(v,S),C.include(b,S);let{vertex:A,fragment:j,varyings:M}=C;p(A,S),C.attributes.add(`position`,`vec3`),C.attributes.add(`previousDelta`,`vec4`),C.attributes.add(`uv0`,`vec2`),M.add(`vColor`,`vec4`),M.add(`vpos`,`vec3`,{invariant:!0}),M.add(`vUV`,`vec2`),M.add(`vSize`,`float`),E&&M.add(`vLineWidth`,`float`),A.uniforms.add(new i(`nearFar`,({camera:e})=>e.nearFar),new a(`viewport`,({camera:e})=>e.fullViewport)).code.add(e`vec4 projectAndScale(vec4 pos) {
