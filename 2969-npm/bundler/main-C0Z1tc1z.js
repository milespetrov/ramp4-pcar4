...
import g from "proj4";
import { TinyEmitter as ye } from "tiny-emitter";
import { createPinia as be, defineStore as _, storeToRefs as xe } from "pinia";
import { Fragment as Se, Teleport as Ce, Transition as we, TransitionGroup as Te, computed as v, createApp as Ee, createBlock as y, createCommentVNode as b, createElementBlock as x, createElementVNode as S, createTextVNode as De, createVNode as C, defineAsyncComponent as Oe, defineComponent as w, getCurrentInstance as ke, h as Ae, inject as je, markRaw as T, mergeProps as Me, nextTick as Ne, normalizeClass as E, normalizeStyle as Pe, onBeforeUnmount as Fe, onMounted as Ie, onUpdated as Le, openBlock as D, reactive as Re, ref as O, render as ze, renderList as Be, renderSlot as Ve, resolveComponent as k, resolveDirective as A, resolveDynamicComponent as He, toDisplayString as j, toRaw as Ue, unref as M, useCssVars as We, useTemplateRef as Ge, vShow as Ke, watch as qe, withCtx as N, withDirectives as P, withKeys as Je, withModifiers as Ye } from "vue";
import { debounce as Xe, throttle as Ze } from "es-toolkit/function";
import { createI18n as Qe, useI18n as F } from "vue-i18n";
import $e from "screenfull";
import { cloneDeep as et } from "es-toolkit/object";
import tt from "animejs";
import { createPopper as nt, detectOverflow as rt } from "@popperjs/core";
import "tippy.js/animations/scale.css";
import it, { setDefaultProps as at, useTippy as ot } from "vue-tippy";
import st from "linkify-html";
import ct from "redaxios";
import lt from "await-to-js";
import { geojsonToArcGIS as ut } from "@terraformer/arcgis";
import { csv2geojson as dt, dsv as ft } from "csv2geojson";
import pt from "svg.js";
...
var mt = /* @__PURE__ */ function(e) {
	...
	invalid() {
		return this.type === I.NONE || this.type === I.UNKNOWN;
	}
	geoJsonFactory(e, t) {
		let n = {
			type: e,
	...
	_angle;
	constructor(e) {
		if (e ||= { style: ht.CIRCLE }, super(), this._style = e.style || ht.CIRCLE, e.style === ht.ICON) {
			let t = e;
			...
			let t = e;
			this._size = Ft.convToPoints(t.size) || 12, this._colour = new Pt(t.colour ?? "#ffffff40"), this._outline = new Lt(t.outline), this._path = this._style === ht.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
		}
	...
	propGrouse(e) {
		this._style === ht.ICON !== e && console.warn(`Accessed a point style property that is invalid for the style type ${this._style}`);
	}
	toOptions() {
		let e = {
	...
	static fromESRI(t) {
		...
		if (t.type === "simple-marker") {
			...
			let e = n;
			e.style = ht.ICON, e.width = t.width, e.height = t.height, e.icon = t.url;
		}
		return new e(n);
	}
	...
	_colour;
	constructor(e) {
		e ||= {}, super(), this._style = e.style || gt.SOLID;
		let t = Ft.convToPoints(e.width);
		this._width = t === void 0 || t < 0 ? .75 : t, this._colour = new Pt(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || vt.ROUND, this._join = e.join || _t.ROUND;
	}
	get styleType() {
		return this._style;
	}
	...
	_fillStyle;
	constructor(e) {
		super(), e ||= {}, e.fill ||= {}, this._fillColour = new Pt(e.fill.colour), this._fillStyle = e.fill.style || yt.SOLID, this._outlineStyle = new Lt(e.outline);
	}
	get fillColour() {
	...
	geomGeoJsonToRamp(e, t) {
		switch (e.type) {
			...
			case B.LINESTRING: return Ot.fromGeoJSON(e, t);
			case B.POLYGON: return jt.fromGeoJSON(e, t);
			case B.MULTIPOINT: return Dt.fromGeoJSON(e, t);
			case B.MULTILINESTRING: return kt.fromGeoJSON(e, t);
			case B.MULTIPOLYGON: return Mt.fromGeoJSON(e, t);
			default: throw Error(`Encountered unhandled geometry type ${e.type}`);
		}
	}
	geomRampToGeoJson(e) {
	...
	serverGeomTypeToRampGeomType(e) {
		if (!e) return I.NONE;
		switch (e) {
			case "esriGeometryPolygon": return I.POLYGON;
			case "esriGeometryPolyline": return I.LINESTRING;
			case "esriGeometryPoint": return I.POINT;
			case "esriGeometryMultipoint": return I.MULTIPOINT;
			case "esriGeometryEnvelope": return I.EXTENT;
			default: return console.error(`Unrecognized server geometry type encountered: ${e}`), I.UNKNOWN;
		}
	}
	clientGeomTypeToRampGeomType(e) {
		if (!e) return I.NONE;
		switch (e) {
			case "polygon": return I.POLYGON;
			case "polyline": return I.LINESTRING;
			case "point": return I.POINT;
			case "multipoint": return I.MULTIPOINT;
			default: return console.error(`Unrecognized client geometry type encountered: ${e}`), I.UNKNOWN;
		}
	}
	...
	espgWorker;
	constructor() {
		this.espgWorker = this.defaultEpsgLookup, g.defs("EPSG:3978", "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), g.defs("EPSG:3979", "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), g.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), g.defs("EPSG:102100", g.defs("EPSG:3857")), g.defs("EPSG:102187", "+proj=tmerc +lat_0=0 +lon_0=-114 +k=0.9999 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), g.defs("EPSG:102190", "+proj=aea +lat_1=50 +lat_2=58.5 +lat_0=45 +lon_0=-126 +x_0=1000000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
		let e = 1;
		for (; e <= 60;) {
			let t = e < 10 ? `0${e}` : e;
			g.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
		}
	}
	addProjection(e, t) {
		e = typeof e == "number" ? `EPSG:${e}` : e, g.defs(e, t);
	}
	defaultEpsgLookup(e) {
	...
	async checkProj(e) {
		...
		let r = (e, t) => {
			e !== t && g.defs(t, g.defs(e));
		};
		if (g.defs(t)) return !0;
		if (n && g.defs(n)) return r(n, t), !0;
		let i = async (e) => {
			try {
				let t = await this.epsgLookup(e);
				return t === null || t === "" ? !1 : (g.defs(e, t), !0);
			} catch {
				return !1;
			}
		};
	...
	async projectGeometry(e, t) {
		if (t.type === I.EXTENT) return this.projectExtent(e, t);
...
var $t = class {
	...
	let e = O({}), t = O([]), n = O([]), r = v(() => t.value.map((t) => t.map((t) => e.value[t]).filter((e) => {
	...
	let e = O([]), t = O({}), n = O({}), r = O(), i = O(0), a = O(0), o = O(!0), s = O();
	function c(t) {
	...
	function r(n) {
		if (e.value = {
			...e.value,
			[n.id]: T(n)
		}, n.id in t.value) t.value[n.id].resolveMe(T(n));
		else {
			let e = new Y();
			e.resolveMe(T(n)), t.value = {
				...t.value,
				[n.id]: e
			};
		}
	...
	_funCounter;
	constructor(e) {
		super(e), this._eventBus = new ye(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(Z).filter((e) => typeof e == "string" && e.indexOf("/") > -1);
	}
	findHandler(e) {
	...
	defaultHandlerFactory(e) {
		...
		switch (e) {
			...
			case Q.MAP_RESIZE_UPDATES_SCALEBAR:
				this.$iApi.event.on(Z.MAP_RESIZED, Xe(() => this.$iApi.geo.map.caption.updateScale(), 100), e);
				break;
			case Q.MAP_SCALE_UPDATES_SCALEBAR:
				this.$iApi.event.on(Z.MAP_SCALECHANGE, Xe(() => this.$iApi.geo.map.caption.updateScale(), 300), e);
				break;
...
var mn = _("maptip", () => {
	...
	__name: "esri-map",
	setup(e) {
		let t = mn(), n = je("iApi"), r = v(() => t.maptipPoint), i = v(() => t.maptipInstance), a = v(() => t.content), o = Re([]), s = O(!1);
		o.push(qe(r, () => {
			if (r.value) {
	...
	setup(e) {
		...
		return (n, r) => {
			let i = A("focus-container");
			return D(), x("div", {
				class: E(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", e.panel.expanded ? "flex-grow max-w-full" : ""]),
				style: Pe(e.panel.style),
				"data-cy": e.panel.id,
				ref_key: "componentEl",
				ref: t
			}, [C(we, {
				...
				default: N(() => [P((D(), y(He(e.panel.route.screen), Me({ class: "h-full" }, e.panel.route.props, { panel: e.panel }), null, 16, ["panel"])), [[i]])]),
				_: 1
			})], 14, vn);
		};
	}
}), bn = _("panel", () => {
	let e = O(void 0), t = O(void 0), n = O(0), r = O(0), i = O(!1), a = O(!0), o = O({}), s = O({}), c = O([]), l = O([]), u = O([]), d = O(1), f = v(() => r.value);
	function p(e) {
...
}), xn = /* @__PURE__ */ n(/* @__PURE__ */ w({
	__name: "panel-stack",
	setup(e) {
		We((e) => ({ v3d36ee4c: i.value }));
		let t = bn(), n = je("iApi"), r = O(), i = v(() => t.opacity), a = v(() => t.mobileView);
		Ie(() => {
		...
		return (e, t) => (D(), y(Te, {
			...
			default: N(() => [(D(!0), x(Se, null, Be(o(M(n).screenSize), (e) => (D(), y(yn, {
				key: `${e.id}`,
				panel: e
			}, null, 8, ["panel"]))), 128))]),
			_: 1
...
}), [["__scopeId", "data-v-717e4bd7"]]), Sn = ["content", "aria-label"], Cn = /* @__PURE__ */ w({
	...
	setup(e) {
		let t = O(!1), n = O(null), r = Re([]), i = O(), a = O(), o = O(), s = e;
		r.push(qe(t, () => {
			n.value.update();
		}));
		let c = () => {
		...
		return Ie(() => {
			window.addEventListener("click", (e) => {
				...
				(!i.value || !i.value.contains(e.target)) && (t.value = !1);
			}), o.value.addEventListener("focus", l), o.value.addEventListener("blur", u), o.value.addEventListener("mouseover", l), o.value.addEventListener("mouseleave", u), Ne(() => {
				o.value && a.value && (n.value = nt(o.value, a.value, {
			...
			return D(), x("div", {
				...
				type: "button",
				class: E(["dropdown-button", e.triggerClass]),
				onClick: c,
				content: e.tooltip,
				"aria-label": e.ariaLabel ? String(e.ariaLabel) : String(e.tooltip),
				ref_key: "dropdownTrigger",
				ref: o
			}, [Ve(r.$slots, "header")], 10, Sn)), [[l, {
				...
				class: E(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": e.centered }]),
				ref_key: "dropdown",
				ref: a
			}, [Ve(r.$slots, "default", { close: () => t.value = !t.value })], 2), [[Ke, t.value]])], 512);
		};
	}
}), wn = _("notification", () => {
	let e = 0, t = O([]), n = O({}), r = v(() => t.value.length >= 99 ? 99 : t.value.length);
	function i(n) {
		t.value = [{
			...n,
			id: `notif-${e++}`
...
}), Tn = { class: "h-full flex flex-col" }, En = { class: "w-full flex mb-6" }, Dn = ["content", "aria-label"], On = /* @__PURE__ */ w({
	__name: "screen",
	props: { panel: {
		type: Object,
		required: !0
	...
	setup(e) {
		let t = wn(), { t: n } = F(), r = v(() => t.notificationNumber), i = () => t.clearAll();
		return (t, a) => {
			let o = k("panel-screen"), s = A("tippy");
			return D(), y(o, { panel: e.panel }, {
				header: N(() => [De(j(M(n)("notifications.title")), 1)]),
				content: N(() => [S("div", Tn, [S("div", En, [P((D(), x("button", {
					type: "button",
					onClick: i,
					class: E(["p-4 ml-auto", [r.value ? "text-gray-500 hover:text-black" : "text-gray-300 cursor-default pointer-events-none"]]),
					content: M(n)("notifications.controls.clearAll"),
					"aria-label": M(n)("notifications.controls.clearAll")
				}, [...a[0] ||= [S("svg", {
					...
					S("path", { d: "M13 17h-9a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6a2 2 0 1 1 4 0a7 7 0 0 1 4 6v2" }),
	...
	constructor(e) {
		super(e), this.$iApi.panel.register({
			id: "notifications",
			config: {
				screens: { "notifications-screen": T(On) },
	...
	setup(e, { emit: t }) {
		...
		return (t, i) => {
			let c = A("tippy");
			return P((D(), x("li", {
				class: E(["flex-col default-focus-style p-4", e.notification.messageList ? "cursor-pointer" : ""]),
				content: M(n)(a.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
				onClick: i[1] ||= (e) => a.value = !a.value
			}, [S("div", Nn, [
				S("span", null, [De(j(o[e.notification.type]) + " ", 1), S("span", Pn, j(e.notification.message), 1)]),
				i[4] ||= S("span", { class: "flex-grow" }, null, -1),
				e.notification.messageList ? (D(), x("div", {
					key: 0,
					class: E(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": a.value }])
				}, [...i[2] ||= [S("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					height: "24",
					viewBox: "0 0 24 24",
					width: "24"
				}, [S("path", { d: "M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z" })], -1)]], 2)) : b("", !0),
				P((D(), x("button", {
					type: "button",
					onClick: i[0] ||= Ye(() => r("remove"), ["stop"]),
					class: "mx-4 p-4 text-gray-500 hover:text-black",
					content: M(n)("notifications.controls.dismiss"),
					"aria-label": M(n)("notifications.controls.dismiss")
				}, [...i[3] ||= [S("svg", {
					class: "fill-current",
					height: "16",
					width: "16",
	...
	setup(e) {
		...
		let c = v(() => t.notificationStack);
		return (e, t) => {
			let a = A("focus-item"), o = A("focus-list"), l = A("tippy");
			return D(), x("div", null, [c.value.length > 0 ? P((D(), x("ul", {
				key: 0,
				content: M(n)("panels.controls.items"),
				ref_key: "el",
				ref: r,
				class: "h-full overflow-y-auto"
			}, [(D(!0), x(Se, null, Be(c.value, (e, t) => (D(), x(Se, { key: e.id }, [t > 0 ? (D(), x("div", zn)) : b("", !0), P(C(Ln, {
				ref_for: !0,
				...
				t[0] ||= S("span", { class: "flex-grow" }, null, -1),
				t[1] ||= S("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					...
					d: "M0 0h24v24H0z",
					fill: "none"
				}), S("path", { d: "M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z" })], -1),
				S("span", null, j(M(n)("notifications.empty")), 1),
				t[2] ||= S("span", { style: { "flex-grow": "6" } }, null, -1)
			]))]);
		};
	}
}), Hn = { class: "flex items-center" }, Un = ["aria-label"], Wn = {
	key: 0,
	class: "number rounded-full w-18 text-white"
}, Gn = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Kn = { class: "pb-8 border-b border-gray-600" }, qn = { class: "absolute flex right-3 top-3" }, Jn = ["content", "aria-label"], Yn = /* @__PURE__ */ n(/* @__PURE__ */ w({
	__name: "caption-button",
	setup(e) {
		let t = wn(), { t: n } = F(), r = v(() => t.notificationNumber), i = () => t.clearAll();
		return (e, t) => {
			let a = k("close"), o = A("tippy");
			return D(), y(Cn, {
				position: "top-start",
				tooltip: M(n)("notifications.title"),
				tooltipPlacement: "top",
				"trigger-class": "text-gray-500 hover:text-white",
				class: "pointer-events-auto sm:flex ml-4 mr-8"
			}, {
				header: N(() => [S("div", Hn, [(D(), x("svg", {
					class: "fill-current w-24 h-24",
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					"aria-label": M(n)("notifications.open")
				}, [...t[0] ||= [S("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)]], 8, Un)), r.value && r.value > 0 ? (D(), x("span", Wn, j(r.value), 1)) : b("", !0)])]),
				default: N((e) => [S("div", Gn, [S("div", null, [S("h4", Kn, j(M(n)("notifications.title")), 1), S("div", qn, [P((D(), x("button", {
					type: "button",
					onClick: i,
					class: E(["p-4 mr-6", [r.value ? "text-gray-500 hover:text-black" : "text-gray-300 cursor-default pointer-events-none"]]),
					content: M(n)("notifications.controls.clearAll"),
					"aria-label": M(n)("notifications.controls.clearAll")
				}, [...t[1] ||= [S("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					...
					animation: "scale",
					appendTo: "parent"
				}]]), C(a, { onClick: e.close }, null, 8, ["onClick"])])]), C(Vn, { class: "overflow-y-auto h-230" })])]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
}), [["__scopeId", "data-v-28078ee6"]]), Xn = { class: "flex" }, Zn = ["aria-label"], Qn = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, $n = ["aria-label", "content"], er = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, tr = { class: "absolute right-5 top-5" }, nr = { class: "select-text" }, rr = { class: "font-bold cursor-text" }, ir = { class: "text-sm cursor-text" }, ar = { class: "font-bold cursor-text" }, or = { class: "ml-5 cursor-text" }, sr = { class: "mt-5" }, cr = ["href"], lr = /* @__PURE__ */ n(/* @__PURE__ */ w({
	...
	setup(e) {
		let { t } = F(), n = je("iApi"), r = () => {
			n.reload();
		}, i = v(() => `${Ws.major}.${Ws.minor}.${Ws.patch}`), a = v(() => Ws.hash.slice(0, 9)), o = v(() => {
		...
		return (n, s) => {
			let c = k("close"), l = k("dropdown-menu"), u = A("tippy"), d = A("focus-item");
			return P((D(), y(l, {
				class: "pointer-events-auto sm:flex",
				position: e.position,
				tooltip: M(t)("ramp.about"),
				tooltipPlacement: e.position,
				"trigger-class": "text-gray-500 hover:text-white"
			}, {
				header: N(() => [S("div", Xn, [(D(), x("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					class: "fill-current w-20 h-20",
					"aria-label": M(t)("ramp.about.open")
				}, [...s[0] ||= [S("path", { d: "M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" }, null, -1)]], 8, Zn))])]),
				default: N((e) => [S("div", Qn, [S("div", null, [
					P((D(), x("button", {
						class: "absolute left-5 top-5 text-gray-500 hover:text-black focus:text-black p-8",
						onClick: r,
						"aria-label": M(t)("ramp.reload"),
						content: M(t)("ramp.reload")
					}, [...s[1] ||= [S("svg", {
						class: "fill-current w-16 h-16",
						xmlns: "http://www.w3.org/2000/svg",
						viewBox: "0 0 24 24"
					}, [S("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })], -1)]], 8, $n)), [[u, {
						placement: "bottom-start",
						theme: "ramp4",
						animation: "scale"
					}]]),
					S("h4", er, j(M(t)("ramp.about")), 1),
					S("div", tr, [C(c, { onClick: e.close }, null, 8, ["onClick"])]),
					S("div", nr, [
						S("div", null, [S("span", rr, j(i.value), 1), S("span", ir, " [" + j(a.value) + "] ", 1)]),
						S("div", null, [S("span", ar, j(o.value[0]), 1), S("span", or, j(o.value[1]), 1)]),
						s[3] ||= S("div", { class: "mt-5" }, [S("a", {
...
}), [["__scopeId", "data-v-966796d3"]]), ur = "__HELP__", dr = _("keyboardnav", () => {
	let e = O(), t = O({}), n = O(!1), r = O([]), i = O(), a = O("idle"), o = ["H", "?"];
	function s() {
	...
	__name: "map-caption",
	setup(e) {
		let n = nn(), r = dr(), i = t(), { t: a } = F(), o = je("iApi"), s = v(() => n.scale), c = v(() => n.attribution), l = v(() => n.coords), u = v(() => n.langtoggle), d = v(() => i.config.map), { keyChain: f, lastAction: p, chainState: m, namespaces: h, activeNamespace: ee } = xe(r), te = v(() => {
		...
		return (e, t) => {
			let n = k("dropdown-menu"), r = A("truncate"), i = A("tippy");
			return D(), x("div", fr, [
				C(lr, {
					class: "sm:block display-none ml-8 mr-4",
					position: "top-end"
				}),
				C(Yn, { class: "sm:block display-none" }),
				te.value ? (D(), x("span", pr, [S("span", mr, [
					t[0] ||= S("span", { class: "chain-colon" }, ":", -1),
					S("span", hr, j(te.value.keys), 1),
					te.value.cursor ? (D(), x("span", gr, "_")) : b("", !0),
					te.value.options ? (D(), x("span", _r, j(te.value.options), 1)) : b("", !0)
				]), te.value.description ? (D(), x("span", vr, "- " + j(te.value.description) + "...", 1)) : b("", !0)])) : c.value?.text.disabled ? b("", !0) : P((D(), x("span", yr, [De(j(c.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				} }]]),
				t[1] ||= S("span", { class: "flex-grow w-15" }, null, -1),
				S("div", br, [
					l.value?.disabled ? b("", !0) : P((D(), x("div", xr, [De(j(l.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
					s.value?.disabled ? b("", !0) : P((D(), x("button", {
						key: 1,
						type: "button",
                ...
                `,
						...
						style: Pe({ width: s.value?.width })
					}, null, 4), S("span", Cr, j(s.value?.label), 1)], 8, Sr)), [[i, {
						delay: [300, 0],
						placement: "top",
						hideOnClick: !1,
						theme: "ramp4",
					...
					u.value?.disabled ? b("", !0) : (D(), y(n, {
						key: 2,
						class: "flex-shrink-0 pointer-events-auto focus:outline-none px-4 mr-4 relative top-2",
						position: "top-end",
						tooltip: M(a)("map.changeLanguage"),
						ariaLabel: `${M(a)("map.language.short")} - ${M(a)("map.changeLanguage")}`,
						tooltipPlacement: "top-start",
						tooltipPlacementAlt: "left-end"
					}, {
						header: N(() => [S("span", wr, j(M(a)("map.language.short")), 1)]),
						default: N(() => [(D(!0), x(Se, null, Be(ne.value, (e, t) => (D(), x("a", {
							key: `${e}-${t}`,
							class: E(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": e === M(o).$i18n.locale.value }]),
							href: "javascript:;",
							onClick: (t) => ie(e)
						}, [De(j(M(a)("map.language." + e)) + " ", 1), e === M(o).$i18n.locale.value ? (D(), x("span", Er, j(M(a)("map.language.curr")), 1)) : b("", !0)], 10, Tr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
...
}, Ar = /* @__PURE__ */ n(/* @__PURE__ */ w({
	__name: "floating-button",
	setup(e) {
		let t = wn(), n = je("iApi"), { t: r } = F(), i = v(() => t.notificationNumber);
		return (e, t) => {
			let a = A("tippy");
			return P((D(), x("button", {
				type: "button",
				onClick: t[0] ||= (e) => M(n).panel.get("notifications").open(),
				...
				content: M(r)("notifications.title"),
				"aria-label": M(r)("notifications.title")
			}, [t[1] ||= S("svg", {
				class: "fill-current w-24 h-24",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
			}, [S("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })], -1), i.value && i.value > 0 ? (D(), x("span", kr, j(i.value), 1)) : b("", !0)], 8, Or)), [[a]]);
		};
	}
}), [["__scopeId", "data-v-a451db5c"]]), jr = { class: "flex items-center mb-20" }, Mr = { class: "text-xl" }, Nr = /* @__PURE__ */ w({
	__name: "keyboard-instructions",
	setup(e) {
		let t = je("iApi"), { t: n } = F(), r = O(!1), i = O([
			"app",
			"lists",
			"map",
			"keyboardNav"
		]), a = O([]), o = O(null), s = O(null);
		Ie(() => {
		...
		return (e, t) => {
			...
			return r.value ? (D(), x("div", {
				...
				onClick: t[2] ||= Ye(() => {}, ["stop", "prevent"]),
				tabindex: "0",
				ref_key: "firstEl",
				ref: o
			}, [
				S("div", jr, [S("h2", Mr, j(M(n)("keyboardInstructions.title")), 1), C(a, {
					class: "ml-auto",
					onClick: t[0] ||= (e) => r.value = !1
				})]),
				(D(!0), x(Se, null, Be(i.value, (e) => (D(), x("p", {
					class: "whitespace-pre-line pb-10",
					key: e
				}, j(M(n)(`keyboardInstructions.${e}`)), 1))), 128)),
				S("button", {
					type: "button",
					...
					ref_key: "lastEl",
					ref: s
				}, j(M(n)("keyboardInstructions.OK")), 513)
			], 512)], 32)) : b("", !0);
		};
	}
}), Pr = _("instance", () => ({ started: O(!1) })), Fr = { class: "h-full relative" }, Ir = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Lr = { class: "absolute top-8 w-full flex justify-center" }, Rr = {
	key: 1,
	class: "w-full h-full"
}, zr = w({
	name: "App",
	components: { Shell: /* @__PURE__ */ n(/* @__PURE__ */ w({
		__name: "shell",
		setup(e) {
			let t = je("iApi"), n = Pr(), r = on(), i = bn(), { t: a } = F(), o = v(() => r.items.appbar), s = () => {
				t.event.emit("openKeyboardInstructions");
			}, c = () => i.teleported;
			return (e, t) => (D(), x("div", Fr, [
				S("div", Ir, [
					t[0] ||= S("div", { class: "sr-only screen-reader-alert" }, null, -1),
					S("div", Lr, [S("button", {
						type: "button",
						class: "bg-white hidden-until-focus z-50 shadow-md px-10",
						onClick: s
					}, j(M(a)("keyboardInstructions.open")), 1)]),
					C(Nr, { class: "keyboard-instructions-modal" }),
					C(xn, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
					o.value ? b("", !0) : (D(), y(Ar, { key: 0 })),
					C(Dr, { class: "z-30" })
				]),
				M(n).started ? (D(), y(hn, { key: 0 })) : (D(), x("div", Rr, [...t[1] ||= [S("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
				(D(!0), x(Se, null, Be(c(), (e) => (D(), y(Ce, {
	...
	setup() {
		let e = ke();
		Ie(() => {
			new _n().observe(e?.proxy?.$refs["app-size"]), at({
...
var ai = /* @__PURE__ */ function(e) {
	...
	mounted(e, t) {
		let n;
		t.value && t.value.externalTrigger && (n = e.closest(`[${_i}]`)), ot(e, {
...
var Si = ["content"], Ci = {
...
}, ki = "focus-container", Ai = "focus-container-active", ji = /* @__PURE__ */ w({
	__name: "panel-screen",
	props: {
		header: {
			type: Boolean,
	...
	setup(e, { expose: t }) {
		let { t: n } = F(), i = bn(), a = en(), o = je("iApi"), s = Ge("el"), c = Ge("contentEl"), l = O(), u = O(), d = O();
		t({ el: s });
		let f = e, p = v(() => o.fixture.get("appbar") ? a.temporary : []), m = v(() => i.mobileView), h = v(() => i.reorderable), ee = `[focus-list], [${ki}]`, te = (e) => e.scrollHeight > e.clientHeight, ne = (e) => e.querySelector(ee), re = () => {
			if (!c.value) return "-1";
			...
			f.panel.move(e), e === "left" && Ne(() => {
				(s.value?.querySelector(".move-left")).focus();
			});
		}, ue = v(() => f.screenId ? f.panel.screens[f.screenId][o.$i18n.locale.value ?? "en"] : null);
		return Ie(() => {
			...
			let i = k("back"), a = k("panel-options-menu"), o = k("left"), l = k("right"), u = k("pin"), d = k("expand"), f = k("minimize"), m = k("close"), ee = A("truncate"), te = A("focus-item"), ne = A("tippy");
			return P((D(), x("div", {
				class: "h-full flex flex-col items-stretch",
				content: `<div style='word-break: break-word;'>${M(n)(e.panel.alertName) + ". " + M(n)("panels.access")}</div>`,
				ref_key: "el",
				ref: s
			}, [
				e.header ? (D(), x("header", Ci, [
					C(i, {
						class: E(e.panel.teleport ? "display-none" : "block sm:display-none"),
						onClick: r[0] ||= (t) => e.panel.close()
					}, null, 8, ["class"]),
					P((D(), x("h2", wi, [t.$slots.header ? Ve(t.$slots, "header", { key: 0 }) : (D(), x("div", Ti, j(M(n)(e.panel.alertName)), 1))])), [[ee]]),
					t.$slots.controls ? (D(), y(a, { key: 0 }, {
						default: N(() => [Ve(t.$slots, "controls")]),
						_: 3
					})) : b("", !0),
					S("div", { class: E(e.panel.teleport ? "flex" : "display-none sm:flex") }, [
						e.panel.teleport ? b("", !0) : (D(), x("div", Ei, [
							h.value ? (D(), y(o, {
								key: 0,
							...
							e.panel.controls && e.panel.controls.expand ? (D(), y(d, {
								key: 2,
								onClick: r[4] ||= (t) => e.panel.expand(),
								active: e.panel.expanded
							}, null, 8, ["active"])) : b("", !0)
						])),
						e.panel.button && p.value?.includes(e.panel.id) ? (D(), y(f, {
							key: 1,
							onClick: r[5] ||= (t) => e.panel.minimize()
						})) : b("", !0),
						C(m, { onClick: r[6] ||= (t) => e.panel.close() })
					], 2)
				])) : b("", !0),
				e.content ? (D(), x("div", {
					key: 1,
					...
					ref: c,
					tabindex: "-1"
				}, [t.$slots.content ? Ve(t.$slots, "content", { key: 0 }) : ue.value ? (D(), x("div", {
					key: 1,
					innerHTML: ue.value.innerHTML
				}, null, 8, Di)) : b("", !0)], 512)) : b("", !0),
				e.footer ? P((D(), x("div", Oi, [Ve(t.$slots, "footer")])), [[te]]) : b("", !0)
			], 8, Si)), [[ne, {
				trigger: "manual",
				touch: !1,
				onShow: ce,
...
}), Mi = { class: "relative" }, Ni = ["content", "aria-label"], Pi = ["transform"], Fi = /* @__PURE__ */ w({
	__name: "pin",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = A("tippy");
			return D(), x("div", Mi, [P((D(), x("button", {
				type: "button",
				class: E(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				content: M(t)(e.active ? "panels.controls.unpin" : "panels.controls.pin"),
				"aria-label": M(t)(e.active ? "panels.controls.unpin" : "panels.controls.pin")
			}, [(D(), x("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 384 512",
				transform: `rotate(${e.active ? 30 : 0})`
			}, [...r[0] ||= [S("path", { d: "M298.028 214.267L285.793 96H328c13.255 0 24-10.745 24-24V24c0-13.255-10.745-24-24-24H56C42.745 0 32 10.745 32 24v48c0 13.255 10.745 24 24 24h42.207L85.972 214.267C37.465 236.82 0 277.261 0 328c0 13.255 10.745 24 24 24h136v104.007c0 1.242.289 2.467.845 3.578l24 48c2.941 5.882 11.364 5.893 14.311 0l24-48a8.008 8.008 0 0 0 .845-3.578V352h136c13.255 0 24-10.745 24-24-.001-51.183-37.983-91.42-85.973-113.733z" }, null, -1)]], 8, Pi))], 10, Ni)), [[i, {
				placement: "bottom",
				hideOnClick: !1
			}]])]);
		};
	}
}), Ii = { class: "relative" }, Li = ["content", "aria-label"], Ri = /* @__PURE__ */ w({
	__name: "close",
	props: { active: Boolean },
	setup(e) {
		let { t } = F();
		return (n, r) => {
			let i = A("tippy");
			return D(), x("div", Ii, [P((D(), x("button", {
				type: "button",
				class: E(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				content: M(t)("panels.controls.close"),
				"aria-label": M(t)("panels.controls.close")
			}, [...r[0] ||= [S("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 352 512"
...
}), zi = { class: "relative" }, Bi = ["content", "aria-label"], Vi = /* @__PURE__ */ w({
	__name: "back",
	props: { active: Boolean },
	setup(e) {
		let { t } = F();
		return (n, r) => {
			let i = A("tippy");
			return D(), x("div", zi, [P((D(), x("button", {
				type: "button",
				class: E(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				content: M(t)("panels.controls.back"),
				"aria-label": M(t)("panels.controls.back")
			}, [...r[0] ||= [S("svg", {
				xmlns: "http://www.w3.org/2000/svg",
				class: "fill-current w-16 h-16",
				viewBox: "0 0 16 16"
	...
	setup(e) {
		...
		return (n, r) => {
			let i = A("tippy");
			return D(), x("div", Hi, [P((D(), x("button", {
				type: "button",
				class: "text-gray-500 hover:text-black focus:text-black w-full h-full flex justify-center items-center",
				content: M(t)(`panels.controls.${e.active ? "collapse" : "expand"}`),
				"aria-label": M(t)(`panels.controls.${e.active ? "collapse" : "expand"}`)
			}, [e.active ? (D(), x("svg", Gi, [...r[1] ||= [
				S("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1),
				...
				S("path", { d: "M8 19h3v3h2v-3h3l-4-4-4 4zm8-15h-3V1h-2v3H8l4 4 4-4zM4 9v2h16V9H4z" }, null, -1),
				S("path", { d: "M4 12h16v2H4z" }, null, -1)
			]])) : (D(), x("svg", Wi, [...r[0] ||= [
				S("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				...
				S("path", { d: "M4 20h16v2H4zM4 2h16v2H4zm9 7h3l-4-4-4 4h3v6H8l4 4 4-4h-3z" }, null, -1)
			]]))], 8, Ui)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale",
...
}), qi = { class: "relative" }, Ji = ["content", "aria-label"], Yi = /* @__PURE__ */ w({
	__name: "minimize",
	props: { active: Boolean },
	setup(e) {
		let { t } = F();
		return (n, r) => {
			let i = A("tippy");
			return D(), x("div", qi, [P((D(), x("button", {
				type: "button",
				class: E(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": e.active }]),
				content: M(t)("panels.controls.minimize"),
				"aria-label": M(t)("panels.controls.minimize")
			}, [...r[0] ||= [S("svg", {
				class: "fill-current w-20 h-20",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), S("path", { d: "M6 19h12v2H6z" })], -1)]], 10, Ji)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
var Zi = { class: "relative" }, Qi = ["content", "aria-label"], $i = /* @__PURE__ */ w({
	__name: "right",
	props: { active: Boolean },
	setup(e) {
		let { t } = F(), n = e, r = O(null), { syncTooltipAfterKeyboardMove: i } = Xi(r, () => !!n.active);
		return (n, a) => {
			let o = A("tippy");
			return D(), x("div", Zi, [P((D(), x("button", {
				ref_key: "buttonRef",
				...
				onClick: a[0] ||= (...e) => M(i) && M(i)(...e),
				content: M(t)("panels.controls.moveRight"),
				"aria-label": M(t)("panels.controls.moveRight")
			}, [...a[1] ||= [S("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [S("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)]], 10, Qi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), ea = { class: "relative" }, ta = ["content", "aria-label"], na = /* @__PURE__ */ w({
	__name: "left",
	props: { active: Boolean },
	setup(e) {
		let t = e, { t: n } = F(), r = O(null), { syncTooltipAfterKeyboardMove: i } = Xi(r, () => !!t.active);
		return (t, a) => {
			let o = A("tippy");
			return D(), x("div", ea, [P((D(), x("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: E(["p-8 move-left", {
					"text-gray-500 hover:text-black focus:text-black": e.active,
					"text-gray-300": !e.active
				}]),
				onClick: a[0] ||= (...e) => M(i) && M(i)(...e),
				content: M(n)("panels.controls.moveLeft"),
				"aria-label": M(n)("panels.controls.moveLeft")
			}, [...a[1] ||= [S("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [S("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)]], 10, ta)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), ra = /* @__PURE__ */ n(/* @__PURE__ */ w({
	__name: "panel-options-menu",
	setup(e) {
		let { t } = F();
		return (e, n) => (D(), y(Cn, {
			class: "flex",
			tooltip: M(t)("panels.controls.optionsMenu"),
			popperOptions: { strategy: "fixed" },
			position: "bottom-end"
		}, {
			header: N(() => [...n[0] ||= [S("div", { class: "p-6" }, [S("svg", {
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24",
				class: "fill-current w-20 h-20"
			}, [S("path", { d: "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" })])], -1)]]),
			default: N(() => [Ve(e.$slots, "default", {}, void 0, !0)]),
			_: 3
		}, 8, ["tooltip"]));
	}
	...
	setup(e) {
		...
		return (e, i) => {
			let a = k("mapnav-button");
			return D(), y(a, {
				onClickFunction: r,
				tooltip: M(t)("mapnav.fullscreen")
			}, {
				default: N(() => [M(n).isFullscreen ? (D(), x("svg", ia, [...i[0] ||= [S("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), S("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)]])) : (D(), x("svg", aa, [...i[1] ||= [S("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), S("path", { d: "M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z" }, null, -1)]]))]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
	...
	setup(e) {
		let { t } = F(), n = je("iApi"), r = Re([]), i = async () => {
			if (r.length) a(r);
			else {
				let e = await o({
					maximumAge: Infinity,
		...
		return (e, n) => {
			let r = k("mapnav-button");
			return D(), y(r, {
				onClickFunction: i,
				tooltip: M(t)("mapnav.geolocator")
			}, {
				default: N(() => [...n[0] ||= [S("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					class: "fill-current w-32 h-20"
				}, [S("path", { d: "M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z" })], -1)]]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
	...
	setup(e) {
		...
		return (e, n) => {
			let i = k("mapnav-button");
			return D(), y(i, {
				onClickFunction: r,
				tooltip: M(t)("mapnav.home")
			}, {
				default: N(() => [...n[0] ||= [S("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					class: "fill-current w-32 h-20"
				}, [S("path", { d: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" }), S("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				})], -1)]]),
				_: 1
	...
	setup(e) {
		return (t, n) => {
			let r = A("focus-item"), i = A("tippy");
			return D(), x("div", la, [P((D(), x("button", {
				type: "button",
				class: E(["w-full h-full default-focus-style", [e.showOutline ? "focus:outline focus:outline-2 focus:outline-blue-400 focus:absolute focus:z-50" : "focus:outline-none"]]),
				onClick: n[0] ||= (t) => e.onClickFunction(),
				content: e.tooltip,
				"aria-label": e.ariaLabel || (typeof e.tooltip == "string" ? e.tooltip : ""),
				"aria-pressed": e.ariaPressed
			}, [Ve(t.$slots, "default")], 10, ua)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), fa = {
	class: "relative",
	tabindex: "-1"
}, pa = ["aria-label", "content"], ma = /* @__PURE__ */ n(/* @__PURE__ */ w({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		let t = je("iApi"), n = e, r = () => t.event.emit(Z.APPBAR_BUTTON_CLICK, n.buttonId);
		return (t, n) => {
			let i = A("focus-item"), a = A("tippy");
			return D(), x("div", fa, [P((D(), x("button", {
				type: "button",
			...
			}, [Ve(t.$slots, "default", {}, void 0, !0)], 8, pa)), [[i], [a, {
				allowHTML: !0,
				placement: "right"
			}]])]);
		};
	}
}), [["__scopeId", "data-v-1cb84ae1"]]), ha = _("areas-of-interest", () => ({ areas: O([]) })), ga = _("export", () => {
	let e = O({
		title: !0,
		map: !0,
		mapElements: !0,
...
var Ka = _("geosearch", () => {
	let e = O(new Wa("en", void 0)), t = O({
		type: "",
		province: "",
		extent: void 0
	}), n = O(!1), r = O(""), i = O(""), a = O(""), o = O([]), s = O([]), c = O(!1), l = O([]), u = v(() => e.value.fetchProvinces().then((e) => (e.sort((e, t) => e.name.localeCompare(t.name, void 0, { sensitivity: "case" })), e))), d = v(() => new Promise((t) => {
	...
	load(e) {
		...
		t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== xt.UP_TO_DATE, t.loadPromise().then(() => {
			this._layerInitVis = this._layerInitVis === void 0 ? t.visibility : this._visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(this.$iApi.event.on(Z.LAYER_VISIBILITYCHANGE, (e) => {
				...
				this.layer.uid === e.layer.uid && (e.layer.drawState === xt.REFRESH ? this.layerRedrawing = !0 : setTimeout(() => {
					this.layerRedrawing = e.layer.drawState === xt.REFRESH;
				}, 500));
	...
	let e = O({
		...
		tileSchemas: [],
		initialBasemapId: ""
	}), t = O({}), n = O(!0), r = O(1.5), i = O("#FF0000"), a = O(1), o = O("#000000"), s = O(.25);
	function c(t) {
	...
	let e = {
		...
		layerType: L.UNKNOWN,
		url: ""
	}, t = O(), n = O(""), r = O(""), i = O(!0), a = O(null), o = O({
		config: e,
		configOptions: []
	}), s = O($.UPLOAD);
	function c(t) {
	...
	constructor(e, t, n) {
		...
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new Ss(this), this.panel = new ws(this), this.geo = new bs(this), this.dev = new js(this), this.ui = {
			...
			escapeHtml: () => "",
			isPlainText: () => !0
		}, this.notify = new An(this), this._isFullscreen = $e.isEnabled && !!this.$vApp.$root && $e.isFullscreen && $e.element === this.$vApp.$root.$el, $e.isEnabled && $e.onchange(() => {
			this._isFullscreen = $e.isEnabled && !!this.$vApp.$root && $e.isFullscreen && $e.element === this.$vApp.$root.$el;
	...
	toggleFullscreen() {
		$e.isEnabled && $e.toggle(this.$element._container || void 0);
	}
	get isFullscreen() {
...
var lo = class e {
	...
	static async create(t) {
		let n = new e(t), r = t.layers.map((e) => {
			...
			if (e.layerType === L.TILE) return K.TileLayer(t);
			if (e.layerType === L.VECTORTILE) return K.VectorTileLayer(t);
			if (e.layerType === L.MAPIMAGE) return K.MapImageLayer(t);
			if (e.layerType === L.OSM) return K.OpenStreetMapLayer(t);
	...
	async createMap(e, t) {
		...
		}), this._basemapStore = i, e.labelsDefault && (this.labelsDefault.visible = e.labelsDefault.visible);
		let a = {};
		this.esriMap = T(await K.Map(a)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
	}
	destroyMap() {
	...
	async applyBasemap(e) {
		...
		t.esriBasemap.id !== n && (this.esriMap.basemap = Ue(t.esriBasemap));
	}
	async setBasemap(e) {
	...
	async zoomMapTo(e, t, n = !0, r = 200, i = "ease") {
		if (this.esriView) {
			...
			a.type === I.POINT && (o.scale = t || this.pointZoomScale);
			let s = {
				animate: n,
				duration: r,
				easing: i
	...
	async checkAtCoord(e) {
		...
		if (n?.geomType != I.POLYGON && this.#e && this.#e.layerId === t.layerId && this.#e.oid === t.oid && this.#e.layerIdx === t.layerIdx) return;
	...
	async createMapView(e) {
		...
		this.esriView = T(await K.MapView({
			map: this.esriMap,
	...
	async mapDrag(e) {
		if (e.native.pointerType === "mouse") {
			if (e.action === "start") await this.cursorHitTest(e) && (this.startExtent = T(this.overviewGraphicLayer.getEsriGraphic("overview-graphic").geometry));
	...
	async createMapView(e) {
		...
		this.esriView = T(await K.MapView({
			...
			handler: this.esriView.on("pointer-move", Xe((e) => {
	...
	async applyBasemap(e) {
		...
		this.esriMap.basemap = Ue(n.esriBasemap);
	...
	runIdentify(e) {
		...
		r.type === I.POINT && t.some((e) => e.identifyMode === V.HYBRID || e.identifyMode === V.SYMBOLIC) && (i = this.symbolIdentify(n.screenX, n.screenY));
		let a = {
			geometry: r,
			hitTest: i
	...
	async getGraphicAtCoord(e) {
		...
		let t = this.$iApi.geo.layer.allLayersOnMap(!1).filter((e) => e.supportsFeatures || e.layerType === L.GRAPHIC);
		...
		if (r.some((e) => {
			...
			if (n) {
				if (!(n.isCosmetic || n.layerType === L.GRAPHIC || e.graphic.isAggregate)) i = n, a = e.graphic.getObjectId();
...
var So = class extends X {
	async fetchFileData(e, t) {
		let n = await ct.get(e, { responseType: "arrayBuffer" });
		switch (t) {
			case L.GEOJSON:
			case L.DATAJSON: return JSON.parse(this.arbToStr(n.data));
			case L.SHAPEFILE:
			case L.GEOJSONZIPPED:
			case L.FLATGEOBUF:
			case L.FLATGEOBUFZIPPED: return n.data;
			case L.CSV:
			case L.DATACSV: return this.arbToStr(n.data);
	...
	extractCsvFields(e, t = ",") {
		return ft.dsvFormat(t).parseRows(e)[0].map((e) => ({
			name: e,
			type: mt.STRING
		}));
	}
	filterCsvLatLonFields(e, t = ",") {
		let n = ft.dsvFormat(t).parseRows(e), r = n[0], i = {
	...
	inferType(e) {
		return typeof e == "number" ? mt.DOUBLE : mt.STRING;
	}
	...
	async loadWfsData(e, t = -1, n = 0, r = 1e3, i = {
		...
		let c = new Gt(e).updateQuery(s), [l, u] = await lt(ct.get(c, { signal: o }));
	...
	async loadLayerMetadata(e) {
		...
		let [t, n] = await lt(ue(e, { query: { f: "json" } }));
	...
	_sublayers;
	constructor(e, t) {
		super(t), this.config = e, this.id = "", this.uid = "", this.name = "error", this.layerState = U.NEW, this.drawState = xt.NOT_LOADED, this.initiationState = H.NEW, this.layerIdx = -1, this.layerFormat = R.UNKNOWN, this.layerType = L.UNKNOWN, this.dataFormat = z.UNKNOWN, this.supportsIdentify = !1, this.identifyMode = V.NONE, this.supportsFeatures = !1, this.mapLayer = !0, this.featureCount = 0, this.fields = [], this.fieldList = "", this.nameField = "", this.maptipField = "", this.oidField = "", this.supportsSublayers = !1, this.isSublayer = !1, this.isRemoved = !1, this.isFile = !1, this.isCosmetic = !1, this.isSystem = !1, this.userAdded = !1, this.identify = !1, this.maptips = !1, this.geomType = I.UNKNOWN, this.legend = [], this._sublayers = [], this.expectedTime = {
			draw: 0,
			load: 0,
			fail: 0
	...
	constructor(e, t) {
		super(e, t), this.name = e.name || "", this.geomType = I.NONE, this.dataFormat = z.UNKNOWN, this.layerType = L.UNKNOWN, this.layerFormat = R.UNKNOWN;
	...
	updateDrawState(e) {
		this.drawState = e, e === xt.REFRESH ? this.startTimer(Oo.DRAW) : e === xt.UP_TO_DATE && this.stopTimer(Oo.DRAW), this.$iApi.event.emit(Z.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		this.updateInitiationState(H.INITIATING), this.startTimer(Oo.LOAD);
		let e = (e) => {
		...
		}, this.expectedTime.fail), [r] = await lt(this.onInitiate());
		clearTimeout(n), t > this.lastCancel && (this.drawState !== xt.UP_TO_DATE && this.startTimer(Oo.DRAW), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(H.INITIATED));
	}
	async onInitiate() {
	...
	async terminate() {
		this.updateInitiationState(H.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new Y(), this.loadPromDone = !1, this.updateLayerState(U.NEW), this.updateDrawState(xt.NOT_LOADED), this.updateInitiationState(H.TERMINATED);
	}
	onLoad() {
		...
		try {
			...
			Promise.all(r).then(() => {
				clearTimeout(n), t ? this.visibility = !1 : (this.stopTimer(Oo.LOAD), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new Y()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((e) => e.onLoad()), this.updateLayerState(U.LOADED)));
			}).catch(() => {
	...
	onError(e = !0) {
		this.layerState !== U.ERROR && (this.initiationState === H.INITIATING && this.updateInitiationState(H.NEW), this.loadPromDone && (this.loadDefProm = new Y()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(kn.ERROR, this.$iApi.$i18n.t("layer.error", { id: this.id })), this.stopTimer(Oo.DRAW), this.stopTimer(Oo.LOAD), this.updateLayerState(U.ERROR, !e));
	}
	onLoadActions() {
		return [];
	}
	...
	async onInitiate() {
		...
		this.esriWatches.push(s(() => this.esriLayer.visible, (e) => {
			...
			this.esriView = T(e.layerView), this.esriWatches.push(s(() => e.layerView.updating, (e) => {
				this.updateDrawState(e ? xt.REFRESH : xt.UP_TO_DATE);
	...
	filter;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.geomType = I.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Ht(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), e.state?.hovertips !== void 0 && console.warn("hovertips layer configuration property is deprecated. Please adjust to use maptips instead"), this.maptips = e.state?.maptips ?? e.state?.hovertips ?? !0, this.attribs = new is();
	}
	makeEsriLayerConfig(e) {
	...
	async loadLayerMetadata(e = {}) {
		...
		if (!(t < this.lastCancel)) if (this.geomType = n.geometryType, this.attribs.quickCache = new us(this.geomType), this.scaleSet.minScale = n.minScale, this.scaleSet.maxScale = n.maxScale, this.dataFormat = n.dataFormat, this.extent = this.extent ?? n.extent, this._serverVisibility = n.defaultVisibility, this.origRampConfig.name || (this.name = n.name ?? this.id), this.dataFormat === z.ESRI_FEATURE) {
			this.supportsFeatures = !0, this.canModifyLayer = this.layerType === L.SUBLAYER ? n.canModifyLayer : !0, this.fields = n.fields, this.nameField = n.displayField, this.oidField = n.objectIdField, this.sourceSR = n.sourceSR, this.drawOrder.forEach((e) => {
	...
	async getGraphic(e, t) {
		...
		if (t.getGeom) {
			...
			if (n) r = n;
			else if (this.layerType === L.FEATURE && !(this.attribs.quickCache.isPoint && t.forZoom)) {
		...
		if (t.getStyle) {
			let e = Ue(this.renderer.getGraphicSymbol(n));
	...
	setSqlFilter(e, t) {
		if (t !== this.filter.getSql(e)) if (this.filter.setSql(e, t), this.$iApi.event.emit(Z.FILTER_CHANGE, {
			uid: this.uid,
			filterKey: e
		}), this.layerFormat === R.MAPIMAGE) this.applySqlFilter();
		else {
			let n = `${this.uid}-${e}-${t}`;
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.layerFormat = R.GRAPHIC, this.maptips = !1;
	}
	_graphics = [];
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.GRAPHIC;
	}
	async onInitiate() {
		this.esriLayer = T(await K.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	onLoadActions() {
		let e = super.onLoadActions();
		return this.layerTree.name = this.name, this.updateDrawState(xt.UP_TO_DATE), e;
	}
}, Po = class extends jo {
	esriJson;
	sourceGeoJson;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = z.ESRI_FEATURE, this.layerFormat = R.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== V.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = V.HYBRID;
	}
	async reload() {
	...
	async onInitiate() {
		...
		this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = T(await K.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	runIdentify(e) {
		...
		if (this.identifyMode === V.HYBRID || this.identifyMode === V.GEOMETRIC) {
			...
			this.geomType !== I.POLYGON && e.geometry.type === I.POINT ? t.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : t.filterGeometry = e.geometry, t.filterSql = this.getCombinedSqlFilter(), i = this.queryFeatures(t).then((e) => {
				a = e;
			});
		}
	...
	extractLayerMetadata() {
		...
		this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? Nt.fromESRI(e.fullExtent, this.id + "_extent");
		let t = T(e.fields.slice());
		this.fields = t.map((e) => ({
			name: e.name,
			alias: e.alias,
			type: e.type,
		...
		this.attribs.attLoader = new cs(this.$iApi, n);
	}
	async getGraphic(e, t) {
		let n;
		...
		if (t.getStyle) {
			let e = Ue(this.renderer.getGraphicSymbol(n.attributes));
	...
	applySqlFilter(e = []) {
		...
		K.FeatureFilter({ where: t }).then((e) => {
			Ue(this.esriView).filter = e;
		});
	}
}, Fo = class extends Po {
	constructor(e, t) {
		super(e, t), this.layerType = L.GEOJSON;
	}
	async onInitiate() {
		let e, t = Date.now();
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.SHAPEFILE;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.CSV;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.GEOJSONZIPPED;
	}
	async onInitiate() {
		let e = Date.now(), t = await this.$iApi.geo.layer.files.binaryInitHelper(this.origRampConfig);
		if (e > this.lastCancel) {
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.FLATGEOBUF;
	}
	async onInitiate() {
		let e = Date.now(), t = await this.$iApi.geo.layer.files.binaryInitHelper(this.origRampConfig);
		if (e > this.lastCancel) {
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.FLATGEOBUFZIPPED;
	}
	async onInitiate() {
		let e = Date.now(), t = await this.$iApi.geo.layer.files.binaryInitHelper(this.origRampConfig);
		if (e > this.lastCancel) {
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = L.FEATURE, this.layerFormat = R.FEATURE, e.identifyMode && e.identifyMode !== V.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = V.HYBRID;
	}
	async onInitiate() {
		T(this.esriLayer = await K.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	runIdentify(e) {
		...
		if (this.identifyMode === V.HYBRID || this.identifyMode === V.GEOMETRIC) {
			...
			this.geomType !== I.POLYGON && e.geometry.type === I.POINT ? t.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : t.filterGeometry = e.geometry, t.filterSql = this.getCombinedSqlFilter(), i = this.queryOIDs(t).then((e) => {
				a = e;
			});
		}
		return e.hitTest && (this.identifyMode === V.HYBRID || this.identifyMode === V.SYMBOLIC) && (r = i.then(async () => {
	...
	async getGraphicExtent(e) {
		...
		else if (this.geomType === I.POINT) console.error(`Attempted to query extent for invalid geometry type ${this.geomType}.`);
		else {
			let n = this.attribs.quickCache.getExtent(e);
			if (n) t = n;
			else {
				let [n, r] = await lt(this.esriLayer.queryExtent({
					objectIds: [e],
	...
	async zoomToFeature(e) {
		let t;
		return this.geomType !== I.POINT && (t = this.attribs.quickCache.getAnyScaleGeom(e), t || (t = await this.getLocalGeometry(e), t ? this.geomType !== I.MULTIPOINT && this.attribs.quickCache.setGeom(e, t, this.$iApi.geo.map.getScale()) : t = await this.getGraphicExtent(e))), t && !t.invalid() ? (await this.$iApi.geo.map.zoomMapTo(t), !0) : await super.zoomToFeature(e);
	}
}, Ho = class extends Ao {
	isDynamic;
	origState;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = L.MAPIMAGE, this.layerFormat = R.MAPIMAGE, this.isDynamic = !1, this.maptips = !1, this.layerTree.layerIdx = -1, this.identifyMode = V.GEOMETRIC;
	}
	actualViz = !1;
	get visibility() {
	...
	set visibility(e) {
		...
		if (e || Uo(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
			...
			e = this.$iApi.event.on(Z.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === xt.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Uo(this, "")));
			});
		}
		e && Uo(this, "");
	}
	async onInitiate() {
		this.esriLayer = T(await K.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		let t = super.makeEsriLayerConfig(e);
	...
	runIdentify(e) {
		...
		if (t.length === 0) return [];
		let n;
		return e.geometry.type === I.POINT && (n = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((t) => {
			let r = new Y(), i = {}, a = Re({
				items: [],
			...
			return t.geomType !== I.POLYGON && n ? i.filterGeometry = n : i.filterGeometry = e.geometry, i.filterSql = t.getCombinedSqlFilter(), i.sourceSR = t.sourceSR, t.queryOIDs(i).then((e) => {
				e.forEach((e) => {
	...
	constructor(e, t, n) {
		if (super(e, t), this.layerType = L.SUBLAYER, this.layerFormat = R.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = n, this.isSystem = n.isSystem, this.dataFormat = z.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !n.esriLayer) throw Error("Map Image Layer with no internal esri layer encountered in sublayer creation");
	...
	fetchEsriSublayer(e) {
		...
		this.esriSubLayer = T(e.esriLayer.allSublayers.find((e) => e.id === this.layerIdx));
	}
	onLoadActions() {
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = L.OSM, this.layerFormat = R.OSM, this.dataFormat = z.OSM_TILE, this.supportsFeatures = !1;
	}
	async onInitiate() {
		this.esriLayer = T(await K.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = L.IMAGERY, this.layerFormat = R.IMAGERY, this.dataFormat = z.ESRI_RASTER;
	}
	async onInitiate() {
		this.esriLayer = T(await K.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	async checkProj() {
		...
		if (this.layerState === U.LOADED && !t) n(), this.onError(), this.updateDrawState(xt.NOT_LOADED);
		else if (this.layerState === U.ERROR && t) this.reload();
		else if (this.layerState !== U.ERROR && !t) return n(), Promise.reject();
	}
}, Jo = class extends qo {
	constructor(e, t) {
		super(e, t), this.layerType = L.IMAGERYTILE, this.layerFormat = R.IMAGERYTILE, this.schemaLocked = !1;
	}
	async onInitiate() {
		this.esriLayer = T(await K.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.TILE, this.layerFormat = R.TILE;
	}
	async onInitiate() {
		this.esriLayer = T(await K.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.VECTORTILE, this.layerFormat = R.VECTORTILE;
	}
	async onInitiate() {
		this.esriLayer = T(await K.VectorTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	mimeType;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.layerType = L.WMS, this.layerFormat = R.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = z.OGC_RASTER, this.identifyMode = V.GEOMETRIC;
	}
	async onInitiate() {
		this.esriLayer = T(await K.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	runIdentify(e) {
		if (e.geometry.type !== I.POINT || !this.canIdentify()) return [];
		let t = new Y(), n = Re({
			items: [],
			loading: t.getPromise(),
			loaded: !1,
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.WFS;
	}
	async onInitiate() {
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.layerFormat = R.NOLAYER, this.drawState = xt.NOT_VISUAL, this.attribs = new is(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
	...
	constructor(e, t) {
		super(e, t), this.layerType = L.DATAJSON;
	}
	async onInitiate() {
		let e = Date.now(), t;
	...
	serviceUrl;
	constructor(e, t) {
		super(e, t), this.layerType = L.DATATABLE, this.serviceUrl = e.url, this.filter = new Ht(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
	}
	async onInitiate() {}
	onLoadActions() {
	...
	async arcGisBatchLoad(e, t) {
		...
		let n = e.permanentFilter ? ` AND ${e.permanentFilter}` : "", r = { query: {
			...
			f: "json"
		} }, [i, a] = await lt(ue(e.serviceUrl + "/query", r));
	...
	async loadGraphicsAttributes(e, t) {
		...
		let n = {
			features: e.sourceGraphics.map((e) => Ue(e).attributes).toArray(),
			oidIndex: {}
		};
	...
	async loadSingleFeature(e) {
		...
		let [n, r] = await lt(ue(e.serviceUrl + "/query", t));
	...
	async generateTabularAttributesWorker(e, t) {
		...
		let r = e.fields.filter((e) => Object.prototype.hasOwnProperty.call(n.features[0], Ue(e).name)).map((e) => ({
			data: Ue(e).name,
			title: Ue(e).alias || Ue(e).name
		})), i = n.features.map((t) => {
			let n = _e({}, t);
	...
	isPoint;
	constructor(e) {
		this.attribs = {}, this.geoms = {}, this.extents = {}, this.isPoint = e === I.POINT || e === I.MULTIPOINT;
	}
	getScaleStore(e) {
	...
	falseRenderer;
	constructor(e, t, n = !1) {
		this.innerRenderer = e, this.symbolUnits = [], this.falseRenderer = n, this.type = bt.Unknown;
	}
	makeSearchParams(e) {
		return e;
	}
	...
	keyFields;
	constructor(e, t, n = !1) {
		super(e, t, n), this.type = bt.Unique, this.delim = e.fieldDelimiter || ", ";
		let r = (e) => e.replace(/'/g, "''");
		this.keyFields = [
			e.field,
			e.field2,
	...
	async generateWMSSymbology(e) {
		let t = pt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0), n = {
			svgcode: "",
			imgHeight: "",
			imgWidth: ""
		};
	...
	async renderSymbologyImage(e, t = null) {
		t === null && (t = pt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0));
	...
	async renderSymbologyIcon(e, t = null) {
		if (t === null) {
			...
			e.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(e), t = pt(e).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
		}
	...
	generatePlaceholderSymbology(e, t = "#000") {
		let n = pt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
	...
	async generateBlankSymbology() {
		return pt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).svg();
	}
	async symbolToSvg(e) {
		...
		let i = pt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
			path({ size: e, path: t }) {
			...
			[gt.DASH]: "5.333,4",
			[gt.DOT]: "1.333,4",
			[gt.DASHDOT]: "5.333,4,1.333,4",
			[gt.LONGDASH]: "10.666,4",
			[gt.LONGDASHDOT]: "10.666,4,1.333,4",
			[gt.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
			[gt.SHORTDOT]: "1.333,1.333",
			[gt.SHORTDASH]: "5.333,1.333",
			[gt.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
			[gt.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
		}, s = {
			color: "#000",
			opacity: 1,
			width: 1,
	...
	async getMapServerLegend(e) {
		...
		let t = { query: { f: "json" } }, n = { layers: [] }, [r, i] = await lt(ue(`${e}/legend`, t));
	...
	async queryGeometryHelper(e, t, n, r) {
		return !t && e.type === I.EXTENT && r && !r.isEqual(e.sr) && !(n && n > 2e7 && e.sr.wkid === 3978 && r.wkid === 4326) ? (await this.$iApi.geo.proj.projectExtent(r, e)).toESRI() : e.toESRI();
	}
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-YH_uzpsU.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-BX_8kuHR.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-Bn3b-oEO.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-BrTzhU5c.js"),
	"../fixtures/details/index.ts": () => import("./details-BmwKWXhv.js"),
	"../fixtures/draw/index.ts": () => import("./draw-CKXS5ZU0.js"),
	"../fixtures/export/index.ts": () => import("./export-DVtlHaSC.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-D6_mGRY-.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-DWtPGxCp.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-CTWuut5L.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-C330xSGz.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-CEgv21UD.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-Bbu2EdZu.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-CgajzQ0s.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-C-isJW4P.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-CtLNzE3I.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-CjACcZuf.js"),
	"../fixtures/grid/index.ts": () => import("./grid-BVR8QGK_.js"),
	"../fixtures/help/index.ts": () => import("./help-yqqaEHRO.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-CaLtJJ6Q.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-B-bjVo8y.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-DcuZ12sp.js"),
	"../fixtures/legend/index.ts": () => import("./legend-UwmeEieg.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-BuQqBptE.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-CgJ7rJPp.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-B-BpMTAZ.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-DPCRmk2B.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-hUFLLRBs.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-CmRu7Dj0.js"),
	"../fixtures/settings/index.ts": () => import("./settings-DRi-NEw-.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-iHchSZpS.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-C6mrGojV.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-Bacz5IhX.js")
}), Ss = class extends X {
	constructor(e) {
		super(e);
	}
	...
	mount(e, { props: t, children: n, element: r, app: i } = {}) {
		let a = r, o = Ae(e, t, n);
		return i && i._context && (o.appContext = i._context), a ||= document.createElement("div"), ze(o, a), {
			vNode: o,
			destroy: () => {
				a && ze(null, a), a = null, o = null;
			},
			el: a
		};
	}
...
var Es = {};
function Ds(e, t) {
	let n = k("panel-screen");
	return D(), y(n, {
		header: !1,
		class: "screen-spinner"
	}, {
		content: N(() => [...t[0] ||= [S("div", { class: "loader" }, null, -1)]]),
		_: 1
	});
}
var Os = /* @__PURE__ */ n(Es, [["render", Ds], ["__scopeId", "data-v-a3c61802"]]), ks = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-CM82j6TP.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-Dq5-_7lK.js"),
	"../fixtures/export/screen.vue": () => import("./screen-CgewSfGC.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-D8YTGPcO.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-vMJEsi3T.js"),
	"../fixtures/help/screen.vue": () => import("./screen-CfI1p5vz.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-Doyu0HJQ.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-C_yKTAcW.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-BsrhiPEC.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-BgIeU2Ro.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-C-MhMZEa.js")
}), As = class extends X {
	id;
	screens;
	loadedScreens = [];
	...
	e.extentSets && (t.map.extentSets = [], e.extentSets.forEach((e) => {
		...
		e.overviewUrl && (t.fixtures.overviewmap || (t.fixtures.overviewmap = { basemaps: {} }, t.fixturesEnabled.push("overviewmap")), t.fixtures.overviewmap.basemaps[e.id] = {
			...
			layers: [{
				...
				layerType: e.overviewUrl.layerType === "esriDynamic" ? L.MAPIMAGE : L.TILE,
		...
		e.attribution && (n.attribution = { text: {} }, e.attribution.text && (n.attribution.text.disabled = !e.attribution.text.enabled, n.attribution.text.value = e.attribution.text.value)), e.layers.forEach((t, r) => {
			let i = {
				id: t.id || `${e.id}-${r}`,
				layerType: t.layerType === "esriDynamic" ? L.MAPIMAGE : L.TILE,
				url: t.url,
				opacity: t.opacity ?? 1
			};
			n.layers.push(i);
...
console.info(`RAMP v${{
	...
	minor: "21",
	patch: "0-beta",
	timestamp: "Fri May 15 14:47:54 2026 -0400",
	hash: "b0b4a285843cd73951736cbd693eb196f4556af0"
}.major}.${{
	major: "4",
	minor: "21",
	patch: "0-beta",
...
//#endregion
export { J as $, za as A, bn as B, Za as C, H as Ct, Ya as D, ht as Dt, qa as E, L as Et, dr as F, en as G, an as H, ur as I, Gt as J, $t as K, lr as L, _a as M, ga as N, Ja as O, ha as P, jt as Q, kn as R, $a as S, St, Xa as T, U as Tt, rn as U, Z as V, tn as W, It as X, Y, Nt as Z, io as _, me as _t, Ws as a, re as at, to as b, W as bt, Yo as c, oe as ct, Do as d, ce as dt, q as et, To as f, d as ft, ao as g, pe as gt, $ as h, fe as ht, Ks as i, ne as it, Da as j, Ka as k, No as l, c as lt, oo as m, p as mt, qs as n, ee as nt, As as o, ie as ot, po as p, f as pt, X as q, Js as r, te as rt, Cs as s, ae as st, Gs as t, h as tt, Mo as u, se as ut, ro as v, he as vt, Qa as w, G as wt, eo as x, mt as xt, no as y, Ct as yt, wn as z };
