...
import { _ as H, d as L, F as K, G as X } from "./main-CocQyP95.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-odg1EoFs.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-Dylm-roL.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-CtuaM703.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-CDfujLnV.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-D8n7m6D1.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-CQaf2Kks.js")))
      }), s;
    }), n = (s) => {
