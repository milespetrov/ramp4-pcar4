...
import { _ as H, d as L, F as K, G as X } from "./main-BfDR7eAU.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-nYnsV75S.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CqFnEzSu.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-D-VM1x9T.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DJ6n4bfz.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BwyucAEo.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-B5ulXfyR.js")))
      }), s;
    }), n = (s) => {
