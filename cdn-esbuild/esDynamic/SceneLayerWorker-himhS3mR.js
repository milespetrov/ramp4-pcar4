import { hX as K, bh as D } from "./main-B46PFZ13.js";
import { y as X } from "./DoubleArray-DbN4atR0.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BNEk-WEz.js";
import { n as Z, s as ee } from "./vec3-C1CegiNO.js";
import "./sphere-BkWWwB6J.js";
import "./I3SUtil-Dgrnei-z.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-mSC0P_1T.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-B46PFZ13.js").then((d) => d.qK), import("./main-B46PFZ13.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Bt5OQiCC.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-himhS3mR.js.map
