import { af as le, hX as ue } from "./main-B46PFZ13.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CE5U5w0T.js").then((i) => i.l) : await import("./libtess-Bu4wDLGP.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DRjVCMAn.js.map
