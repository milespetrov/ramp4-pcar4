import { p as s$1, c as s$2, aa as u, fM as x, aj as c$1, t as t$1 } from './main-5614000d.js';
import { v, n } from './timeSupport-e86a0ba6.js';
import { J } from './utils-5c52b956.js';
import { p as p$1 } from './FeatureStore2D-22491cc1.js';
...
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await __vitePreload(() => import('./WhereClause-c18a3cd4.js').then(n => n.W),true?["./WhereClause-c18a3cd4.js","./main-5614000d.js","./preload-helper-a4975f27.js","./main-2af48127.css","./executionError-ed2c63c0.js"]:void 0,import.meta.url);try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
