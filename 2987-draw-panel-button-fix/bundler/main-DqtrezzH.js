...
var uo = class extends Z {
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-Dwxu2D17.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-BYx57L6_.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-qg12MAW8.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-BQ2zgkBg.js"),
	"../fixtures/details/index.ts": () => import("./details-Cp7-Pjsd.js"),
	"../fixtures/draw/index.ts": () => import("./draw-BFlvw_zk.js"),
	"../fixtures/export/index.ts": () => import("./export-ohnUl8En.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-8zCDnXle.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-C8MxFi3l.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-BxPf_6Mk.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-COCnI7JY.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-7K-CycWg.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-DxEb9p35.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-Cvb3f3RQ.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-DGN5jd8S.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-BpfEE0mb.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-DTTGE2Du.js"),
	"../fixtures/grid/index.ts": () => import("./grid-CStBpM_z.js"),
	"../fixtures/help/index.ts": () => import("./help-Cy8JutRx.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-BH5NgeN2.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-CdyXon9F.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-PYwIo8K0.js"),
	"../fixtures/legend/index.ts": () => import("./legend-Bs6elJGf.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-C7A30BNL.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-DpNkZ0oY.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-BpGL_V0D.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-ComsuQoz.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-CQ4oKlsn.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-CENy0921.js"),
	"../fixtures/settings/index.ts": () => import("./settings-BDjsK9GI.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-BlWbJISr.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-uOmCGtOu.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-ebb4btL6.js")
...
var vs = /* @__PURE__ */ te(gs, [["render", _s], ["__scopeId", "data-v-a3c61802"]]), ys = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-Chm0veQp.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-CecNqNOc.js"),
	"../fixtures/export/screen.vue": () => import("./screen-BTrYd2bo.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-D2Z5UD13.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-BIpbRn55.js"),
	"../fixtures/help/screen.vue": () => import("./screen-CYkky8X1.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-FKM3MraD.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-D3TsItOi.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-D43jMx1s.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-Ged5F38D.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-DKOMVrnv.js")
}), bs = class extends Z {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "22",
	patch: "0-beta",
	timestamp: "Thu May 28 14:10:11 2026 -0400",
	hash: "5b83ef466354daa769d548eb2cdd19f713935241"
}.major}.${{
	major: "4",
	minor: "22",
	patch: "0-beta",
