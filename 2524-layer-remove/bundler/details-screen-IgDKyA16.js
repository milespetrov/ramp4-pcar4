...
import { _ as ie, e as ee, N as ne, L as Te, O as Me, G as J } from "./main-CiDsJPui.js";
...
import { T as Ee } from "./toggle-switch-control-DNe5NAm8.js";
import "pinia";
import "screenfull";
...
const Ie = {
  ...
  setup(v) {
    const b = w(), i = () => {
      ...
      d.value.removeDetailsHilight(), D.value.forEach((l) => l()), O.value.forEach((l) => p.event.off(l));
    }, _e = () => {
      d.value.removeDetailsHilight();
    }, be = (l) => {
      const x = o.value;
...
}), Et = /* @__PURE__ */ ie(Mt, [["__scopeId", "data-v-18541962"]]), It = { class: "relative h-full" }, Ct = { class: "detailsContentSection overflow-y-auto h-full" }, zt = /* @__PURE__ */ F({
