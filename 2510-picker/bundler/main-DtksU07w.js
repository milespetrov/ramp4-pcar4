...
import { defineStore as z, createPinia as ns } from "pinia";
import { ref as h, computed as N, markRaw as re, defineComponent as O, inject as be, reactive as Ae, watch as xt, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, openBlock as g, createElementBlock as A, withKeys as as, withModifiers as Xt, onMounted as Je, normalizeClass as ne, normalizeStyle as Ci, createVNode as oe, Transition as Oi, withCtx as te, createBlock as W, resolveDynamicComponent as ls, mergeProps as cs, TransitionGroup as ki, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as f, vShow as us, resolveComponent as K, createTextVNode as nt, toDisplayString as B, createCommentVNode as U, onUpdated as ps, Teleport as ds, getCurrentInstance as hs, useTemplateRef as di, createApp as Mi, toRaw as _e, h as fs, render as Gt, defineAsyncComponent as ms } from "vue";
...
class fe extends Ze {
  ...
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = fe.arrayDeepCopy(t) : t instanceof fe ? this.rawArray = t.toArray() : this.rawArray = fe.parsePointSet(t);
  }
   ...
   */
  toArray() {
    return fe.arrayDeepCopy(this.rawArray);
  }
...
class we extends Ze {
  ...
  constructor(e, t, i, s) {
    if (super(e, t.sr || i), s)
      this.rawArray = we.arrayDeepCopy(t);
      ...
      this.rawArray = t.map((o) => fe.parsePointSet(o));
    } else
  ...
  updateAt(e, t) {
    this.rawArray[t] = fe.parsePointSet(e);
  }
  ...
  static fromESRI(e, t) {
    return new we(t, e.paths, I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Pi({
      paths: this.toArray(),
...
class Oe extends Ze {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof se)
      return [e.toArray()];
    if (e instanceof we || e instanceof fe)
...
class Te extends ke {
  ...
  _colour;
  constructor(e) {
    e = e || {}, super(), this._style = e.style || pe.SOLID;
...
class Ms {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Be.fromESRI(i, t) : we.fromESRI(i, t);
      }
      case "polygon":
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((n) => s[n] = e.properties[n])), new Ee(i, "", s);
  }
  /**
...
class Fs {
  ...
  async checkProj(e) {
    ...
    const o = async (a) => {
      try {
        ...
        return c === null || c === "" ? !1 : (le.defs(a, c), !0);
      } catch {
        return !1;
      }
    };
  ...
  async projectExtent(e, t) {
    ...
    const n = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, n), a = l.toArray().pop() || [], c = a.map((y) => y[0]), u = a.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), m = Math.max.apply(null, u);
...
const Lt = z("appbar", () => {
  ...
  function i(n) {
    if (r.value = { ...r.value, [n.id]: re(n) }, n.id in e.value)
      e.value[n.id].resolveMe(re(n));
    else {
      const l = new J();
      l.resolveMe(re(n)), e.value = {
        ...e.value,
        [n.id]: l
      };
    }
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_basemap_updates_map_attribs":
        t = () => {
          this.$iApi.geo.map.caption.updateAttribution(
            he(this.$vApp.$pinia).activeBasemapConfig?.attribution
          );
        }, this.$iApi.event.on("map/basemapchanged", t, e);
        break;
      ...
      case "ramp_map_created_initializes_fixtures":
        t = () => {
          const i = ve(this.$vApp.$pinia).items;
...
function Hs(r, e = 0) {
  return (X[r[e + 0]] + X[r[e + 1]] + X[r[e + 2]] + X[r[e + 3]] + "-" + X[r[e + 4]] + X[r[e + 5]] + "-" + X[r[e + 6]] + X[r[e + 7]] + "-" + X[r[e + 8]] + X[r[e + 9]] + "-" + X[r[e + 10]] + X[r[e + 11]] + X[r[e + 12]] + X[r[e + 13]] + X[r[e + 14]] + X[r[e + 15]]).toLowerCase();
}
let Bt;
...
function Zs(r, e, t) {
  let i;
  {
    const s = Date.now(), o = Js();
    Ks(zt, s, o), i = Qs(o, zt.msecs, zt.seq, e, t);
  }
  return e ?? Hs(i);
}
function Ks(r, e, t) {
  return r.msecs ??= -1 / 0, r.seq ??= 0, e > r.msecs ? (r.seq = t[6] << 23 | t[7] << 16 | t[8] << 8 | t[9], r.msecs = e) : (r.seq = r.seq + 1 | 0, r.seq === 0 && r.msecs++), r;
}
function Qs(r, e, t, i, s = 0) {
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  if (!i)
    i = new Uint8Array(16), s = 0;
  else if (s < 0 || s + 16 > i.length)
    throw new RangeError(`UUID byte range ${s}:${s + 15} is out of buffer bounds`);
  return e ??= Date.now(), t ??= r[6] * 127 << 24 | r[7] << 16 | r[8] << 8 | r[9], i[s++] = e / 1099511627776 & 255, i[s++] = e / 4294967296 & 255, i[s++] = e / 16777216 & 255, i[s++] = e / 65536 & 255, i[s++] = e / 256 & 255, i[s++] = e & 255, i[s++] = 112 | t >>> 28 & 15, i[s++] = t >>> 20 & 255, i[s++] = 128 | t >>> 14 & 63, i[s++] = t >>> 6 & 255, i[s++] = t << 2 & 255 | r[10] & 3, i[s++] = r[11], i[s++] = r[12], i[s++] = r[13], i[s++] = r[14], i[s++] = r[15], i;
}
const Rt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Rt(), t = be("iApi"), i = N(() => e.maptipPoint), s = N(() => e.maptipInstance), o = N(() => e.content), n = Ae([]), l = h(!1);
    n.push(
      xt(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const s = i.target.dataset.breakpoints, o = s ? JSON.parse(s) : e ?? er;
          Object.keys(o).forEach((n) => {
            const l = o[n];
            i.contentRect.width >= l ? i.target.classList.add(n) : i.target.classList.remove(n);
          });
        });
      });
    });
...
const tr = ["data-cy"], Wi = /* @__PURE__ */ O({
  ...
  setup(r) {
    ...
    return (a, c) => {
      ...
      return g(), A("div", {
        class: ne(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", r.panel.expanded ? "flex-grow max-w-full" : ""]),
  ...
  const r = h(void 0), e = h(void 0), t = h(0), i = h(0), s = h(!1), o = h(!0), n = h({}), l = h({}), a = h([]), c = h([]), u = h([]), p = N(() => i.value);
  function d(_) {
  ...
  function C() {
    let _ = t.value;
    const R = [], ae = 350, me = 12, ui = 600;
    for (let Fe = a.value.length - 1; Fe >= 0; Fe--) {
      const et = a.value[Fe];
      let Re = et.width || ae;
      if (s.value ? Re = _ : Re += me, et.id === "grid" && (Re = Math.max(Math.min(Re, _), ui)), (_ >= Re && !s.value || R.length === 0) && (_ -= Re, R.unshift(et)), et.id === "grid" && _ < ui)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Fe;
      for (let pi = 0; pi < R.length - 1 && _ < (r.value.width || ae) + me; pi++)
        Fe = R.shift(), _ += Fe.width || ae;
      _ >= (r.value.width || ae) ? R.unshift(r.value) : e.value || (Fe = R.shift(), R.unshift(r.value));
      const et = a.value.indexOf(r.value), Re = a.value.indexOf(Fe), Dt = a.value.slice();
      Re > -1 && (Dt.splice(et, 1), Dt.splice(Re, 0, r.value)), a.value = Dt;
    }
    i.value = _, u.value = R;
  }
  function F(_) {
    if (n.value = { ...n.value, [_.id]: _ }, _.id in l.value)
  ...
  function ue(_) {
    _.teleport ? c.value = [...c.value, _] : (a.value = [...a.value, _], e.value = _);
  }
  function Xe(_) {
    if (_.teleport) {
      ...
      const R = a.value.indexOf(_);
      R !== -1 && (a.value = [...a.value.slice(0, R), ...a.value.slice(R + 1)]);
    }
  }
  function Pt(_, R) {
    const ae = a.value.indexOf(_), me = R === "right" ? 1 : -1;
    u.value.includes(a.value[ae + me]) && ([a.value[ae], a.value[ae + me]] = [
      a.value[ae + me],
      a.value[ae]
    ]);
  }
  function Nt(_) {
    n.value[_.id] !== void 0 && delete n.value[_.id], l.value[_.id] !== void 0 && delete l.value[_.id];
  ...
  __name: "panel-stack",
  setup(r) {
    const e = Ye(), t = be("iApi"), i = h(), s = N(() => e.mobileView);
    Je(() => {
    ...
    return (c, u) => (g(), W(ki, {
      ...
      default: te(() => [
        (g(!0), A(We, null, ht(o(S(t).screenSize), (p) => (g(), W(Wi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, sr = /* @__PURE__ */ Ne(ir, [["__scopeId", "data-v-197830c4"]]), rr = ["content", "aria-label"], ii = /* @__PURE__ */ O({
  ...
  setup(r) {
    const e = h(!1), t = h(null), i = Ae([]), s = h(), o = h(), n = h(), l = r;
    i.push(
      xt(e, () => {
        t.value.update();
      })
    ...
    return Je(() => {
      window.addEventListener(
        ...
        n.value && o.value && (t.value = $s(n.value, o.value, {
      ...
      return g(), A("div", {
        ...
        M(f("div", {
          ...
          class: ne(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": r.centered }]),
          ref_key: "dropdown",
          ref: o
        }, [
          Me(p.$slots, "default", {
...
}), or = { class: "h-full flex flex-col" }, nr = { class: "w-full flex mb-6" }, ar = ["content", "aria-label"], lr = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    ...
    return (o, n) => {
      const l = K("panel-screen"), a = k("tippy");
      return g(), W(l, { panel: r.panel }, {
        header: te(() => [
          nt(B(S(t)("notifications.title")), 1)
        ]),
        content: te(() => [
          f("div", or, [
            f("div", nr, [
...
var ye = /* @__PURE__ */ ((r) => (r.ERROR = "error", r.INFO = "info", r.WARNING = "warning", r))(ye || {});
class cr extends Z {
  notificationStore;
  /**
...
const ur = ["content"], pr = { class: "flex items-center text-left" }, dr = { class: "select-text cursor-text" }, hr = ["content"], fr = {
  ...
  setup(r) {
    ...
    return (a, c) => {
      const u = k("tippy");
      return M((g(), A("li", {
        class: ne(["flex-col default-focus-style p-4", r.notification.messageList ? "cursor-pointer" : ""]),
        content: S(t)(s.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
        onClick: c[1] || (c[1] = (p) => s.value = !s.value)
      }, [
        f("div", pr, [
          f("span", null, [
            nt(B(o[r.notification.type]) + " ", 1),
            f("span", dr, B(r.notification.message), 1)
          ]),
          c[4] || (c[4] = f("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (g(), A("div", {
            key: 0,
            class: ne(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": s.value }])
          }, c[2] || (c[2] = [
            f("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "24",
          ...
          M((g(), A("button", {
            type: "button",
            onClick: c[0] || (c[0] = Xt((p) => n(r.notification), ["stop"])),
        ...
        r.notification.messageList && s.value ? (g(), A("div", fr, [
  ...
  setup(r) {
    ...
    const n = N(() => e.notificationStack);
    return (l, a) => {
      const c = k("focus-item"), u = k("focus-list"), p = k("tippy");
      return g(), A("div", null, [
        n.value.length > 0 ? M((g(), A("ul", {
          key: 0,
          ...
          (g(!0), A(We, null, ht(n.value, (d, v) => (g(), A(We, {
            key: d.message + v
          }, [
            v > 0 ? (g(), A("div", gr)) : U("", !0),
            M(oe(mr, {
          ...
          a[0] || (a[0] = f("span", { class: "flex-grow" }, null, -1)),
          a[1] || (a[1] = f("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          ...
          a[2] || (a[2] = f("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
...
}, Er = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, xr = { class: "pb-8 border-b border-gray-600" }, Sr = { class: "absolute flex right-3 top-3" }, _r = ["content", "aria-label"], Ir = /* @__PURE__ */ O({
  __name: "caption-button",
  setup(r) {
    const e = Le(), { t } = H(), i = N(() => e.notificationNumber), s = () => e.clearAll();
    return (o, n) => {
      const l = K("close"), a = k("tippy");
      return g(), W(ii, {
        position: "top-start",
        ...
        header: te(() => [
          f("div", br, [
            ...
            i.value && i.value > 0 ? (g(), A("span", Ar, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          f("div", Er, [
            f("div", null, [
              f("h4", xr, B(S(t)("notifications.title")), 1),
              f("div", Sr, [
                M((g(), A("button", {
                  type: "button",
                  onClick: s,
...
}), Tr = /* @__PURE__ */ Ne(Ir, [["__scopeId", "data-v-3623a7d2"]]), Lr = { class: "flex hover:text-white" }, Rr = ["aria-label"], $r = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Cr = ["aria-label", "content"], Or = { class: "pb-8 border-b border-gray-600 mb-10" }, kr = { class: "absolute right-5 top-5" }, Mr = { class: "select-text" }, Pr = { class: "font-bold cursor-text" }, Nr = { class: "text-sm cursor-text" }, Fr = { class: "text-sm cursor-text" }, Dr = /* @__PURE__ */ O({
  ...
  setup(r) {
    const { t: e } = H(), t = be("iApi"), i = () => {
      t.reload();
    }, s = N(() => `${mt.major}.${mt.minor}.${mt.patch}`), o = N(() => mt.hash.slice(0, 9)), n = N(() => {
      const l = new Date(mt.timestamp);
      if (isNaN(l))
        return "dev mode, no date";
      {
        const a = (c) => c < 10 ? "0" + c.toString() : c.toString();
        return `${l.getFullYear()}-${l.getMonth() + 1}-${l.getDate()} ${l.getHours()}:${a(
          l.getMinutes()
        )}:${a(l.getSeconds())}`;
      }
    });
        ...
        default: te((v) => [
          f("div", $r, [
            f("div", null, [
              ...
              f("div", Mr, [
                f("div", null, [
                  f("span", Pr, B(s.value), 1),
                  f("span", Nr, " [" + B(o.value) + "] ", 1)
                ]),
                f("div", null, [
                  f("span", Fr, B(n.value), 1)
                ]),
                a[2] || (a[2] = f("div", { class: "mt-5" }, [
                  f("a", {
...
}), Gr = /* @__PURE__ */ Ne(Dr, [["__scopeId", "data-v-dc5124c0"]]), Ur = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Br = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, zr = ["href", "aria-label"], Vr = ["src", "alt"], jr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, qr = { class: "flex min-w-fit justify-end" }, Wr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, Hr = ["aria-pressed", "aria-label", "content"], Yr = { class: "relative top-1 text-sm sm:text-base" }, Jr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Zr = ["onClick"], Kr = {
  key: 0,
  class: "sr-only"
}, Qr = /* @__PURE__ */ O({
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = he(), { t: i } = H(), s = be("iApi"), o = N(() => e.scale), n = N(() => e.attribution), l = N(() => e.coords), a = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = Ae([]);
    p.push(
      xt(c, (w) => {
    ...
    const d = () => n.value?.logo?.link && n.value?.logo?.value && !n.value?.logo?.disabled, v = (w) => {
    ...
    return (w, b) => {
      ...
      return g(), A("div", Ur, [
        ...
        n.value?.text.disabled ? U("", !0) : M((g(), A("span", jr, [
          nt(B(n.value?.text.value), 1)
        ])), [
          [T, {
            options: {
              placement: "top",
        ...
        f("div", qr, [
          l.value?.disabled ? U("", !0) : M((g(), A("div", Wr, [
            nt(B(l.value?.formattedString), 1)
          ])), [
            [T, {
              options: {
                hideOnClick: !1,
          ...
          a.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            header: te(() => [
              f("span", Jr, B(S(i)("map.language.short")), 1)
            ]),
            default: te(() => [
              (g(!0), A(We, null, ht(u.value, (F, ue) => (g(), A("a", {
                key: `${F}-${ue}`,
                class: ne(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === S(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Xe) => v(F)
              }, [
                nt(B(S(i)("map.language." + F)) + " ", 1),
                F === S(s).$i18n.locale.value ? (g(), A("span", Kr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, Zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
...
}), Xr = ["content", "aria-label"], eo = {
  key: 0,
  class: "number absolute -top-2 -right-2 text-white w-18 rounded-full"
}, to = /* @__PURE__ */ O({
  __name: "floating-button",
  setup(r) {
    const e = Le(), t = be("iApi"), { t: i } = H(), s = N(() => e.notificationNumber);
    return (o, n) => {
      const l = k("tippy");
      return M((g(), A("button", {
        type: "button",
        onClick: n[0] || (n[0] = (a) => S(t).panel.get("notifications").open()),
        ...
        s.value && s.value > 0 ? (g(), A("span", eo, B(s.value), 1)) : U("", !0)
      ], 8, Xr)), [
        [l]
      ]);
    };
  ...
  setup(r) {
    const e = be("iApi"), { t } = H(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), n = h(null), l = h(null);
    Je(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), A("div", {
        ...
        f("div", {
          ...
          f("div", so, [
            f("h2", ro, B(S(t)("keyboardInstructions.title")), 1),
            oe(p, {
              class: "ml-auto",
...
}), st = z("instance", () => ({ started: h(!1) })), no = { class: "h-full relative" }, ao = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, lo = { class: "absolute top-8 w-full flex justify-center" }, co = {
  key: 1,
  class: "w-full h-full"
}, uo = /* @__PURE__ */ O({
  __name: "shell",
  setup(r) {
    const e = be("iApi"), t = st(), i = ve(), s = Ye(), { t: o } = H(), n = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, a = () => s.teleported;
    return (c, u) => (g(), A("div", no, [
      f("div", ao, [
        ...
        n.value ? U("", !0) : (g(), W(io, { key: 0 })),
        oe(Qr, { class: "z-30" })
      ]),
      S(t).started ? (g(), W(Xs, { key: 0 })) : (g(), A("div", co, u[1] || (u[1] = [
        f("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), A(We, null, ht(a(), (p) => (g(), W(ds, {
...
}), po = /* @__PURE__ */ Ne(uo, [["__scopeId", "data-v-7a1e48c2"]]), ho = O({
  name: "App",
  components: { Shell: po },
  setup() {
    const r = hs();
...
const go = /* @__PURE__ */ Ne(ho, [["render", yo]]), Se = "focus-list", je = "focus-item", vo = "focus-icon", bo = "focus-container", ct = `[${Se}],[${bo}]`, bt = "truncate-text", wt = "show-truncate", ot = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${vo}],[tabIndex]`, wo = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Se, !0), new Ao(r, e.value);
  },
  updated(r) {
    Ji(r);
  }
...
class Ao {
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === wt && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Ji(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const gi = "focus-item", Eo = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", xo()), e.value ? r.setAttribute(gi, e.value) : r.toggleAttribute(gi, !0);
  }
};
function xo() {
  let r;
...
const si = "focus-container", Zi = "focus-list", So = "focus-icon", Vt = `[${Zi}],[${si}]`, vi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${si}],[${So}],[tabIndex]`;
let jt = [];
const _o = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && jt.push(new Io(r));
  },
  beforeUnmount(r) {
...
const To = "truncate-text", Lo = "truncate-trigger", Ro = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(To, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Lo}]`)), Ls(r, {
...
const Co = ["content"], Oo = {
  ...
  setup(r, { expose: e }) {
    const { t } = H(), i = Ye(), s = Lt(), o = be("iApi"), n = di("el"), l = di("contentEl"), a = h();
    e({ el: n });
    ...
    return Je(() => {
      n.value?.addEventListener("blur", () => {
        n.value._tippy.hide();
      }), n.value?.addEventListener("keyup", (b) => {
        b.key === "Tab" && n.value?.matches(":focus") && n.value._tippy.show();
      ...
      n.value?.removeEventListener("blur", () => {
        n.value._tippy.hide();
      }), n.value?.removeEventListener("keyup", (b) => {
        b.key === "Tab" && n.value?.matches(":focus") && n.value._tippy.show();
      }), a.value.disconnect();
    }), (b, $) => {
      const T = K("back"), C = K("panel-options-menu"), F = K("left"), ue = K("right"), Xe = K("pin"), Pt = K("expand"), Nt = K("minimize"), Ft = K("close"), _ = k("truncate"), R = k("focus-item"), ae = k("tippy");
      return M((g(), A("div", {
        ...
        r.header ? (g(), A("header", Oo, [
          oe(T, {
            class: ne(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (me) => r.panel.close())
          }, null, 8, ["class"]),
          M((g(), A("h2", ko, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (g(), A("div", Mo, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [_]
          ]),
          ...
          f("div", {
            class: ne(r.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
            r.panel.teleport ? U("", !0) : (g(), A("div", Po, [
              d.value ? (g(), W(F, {
                key: 0,
                onClick: $[1] || ($[1] = (me) => y("left")),
                active: !r.panel.isLeftMostPanel
              }, null, 8, ["active"])) : U("", !0),
              d.value ? (g(), W(ue, {
                key: 1,
                onClick: $[2] || ($[2] = (me) => y("right")),
                active: !r.panel.isRightMostPanel
              }, null, 8, ["active"])) : U("", !0),
              oe(Xe, {
                onClick: $[3] || ($[3] = (me) => r.panel.pin()),
                active: r.panel.isPinned
              }, null, 8, ["active"]),
              r.panel.controls && r.panel.controls.expand ? (g(), W(Pt, {
                key: 2,
                onClick: $[4] || ($[4] = (me) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : U("", !0)
            ])),
            r.panel.button && u.value?.includes(r.panel.id) ? (g(), W(Nt, {
              key: 1,
              onClick: $[5] || ($[5] = (me) => r.panel.minimize())
            })) : U("", !0),
            oe(Ft, {
              onClick: $[6] || ($[6] = (me) => r.panel.close())
            })
          ], 2)
        ])) : U("", !0),
        r.content ? (g(), A("div", {
          ...
          b.$slots.content ? Me(b.$slots, "content", { key: 0 }) : w.value ? (g(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, No)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? M((g(), A("div", Fo, [
          Me(b.$slots, "footer")
        ])), [
          [R]
        ]) : U("", !0)
...
}), Go = { class: "relative" }, Uo = ["content", "aria-label"], Bo = ["transform"], zo = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
  setup(r) {
    ...
    return (t, i) => {
      ...
      return g(), A("div", Go, [
        M((g(), A("button", {
          type: "button",
          class: ne(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": r.active }]),
...
}), Jo = { class: "w-32 h-32" }, Zo = ["content", "aria-label"], Ko = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), en = { class: "relative" }, tn = ["content", "aria-label"], sn = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
  setup(r) {
    ...
    return (t, i) => {
      ...
      return g(), A("div", en, [
        M((g(), A("button", {
          type: "button",
          class: ne(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": r.active }]),
...
}), rn = { class: "relative" }, on = ["content", "aria-label"], nn = /* @__PURE__ */ O({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), an = { class: "relative" }, ln = ["content", "aria-label"], cn = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), pn = /* @__PURE__ */ Ne(un, [["__scopeId", "data-v-51e22a4a"]]), dn = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      const n = K("mapnav-button");
      return g(), W(n, {
        onClickFunction: i,
        tooltip: S(e)("mapnav.fullscreen")
      }, {
        default: te(() => [
          S(t).isFullscreen ? (g(), A("svg", dn, o[0] || (o[0] = [
            f("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
    ...
    const s = async () => {
      if (i.length)
        ...
        const l = await n({
          ...
          a.code === GeolocationPositionError.PERMISSION_DENIED ? t.notify.show(ye.ERROR, e("mapnav.geolocator.error.permission")) : t.notify.show(ye.ERROR, e("mapnav.geolocator.error.internal"));
        });
        l && (i = [l.coords.longitude, l.coords.latitude], o(i));
      }
    }, o = (l) => {
      const a = new Y("geolocation", l, I.latLongSR(), !0);
  ...
  tabindex: "-1"
}, vn = ["content", "aria-label"], bn = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, An = ["aria-label", "content"], En = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), xn = /* @__PURE__ */ Ne(En, [["__scopeId", "data-v-457cd2d4"]]), Sn = z("areas-of-interest", () => ({ areas: h([]) })), _n = z("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Ln {
  ...
  fsaToProvinces(e) {
    const t = {};
    let i = Tn[e.substring(0, 1).toUpperCase()];
...
function On(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new kn(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new Mn(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new Pn(r, e.substring(0, 6).toUpperCase()) : new Nn(r, e);
}
class kt {
  config;
  query;
...
const wi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", xi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Fn = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Si {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : wi, s = l.geoNames ? l.geoNames : Ai, o = l.geoProvince ? l.geoProvince : Ei, n = l.geoTypes ? l.geoTypes : xi) : (i = wi, s = Ai, o = Ei, n = xi), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), n = n.replace("@{language}", e);
    const a = t?.settings;
    let c, u, p, d, v;
   ...
   */
  query(e) {
    return On(this.config, e.toUpperCase()).onComplete.then((t) => {
      let i = [];
...
const Dn = z("geosearch", () => {
  const r = h(new Si("en", void 0)), e = h({
    type: "",
    province: "",
    extent: void 0
  }), t = h(!1), i = h(""), s = h(""), o = h(""), n = h([]), l = h([]), a = h(!1), c = h([]), u = N(
    () => new Promise((T) => {
      r.value.fetchProvinces().then((C) => {
        C.sort((F, ue) => F.name > ue.name ? 1 : -1), T(C);
      });
    })
  ), p = N(
    () => new Promise((T) => {
  ...
  function v(T) {
    ...
    if (!C)
      ...
      const F = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(F), r.value.query(`${C}*`).then((ue) => {
          c.value = ue.failedServs, o.value = C, l.value = ue.results;
          const Xe = _i(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
...
class De extends Qi {
  ...
  load(e) {
    ...
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== de.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        ...
        this.$iApi.event.on(
          ...
          (i) => {
            this.layer.uid === i.layer.uid && (i.layer.drawState === de.REFRESH ? this.layerRedrawing = !0 : setTimeout(() => {
              this.layerRedrawing = i.layer.drawState === de.REFRESH;
            }, 500));
          }
        )
...
var Un = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(Un || {});
class Ii extends Qi {
  _infoType;
...
const Bn = z("legend", () => {
  ...
  function o(a) {
    if (a.parent === void 0)
      ...
      if (!(a.item instanceof Ii) && !(a.item instanceof De)) {
  ...
  function a(c) {
    switch (l.value) {
      ...
      case ie.FORMAT:
        ...
        break;
      case ie.CONFIGURE:
        c === ie.UPLOAD ? (t.value = "", i.value = "", o.value = null, s.value = !0, n.value = {
          config: r,
          configOptions: []
        }, l.value = ie.UPLOAD) : c === ie.FORMAT && (n.value = {
          config: r,
          configOptions: []
...
class Yn {
  ...
  constructor(e, t, i) {
    ...
    const s = Jn(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new za(this), this.panel = new Va(this), this.geo = new Ua(this), this.ui = {
   ...
   */
  initialize(e, t, i) {
    const s = he(this.$vApp.$pinia), o = Ye(this.$vApp.$pinia), n = Rt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      const u = setInterval(() => {
        ...
        m && (clearInterval(u), this.geo.map.createMap(c.map, m).then(() => {
          if (m._tippy.hide(0), n.setMaptipInstance(m._tippy), c.layers && c.layers.length > 0) {
            let y = 0;
            c.layers.forEach((w) => {
   ...
   */
  reload(e, t) {
    const i = st(this.$vApp.$pinia), s = Le(this.$vApp.$pinia), o = he(this.$vApp.$pinia), n = ve(this.$vApp.$pinia), l = Ie(this.$vApp.$pinia), a = Yt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "export":
          return _n(this.$vApp.$pinia);
        case "extentguard":
          return In(this.$vApp.$pinia);
        case "geosearch":
          return Dn(this.$vApp.$pinia);
        case "grid":
          return Yt(this.$vApp.$pinia);
        case "help":
          return Gn(this.$vApp.$pinia);
        case "legend":
          return Bn(this.$vApp.$pinia);
        case "mapnav":
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = he(this.$vApp.$pinia), i = Le(this.$vApp.$pinia), s = t.registeredLangs;
...
function Jn(r, e) {
  ...
  t.use(({ store: n }) => {
    const l = fi(n.$state);
    n.$reset = () => n.$patch(fi(l));
  });
  const i = Ws(), s = Mi(go).use(i).use(Is, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", _o), s.directive("focus-list", wo), s.directive("focus-item", Eo), s.directive("truncate", Ro), s.component("panel-screen", Do), s.component("pin", zo), s.component("close", qo), s.component("back", Yo), s.component("expand", Xo), s.component("panel-options-menu", pn), s.component("dropdown-menu", ii), s.component("minimize", sn), s.component("right", nn), s.component("left", cn), s.component("fullscreen-nav-button", fn), s.component("geolocator-nav-button", mn), s.component("home-nav-button", yn), s.component("mapnav-button", bn), s.component("appbar-button", xn), s.component("transition", Oi), s.component("transition-group", ki), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || Zs()}`, s.provide("iApi", e);
  const o = s.mount(r);
...
class ri {
  ...
  static async create(e) {
    const t = new ri(e), i = e.layers.map((n) => {
      if (n.layerType === x.TILE)
        return P.TileLayer({
          url: n.url,
          opacity: n.opacity
        });
      if (n.layerType === x.MAPIMAGE)
        return P.MapImageLayer({
          url: n.url,
          opacity: n.opacity
        });
      if (n.layerType === x.OSM)
        return P.OpenStreetMapLayer({
          opacity: n.opacity
        });
      throw new Error(`Unsupported layer type provided to basemap config: ${n.layerType}`);
    }), o = (await Promise.allSettled(i)).filter((n) => n.status === "rejected" ? (console.error(n.reason), t.createErr = !0, !1) : !0).map((n) => {
...
class Zn extends Z {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((a) => ri.create(a)), n = (await Promise.all(s)).filter((a) => (a.createErr && i(a), a.esriBasemap.baseLayers.length > 0));
    n.forEach((a) => {
      a.esriBasemap.baseLayers.forEach((c) => {
        c.watch("loadStatus", () => {
          c.loadStatus === "loaded" ? this.trackFirstBasemap = !1 : c.loadStatus === "failed" && (i(a), this.trackFirstBasemap && this.recoverBasemap(a.tileSchemaId));
        });
      });
    }), this._basemapStore = n, e.labelsDefault && (this.labelsDefault.visible = e.labelsDefault.visible);
    const l = {};
    this.esriMap = re(await P.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
  ...
  async zoomMapTo(e, t, i = !0, s = 200, o = "ease") {
    if (this.esriView) {
      ...
      n.type === L.POINT && (l.scale = t || this.pointZoomScale);
  ...
  updateAttribution(e) {
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ue(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      Promise.all(a).then((c) => {
        o = c.filter((p) => p?.copyright).map((p) => p.copyright).join(" | "), s.text.value = o || s.text.value || t.value, Ue(this.$vApp.$pinia).setAttribution(s);
      });
    }
  }
  /**
...
class Xn extends Zn {
   ...
   */
  constructor(e) {
    super(e), this.maptip = new Kn(e), this.caption = new Qn(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
   ...
   */
  async createMapView(e) {
    const i = he(this.$vApp.$pinia).config.map;
    if (!i)
  ...
  async setBasemap(e) {
    ...
    const t = he(this.$vApp.$pinia), i = await this.findBasemap(e), o = t.activeBasemapConfig.tileSchemaId !== i.tileSchemaId;
    if (o) {
      ...
      const n = await P.ColorBackground({
        color: new Pe(i.backgroundColour).toESRI()
      });
      this.esriView.background = n, this.$iApi.event.emit(E.MAP_BASEMAPCHANGE, {
        basemapId: e,
        schemaChanged: o
      });
    }
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      ...
      let l = 0;
      const a = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === j.ERROR ? (clearInterval(a), e.lastCancel < n && console.error(`Failed to add layer: ${e.id}.`), s()) : e.initiationState === D.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(a), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
...
const ea = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, ta = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, ia = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, sa = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, ra = {
  circlePoint: ea,
  solidLine: ta,
  outlinedPoly: ia,
  boundingBoxPoly: sa
...
class ua extends Z {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    na(e);
    const l = e.features[0].geometry.type, a = oa[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(ra[a])
    );
    if (t) {
    ...
    s || (s = I.parseGeoJsonCrs(e.crs)), n.renderer = await P.RendererFromJson(c.renderer), n.fields = (n.fields || []).concat(
    ...
    const v = n.fields.map((y) => y.name);
    for (let y = 0; y < d.length; y++) {
      const w = d[y];
      w.geometry.spatialReference = p, w.geometry.type = n.geometryType, Object.keys(w.attributes).forEach((b) => {
...
class da extends Z {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return n && o.features.length > 0 && o.features[0].geometry.type === V.POINT && o.features.forEach((v) => {
...
class ha extends Z {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new ua(e), this.ogc = new da(e);
  }
  /**
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || s.push(q.Datatable), t.extent === void 0 && s.push(q.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || s.push(q.Metadata), !t.mapLayer && !t.config.controls?.includes(q.Settings) && s.push(q.Settings), s.forEach((n) => {
    ...
    if (o.name = s.name || "", o.currentVersion = s.currentVersion || -1, o.minScale = s.effectiveMinScale || s.minScale || 0, o.maxScale = s.effectiveMaxScale || s.maxScale || 0, o.extent = s.extent ? G.fromArcServer(s.extent, "layer_extent") : void 0, o.defaultVisibility = s.defaultVisibility ?? !0, o.canModifyLayer = s.canModifyLayer ?? !0, s.type === "Feature Layer" || s.type === "Table") {
      if (o.dataFormat = ee.ESRI_FEATURE, o.displayField = s.displayField || "", Array.isArray(s.fields)) {
        const n = await Promise.all(
          s.fields.map((a) => P.FieldFromJson(a))
        );
        o.fields = n.map((a) => ({
          name: a.name,
          alias: a.alias,
...
class Xi extends oi {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = Q.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = j.NEW, this.initiationState = D.NEW, this.drawState = de.NOT_LOADED, this.loadDefProm = new J(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.layerTree = new It(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  updateDrawState(e) {
    this.drawState = e, e === de.REFRESH ? this.startTimer(
      "draw"
      /* DRAW */
    ) : e === de.UP_TO_DATE && this.stopTimer(
      "draw"
      /* DRAW */
  ...
  async initiate() {
    ...
    clearTimeout(i), t > this.lastCancel && (this.drawState !== de.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
  ...
  async terminate() {
    this.updateInitiationState(D.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new J(), this.loadPromDone = !1, this.updateLayerState(j.NEW), this.updateDrawState(de.NOT_LOADED), this.updateInitiationState(D.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    this.esriWatches.push(
      ...
      this.esriView = e.layerView, this.esriWatches.push(
        e.layerView.watch("updating", (t) => {
          this.updateDrawState(t ? de.REFRESH : de.UP_TO_DATE);
        })
...
class fa extends Ke {
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((a) => this._graphics.findIndex((u) => u.id === a.id) === -1 ? (this._graphics.push(a), !0) : (console.error(`Attempting to add graphic with id '${a.id}' that has already been added.`), !1)), s = this.$iApi.geo.map.getSR(), o = i.map((a) => this.$iApi.geo.proj.projectGeometry(s, a.geometry)), n = await Promise.all(o), l = i.map((a, c) => {
      const u = new Ee(n[c], a.id, a.attributes);
...
class ma extends fa {
  ...
  async onInitiate() {
    this.esriLayer = re(await P.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    const e = super.onLoadActions();
    return this.layerTree.name = this.name, this.updateDrawState(de.UP_TO_DATE), e;
  }
  // ----------- LAYER ACTIONS -----------
}
class Qe extends ni {
  ...
  runIdentify(e) {
    ...
    if (this.identifyMode === Q.HYBRID || this.identifyMode === Q.GEOMETRIC) {
      ...
      this.geomType !== L.POLYGON && e.geometry.type === L.POINT ? a.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : a.filterGeometry = e.geometry, a.filterSql = this.getCombinedSqlFilter(), o = this.queryFeatures(a).then((c) => {
        n = c;
      });
    }
    return e.hitTest && (this.identifyMode === Q.HYBRID || this.identifyMode === Q.SYMBOLIC) && (s = o.then(async () => {
      ...
      n.forEach((a) => {
        i.items.push(vt.makeRawItem(at.ESRI, a.attributes));
      }), l.forEach((a) => {
        i.items.push(vt.makeOidItem(a, this));
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new ka(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
...
class Ea extends ni {
  ...
  async onInitiate() {
    re(this.esriLayer = await P.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const n = async () => {
      ...
      if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
        ...
        this.esriLayer.renderer = c, a = { customRenderer: c };
      } else
        a = {};
      await this.loadLayerMetadata(a), e > this.lastCancel && (this.layerTree.name = this.name, this.visibility = this.origRampConfig?.state?.visibility ?? this._serverVisibility ?? !0, this.nameField = this.origRampConfig.nameField || this.nameField || "", this.tooltipField = this.origRampConfig.tooltipField || this.nameField, this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.attribs.attLoader.updateFieldList(this.fieldList), this.attribs.attLoader.updateFieldsToTrim(this.getFieldsToTrim()));
    }, l = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ce.PERMANENT)).then((a) => {
      e > this.lastCancel && (this.featureCount = a);
    });
    return this.layerTree.layerIdx = o, t.push(l, n()), t;
  }
  // ----------- LAYER ACTIONS -----------
  runIdentify(e) {
    if (!this.canIdentify())
    ...
    if (this.identifyMode === Q.HYBRID || this.identifyMode === Q.GEOMETRIC) {
      ...
      this.geomType !== L.POLYGON && e.geometry.type === L.POINT ? l.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : l.filterGeometry = e.geometry, l.filterSql = this.getCombinedSqlFilter(), o = this.queryOIDs(l).then((a) => {
        n = a;
      });
    }
    return e.hitTest && (this.identifyMode === Q.HYBRID || this.identifyMode === Q.SYMBOLIC) && (s = o.then(async () => {
...
class xa extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = re(await P.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = [], n = (a, c) => {
      ...
      if (a.sublayers && a.sublayers.length > 0) {
        const d = (p ? p.name : "") || a.title || "", v = new It(u, "", d, !1);
        c.findChildByIdx(u) || c.children.push(v), a.sublayers.reverse().forEach((m) => {
          n(m, v);
        });
      } else {
        this._sublayers[u] || (this._sublayers[u] = new Sa(
          {
            id: `${this.id}-${u}`,
            index: u,
    ...
    const l = o.map(async (a) => {
      ...
      if (p && (a.esriSubLayer.renderer = await P.RendererFromJson(u.customRenderer)), await a.loadLayerMetadata(p ? { customRenderer: a.esriSubLayer?.renderer } : {}), t < this.lastCancel)
        return;
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === L.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((s) => {
      ...
      return s.geomType !== L.POLYGON && i ? n.filterGeometry = i : n.filterGeometry = e.geometry, n.filterSql = s.getCombinedSqlFilter(), n.sourceSR = s.sourceSR, s.queryOIDs(n).then((a) => {
        a.forEach((c) => {
...
class _a extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = re(await P.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ia extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = re(await P.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ta extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = re(await P.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class La extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = re(await P.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((s) => {
      if (s) {
        let o = !0, n;
        typeof s != "string" ? n = at.JSON : s.indexOf("Search returned no results") === -1 && s !== "" ? n = at.TEXT : (o = !1, n = at.UNKNOWN), o && i.items.push(vt.makeRawItem(n, s));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    let n, l;
    const a = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), v = Math.floor(p.y), y = {
...
class es extends Xi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ge.NOLAYER, this.drawState = de.NOT_VISUAL, this.attribs = new ts(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Ce.OID }), e.fields.push(this.oidField), e.data.forEach((n, l) => n.push(l + 1)), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const o = {
        batchSize: -1,
...
class Ca extends es {
  ...
  onLoadActions() {
    ...
    }), n = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ce.PERMANENT)).then((l) => {
  ...
  async getGraphic(e) {
    ...
    if (i)
      ...
      const o = {
        ...
        includeGeometry: !1,
        attribs: this.fieldList
      }, n = await this.$iApi.geo.attributes.loadSingleFeature(o);
      this.attribs.quickCache.setAttribs(e, n.attributes), t = n.attributes;
    }
  ...
  async loadSingleFeature(e) {
    ...
    if (o.length > 0) {
      ...
      if (e.includeGeometry) {
        ...
        const a = bs(l.geometry);
        n = this.$iApi.geo.geom.geomEsriToRamp(a);
      } else
        n = new Ve();
      return new Ee(n, "", l.attributes);
    }
...
class Fa extends li {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, o) => {
      const n = o === 0, l = new Ri(this, s.minValue, s.maxValue, n);
...
class Da extends Z {
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), n = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: m, path: y }) {
      ...
      [pe.DOT]: "1.333,4",
      // esriSLSDot
      [pe.DASHDOT]: "5.333,4,1.333,4",
      // esriSLSDashDot
      [pe.LONGDASH]: "10.666,4",
      // esriSLSLongDash
      [pe.LONGDASHDOT]: "10.666,4,1.333,4",
      // esriSLSLongDashDot
      [pe.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
      // esriSLSLongDashDotDot
      [pe.SHORTDOT]: "1.333,1.333",
      // esriSLSShortDot
      [pe.SHORTDASH]: "5.333,1.333",
      // esriSLSShortDash
      [pe.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
      // esriSLSShortDashDot
      [pe.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      s = {
        type: "uniqueValue",
        field: "fakefield",
        uniqueValueInfos: i.legend.map((n) => ({
          label: n.label,
          value: n.label,
          symbol: {
            type: "esriPMS",
...
class Ga extends Z {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, o) => {
      let n;
      return t.returnGeometry ? n = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${o}`) : n = new Ve(), new Ee(n, "", s.attributes);
    });
  }
  /**
...
class Ua extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new Xn(e), this.layer = new ha(e), this.attributes = new Oa(e), this.query = new Ga(e), this.symbology = new Da(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Ba = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BRVo5bCc.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Dx8N8gy9.js"), "../fixtures/basemap/index.ts": () => import("./index-Bka_fdAP.js"), "../fixtures/crosshairs/index.ts": () => import("./index-QKKSZaB5.js"), "../fixtures/details/index.ts": () => import("./index-IqJyBusR.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DYQ608mk.js"), "../fixtures/export-legend/index.ts": () => import("./index-DZ79xkSJ.js"), "../fixtures/export-map/index.ts": () => import("./index-DcSc02Iz.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-DaxD3Cr5.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-D0svSojH.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DVN5eU_j.js"), "../fixtures/export-title/index.ts": () => import("./index-CHBHC9Hn.js"), "../fixtures/export/index.ts": () => import("./index-B88VD3z1.js"), "../fixtures/extentguard/index.ts": () => import("./index-VX14B5mL.js"), "../fixtures/gazebo/index.ts": () => import("./index-BcqZXXmU.js"), "../fixtures/geosearch/index.ts": () => import("./index-Bjs6XB_J.js"), "../fixtures/grid/index.ts": () => import("./index-BTWQ1ap7.js"), "../fixtures/help/index.ts": () => import("./index-s8ybv-IX.js"), "../fixtures/hilight/index.ts": () => import("./index-BDjTX-Nr.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-BvHUAVpF.js"), "../fixtures/legend/index.ts": () => import("./index-guoAbVbY.js"), "../fixtures/mapnav/index.ts": () => import("./index-CsBoGUB2.js"), "../fixtures/metadata/index.ts": () => import("./index-o4uW1wMG.js"), "../fixtures/northarrow/index.ts": () => import("./index-CPvZdwjz.js"), "../fixtures/overviewmap/index.ts": () => import("./index-arFT9aej.js"), "../fixtures/panguard/index.ts": () => import("./index-isBr4aCX.js"), "../fixtures/scrollguard/index.ts": () => import("./index-dO0QL1f2.js"), "../fixtures/settings/index.ts": () => import("./index-CGUayRML.js"), "../fixtures/snowman/index.ts": () => import("./index-BSYmqY-V.js"), "../fixtures/wizard/index.ts": () => import("./index-BNScs3Z-.js") });
class za extends Z {
  /**
   ...
   */
  exists(e) {
    return e in ve(this.$vApp.$pinia).items;
  }
  /**
  ...
  async add(e, t) {
    let i;
    if (e in ve(this.$vApp.$pinia).items)
      return this.get(e);
    if (t) {
      ...
      const s = (await Ba[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
    return ve(this.$vApp.$pinia).addFixture(i), this.$iApi.event.emit(E.FIXTURE_ADDED, i), this.$iApi.geo.map.created && i.initialized?.(), i;
  }
  /**
  ...
  remove(e) {
    ...
    return ve(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(E.FIXTURE_REMOVED, t), t;
  }
  ...
  get(e) {
    ...
    const i = t.map((s) => {
      const o = ve(this.$vApp.$pinia).items[s];
      if (o)
        return o;
    });
   ...
   */
  isLoaded(e) {
    const t = ve(this.$vApp.$pinia), i = Array.isArray(e) ? e : [e];
    i.forEach((o) => {
...
class ci extends Z {
  ...
  mount(e, { props: t, children: i, element: s, app: o } = {}) {
    let n = s, l = fs(e, t, i);
    return o && o._context && (l.appContext = o._context), n ? Gt(l, n) : (n = document.createElement("div"), Gt(l, n)), { vNode: l, destroy: () => {
      n && Gt(null, n), n = null, l = null;
    }, el: n };
  }
  /**
   ...
   */
  get config() {
    return he(this.$vApp.$pinia).config.fixtures[this.id];
  }
  /**
...
class Va extends Z {
  ...
  register(e, t) {
    ...
    const s = Object.entries(i).reduce((o, [n, l]) => (o.push(new Et(this.$iApi, n, l)), o), []);
...
const Ha = /* @__PURE__ */ Ne(qa, [["render", Wa], ["__scopeId", "data-v-a3c61802"]]), Ya = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-Db-lB6dl.js"), "../fixtures/basemap/screen.vue": () => import("./screen-oJjWqT5s.js"), "../fixtures/export/screen.vue": () => import("./screen-XCvVlAhK.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BhGOZ4XZ.js"), "../fixtures/grid/screen.vue": () => import("./screen-BJC3tXwd.js"), "../fixtures/help/screen.vue": () => import("./screen-DLUjIq7_.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-5f9xXIj2.js"), "../fixtures/legend/screen.vue": () => import("./screen-cN0J15Y_.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DfuupFty.js"), "../fixtures/settings/screen.vue": () => import("./screen-B7I3KoXQ.js"), "../fixtures/wizard/screen.vue": () => import("./screen-Ci7S53ee.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Us(t) || Gs(t))
      ...
      let s;
      typeof t == "string" ? s = Ya[`../fixtures/${t}`]() : s = t();
      const o = new Promise((n, l) => {
        s.then((a) => {
          this.loadedScreens.push(e), n(Bs(a) ? a.default : a);
        }), s.catch((a) => l(a));
      });
      i = ms({
...
function Za(r) {
  ...
  return Qa(r.services, e), Ka(r.map, e), Xa(r.ui, e), r.plugins && el(r.plugins, e), e;
}
function Ka(r, e) {
...
function Wt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), tl(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var rt = { major: "4", minor: "11", patch: "0-beta", timestamp: "Mon Mar 17 12:01:33 2025 -0400", hash: "e39f306700c73356a2f8ea8b50250bbc0afb5430" };
console.info(
...
const Ul = (r, e, t) => new Yn(r, e, t), ut = new Ds();
export {
  q as $,
  Gr as A,
  yt as B,
