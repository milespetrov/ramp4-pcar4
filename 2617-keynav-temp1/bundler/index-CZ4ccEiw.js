import "tiny-emitter";
import { z as I, L as O, B as d, D as P, x as R, I as z, l as G, J as F, F as T, G as v, _ as k } from "./main-4ftHFA3j.js";
...
import { markRaw as E, defineComponent as D, inject as W, ref as f, computed as l, reactive as x, onMounted as j, onBeforeUnmount as q, resolveDirective as J, createElementBlock as y, openBlock as g, createElementVNode as c, normalizeStyle as S, normalizeClass as U, withDirectives as X, unref as L } from "vue";
import "pinia";
...
const Q = { class: "relative h-full w-full overflow-hidden" }, ee = { class: "absolute h-30 w-30 top-0 right-0" }, te = ["content", "aria-label"], ie = /* @__PURE__ */ D({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: i } = Y(), a = W("iApi"), t = G(), o = f(), n = l(() => t.activeBasemapConfig), _ = l(() => e.mapConfig), b = l(() => e.basemaps), A = l(() => e.startMinimized), r = x(new Z(a)), p = f(!0), M = f(!1), m = x([]);
    j(async () => {
