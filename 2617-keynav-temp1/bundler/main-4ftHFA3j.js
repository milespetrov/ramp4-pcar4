...
import { defineStore as j, storeToRefs as us, createPinia as ps } from "pinia";
import { ref as f, computed as F, markRaw as ae, defineComponent as M, inject as Se, reactive as Le, watch as Ct, onBeforeUnmount as vt, resolveDirective as D, withDirectives as G, createElementBlock as w, openBlock as v, withKeys as ds, withModifiers as ei, onMounted as rt, normalizeStyle as Mi, normalizeClass as le, createVNode as he, Transition as Pi, withCtx as ce, createBlock as X, resolveDynamicComponent as hs, mergeProps as fs, useCssVars as ms, TransitionGroup as Ni, Fragment as it, renderList as bt, unref as _, nextTick as Dt, renderSlot as Be, createElementVNode as m, vShow as ys, resolveComponent as se, createTextVNode as ht, toDisplayString as U, createCommentVNode as V, onUpdated as gs, Teleport as vs, getCurrentInstance as bs, useTemplateRef as mi, createApp as Fi, toRaw as ke, h as As, render as zt, defineAsyncComponent as ws } from "vue";
...
import fe from "proj4";
import { debounce as kt, throttle as ct } from "throttle-debounce";
import { createI18n as Cs, useI18n as ee } from "vue-i18n";
...
var Ge = /* @__PURE__ */ ((s) => (s.BLOB = "blob", s.DATE = "date", s.DOUBLE = "double", s.GEOMETRY = "geometry", s.GLOBAL_ID = "global-id", s.GUID = "guid", s.INTEGER = "integer", s.LONG = "long", s.OID = "oid", s.RASTER = "raster", s.SINGLE = "single", s.SMALL_INTEGER = "small-integer", s.STRING = "string", s.XML = "xml", s))(Ge || {}), De = /* @__PURE__ */ ((s) => (s.CIRCLE = "circle", s.CROSS = "cross", s.DIAMOND = "diamond", s.ICON = "icon", s.PATH = "path", s.SQUARE = "square", s.TRIANGLE = "triangle", s.X = "x", s))(De || {}), me = /* @__PURE__ */ ((s) => (s.DASH = "dash", s.DASHDOT = "dash-dot", s.DASHDOTDOT = "short-dash-dot-dot", s.DOT = "dot", s.LONGDASH = "long-dash", s.LONGDASHDOT = "long-dash-dot", s.LONGDASHDOTDOT = "long-dash-dot-dot", s.NONE = "none", s.NULL = "none", s.SHORTDASH = "short-dash", s.SHORTDASHDOT = "short-dash-dot", s.SHORTDASHDOTDOT = "short-dash-dot-dot", s.SHORTDOT = "short-dot", s.SOLID = "solid", s))(me || {}), Vi = /* @__PURE__ */ ((s) => (s.BEVEL = "bevel", s.MITER = "miter", s.ROUND = "round", s))(Vi || {}), Bi = /* @__PURE__ */ ((s) => (s.ROUND = "round", s.BUTT = "butt", s.SQUARE = "square", s))(Bi || {}), zi = /* @__PURE__ */ ((s) => (s.BDIAG = "backward-diagonal", s.CROSS = "cross", s.DIAG_CROSS = "diagonal-cross", s.FDIAG = "forward-diagonal", s.HORIZONTAL = "horizontal", s.NONE = "none", s.NULL = "none", s.SOLID = "solid", s.VERTICAL = "vertical", s))(zi || {}), R = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s.LINEARRING = "LinearRing", s.EXTENT = "Extent", s.NONE = "None", s.UNKNOWN = "Unknown", s))(R || {}), Gt = /* @__PURE__ */ ((s) => (s.Simple = "simple", s.Unique = "uniqueValue", s.ClassBreaks = "classBreaks", s.Unknown = "unknown", s))(Gt || {}), S = /* @__PURE__ */ ((s) => (s.FEATURE = "esri-feature", s.MAPIMAGE = "esri-map-image", s.TILE = "esri-tile", s.IMAGERY = "esri-imagery", s.IMAGERYTILE = "esri-imagery-tile", s.GRAPHIC = "esri-graphic", s.WMS = "ogc-wms", s.WFS = "ogc-wfs", s.GEOJSON = "file-geojson", s.GEOJSONZIPPED = "file-zip-geojson", s.CSV = "file-csv", s.SHAPEFILE = "file-shape", s.FLATGEOBUF = "file-fgb", s.FLATGEOBUFZIPPED = "file-zip-fgb", s.OSM = "osm-tile", s.DATACSV = "data-csv", s.DATAJSON = "data-json", s.DATATABLE = "data-esri-table", s.UNKNOWN = "unknown", s.SUBLAYER = "sublayer", s))(S || {}), be = /* @__PURE__ */ ((s) => (s.FEATURE = "feature", s.GRAPHIC = "graphic", s.IMAGERY = "imagery", s.IMAGERYTILE = "imagery-tile", s.MAPIMAGE = "map-image", s.NOLAYER = "no-layer", s.OSM = "osm-tile", s.TILE = "tile", s.UNKNOWN = "unknown", s.WMS = "wms", s))(be || {}), oe = /* @__PURE__ */ ((s) => (s.ESRI_FEATURE = "esriFeature", s.ESRI_RASTER = "esriRaster", s.ESRI_TILE = "esriTile", s.OSM_TILE = "osmTile", s.OGC_RASTER = "ogcRaster", s.UNKNOWN = "unknown", s))(oe || {}), Y = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s))(Y || {}), re = /* @__PURE__ */ ((s) => (s.GEOMETRIC = "geometric", s.SYMBOLIC = "symbolic", s.HYBRID = "hybrid", s.NONE = "none", s))(re || {}), z = /* @__PURE__ */ ((s) => (s.NEW = "new", s.INITIATING = "initiating", s.INITIATED = "initiated", s.TERMINATING = "terminating", s.TERMINATED = "terminated", s))(z || {}), J = /* @__PURE__ */ ((s) => (s.NEW = "new", s.LOADING = "loading", s.LOADED = "loaded", s.ERROR = "error", s))(J || {}), ye = /* @__PURE__ */ ((s) => (s.NOT_LOADED = "not-loaded", s.NOT_VISUAL = "not-visual", s.REFRESH = "refresh", s.UP_TO_DATE = "up-to-date", s))(ye || {}), ft = /* @__PURE__ */ ((s) => (s.ESRI = "esri", s.TEXT = "text", s.IMAGE = "image", s.HTML = "html", s.XML = "xml", s.JSON = "json", s.UNKNOWN = "unknown", s))(ft || {}), pe = /* @__PURE__ */ ((s) => (s.SYMBOL = "symbol", s.GRID = "grid", s.EXTENT = "extent", s.INITIAL = "initial", s.API = "api", s.PERMANENT = "permanent", s))(pe || {}), Z = /* @__PURE__ */ ((s) => (s.BoundaryZoom = "boundaryZoom", s.Datatable = "datatable", s.Identify = "identify", s.Metadata = "metadata", s.Opacity = "opacity", s.Refresh = "refresh", s.Reload = "reload", s.Remove = "remove", s.Settings = "settings", s.Symbology = "symbology", s.Visibility = "visibility", s))(Z || {});
class $e {
  attributes;
  geometry;
  style;
  id;
  constructor(e, t, i) {
    this.geometry = e, t ? this.id = t : this.id = tt.sharedUtils.generateUUID(), i ? this.attributes = i : this.attributes = {};
  }
  _hover;
...
class at {
  ...
  invalid() {
    return this.type === R.NONE || this.type === R.UNKNOWN;
  }
  geoJsonFactory(e, t) {
    const i = {
      type: e,
...
class ie extends at {
  ...
  toGeoJSON() {
    return this.geoJsonFactory(Y.POINT, this.toArray());
  }
}
class ve extends at {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = ve.arrayDeepCopy(t) : t instanceof ve ? this.rawArray = t.toArray() : this.rawArray = ve.parsePointSet(t);
  }
...
class mt extends ve {
  ...
  toGeoJSON() {
    return this.geoJsonFactory(Y.MULTIPOINT, this.toArray());
  }
}
class Je extends ve {
  constructor(e, t, i, r) {
  ...
  toGeoJSON() {
    return this.geoJsonFactory(Y.LINESTRING, this.toArray());
  }
}
class _e extends at {
  rawArray;
  constructor(e, t, i, r) {
    if (super(e, t.sr || i), r)
      ...
      this.rawArray = t.map((a) => ve.parsePointSet(a));
    } else
  ...
  updateAt(e, t) {
    this.rawArray[t] = ve.parsePointSet(e);
  }
  ...
  toGeoJSON() {
    return this.geoJsonFactory(Y.MULTILINESTRING, this.toArray());
  }
}
class et extends ve {
  constructor(e, t, i, r) {
    if (super(e, t, i, r), et.closeRing(this.rawArray), this.length < 4)
  ...
  static fromESRI(e, t) {
    return new et(t, e.rings[0], T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ti({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new et(t, e.coordinates, T.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(Y.POLYGON, [this.toArray()]);
  }
}
class de extends at {
  rawArray;
  ...
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = de.arrayDeepCopy(t) : this.rawArray = de.parsePolygon(t);
  }
  addLinearRings(e) {
  ...
  get ringArray() {
    return this.rawArray.map((e, t) => new et(this.childIdGenerator(t), e, this.sr, !0));
  }
  ...
  static parsePolygon(e) {
    ...
    if (e instanceof _e)
      ...
      t = e.map((i) => ve.parsePointSet(i));
    } else
      throw new Error("invalid input format for parsePolygon");
    return t.forEach((i) => et.closeRing(i)), t;
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
  static fromESRI(e, t) {
    return new de(t, e.rings, T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ti({
      rings: this.toArray(),
  ...
  static fromGeoJSON(e, t) {
    return new de(t, e.coordinates, T.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(Y.POLYGON, this.toArray());
  }
...
class Ue extends at {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof de)
      return [e.toArray()];
    if (e instanceof _e || e instanceof ve)
      return [de.parsePolygon(e)];
    if (Array.isArray(e)) {
      if (e.length === 0)
        throw new Error("no polygons provided");
      return e.map((t) => de.parsePolygon(t));
    } else
  ...
  toGeoJSON() {
    return this.geoJsonFactory(Y.MULTIPOLYGON, this.toArray());
  }
}
class q extends at {
  ...
  expand(e) {
    return q.fromESRI(this.toESRI().expand(e), `${this.id}-expanded`);
  }
  clone() {
    return new q(this.id, this.rawMin, this.rawMax, this.sr);
  }
  /**
  ...
  toPolygon() {
    return new de(this.id, this.toPolygonArray(), this.sr, !0);
  }
  static fromParams(e, t, i, r, a, o) {
    return new q(e, [t, i], [r, a], o);
  }
  ...
  static fromArcServer(e, t) {
    return q.fromESRI(yi.fromJSON(e), t);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    }), new q(t, i, r, T.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
    return this.geoJsonFactory(Y.POLYGON, this.toPolygonArray());
  }
}
class ze {
  c;
...
class Pe extends Ve {
  ...
  _colour;
  constructor(e) {
    e = e || {}, super(), this._style = e.style || me.SOLID;
    const t = Ve.convToPoints(e.width);
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new ze(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Bi.ROUND, this._join = e.join || Vi.ROUND;
  }
...
class Et extends Ve {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new ze(e.fill.colour), this._fillStyle = e.fill.style || zi.SOLID, this._outlineStyle = new Pe(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new Ot(this.fillColour.rgba), i = new Ls();
...
class Us {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polygon":
        return de.fromESRI(e, t);
      case "extent":
        return q.fromESRI(e, t);
      case "multipoint":
  ...
  serverGeomTypeToRampGeomType(e) {
    ...
    switch (e) {
      ...
      case "esriGeometryEnvelope":
        return R.EXTENT;
      default:
        return console.error(`Unrecognized server geometry type encountered: ${e}`), R.UNKNOWN;
    }
  }
  ...
  clientGeomTypeToRampGeomType(e) {
    ...
    switch (e) {
      ...
      case "multipoint":
        return R.MULTIPOINT;
      default:
        return console.error(`Unrecognized client geometry type encountered: ${e}`), R.UNKNOWN;
    }
  }
...
class ji {
   ...
   */
  isActive() {
    return this.sqlActiveFilters([pe.PERMANENT]).length > 0;
  }
  /**
   ...
   */
  setSql(e, t) {
    e === pe.PERMANENT ? console.error("Attempted to overwrite a permanent filter. Not allowed.") : (this.sql[e] = t, this.clearCacheSet(e));
  }
  /**
   ...
   */
  setExtent(e) {
    e.isEqual(this.extent) || (this.extent = e, this.clearCacheSet(pe.EXTENT));
  }
  /**
   ...
   */
  getCacheKey(e, t) {
    return `_cache$${e.sort().join("$")}${t ? "$" + pe.EXTENT : ""}$`;
  }
  /**
   ...
   */
  clearAll() {
    this.sql = { [pe.PERMANENT]: this.sql[pe.PERMANENT] }, this.extent = void 0, this.clearAllCaches();
  }
}
class xt {
  id;
  ...
  static fromConfig(e) {
    return new xt(
      e.id,
      q.fromConfig(`${e.id}-extent-default`, e.default),
      e.full !== void 0 ? q.fromConfig(`${e.id}-extent-full`, e.full) : void 0,
      e.maximum !== void 0 ? q.fromConfig(`${e.id}-extent-maximum`, e.maximum) : void 0
    );
  }
  clone() {
...
class zs {
  espgWorker;
  constructor() {
    this.espgWorker = this.defaultEpsgLookup, fe.defs(
      "EPSG:3978",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), fe.defs(
      "EPSG:3979",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), fe.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), fe.defs("EPSG:102100", fe.defs("EPSG:3857")), fe.defs(
      "EPSG:102187",
    ...
    for (; e <= 60; ) {
      const t = e < 10 ? `0${e}` : e;
      fe.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
    }
  }
  /**
   ...
   */
  addProjection(e, t) {
    e = typeof e == "number" ? `EPSG:${e}` : e, fe.defs(e, t);
  }
  ...
  async checkProj(e) {
    ...
    const a = async (n) => {
      try {
        ...
        return c === null || c === "" ? !1 : (fe.defs(n, c), !0);
      } catch {
        return !1;
      }
    };
  ...
  async projectGeoJson(e, t, i) {
    let r, a;
    if (t ? r = this.normalizeProj(t) : r = T.parseGeoJsonCrs(e.crs), i ? a = this.normalizeProj(i) : a = Bs, a === r)
      return e;
    await this.checkProjBomber([r, a]);
    const o = fe(r, a).forward;
    return $s(e, o);
  }
  /**
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), a = tt.geom.geomGeoJsonToRamp(r, t.id);
  ...
  async projectExtent(e, t) {
    const i = (y, A, b) => {
      if (b === 0)
        return [y, A];
      const O = [(y[0] + A[0]) / 2, (y[1] + A[1]) / 2];
      if (b === 1)
        return [y, O, A];
      if (b > 1) {
        const L = i(y, O, b - 1), P = i(O, A, b - 1);
    ...
    const o = new de("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
    return q.fromParams(t.id + "_projected", p, g, d, h, l.sr);
  }
}
class qs {
  // useful functions
...
const Nt = j("appbar", () => {
  ...
  function i(o) {
    if (s.value = { ...s.value, [o.id]: ae(o) }, o.id in e.value)
      e.value[o.id].resolveMe(ae(o));
    else {
      const l = new Q();
      l.resolveMe(ae(o)), e.value = {
        ...e.value,
        [o.id]: l
      };
    }
...
class Js extends te {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new cs(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(x).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_basemap_checks_tile_proj":
        t = (i) => {
          i.schemaChanged && this.$iApi.geo.layer.allLayers().filter((r) => r.layerType === S.TILE).forEach((r) => {
            r.checkProj();
          });
      ...
      case "ramp_map_basemap_updates_map_attribs":
        t = () => {
          this.$iApi.geo.map.caption.updateAttribution(
            ge(this.$vApp.$pinia).activeBasemapConfig?.attribution
          );
        }, this.$iApi.event.on("map/basemapchanged", t, e);
        break;
...
const Ft = j("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ft(), t = Se("iApi"), i = F(() => e.maptipPoint), r = F(() => e.maptipInstance), a = F(() => e.content), o = Le([]), l = f(!1);
    o.push(
      Ct(i, () => {
        if (i.value) {
...
const tr = ["data-cy"], Ji = /* @__PURE__ */ M({
  ...
  setup(s) {
    ...
    return (n, c) => {
      const u = D("focus-container");
      return v(), w("div", {
        class: le(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", s.panel.expanded ? "flex-grow max-w-full" : ""]),
        ...
        he(Pi, {
          ...
          default: ce(() => [
            G((v(), X(hs(s.panel.route.screen), fs({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const s = f(void 0), e = f(void 0), t = f(0), i = f(0), r = f(!1), a = f(!0), o = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = f(1), d = F(() => i.value);
  function g(E) {
  ...
  function h(E) {
    const $ = [];
    return E.forEach((K) => {
      K in l.value && $.push(l.value[K].getPromise());
    }), $;
  }
  function y(E) {
    N(E), I(), e.value = void 0;
  }
  function A(E) {
    B(E), I();
  }
  ...
  function I() {
    let E = t.value;
    const $ = [], K = 350, Ee = 12, je = 600;
    for (let Ie = n.value.length - 1; Ie >= 0; Ie--) {
      const nt = n.value[Ie];
      let Fe = nt.width || K;
      if (r.value ? Fe = E : Fe += Ee, nt.id === "grid" && (Fe = Math.max(Math.min(Fe, E), je)), (E >= Fe && !r.value || $.length === 0) && (E -= Fe, $.unshift(nt)), nt.id === "grid" && E < je)
        break;
    }
    if (s.value && //@ts-expect-error TODO: explain why this is needed or remove
    !$.includes(s.value) && !r.value) {
      let Ie;
      for (let fi = 0; fi < $.length - 1 && E < (s.value.width || K) + Ee; fi++)
        Ie = $.shift(), E += Ie.width || K;
      E >= (s.value.width || K) ? $.unshift(s.value) : e.value || (Ie = $.shift(), $.unshift(s.value));
  ...
  function ne(E, $) {
    const K = n.value.indexOf(E), Ee = $ === "right" ? 1 : -1;
    u.value.includes(n.value[K + Ee]) && ([n.value[K], n.value[K + Ee]] = [
      n.value[K + Ee],
      n.value[K]
    ]);
  }
  function Ae(E) {
    ...
    $ !== -1 && (u.value = [...u.value.slice(0, $), ...u.value.slice($ + 1)]), s.value && s.value.id == E.id && (s.value = void 0);
  }
  function W(E) {
    l.value = {
      ...l.value,
  ...
  setup(s) {
    ...
    const e = st(), t = Se("iApi"), i = f(), r = F(() => e.opacity), a = F(() => e.mobileView);
    rt(() => {
    ...
    return (u, p) => (v(), X(Ni, {
      ...
      default: ce(() => [
        (v(!0), w(it, null, bt(o(_(t).screenSize), (d) => (v(), X(Ji, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, r] of e)
    t[i] = r;
  return t;
}, sr = /* @__PURE__ */ qe(ir, [["__scopeId", "data-v-717e4bd7"]]), rr = ["content", "aria-label"], si = /* @__PURE__ */ M({
    ...
    return rt(() => {
      ...
      return v(), w("div", {
        ...
        G(m("div", {
          ...
          class: le(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": s.centered }]),
          ref_key: "dropdown",
          ref: a
        }, [
          Be(p.$slots, "default", {
...
}), ar = { class: "h-full flex flex-col" }, or = { class: "w-full flex mb-6" }, nr = ["content", "aria-label"], lr = /* @__PURE__ */ M({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(s) {
    const e = Ne(), { t } = ee(), i = F(() => e.notificationNumber), r = () => e.clearAll();
    return (a, o) => {
      const l = se("panel-screen"), n = D("tippy");
      return v(), X(l, { panel: s.panel }, {
        header: ce(() => [
          ht(U(_(t)("notifications.title")), 1)
        ]),
        content: ce(() => [
          m("div", ar, [
            m("div", or, [
...
var we = /* @__PURE__ */ ((s) => (s.ERROR = "error", s.INFO = "info", s.WARNING = "warning", s))(we || {});
class cr extends te {
  notificationStore;
  /**
...
const ur = ["content"], pr = { class: "flex items-center text-left" }, dr = { class: "select-text cursor-text" }, hr = ["content"], fr = {
  ...
  setup(s) {
    const e = Ne(), { t } = ee(), i = s, r = f(!1), a = Le({
      [we.WARNING]: "⚠",
      [we.INFO]: "ℹ️",
      [we.ERROR]: "❌"
    }), o = (n) => {
    ...
    return (n, c) => {
      const u = D("tippy");
      return G((v(), w("li", {
        class: le(["flex-col default-focus-style p-4", s.notification.messageList ? "cursor-pointer" : ""]),
        content: _(t)(r.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
        onClick: c[1] || (c[1] = (p) => r.value = !r.value)
      }, [
        m("div", pr, [
          m("span", null, [
            ht(U(a[s.notification.type]) + " ", 1),
            m("span", dr, U(s.notification.message), 1)
          ]),
          c[4] || (c[4] = m("span", { class: "flex-grow" }, null, -1)),
          s.notification.messageList ? (v(), w("div", {
            key: 0,
            class: le(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": r.value }])
          }, c[2] || (c[2] = [
            m("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "24",
        ...
        s.notification.messageList && r.value ? (v(), w("div", fr, [
          (v(!0), w(it, null, bt(s.notification.messageList, (p, d) => (v(), w("p", {
  ...
  setup(s) {
    ...
    const o = F(() => e.notificationStack);
    return (l, n) => {
      const c = D("focus-item"), u = D("focus-list"), p = D("tippy");
      return v(), w("div", null, [
        o.value.length > 0 ? G((v(), w("ul", {
          key: 0,
          ...
          (v(!0), w(it, null, bt(o.value, (d, g) => (v(), w(it, {
            key: d.message + g
          }, [
            g > 0 ? (v(), w("div", gr)) : V("", !0),
            G(he(mr, {
...
}), br = { class: "flex items-center hover:text-white" }, Ar = ["aria-label"], wr = {
  key: 0,
      ...
      return v(), X(si, {
        ...
        header: ce(() => [
          m("div", br, [
            ...
            i.value && i.value > 0 ? (v(), w("span", wr, U(i.value), 1)) : V("", !0)
          ])
        ]),
        default: ce((c) => [
          m("div", Er, [
            m("div", null, [
              m("h4", xr, U(_(t)("notifications.title")), 1),
              m("div", Sr, [
                G((v(), w("button", {
                  type: "button",
                  onClick: r,
            ...
            he(Zi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
  ...
  setup(s) {
    const { t: e } = ee(), t = Se("iApi"), i = () => {
      t.reload();
    }, r = F(() => `${wt.major}.${wt.minor}.${wt.patch}`), a = F(() => wt.hash.slice(0, 9)), o = F(() => {
    ...
    return (l, n) => {
      const c = se("close"), u = se("dropdown-menu"), p = D("tippy"), d = D("focus-item");
      return G((v(), X(u, {
...
}), Ur = /* @__PURE__ */ qe(Gr, [["__scopeId", "data-v-24f3a9dc"]]), Vr = "S", Br = "__HELP__", zr = j("keyboardnav", () => {
  const s = f(null), e = f({}), t = f(!1), i = f([]), r = f(null), a = f("idle"), o = ["H", "?"];
  function l() {
    const I = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    for (const C of I)
      if (!e.value[C] && !o.includes(C)) return C;
    return null;
  }
  function n(I, C) {
    let N = I.toUpperCase();
    if (o.includes(N) || e.value[N]) {
      const B = l();
      B ? N = B : console.error("No available keyboard namespace letters");
    }
    if (!C.handler)
      for (const B of C.keys)
        B.handler || console.error(
          `Keyboardnav registration for ${N} requires handlers for all keys or a parent handler`
        );
    return e.value[N] = C, N;
  }
  function c(I) {
    t.value !== I && (t.value = I);
  }
  function u(I) {
    s.value === I && (s.value = null), delete e.value[I];
  }
  function p(I, C, N) {
    return {
      clear: () => {
        N.action = "clear", y({ event: C, suppressHandler: !0 });
      },
      reset: () => {
        N.action = "reset";
        const B = I || i.value[1];
        if (!B) {
          y({ event: C, suppressHandler: !0 });
          return;
        }
        A([Vr, B]), L(null), P("awaitAction"), s.value = B;
      }
    };
  }
  function d(I, C, N) {
    if (s.value = I, N?.suppressHandler) return;
    const ne = p(I, C, { action: null });
    e.value[I]?.activeHandler?.(ne, C);
  }
  function g(I, C) {
    s.value && !C?.suppressHandler && e.value[s.value]?.deactiveHandler?.(I), s.value = null;
  }
  function h(I, C) {
    const N = s.value;
    if (!N) return null;
    const B = e.value[N];
    if (!B) return null;
    const ne = { action: null }, Ae = p(N, C, ne);
    if (B.handler)
      return B.handler(Ae, C, I), { namespace: N, key: I, chainAction: ne.action ?? void 0 };
    const W = B.keys.find((E) => E.key === I);
    return W?.handler?.(Ae, C), W ? { namespace: N, key: W.key, chainAction: ne.action ?? void 0 } : null;
  }
  function y(I) {
    g(I?.event, { suppressHandler: I?.suppressHandler }), I?.preserveChain || (i.value = []), I?.preserveLastAction || (r.value = null), a.value = "idle";
  }
  function A(I) {
    i.value = [...I];
  }
  ...
  function H(I) {
    g(I?.event, { suppressHandler: !0 }), a.value = "complete";
  }
  return {
    activeNamespace: s,
    namespaces: e,
...
}), qr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, jr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Hr = ["href", "aria-label"], Wr = ["src", "alt"], Yr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base font-mono flex items-center gap-2",
  "aria-live": "polite"
}, Jr = { class: "chain-content" }, Kr = { class: "chain-keys" }, Zr = {
  key: 0,
  class: "chain-cursor"
}, Xr = {
  key: 1,
...
}, ta = { class: "flex min-w-fit justify-end" }, ia = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, sa = ["aria-pressed", "aria-label", "content"], ra = { class: "relative top-1 text-sm sm:text-base" }, aa = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, oa = ["onClick"], na = {
  key: 0,
  class: "sr-only"
}, la = /* @__PURE__ */ M({
  __name: "map-caption",
  setup(s) {
    const e = Ye(), t = zr(), i = ge(), { t: r } = ee(), a = Se("iApi"), o = F(() => e.scale), l = F(() => e.attribution), n = F(() => e.coords), c = F(() => e.langtoggle), u = F(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: y } = us(t), A = F(() => {
      if (!p.value.length) return null;
      const C = p.value.join(" "), N = g.value === "awaitNamespace" || g.value === "awaitAction";
      let B = null;
      const ne = d.value;
      if (ne)
        if (ne.namespace === Br)
          B = r("keyboardnav.chain.help");
        else {
          const W = `keyboardnav.key.${ne.namespace}.${ne.key}`, E = r(W);
          E !== W && (B = E);
        }
      let Ae = null;
      if (g.value === "awaitNamespace") {
        const W = `H - ${r("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((K) => {
          const Ee = `keyboardnav.ns.${K}`, je = r(Ee);
          return `${K} - ${je === Ee ? K : je}`;
        });
        Ae = `[${[W, ...E].join(", ")}]`;
      } else if (g.value === "awaitAction") {
        const W = y.value ?? p.value[1], E = W ? h.value[W] : void 0;
        E && E.keys?.length && (Ae = `[${E.keys.map((K) => {
          const Ee = `keyboardnav.key.${W}.${K.key}`, je = r(Ee), Ie = je === Ee ? K.key : je;
          return `${K.key} - ${Ie}`;
        }).join(", ")}]`);
      }
      return {
    ...
    O.push(
      Ct(u, (C) => {
        C && a.geo.map.caption.createCaption(u.value?.caption);
      })
    ), vt(() => {
      O.forEach((C) => C());
    }), gs(() => {
    ...
    const L = () => l.value?.logo?.link && l.value?.logo?.value && !l.value?.logo?.disabled, P = (C) => {
      a.$i18n.locale.value != C && a.setLanguage(C);
    }, H = () => {
      e.toggleScale(), a.geo.map.caption.updateScale();
    }, I = (C = !1) => r(C ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (C, N) => {
      const B = se("dropdown-menu"), ne = D("truncate"), Ae = D("tippy");
      return v(), w("div", qr, [
        he(Ur, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        he(Tr, { class: "sm:block display-none" }),
        L() ? (v(), w("span", jr, [
          m("a", {
        ...
        A.value ? (v(), w("span", Yr, [
          m("span", Jr, [
            N[0] || (N[0] = m("span", { class: "chain-colon" }, ":", -1)),
            m("span", Kr, U(A.value.keys), 1),
            A.value.cursor ? (v(), w("span", Zr, "_")) : V("", !0),
            A.value.options ? (v(), w("span", Xr, U(A.value.options), 1)) : V("", !0)
          ]),
          A.value.description ? (v(), w("span", Qr, "- " + U(A.value.description) + "...", 1)) : V("", !0)
        ])) : l.value?.text.disabled ? V("", !0) : G((v(), w("span", ea, [
          ht(U(l.value?.text.value), 1)
        ])), [
          [ne, {
            options: {
              placement: "top",
        ...
        N[1] || (N[1] = m("span", { class: "flex-grow w-15" }, null, -1)),
        m("div", ta, [
          n.value?.disabled ? V("", !0) : G((v(), w("div", ia, [
            ht(U(n.value?.formattedString), 1)
          ])), [
            [ne, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? V("", !0) : G((v(), w("button", {
            key: 1,
            type: "button",
          ...
          c.value?.disabled ? V("", !0) : (v(), X(B, {
            key: 2,
            class: "flex-shrink-0 pointer-events-auto focus:outline-none px-4 mr-4 relative top-2",
            position: "top-end",
            tooltip: _(r)("map.changeLanguage"),
            ariaLabel: `${_(r)("map.language.short")} - ${_(r)("map.changeLanguage")}`,
            tooltipPlacement: "top-start",
            tooltipPlacementAlt: "left-end"
          }, {
            header: ce(() => [
              m("span", aa, U(_(r)("map.language.short")), 1)
            ]),
            default: ce(() => [
              (v(!0), w(it, null, bt(b.value, (W, E) => (v(), w("a", {
                key: `${W}-${E}`,
                class: le(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": W === _(a).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: ($) => P(W)
              }, [
                ht(U(_(r)("map.language." + W)) + " ", 1),
                W === _(a).$i18n.locale.value ? (v(), w("span", na, U(_(r)("map.language.curr")), 1)) : V("", !0)
              ], 10, oa))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
...
}), ca = ["content", "aria-label"], ua = {
  key: 0,
  class: "number absolute -top-2 -right-2 text-white w-18 rounded-full"
}, pa = /* @__PURE__ */ M({
  __name: "floating-button",
  setup(s) {
    const e = Ne(), t = Se("iApi"), { t: i } = ee(), r = F(() => e.notificationNumber);
    return (a, o) => {
      const l = D("tippy");
      return G((v(), w("button", {
        type: "button",
        onClick: o[0] || (o[0] = (n) => _(t).panel.get("notifications").open()),
        ...
        r.value && r.value > 0 ? (v(), w("span", ua, U(r.value), 1)) : V("", !0)
      ], 8, ca)), [
        [l]
      ]);
    };
  }
}), da = /* @__PURE__ */ qe(pa, [["__scopeId", "data-v-a451db5c"]]), ha = { class: "flex items-center mb-20" }, fa = { class: "text-xl" }, ma = /* @__PURE__ */ M({
  __name: "keyboard-instructions",
  setup(s) {
    const e = Se("iApi"), { t } = ee(), i = f(!1), r = f(["app", "lists", "map", "panels"]), a = f([]), o = f(null), l = f(null);
    rt(() => {
      a.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        m("div", {
          ...
          m("div", ha, [
            m("h2", fa, U(_(t)("keyboardInstructions.title")), 1),
            he(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (v(!0), w(it, null, bt(r.value, (d) => (v(), w("p", {
...
}), ut = j("instance", () => ({ started: f(!1) })), ya = { class: "h-full relative" }, ga = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, va = { class: "absolute top-8 w-full flex justify-center" }, ba = {
  key: 1,
  class: "w-full h-full"
}, Aa = /* @__PURE__ */ M({
  __name: "shell",
  setup(s) {
    const e = Se("iApi"), t = ut(), i = xe(), r = st(), { t: a } = ee(), o = F(() => i.items.appbar), l = () => {
      e.event.emit("openKeyboardInstructions");
    }, n = () => r.teleported;
    return (c, u) => (v(), w("div", ya, [
      m("div", ga, [
        ...
        m("div", va, [
          m("button", {
            ...
            onClick: l
          }, U(_(a)("keyboardInstructions.open")), 1)
        ]),
        he(ma, { class: "keyboard-instructions-modal" }),
        he(sr, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        o.value ? V("", !0) : (v(), X(da, { key: 0 })),
        he(la, { class: "z-30" })
      ]),
      _(t).started ? (v(), X(Qs, { key: 0 })) : (v(), w("div", ba, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), w(it, null, bt(n(), (p) => (v(), X(vs, {
...
}), wa = /* @__PURE__ */ qe(Aa, [["__scopeId", "data-v-3d441124"]]), Ea = M({
  name: "App",
  components: { Shell: wa },
  setup() {
    const s = bs();
...
const _a = /* @__PURE__ */ qe(Ea, [["render", Ia]]), Oe = "focus-list", Qe = "focus-item", Ta = "focus-icon", La = "focus-container", yt = `[${Oe}],[${La}]`, _t = "truncate-text", Tt = "show-truncate", dt = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Oe}],[${Ta}],[tabIndex]`, Ra = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Oe, !0), new $a(s, e.value);
  },
  updated(s) {
    Xi(s);
  }
...
class $a {
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Qe) === Tt && this.highlightedItem.querySelector(`[${_t}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Xi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const Ai = "focus-item", Ca = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", Oa()), e.value ? s.setAttribute(Ai, e.value) : s.toggleAttribute(Ai, !0);
  }
};
function Oa() {
  let s;
...
const ri = "focus-container", Qi = "focus-list", ka = "focus-icon", jt = `[${Qi}],[${ri}]`, wi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Qi}],[${ri}],[${ka}],[tabIndex]`;
let Ht = [];
const Ma = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && Ht.push(new Pa(s));
  },
  beforeUnmount(s) {
...
class Pa {
  ...
  disableTabbing() {
    if (this.element.contains(document.activeElement))
      return;
    Array.prototype.filter.call(this.element.querySelectorAll(wi), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(wi), (t) => {
...
const Na = "truncate-text", Fa = "truncate-trigger", Da = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(Na, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${Fa}]`)), Ms(s, {
...
const Va = ["content"], Ba = {
  ...
  setup(s, { expose: e }) {
    const { t } = ee(), i = st(), r = Nt(), a = Se("iApi"), o = mi("el"), l = mi("contentEl"), n = f();
    e({ el: o });
    const c = s, u = F(() => a.fixture.get("appbar") ? r.temporary : []), p = F(() => i.mobileView), d = F(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, y = (b) => {
      c.panel.move(b), b === "left" && Dt(() => {
        (o.value?.querySelector(".move-left")).focus();
      });
    }, A = F(() => c.screenId ? c.panel.screens[c.screenId][a.$i18n.locale.value ?? "en"] : null);
    return rt(() => {
      ...
      const L = se("back"), P = se("panel-options-menu"), H = se("left"), I = se("right"), C = se("pin"), N = se("expand"), B = se("minimize"), ne = se("close"), Ae = D("truncate"), W = D("focus-item"), E = D("tippy");
      return G((v(), w("div", {
        class: "h-full flex flex-col items-stretch",
        content: `<div style='word-break: break-word;'>${_(t)(s.panel.alertName) + ". " + _(t)("panels.access")}</div>`,
        ref_key: "el",
        ref: o
      }, [
        s.header ? (v(), w("header", Ba, [
          he(L, {
            class: le(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: O[0] || (O[0] = ($) => s.panel.close())
          }, null, 8, ["class"]),
          G((v(), w("h2", za, [
            b.$slots.header ? Be(b.$slots, "header", { key: 0 }) : (v(), w("div", qa, U(_(t)(s.panel.alertName)), 1))
          ])), [
            [Ae]
          ]),
          b.$slots.controls ? (v(), X(P, { key: 0 }, {
            default: ce(() => [
              Be(b.$slots, "controls")
            ]),
            _: 3
          ...
          m("div", {
            class: le(s.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
            s.panel.teleport ? V("", !0) : (v(), w("div", ja, [
              d.value ? (v(), X(H, {
                key: 0,
                onClick: O[1] || (O[1] = ($) => y("left")),
                active: !s.panel.isLeftMostPanel
              }, null, 8, ["active"])) : V("", !0),
              d.value ? (v(), X(I, {
                key: 1,
                onClick: O[2] || (O[2] = ($) => y("right")),
                active: !s.panel.isRightMostPanel
              }, null, 8, ["active"])) : V("", !0),
              he(C, {
                onClick: O[3] || (O[3] = ($) => s.panel.pin()),
                active: s.panel.isPinned
              }, null, 8, ["active"]),
              s.panel.controls && s.panel.controls.expand ? (v(), X(N, {
                key: 2,
                onClick: O[4] || (O[4] = ($) => s.panel.expand()),
                active: s.panel.expanded
              }, null, 8, ["active"])) : V("", !0)
            ])),
            s.panel.button && u.value?.includes(s.panel.id) ? (v(), X(B, {
              key: 1,
              onClick: O[5] || (O[5] = ($) => s.panel.minimize())
            })) : V("", !0),
            he(ne, {
              onClick: O[6] || (O[6] = ($) => s.panel.close())
            })
          ], 2)
        ])) : V("", !0),
        s.content ? (v(), w("div", {
          ...
          b.$slots.content ? Be(b.$slots, "content", { key: 0 }) : A.value ? (v(), w("div", {
            key: 1,
            innerHTML: A.value.innerHTML
          }, null, 8, Ha)) : V("", !0)
        ], 512)) : V("", !0),
        s.footer ? G((v(), w("div", Wa, [
          Be(b.$slots, "footer")
        ])), [
          [W]
        ]) : V("", !0)
...
}), Ja = { class: "relative" }, Ka = ["content", "aria-label"], Za = ["transform"], Xa = /* @__PURE__ */ M({
  __name: "pin",
  props: {
    active: Boolean
  },
  setup(s) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", Ja, [
        G((v(), w("button", {
          type: "button",
          class: le(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": s.active }]),
          content: _(e)(s.active ? "panels.controls.unpin" : "panels.controls.pin"),
          "aria-label": _(e)(s.active ? "panels.controls.unpin" : "panels.controls.pin")
        }, [
          (v(), w("svg", {
            class: "fill-current w-16 h-16",
            xmlns: "http://www.w3.org/2000/svg",
...
}), Qa = { class: "relative" }, eo = ["content", "aria-label"], to = /* @__PURE__ */ M({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), io = { class: "relative" }, so = ["content", "aria-label"], ro = /* @__PURE__ */ M({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), ao = { class: "w-32 h-32" }, oo = ["content", "aria-label"], no = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
    ...
    return (t, i) => {
      ...
      return v(), w("div", ao, [
        G((v(), w("button", {
          ...
          content: _(e)(`panels.controls.${s.active ? "collapse" : "expand"}`),
          "aria-label": _(e)(`panels.controls.${s.active ? "collapse" : "expand"}`)
        }, [
          s.active ? (v(), w("svg", lo, i[1] || (i[1] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
...
}), uo = { class: "relative" }, po = ["content", "aria-label"], ho = /* @__PURE__ */ M({
  __name: "minimize",
  props: {
    active: Boolean
  },
  setup(s) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", uo, [
        G((v(), w("button", {
          type: "button",
          class: le(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": s.active }]),
...
}), fo = { class: "relative" }, mo = ["content", "aria-label"], yo = /* @__PURE__ */ M({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), go = { class: "relative" }, vo = ["content", "aria-label"], bo = /* @__PURE__ */ M({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), wo = /* @__PURE__ */ qe(Ao, [["__scopeId", "data-v-51e22a4a"]]), Eo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, a) => {
      const o = se("mapnav-button");
      return v(), X(o, {
        onClickFunction: i,
        tooltip: _(e)("mapnav.fullscreen")
      }, {
        default: ce(() => [
          _(t).isFullscreen ? (v(), w("svg", Eo, a[0] || (a[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
    ...
    const r = async () => {
      if (i.length)
        ...
        const l = await o({
          ...
          n.code === GeolocationPositionError.PERMISSION_DENIED ? t.notify.show(we.ERROR, e("mapnav.geolocator.error.permission")) : t.notify.show(we.ERROR, e("mapnav.geolocator.error.internal"));
        });
  ...
  tabindex: "-1"
}, Lo = ["content", "aria-label"], Ro = /* @__PURE__ */ M({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    return (e, t) => {
      const i = D("focus-item"), r = D("tippy");
      return v(), w("div", To, [
        G((v(), w("button", {
          type: "button",
          class: le(["w-full h-full default-focus-style", [
  ...
  class: "relative",
  tabindex: "-1"
}, Co = ["aria-label", "content"], Oo = /* @__PURE__ */ M({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    ...
    return (r, a) => {
      const o = D("focus-item"), l = D("tippy");
      return v(), w("div", $o, [
        G((v(), w("button", {
          type: "button",
...
}), ko = /* @__PURE__ */ qe(Oo, [["__scopeId", "data-v-1cb84ae1"]]), Mo = j("areas-of-interest", () => ({ areas: f([]) })), Po = j("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Go {
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Fo[r], this.codeToProvince(t);
  }
}
function Uo(s) {
  return new Go(s);
...
async function zo(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new Rt(s, i), await Ho(t)) : o.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new Rt(s, i), await Wo(t)) : a.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new Rt(s, i), await Yo(t)) : (i = encodeURIComponent(e.trim()), t = new Rt(s, i), await Jo(t)), t;
}
const ai = async (s) => {
  ...
  const e = s.config;
  if (await qo(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
...
}, Ko = "~FSA~", xi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Si = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ii = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", _i = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ti {
  config;
  constructor(e, t) {
    let i, r, a, o;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${A}%3D'${Ko}'&outFields=${A}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, y;
   ...
   */
  async query(e) {
    const t = await zo(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), a = t.results.filter((n) => n.order >= i);
...
const Zo = j("geosearch", () => {
  const s = f(new Ti("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), r = f(""), a = f(""), o = f([]), l = f([]), n = f(!1), c = f([]), u = F(
    () => s.value.fetchProvinces().then((L) => (L.sort((P, H) => P.name.localeCompare(H.name, void 0, { sensitivity: "case" })), L))
  ), p = F(
    () => new Promise((L) => {
      s.value.fetchTypes().then((P) => {
        P.sort(
          (H, I) => H.name.localeCompare(I.name, void 0, { sensitivity: "case" })
        ), L(P);
      });
    })
  );
  ...
  function g(L) {
    ...
    else if (P && P !== a.value || L) {
      const H = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(H), s.value.query(`${P}*`).then((I) => {
          c.value = I.failedServs, a.value = P, l.value = I.results;
          const C = Li(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function b(L) {
    ...
    L = L.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), r.value = Array.from(L).map((H) => Object.keys(P).includes(H) ? "[" + H + P[H] + "]" : H.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function O(L) {
...
}), Xo = j("help", () => ({ location: f("./help/") }));
var ts = /* @__PURE__ */ ((s) => (s.Visibility = "visibilityButton", s.Expand = "expandButton", s))(ts || {}), Xt = /* @__PURE__ */ ((s) => (s.Item = "item", s.Placeholder = "placeholder", s.Error = "error", s))(Xt || {});
class is extends te {
  _uid;
  _name;
  _type;
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = tt.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new Q(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof He) || this._lastVisible.layerControlAvailable(Z.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (r) => !(r instanceof He) || r.layerControlAvailable(Z.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof He && !this.layerControlAvailable(Z.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
...
class He extends is {
  ...
  clickSymbology(e, t) {
    if (!this.symbolsVisible() && t ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), this.toggleVisibility(!0)) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || this.toggleVisibility(!1), this.layer?.supportsFeatures) {
      ...
      let r = "";
      i.length === 0 ? r = "1=2" : i.length < this.symbologyStack.length && (r = i.join(" OR ")), this.layer.setSqlFilter(pe.SYMBOL, r);
    }
  }
  /**
...
var Qo = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(Qo || {});
class Ri extends is {
  _infoType;
...
const en = j("legend", () => {
  ...
  function a(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Ri) && !(n.item instanceof He)) {
...
var ue = /* @__PURE__ */ ((s) => (s[s.UPLOAD = 0] = "UPLOAD", s[s.FORMAT = 1] = "FORMAT", s[s.CONFIGURE = 2] = "CONFIGURE", s))(ue || {});
const nn = j("wizard", () => {
  const s = {
    id: "Placeholder",
    layerType: S.UNKNOWN,
  ...
  function n(c) {
    switch (l.value) {
      case ue.UPLOAD:
        c === ue.UPLOAD ? t.value = "" : c === ue.FORMAT && (l.value = ue.FORMAT);
        break;
      case ue.FORMAT:
        c === ue.UPLOAD ? (a.value && (t.value = "", a.value = null), i.value = "", l.value = ue.UPLOAD) : c === ue.CONFIGURE && (l.value = ue.CONFIGURE);
        break;
      case ue.CONFIGURE:
        c === ue.UPLOAD ? (t.value = "", i.value = "", a.value = null, r.value = !0, o.value = {
          config: s,
          configOptions: []
        }, l.value = ue.UPLOAD) : c === ue.FORMAT && (o.value = {
          config: s,
          configOptions: []
        }, r.value = !0, l.value = ue.FORMAT);
        break;
    }
  }
  return {
...
class ln {
  ...
  constructor(e, t, i) {
    ...
    const r = cn(e, this);
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new rl(this), this.panel = new al(this), this.geo = new il(this), this.dev = new pl(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new cr(this), this._isFullscreen = Ce.isEnabled && !!this.$vApp.$root && Ce.isFullscreen && Ce.element === this.$vApp.$root.$el, Ce.isEnabled && Ce.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const r = ge(this.$vApp.$pinia), a = st(this.$vApp.$pinia), o = Ft(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = ut(this.$vApp.$pinia), r = Ne(this.$vApp.$pinia), a = ge(this.$vApp.$pinia), o = xe(this.$vApp.$pinia), l = Me(this.$vApp.$pinia), n = Jt(this.$vApp.$pinia), c = !!e;
    ...
    if (!([
      ...
      switch (e) {
        ...
        case "areas-of-interest":
          return Mo(this.$vApp.$pinia);
        case "details":
          return Wi(this.$vApp.$pinia);
        case "export":
          return Po(this.$vApp.$pinia);
        case "extentguard":
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = ge(this.$vApp.$pinia), i = Ne(this.$vApp.$pinia), r = t.registeredLangs;
...
function cn(s, e) {
  ...
  const i = Xs(), r = Fi(_a).use(i).use(Os, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", Ma), r.directive("focus-list", Ra), r.directive("focus-item", Ca), r.directive("truncate", Da), r.component("panel-screen", Ya), r.component("pin", Xa), r.component("close", to), r.component("back", ro), r.component("expand", co), r.component("panel-options-menu", wo), r.component("dropdown-menu", si), r.component("minimize", ho), r.component("right", yo), r.component("left", bo), r.component("fullscreen-nav-button", So), r.component("geolocator-nav-button", Io), r.component("home-nav-button", _o), r.component("mapnav-button", Ro), r.component("appbar-button", ko), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || tt.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class un extends te {
  ...
  async createMap(e, t) {
    ...
    const l = {};
    this.esriMap = ae(await k.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
  ...
  async zoomMapTo(e, t, i = !0, r = 200, a = "ease") {
    if (this.esriView) {
      ...
      o.type === R.POINT && (l.scale = t || this.pointZoomScale);
   ...
   */
  getExtent() {
    return this.esriView ? q.fromESRI(this.esriView.extent) : (this.noMapErr(), q.fromParams("i_am_error", 0, 1, 0, 1));
  }
  /**
...
class pn extends te {
  ...
  async checkAtCoord(e) {
    ...
    if (i?.geomType != R.POLYGON && this.#e && this.#e.layerId === t.layerId && this.#e.oid === t.oid && this.#e.layerIdx === t.layerIdx)
      return;
...
class hn extends un {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new pn(e), this.caption = new dn(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
   ...
   */
  async createMapView(e) {
    const i = ge(this.$vApp.$pinia).config.map;
    if (!i)
  ...
  async setBasemap(e) {
    ...
    const t = ge(this.$vApp.$pinia), i = await this.findBasemap(e), a = t.activeBasemapConfig.tileSchemaId !== i.tileSchemaId;
    if (a) {
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, r) => {
      if (this.esriMap || (this.noMapErr(), r()), e.initiationState !== z.INITIATING && e.initiationState !== z.INITIATED && e.layerState !== J.ERROR && e.initiate(), e.mapLayer && t === void 0) {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === J.ERROR ? (clearInterval(n), e.lastCancel < o && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === z.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  removeLayer(e) {
    ...
    i.removeLayer(t), i.removeLayerConfig(t.id), t.removeEsriLayer(), t.initiationState === z.INITIATED && t.terminate(), t.isRemoved = !0, this.$iApi.event.emit(x.LAYER_REMOVE, t);
  }
  /**
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((u) => u.identifyMode === re.HYBRID || u.identifyMode === re.SYMBOLIC) && (a = this.symbolIdentify(i.screenX, i.screenY));
    const o = {
      geometry: i.mapPoint,
      hitTest: a
...
const fn = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, mn = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, yn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, gn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, vn = {
  circlePoint: fn,
  solidLine: mn,
  outlinedPoly: yn,
  boundingBoxPoly: gn
...
class Sn extends te {
  ...
  extractCsvFields(e, t = ",") {
    return vi.dsvFormat(t).parseRows(e)[0].map((r) => ({ name: r, type: Ge.STRING }));
  }
  /**
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    An(e);
    const l = e.features[0].geometry.type, n = bn[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(vn[n])
    );
    if (t) {
...
class _n extends te {
  ...
  async loadWfsData(e, t = -1, i = 0, r = 1e3, a = {
    ...
    if (a.features = a.features.concat(d.features), d.features.length < t - i) {
      ...
      return o && a.features.length > 0 && a.features[0].geometry.type === Y.POINT && a.features.forEach((g) => {
...
class Tn extends te {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new Sn(e), this.ogc = new _n(e);
  }
  /**
  ...
  allActiveLayers() {
    return this.allLayers().filter(
      (e) => e.layerState !== J.ERROR && e.initiationState === z.INITIATED
    );
  }
  /**
   ...
   */
  allLayersOnMap(e = !0) {
    const t = this.allLayers().filter((i) => i.mapLayer && i.initiationState === z.INITIATED);
    if (e) {
   ...
   */
  allDataLayers() {
    return this.allLayers().filter((e) => !e.mapLayer && e.initiationState === z.INITIATED);
  }
  /**
   ...
   */
  allInitiatingLayers() {
    return this.allLayers().filter((e) => e.initiationState === z.INITIATING);
  }
  /**
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || r.push(Z.Datatable), t.extent === void 0 && r.push(Z.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || r.push(Z.Metadata), !t.mapLayer && !t.config.controls?.includes(Z.Settings) && r.push(Z.Settings), r.forEach((o) => {
  ...
  async loadLayerMetadata(e) {
    ...
    const r = i.data, a = {
      ...
      currentVersion: 0,
      name: "",
      dataFormat: oe.UNKNOWN,
      mapLayer: !0
    };
    if (a.name = r.name || "", a.currentVersion = r.currentVersion || -1, a.minScale = r.effectiveMinScale || r.minScale || 0, a.maxScale = r.effectiveMaxScale || r.maxScale || 0, a.extent = r.extent ? q.fromArcServer(r.extent, "layer_extent") : void 0, a.defaultVisibility = r.defaultVisibility ?? !0, a.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
      if (a.dataFormat = oe.ESRI_FEATURE, a.displayField = r.displayField || "", Array.isArray(r.fields)) {
...
class ci extends te {
   ...
   */
  constructor(e, t) {
    super(t), this.config = e, this.id = "", this.uid = "", this.name = "error", this.layerState = J.NEW, this.drawState = ye.NOT_LOADED, this.initiationState = z.NEW, this.layerIdx = -1, this.layerFormat = be.UNKNOWN, this.layerType = S.UNKNOWN, this.dataFormat = oe.UNKNOWN, this.supportsIdentify = !1, this.identifyMode = re.NONE, this.supportsFeatures = !1, this.mapLayer = !0, this.featureCount = 0, this.fields = [], this.fieldList = "", this.nameField = "", this.tooltipField = "", this.oidField = "", this.supportsSublayers = !1, this.isSublayer = !1, this.isRemoved = !1, this.isFile = !1, this.isCosmetic = !1, this.isSystem = !1, this.userAdded = !1, this.identify = !1, this.hovertips = !1, this.geomType = R.UNKNOWN, this.legend = [], this._sublayers = [], this.expectedTime = { draw: 0, load: 0, fail: 0 }, this.lastCancel = 0, this.canModifyLayer = !0, this.canReload = !0, this.url = "";
  }
  /**
   ...
   */
  getGraphicExtent(e) {
    return Promise.resolve(q.fromParams("fake", 0, 0, 0, 0));
  }
  /**
...
class ss extends ci {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = R.NONE, this.dataFormat = oe.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = be.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = re.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = J.NEW, this.initiationState = z.NEW, this.drawState = ye.NOT_LOADED, this.loadDefProm = new Q(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new Mt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async initiate() {
    this.updateInitiationState(z.INITIATING), this.startTimer(
      "load"
      /* LOAD */
    );
    const e = (a) => {
      this.layerState !== J.ERROR && (console.error(a), this.onError());
    ...
    clearTimeout(i), t > this.lastCancel && (this.drawState !== ye.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
    ), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(z.INITIATED));
  }
  async onInitiate() {
    if (this.isSublayer)
      return console.warn("Attempted to initiate a sublayer as a CommonLayer"), Promise.resolve();
    this.initiationState === z.INITIATED && console.error(`Encountered layer initialize while already initiated, layer id ${this.id}`);
  }
  async terminate() {
    this.updateInitiationState(z.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new Q(), this.loadPromDone = !1, this.updateLayerState(J.NEW), this.updateDrawState(ye.NOT_LOADED), this.updateInitiationState(z.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(r).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new Q()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((a) => a.onLoad()), this.updateLayerState(J.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== J.ERROR && (this.initiationState === z.INITIATING && this.updateInitiationState(z.NEW), this.loadPromDone && (this.loadDefProm = new Q()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      we.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
  ...
  cancelLoad() {
    this.isLoaded || this.initiationState === z.NEW || this.initiationState === z.TERMINATING || this.initiationState === z.TERMINATED || (this.lastCancel = Date.now(), this.esriLayer && this.esriLayer.loadStatus === "loading" && this.esriLayer.cancelLoad(), this.removeEsriLayer(), this.onError(!1));
  }
  loadPromise() {
   ...
   */
  getGraphicExtent(e) {
    return this.stubError(), Promise.resolve(q.fromParams("fake", 0, 0, 0, 0));
  }
  applySqlFilter(e = []) {
    this.stubError();
  }
...
class Xe extends ss {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new qi(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? q.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new Q(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
  ...
  async onInitiate() {
    ...
    this.esriWatches.push(
      ...
      this.esriView = ae(e.layerView), this.esriWatches.push(
        Te(
   ...
   */
  get layerExists() {
    return this.initiationState === z.INITIATED && !!this.esriLayer;
  }
  /**
...
class ui extends Xe {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = R.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new ji(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new as();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ns(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === oe.ESRI_FEATURE) {
        ...
        const a = {
          ...
          permanentFilter: this.getSqlFilter(pe.PERMANENT)
        };
...
class Ln extends Xe {
  constructor(e, t) {
    super(e, t), this.dataFormat = oe.ESRI_FEATURE, this.layerFormat = be.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class Rn extends Ln {
  ...
  async onInitiate() {
    this.esriLayer = ae(await k.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class ot extends ui {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = oe.ESRI_FEATURE, this.layerFormat = be.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== re.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = re.HYBRID;
  }
  async reload() {
  ...
  runIdentify(e) {
    ...
    if (this.identifyMode === re.HYBRID || this.identifyMode === re.GEOMETRIC) {
      const n = {
        includeGeometry: !1
      };
      this.geomType !== R.POLYGON && e.geometry.type === R.POINT ? n.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : n.filterGeometry = e.geometry, n.filterSql = this.getCombinedSqlFilter(), a = this.queryFeatures(n).then((c) => {
        o = c;
      });
    }
    return e.hitTest && (this.identifyMode === re.HYBRID || this.identifyMode === re.SYMBOLIC) && (r = a.then(async () => {
  ...
  extractLayerMetadata() {
    ...
    this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? q.fromESRI(e.fullExtent, this.id + "_extent");
    const t = ae(e.fields.slice());
    this.fields = t.map((r) => ({
      name: r.name,
      alias: r.alias,
      type: r.type,
    ...
    this.attribs.attLoader = new Jn(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
...
class Nn extends ui {
  constructor(e, t) {
    super(e, t), this.dataFormat = oe.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = be.FEATURE, e.identifyMode && e.identifyMode !== re.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = re.HYBRID;
  }
  async onInitiate() {
    ae(this.esriLayer = await k.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    }, l = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(pe.PERMANENT)).then((n) => {
  ...
  runIdentify(e) {
    ...
    if (this.identifyMode === re.HYBRID || this.identifyMode === re.GEOMETRIC) {
      ...
      this.geomType !== R.POLYGON && e.geometry.type === R.POINT ? l.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : l.filterGeometry = e.geometry, l.filterSql = this.getCombinedSqlFilter(), a = this.queryOIDs(l).then((n) => {
        o = n;
      });
    }
    return e.hitTest && (this.identifyMode === re.HYBRID || this.identifyMode === re.SYMBOLIC) && (r = a.then(async () => {
...
class Fn extends Xe {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = be.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = re.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = ae(await k.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    this.isDynamic = this.esriLayer.capabilities.exportMap.supportsDynamicLayers, this.extent = this.extent ?? q.fromESRI(this.esriLayer.fullExtent, this.id + "_extent");
    const i = (n) => {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new Dn(
          {
  ...
  runIdentify(e) {
    ...
    if (t.length === 0)
      return [];
    let i;
    return e.geometry.type === R.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((r) => {
      ...
      return r.geomType !== R.POLYGON && i ? o.filterGeometry = i : o.filterGeometry = e.geometry, o.filterSql = r.getCombinedSqlFilter(), o.sourceSR = r.sourceSR, r.queryOIDs(o).then((n) => {
        n.forEach((c) => {
...
class Dn extends ui {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = be.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.isSystem = i.isSystem, this.dataFormat = oe.ESRI_FEATURE, this.supportsFeatures = !0, this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
   ...
   */
  async onInitiate() {
    this.initiationState = z.INITIATED;
   ...
   */
  get layerExists() {
    return !!(this.parentLayer?.layerExists && this.esriSubLayer && this.initiationState === z.INITIATED);
  }
  /**
...
class Gn extends Xe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.OSM, this.layerFormat = be.OSM, this.dataFormat = oe.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = ae(await k.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Un extends Xe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERY, this.layerFormat = be.IMAGERY, this.dataFormat = oe.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = ae(await k.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Vn extends Xe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERYTILE, this.layerFormat = be.IMAGERYTILE, this.dataFormat = oe.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = ae(await k.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Bn extends Xe {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.TILE, this.layerFormat = be.TILE, this.dataFormat = oe.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = ae(await k.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class zn extends Xe {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = be.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = oe.OGC_RASTER, this.identifyMode = re.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = ae(await k.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  getFeatureInfo(e, t, i) {
    ...
    const b = {
      ...
      LAYERS: u,
      INFO_FORMAT: i
    }, O = a.customLayerParameters;
    return O && Object.keys(O).forEach((L) => {
      L.toLowerCase() !== "styles" && (b[L] = O[L]);
    }), Object.keys(b).forEach((L) => l[L] = b[L]), Ke(a.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class rs extends ss {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = oe.ESRI_FEATURE, this.layerFormat = be.NOLAYER, this.drawState = ye.NOT_VISUAL, this.attribs = new as(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Kn(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
  ...
  async reload() {
    this.$iApi.event.emit(x.LAYER_RELOAD_START, this), await this.terminate(), await this.initiate(), this.layerState !== J.ERROR && this.onLoad(), setTimeout(() => {
...
class Hn extends rs {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = S.DATATABLE, this.serviceUrl = e.url, this.filter = new ji(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    ...
    }), o = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(pe.PERMANENT)).then((l) => {
...
class Yn extends te {
  ...
  async generateTabularAttributesWorker(e, t) {
    if (e.dataFormat === oe.ESRI_RASTER)
...
class ns {
  ...
  isPoint;
  constructor(e) {
    this.attribs = {}, this.geoms = {}, this.extents = {}, this.isPoint = e === R.POINT || e === R.MULTIPOINT;
  }
  getScaleStore(e) {
...
class el extends te {
  ...
  async symbolToSvg(e) {
    ...
    const a = lt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      ...
      [me.DOT]: "1.333,4",
      // esriSLSDot
      [me.DASHDOT]: "5.333,4,1.333,4",
      // esriSLSDashDot
      [me.LONGDASH]: "10.666,4",
      // esriSLSLongDash
      [me.LONGDASHDOT]: "10.666,4,1.333,4",
      // esriSLSLongDashDot
      [me.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
      // esriSLSLongDashDotDot
      [me.SHORTDOT]: "1.333,1.333",
      // esriSLSShortDot
      [me.SHORTDASH]: "5.333,1.333",
      // esriSLSShortDash
      [me.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
      // esriSLSShortDashDot
      [me.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
      ...
      "simple-fill"() {
        ...
        a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(A).stroke(O);
      },
      text() {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((P) => {
          ...
          a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(H).stroke(O);
        });
      },
      "picture-marker"() {
...
class tl extends te {
  ...
  async queryGeometryHelper(e, t, i, r) {
    return !t && e.type === R.EXTENT && r && !r.isEqual(e.sr) && !(i && i > 2e7 && e.sr.wkid === 3978 && r.wkid === 4326) ? (await this.$iApi.geo.proj.projectExtent(r, e)).toESRI() : e.toESRI();
  }
  /**
...
class il extends te {
   ...
   */
  constructor(e) {
    super(e), this.geom = tt.geom, this.proj = tt.proj, this.shared = tt.sharedUtils, this.map = new hn(e), this.layer = new Tn(e), this.attributes = new Yn(e), this.query = new tl(e), this.symbology = new el(e), Array.isArray(At.request.interceptors) || (At.request.interceptors = []), At.request.interceptors.push({
      before: (t) => {
...
const sl = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DTZABJz5.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-C9s2F4Kw.js"), "../fixtures/basemap/index.ts": () => import("./index-DwvWeiwg.js"), "../fixtures/crosshairs/index.ts": () => import("./index-8FvtKCRH.js"), "../fixtures/details/index.ts": () => import("./index-BMLP6HwY.js"), "../fixtures/draw/index.ts": () => import("./index-COgkHC9Y.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DXp7vNmM.js"), "../fixtures/export-legend/index.ts": () => import("./index-dGFX8wq2.js"), "../fixtures/export-map/index.ts": () => import("./index-YVFcXcI8.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Cy6bv4wa.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Dnpvi4Ua.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BtrCmu7q.js"), "../fixtures/export-title/index.ts": () => import("./index-BFCZu1hc.js"), "../fixtures/export/index.ts": () => import("./index-Di2ee5N1.js"), "../fixtures/extentguard/index.ts": () => import("./index-DGm2XUHZ.js"), "../fixtures/gazebo/index.ts": () => import("./index-CMKVV3Ya.js"), "../fixtures/geosearch/index.ts": () => import("./index-kD8hlTss.js"), "../fixtures/grid/index.ts": () => import("./index-DZcOIWcs.js"), "../fixtures/help/index.ts": () => import("./index-naiJPW5h.js"), "../fixtures/hilight/index.ts": () => import("./index-BJUMENOD.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-BiBRMlPD.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-zCzZcB67.js"), "../fixtures/legend/index.ts": () => import("./index-CLM7ZHFr.js"), "../fixtures/mapnav/index.ts": () => import("./index-BlpTsXd9.js"), "../fixtures/metadata/index.ts": () => import("./index-ha2_4Q6T.js"), "../fixtures/northarrow/index.ts": () => import("./index-Kf0c4DXA.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CZ4ccEiw.js"), "../fixtures/panguard/index.ts": () => import("./index-IhdyOffW.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CpvIJFJg.js"), "../fixtures/settings/index.ts": () => import("./index-BEoWCcZf.js"), "../fixtures/snowman/index.ts": () => import("./index-B58t9i6-.js"), "../fixtures/swipe/index.ts": () => import("./index-D_YKvXp4.js"), "../fixtures/wizard/index.ts": () => import("./index-CkTm9fb2.js") });
class rl extends te {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const r = (await sl[`../fixtures/${e}/index.ts`]()).default;
      i = new r(e, this.$iApi);
    }
  ...
  get(e) {
    ...
    const i = t.map((r) => {
      const a = xe(this.$vApp.$pinia).items[r];
      if (a)
        return a;
    });
...
class hi extends te {
   ...
   */
  get config() {
    return ge(this.$vApp.$pinia).config.fixtures[this.id];
  }
  /**
  ...
  handlePanelTeleports(e) {
    if (this.config?.panelTeleport) {
      const t = st(this.$vApp.$pinia), i = !!this.config.panelTeleport.target;
      e.forEach((r) => {
...
const cl = /* @__PURE__ */ qe(nl, [["render", ll], ["__scopeId", "data-v-a3c61802"]]), ul = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BP2xYYEy.js"), "../fixtures/basemap/screen.vue": () => import("./screen-C4UoOhrP.js"), "../fixtures/export/screen.vue": () => import("./screen-TD0GkBR-.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BcEKttgu.js"), "../fixtures/grid/screen.vue": () => import("./screen-C4hchmEe.js"), "../fixtures/help/screen.vue": () => import("./screen-XL_Vi_9T.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-CzCXDKiB.js"), "../fixtures/legend/screen.vue": () => import("./screen-DxLjXjc-.js"), "../fixtures/metadata/screen.vue": () => import("./screen-D5q_C28r.js"), "../fixtures/settings/screen.vue": () => import("./screen-CbvgZsSA.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CBs-oYFA.js") });
class $t extends te {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Hs(t) || js(t))
      ...
      let r;
      typeof t == "string" ? r = ul[`../fixtures/${t}`]() : r = t();
...
function hl(s) {
  ...
  return ml(s.services, e), fl(s.map, e), yl(s.ui, e), s.plugins && gl(s.plugins, e), e;
}
function fl(s, e) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = gt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? r.children.push(ki(a)) : r.children.push(Qt(a));
      }), e.children.push(r);
    } else
...
function Wt(s) {
  ...
  )), typeof s.stateOnly < "u" && (e.cosmetic = s.stateOnly), s.initialFilteredQuery && (e.initialFilteredQuery = s.initialFilteredQuery), vl(s, e), (typeof s.toggleSymbology < "u" || s.table) && (e.fixtures = {}, typeof s.toggleSymbology < "u" && (e.fixtures.legend = {
...
var pt = { major: "4", minor: "14", patch: "0-beta", timestamp: "Thu Oct 23 17:41:35 2025 -0400", hash: "ee44c3868dfa7def68f8a90526cb695ad291a78c" };
console.info(
...
const ac = (s, e, t) => new ln(s, e, t), tt = new qs();
export {
  Ge as $,
  Ur as A,
  an as B,
