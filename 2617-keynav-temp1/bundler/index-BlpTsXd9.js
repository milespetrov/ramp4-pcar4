...
import { _ as H, d as L, F as X, G as ee } from "./main-4ftHFA3j.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-D4xpz0e3.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-B4XGw-nK.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Cdwf2_16.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BH4tyK44.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BWz1sC43.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DGMW1HVH.js")))
      }), s;
    }), n = (s) => {
