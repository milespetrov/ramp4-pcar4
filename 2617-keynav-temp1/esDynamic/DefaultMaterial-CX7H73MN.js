import{H as We,o as B,s as qo,A as Yo,c as Se,r as Jo,g as Ue,P as Zo,N as ko}from"./vec32-C2jiefZc.js";import{ff as qe,gN as k,gM as ye,ah as E,v as c,x as Ce,z as $o,d$ as ie,ab as Xo,fV as Ko,af as Qo,cU as ea,lq as $,da as oa}from"./main-CsxAHRlH.js";import{l as Ye}from"./ViewingMode-CdRKcXnc.js";import{O as aa}from"./InterleavedLayout-CVPFwUFf.js";import{n as w,u as X,r as Je,o as Ne,t as ta,C as ra}from"./ShaderOutput-CUn9tpiG.js";import{n as G,a as M,t as ne}from"./NormalAttribute.glsl-C4YIrlp_.js";import{F as ia,q as na,r as D,u as sa,v as la,x as ca,y as se,z as da,A as ma,h as ua,B as ha,C as pa,c as F,D as K,f as H,E as W,G as U,H as Q,I as N,J as q,K as va,M as fa,N as ga,O as V,P as xa,Q as Ze,R as ke,S as $e,T as Xe,U as ba,V as Oe,W as le,X as Ke,Y as wa,e as ce,Z as Ma,_ as Ta,$ as Qe,a0 as ze,k as Sa,o as I,a1 as p,a2 as Ee,a3 as Ie,a4 as de,j as ya,a5 as Ca,a6 as Na,a7 as Le,a8 as Oa,a9 as za,aa as eo,d as me,ab as oo,ac as ao,ad as to,ae as ro,af as io,ag as ue,ah as no,ai as Ea,aj as Ia,ak as La,al as Ga,am as Aa,an as Pa,ao as Ra,ap as Da,aq as Fa,ar as ja,as as _a,at as j,au as u,av as Va,aw as Ge,ax as Ba,ay as Ha,az as Wa,aA as Ua,aB as qa,aC as Ya,aD as Ja}from"./OutputColorHighlightOID.glsl-CLQN8U8t.js";import{n as i,t as v}from"./glsl-Z5uYj8ka.js";import{i as O,a as so,e as ee,n as oe}from"./basicInterfaces-Dsf65ICa.js";import{e as x}from"./VertexAttribute-hUz6pozM.js";import{n as lo,s as Za,r as ka}from"./vec4f64-DD-nkcCV.js";import{e as Ae,r as Y}from"./mat3f64-BnNZDR5l.js";import{j as $a}from"./mat3-DOnW3DjW.js";import{r as co}from"./mat4f64-xsZDPPj0.js";import{a as he}from"./BindType-CKbZk6AG.js";import{a as Xa,n as mo}from"./vec2f64-CkowXrDb.js";import{o as pe}from"./vec2-BnynUbeJ.js";import{i as ve}from"./ShaderBuilder-CzNXNN7j.js";import{B as Pe,g as Re,f as Ka}from"./renderState-BM-MCKUz.js";import{P as uo,M as Qa,g as et,_ as ot,C as ho}from"./enums-wEDHPbCF.js";import{a as at,S as tt}from"./Texture-BJExgMxB.js";import{s as A}from"./vec42-D8CJyqHG.js";function rt(e){e.vertex.code.add(i`
...
gl_FragDepth = fragDepth;
  ...
  `)}function To(e,o){const{vertex:t,fragment:r,varyings:a}=e,{hasColorTexture:n,alphaDiscardMode:s}=o,l=n&&s!==O.Opaque,{output:d,normalType:h,hasColorTextureTransform:f}=o;switch(d){case w.Depth:H(t,o),e.include(W,o),r.include(q,o),e.include(U,o),l&&r.uniforms.add(new N("tex",g=>g.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),e.include(J,o),r.main.add(i`
        ...
        ${v(l,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case w.Shadow:case w.ShadowHighlight:case w.ShadowExcludeHighlight:case w.ViewshedShadow:case w.ObjectAndLayerIdColor:H(t,o),e.include(W,o),e.include(U,o),e.include(Q,o),e.include(Mo,o),r.include(q,o),e.include(fa,o),ga(e),a.add("depth","float",{invariant:!0}),l&&r.uniforms.add(new N("tex",g=>g.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),e.include(J,o),r.main.add(i`
        ...
        vpos = addVerticalOffset(vpos, localOrigin);
        gl_Position = transformPosition(proj, view, vpos);
        forwardTextureCoordinates();`),r.include(q,o),e.include(J,o),r.main.add(i`
        discardBySlice(vpos);
        ${v(l,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),r.include(q,o),e.include(J,o),e.include(va,o),r.main.add(i`
        discardBySlice(vpos);
        ${v(l,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`),n&&s!==V.None&&(e.include(xa,o),t.uniforms.add(l===he.Pass?new N("normalTexture",h=>h.textureNormal):new Ze("normalTexture",h=>h.textureNormal)),d&&(t.uniforms.add(new ke("scale",h=>h.scale??Xa)),t.uniforms.add(new D("normalTextureTransformMatrix",h=>h.normalTextureTransformMatrix??Y))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`)}function Et(e,o){o.hasColorTextureTransform?(e.varyings.add("colorUV","vec2"),e.vertex.uniforms.add(new D("colorTextureTransformMatrix",t=>t.colorTextureTransformMatrix??Y)).code.add(i`void forwardColorUV(){
colorUV = (colorTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardColorUV(){}`)}function It(e,o){o.hasNormalTextureTransform&&o.textureCoordinateType!==V.None?(e.varyings.add("normalUV","vec2"),e.vertex.uniforms.add(new D("normalTextureTransformMatrix",t=>t.normalTextureTransformMatrix??Y)).code.add(i`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardNormalUV(){}`)}function Lt(e,o){o.hasEmissionTextureTransform&&o.textureCoordinateType!==V.None?(e.varyings.add("emissiveUV","vec2"),e.vertex.uniforms.add(new D("emissiveTextureTransformMatrix",t=>t.emissiveTextureTransformMatrix??Y)).code.add(i`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardEmissiveUV(){}`)}function Gt(e,o){o.hasOcclusionTextureTransform&&o.textureCoordinateType!==V.None?(e.varyings.add("occlusionUV","vec2"),e.vertex.uniforms.add(new D("occlusionTextureTransformMatrix",t=>t.occlusionTextureTransformMatrix??Y)).code.add(i`void forwardOcclusionUV(){
occlusionUV = (occlusionTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardOcclusionUV(){}`)}function At(e,o){o.hasMetallicRoughnessTextureTransform&&o.textureCoordinateType!==V.None?(e.varyings.add("metallicRoughnessUV","vec2"),e.vertex.uniforms.add(new D("metallicRoughnessTextureTransformMatrix",t=>t.metallicRoughnessTextureTransformMatrix??Y)).code.add(i`void forwardMetallicRoughnessUV(){
