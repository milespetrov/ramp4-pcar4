...
import { _ as C, d as A, F as j, G } from "./main-CD5P0FCe.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-7lwWsoJb.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-5JhSKLhz.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-CBjQn0hJ.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-BNXKAAEg.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-Cj7Xavrl.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-Dx-qYpyZ.js")))
      }), a;
    }), n = (a) => {
