...
class Ps {
  ...
  async projectExtent(e, t) {
    ...
    const a = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), f = Math.max.apply(null, u);
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    ...
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, f = () => !p.value && !c.panel.teleport, y = (b) => {
...
const Mn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CXi7ky_-.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-C3tNZ5hT.js"), "../fixtures/basemap/index.ts": () => import("./index-DJINyw4r.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CY4S_Gzl.js"), "../fixtures/details/index.ts": () => import("./index-DbpHJkss.js"), "../fixtures/export-footnote/index.ts": () => import("./index-C5De0BWv.js"), "../fixtures/export-legend/index.ts": () => import("./index-D6h6yEJ6.js"), "../fixtures/export-map/index.ts": () => import("./index-BwYoeFfr.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-DLaH3zcP.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DM3gcvlO.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CEf83jjW.js"), "../fixtures/export-title/index.ts": () => import("./index-C_iBrdOQ.js"), "../fixtures/export/index.ts": () => import("./index-CeWm3bdG.js"), "../fixtures/extentguard/index.ts": () => import("./index-BzGquf51.js"), "../fixtures/gazebo/index.ts": () => import("./index-Bq3rDmop.js"), "../fixtures/geosearch/index.ts": () => import("./index-Q5I7j44I.js"), "../fixtures/grid/index.ts": () => import("./index-D5EBxW46.js"), "../fixtures/help/index.ts": () => import("./index-BxUg7uRE.js"), "../fixtures/hilight/index.ts": () => import("./index-BTicaV4r.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CDJY3ipT.js"), "../fixtures/legend/index.ts": () => import("./index-CijpvDpF.js"), "../fixtures/mapnav/index.ts": () => import("./index-H7eRyNvO.js"), "../fixtures/metadata/index.ts": () => import("./index-Dv06ltFR.js"), "../fixtures/northarrow/index.ts": () => import("./index-Cbx0UOLi.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BLObSDBP.js"), "../fixtures/panguard/index.ts": () => import("./index-D_wKXang.js"), "../fixtures/scrollguard/index.ts": () => import("./index-D6KhC-Ot.js"), "../fixtures/settings/index.ts": () => import("./index-BrVfiT3M.js"), "../fixtures/snowman/index.ts": () => import("./index-Bc49egEz.js"), "../fixtures/wizard/index.ts": () => import("./index-BqisvLoK.js") });
class Pn extends J {
  /**
...
const Un = /* @__PURE__ */ Ne(Dn, [["render", Gn], ["__scopeId", "data-v-a3c61802"]]), Bn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-9JxuYfUt.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CW_BNvKK.js"), "../fixtures/export/screen.vue": () => import("./screen-DtSBsw57.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-JYPXarUV.js"), "../fixtures/grid/screen.vue": () => import("./screen-DXxssdMU.js"), "../fixtures/help/screen.vue": () => import("./screen-Bv4kRYZL.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-Dy5YAtl9.js"), "../fixtures/legend/screen.vue": () => import("./screen-CtD7xzd_.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DNLZYG3-.js"), "../fixtures/settings/screen.vue": () => import("./screen-BbXe2iMo.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DQCCtw4w.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Mon May 12 11:44:46 2025 -0400", hash: "920ef3be579abbbc0e744e839722e96c68999e65" };
console.info(
