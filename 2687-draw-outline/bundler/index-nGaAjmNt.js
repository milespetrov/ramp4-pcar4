...
import { _ as H, d as L, F as K, G as X } from "./main-B9Ja19eT.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-QVcdosww.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-JFLKmwET.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-QfSMhAdA.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Blny-os6.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D98F4D7Q.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Dk0pF-Re.js")))
      }), s;
    }), n = (s) => {
