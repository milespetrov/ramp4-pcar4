import { fq as T } from "./main-B1IpazS3.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-C1WIxUK1.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-ChOSWqR-.js.map
