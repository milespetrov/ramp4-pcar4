import { a9 as Et, fq as bt } from "./main-B1IpazS3.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-DyyyCFw_.js").then((i) => i.l) : await import("./libtess-lXeWtL3E.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-C3RXD_u3.js.map
