import { fq as q, bx as v, cy as K } from "./main-B1IpazS3.js";
import { y as Q } from "./DoubleArray-DA53v_92.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-C3WMIjzE.js";
import { f as Z, l as ee } from "./vec3-Db9FYahS.js";
import "./sphere-B8jvighz.js";
import "./I3SUtil-C6FPKs5Q.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-DU5UqMHv.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-B1IpazS3.js").then((a) => a.r9), import("./main-B1IpazS3.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-D5HWcYZk.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-CrvlGTix.js.map
