...
let i = class extends q(P(T(k(D(G(C(Q(Z(z(L(de))))))))))) {
  ...
  async applyEdits(e, t) {
    const { applyEdits: o } = await import("./editingSupport-Cd8RKcJc.js");
    await this.load();
...
//# sourceMappingURL=GeoJSONLayer-BT9qrGlu.js.map
