import { fq as q, bx as v, cy as K } from "./main-Bnvk3STL.js";
import { y as Q } from "./DoubleArray-CqmnVnGj.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-C6J0occ2.js";
import { f as Z, l as ee } from "./vec3-DwOZge6H.js";
import "./sphere-DszQ-3VH.js";
import "./I3SUtil-D4L9hFdY.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-BiRQN-nb.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-Bnvk3STL.js").then((a) => a.r9), import("./main-Bnvk3STL.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-CF4RMwlW.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-CmWpt5DB.js.map
