import { a9 as Et, fq as bt } from "./main-Bnvk3STL.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-D_4rU-dN.js").then((i) => i.l) : await import("./libtess-DSy5cacV.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-DnZRxHrH.js.map
