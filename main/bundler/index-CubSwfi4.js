...
import { _ as C, d as A, F as j, G } from "./main-Cj1Rf1vD.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-D7PEpj2L.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-DRl09MfW.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-C4w9Rt_Q.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-Cx4KpLah.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-7nQCJmAB.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-DQ1tyxjh.js")))
      }), a;
    }), n = (a) => {
