...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-Cj1Rf1vD.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-Cx4KpLah.js"), "./icons/edit-icon.vue": () => import("./edit-icon-DQ1tyxjh.js"), "./icons/point-icon.vue": () => import("./point-icon-D7PEpj2L.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-C4w9Rt_Q.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DRl09MfW.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-7nQCJmAB.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
