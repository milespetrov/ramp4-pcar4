import { cU as O, s as I, cV as Q, cX as Z, cW as A, bg as $, cy as b, c$ as w, d0 as k, d1 as C, cT as S, aV as v } from "./main-n1d2W0Ts.js";
import { t as P, n as G } from "./objectIdUtils-EszJVKSV.js";
import { m as L } from "./FeatureStore-DHN1QKiy.js";
import { x as E, j as T } from "./timeSupport-BajsmNHb.js";
import { $ as W } from "./QueryEngine-CQ5A0Pnd.js";
import { i as z, o as U, c as V } from "./clientSideDefaults-D1T7exSR.js";
import { j as B, f as g, p as _, d as j, y as D } from "./sourceUtils-BFS5QS-E.js";
const H = S, N = { xmin: -180, ymin: -90, xmax: 180, ymax: 90, spatialReference: S }, J = { hasAttachments: !1, capabilities: "query, editing, create, delete, update", useStandardizedQueries: !0, supportsCoordinatesQuantization: !0, supportsReturningQueryGeometry: !0, advancedQueryCapabilities: { supportsQueryAttachments: !1, supportsStatistics: !0, supportsPercentileStatistics: !0, supportsReturningGeometryCentroid: !0, supportsQueryWithDistance: !0, supportsDistinct: !0, supportsReturningQueryExtent: !0, supportsReturningGeometryProperties: !1, supportsHavingClause: !0, supportsOrderBy: !0, supportsPagination: !0, supportsQueryWithResultType: !1, supportsSqlExpression: !0, supportsDisjointSpatialRel: !0 } };
function K(h) {
...
class ae {
  ...
  async load(e) {
    const s = [], { features: a } = e, r = this._inferLayerProperties(a, e.fields), o = e.fields || [], u = e.hasM != null ? e.hasM : !!r.hasM, f = e.hasZ != null ? e.hasZ : !!r.hasZ, p = !e.spatialReference && !r.spatialReference, d = p ? H : e.spatialReference || r.spatialReference, m = p ? N : null, y = e.geometryType || r.geometryType, l = !y;
    ...
    const R = { warnings: s, featureErrors: [], layerDefinition: { ...J, drawingInfo: U(y), templates: V(F), extent: m, geometryType: y, objectIdField: t, fields: o, hasZ: f, hasM: u, timeInfo: n, dateFieldsTimeReference: x }, assignedObjectIds: {} };
  ...
  async applyEdits(e) {
    ...
    return await Promise.all([B(s, a), E(e.adds, s), E(e.updates, s)]), this._applyEdits(e);
  }
  queryFeatures(e, s = {}) {
...
//# sourceMappingURL=MemorySourceWorker-mImnEdWt.js.map
