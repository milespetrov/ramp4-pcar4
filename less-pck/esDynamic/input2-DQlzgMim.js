import { cA as n, cE as z, cF as I, cG as L, lN as T, ex as y, cC as F } from "./main-n1d2W0Ts.js";
import { r as x, g as O, x as U, n as K, t as V } from "./dom-BHTTQ4_z.js";
import { s as W, c as j, i as C, d as R, H as q } from "./form-DoHWJEJq.js";
import { u as _, I as $ } from "./interactive-CoK8hSSo.js";
import { n as d, i as p, p as G, s as Y, a as Z, c as J, d as Q, B as X, b as ee } from "./locale-Ksjr9aYY.js";
import { c as te, d as ie, g as S } from "./label-jeF0yOwN.js";
import { s as ne, a as ae, c as se } from "./loadable-DHg7a56u.js";
import { c as oe } from "./observers-X2ZOvJBq.js";
import { u as re, c as le, d as ce, s as ue } from "./t9n-D3N8cevx.js";
import { g as f } from "./component-CWGf1hug.js";
import { d as M } from "./icon-CffnFU39.js";
const de = {
...
const o = {
  ...
  //--------------------------------------------------------------------------
  connectedCallback() {
    J(this), le(this), this.inlineEditableEl = this.el.closest("calcite-inline-editable"), this.inlineEditableEl && (this.editingEnabled = this.inlineEditableEl.editingEnabled || !1), te(this), j(this), this.mutationObserver?.observe(this.el, { childList: !0 }), this.setDisabledAction(), this.el.addEventListener(C, this.onHiddenFormInputInput);
  }
  disconnectedCallback() {
    ie(this), R(this), Q(this), ce(this), this.mutationObserver?.disconnect(), this.el.removeEventListener(C, this.onHiddenFormInputInput);
  }
  ...
  incrementOrDecrementNumberValue(e, t, i, s) {
    ...
    if (a === "Infinity" || a === "-Infinity")
      return;
    const l = e === "up" ? 1 : -1, u = this.step === "any" ? 1 : Math.abs(this.step || 1), c = new X(a !== "" ? a : "0").add(`${u * l}`), h = () => typeof i == "number" && !isNaN(i) && c.subtract(`${i}`).isNegative, g = () => typeof t == "number" && !isNaN(t) && !c.subtract(`${t}`).isNegative, v = h() ? `${i}` : g() ? `${t}` : c.toString();
    this.setValue({
      committing: !0,
      nativeEvent: s,
      origin: "user",
...
//# sourceMappingURL=input2-DQlzgMim.js.map
