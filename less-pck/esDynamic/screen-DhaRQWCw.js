import { iG as pe, iF as me, fw as ft, fP as Y, hH as nt, fT as Ot, fV as Et, fE as et, fI as dt, fH as B, fX as Pt, fL as Z, fW as ct, fM as N, kK as Dt, fx as It, it as ve, iv as ye, a4 as ge, hk as xt, fF as Nt, hM as be, fO as ke, fU as xe, f_ as ut, fB as Se, fG as zt, nW as St } from "./main-n1d2W0Ts.js";
import { r as we } from "./vue.runtime.esm-bundler-DeYJ22GV.js";
import { T as Pe } from "./toggle-switch-control-BADM-sYK.js";
var Tt = { exports: {} };
(function(C, L) {
  (function(j, y) {
    C.exports = y(we);
      ...
      var y = { 388: function(l, d) {
        ...
        (function(S, O) {
          ...
          function S() {
            ...
            try {
              ...
              var A, q, _, h = /.*at [^(]*\((.*):(.+):(.+)\)$/gi, x = /@([^@]*):(\d+):(\d+)\s*$/gi, m = h.exec(tt.stack) || x.exec(tt.stack), X = m && m[1] || !1, rt = m && m[2] || !1, Q = document.location.href.replace(document.location.hash, ""), $ = document.getElementsByTagName("script");
              X === Q && (A = document.documentElement.outerHTML, q = new RegExp("(?:[^\\n]+?\\n){0," + (rt - 2) + "}[^<]*<script>([\\d\\D]*?)<\\/script>[\\d\\D]*", "i"), _ = A.replace(q, "$1").trim());
              for (var E = 0; E < $.length; E++)
                if ($[E].readyState === "interactive" || $[E].src === X || X === Q && $[E].innerHTML && $[E].innerHTML.trim() === _) return $[E];
              return null;
            }
          }
          return S;
        ...
        function i(p, w) {
          for (var k = [], b = {}, v = 0; v < w.length; v++) {
            var R = w[v], V = R[0], D = R[1], F = R[2], G = R[3], J = { id: p + ":" + v, css: D, media: F, sourceMap: G };
        ...
        var S = {}, O = c && (document.head || document.getElementsByTagName("head")[0]), A = null, q = 0, _ = !1, h = function() {
        }, x = null, m = "data-vue-ssr-id", X = typeof navigator < "u" && /msie [6-9]\b/.test(navigator.userAgent.toLowerCase());
        function rt(p, w, k, b) {
          _ = k, x = b || {};
          var v = i(p, w);
          return Q(v), function(R) {
            for (var V = [], D = 0; D < v.length; D++) {
              var F = v[D], G = S[F.id];
              G.refs--, V.push(G);
            }
            for (R ? (v = i(p, R), Q(v)) : v = [], D = 0; D < V.length; D++)
              if (G = V[D], G.refs === 0) {
        ...
        function Q(p) {
          for (var w = 0; w < p.length; w++) {
            ...
            if (b) {
              ...
              for (; v < k.parts.length; v++) b.parts.push(E(k.parts[v]));
              b.parts.length > k.parts.length && (b.parts.length = k.parts.length);
            } else {
              var R = [];
              for (v = 0; v < k.parts.length; v++) R.push(E(k.parts[v]));
        ...
        function E(p) {
          ...
          } else b = $(), w = ht.bind(null, b), k = function() {
            b.parentNode.removeChild(b);
          };
      ...
      return function() {
        ...
        function O(t, e, n, r, o, a) {
          ...
          return (0, i.openBlock)(), (0, i.createElementBlock)("div", (0, i.mergeProps)({ ref: "container", class: t.containerClasses, style: t.containerStyles, onClick: e[2] || (e[2] = function() {
            ...
            return t.dragStartOnProcess && t.dragStartOnProcess.apply(t, arguments);
          }) }, t.$attrs), [(0, i.createElementVNode)("div", { class: "vue-slider-rail", style: (0, i.normalizeStyle)(t.railStyle) }, [((0, i.openBlock)(!0), (0, i.createElementBlock)(i.Fragment, null, (0, i.renderList)(t.processArray, function(f, M) {
            return (0, i.renderSlot)(t.$slots, "process", (0, i.normalizeProps)((0, i.guardReactiveProps)(f)), function() {
              return [((0, i.openBlock)(), (0, i.createElementBlock)("div", { class: "vue-slider-process", key: "process-".concat(M), style: (0, i.normalizeStyle)(f.style) }, null, 4))];
            });
          }), 256)), t.sliderMarks && t.control ? ((0, i.openBlock)(), (0, i.createElementBlock)("div", S, [((0, i.openBlock)(!0), (0, i.createElementBlock)(i.Fragment, null, (0, i.renderList)(t.control.markList, function(f, M) {
            return (0, i.renderSlot)(t.$slots, "mark", (0, i.normalizeProps)((0, i.guardReactiveProps)(f)), function() {
              var H;
              return [((0, i.openBlock)(), (0, i.createBlock)(u, { key: "mark-".concat(M), mark: f, hideLabel: t.hideLabel, style: (0, i.normalizeStyle)((H = {}, c(H, t.isHorizontal ? "height" : "width", "100%"), c(H, t.isHorizontal ? "width" : "height", t.tailSize), c(H, t.mainDirection, "".concat(f.pos, "%")), H)), stepStyle: t.stepStyle, stepActiveStyle: t.stepActiveStyle, labelStyle: t.labelStyle, labelActiveStyle: t.labelActiveStyle, onPressLabel: e[0] || (e[0] = function(ot) {
                return t.clickable && t.setValueByPos(ot);
              }) }, { step: (0, i.withCtx)(function() {
                return [(0, i.renderSlot)(t.$slots, "step", (0, i.normalizeProps)((0, i.guardReactiveProps)(f)))];
              }), label: (0, i.withCtx)(function() {
                return [(0, i.renderSlot)(t.$slots, "label", (0, i.normalizeProps)((0, i.guardReactiveProps)(f)))];
              }), _: 2 }, 1032, ["mark", "hideLabel", "style", "stepStyle", "stepActiveStyle", "labelStyle", "labelActiveStyle"]))];
            });
          }), 256))])) : (0, i.createCommentVNode)("", !0), ((0, i.openBlock)(!0), (0, i.createElementBlock)(i.Fragment, null, (0, i.renderList)(t.dots, function(f, M) {
            var H;
            return (0, i.openBlock)(), (0, i.createBlock)(I, (0, i.mergeProps)({ ref_for: !0, ref: "dot-".concat(M), key: "dot-".concat(M), value: f.value, disabled: f.disabled, focus: f.focus, "dot-style": [f.style, f.disabled ? f.disabledStyle : null, f.focus ? f.focusStyle : null], tooltip: f.tooltip || t.tooltip, "tooltip-style": [t.tooltipStyle, f.tooltipStyle, f.disabled ? f.tooltipDisabledStyle : null, f.focus ? f.tooltipFocusStyle : null], "tooltip-formatter": Array.isArray(t.sliderTooltipFormatter) ? t.sliderTooltipFormatter[M] : t.sliderTooltipFormatter, "tooltip-placement": t.tooltipDirections[M], style: [t.dotBaseStyle, (H = {}, c(H, t.mainDirection, "".concat(f.pos, "%")), c(H, "transition", "".concat(t.mainDirection, " ").concat(t.animateTime, "s")), H)], onDragStart: function() {
              return t.dragStart(M);
            }, role: "slider", "aria-valuenow": f.value, "aria-valuemin": t.min, "aria-valuemax": t.max, "aria-orientation": t.isHorizontal ? "horizontal" : "vertical", tabindex: "0", onFocus: function() {
              return t.focus(f, M);
            }, onBlur: e[1] || (e[1] = function() {
              return t.blur();
            }) }, t.dotAttrs), { dot: (0, i.withCtx)(function() {
              return [(0, i.renderSlot)(t.$slots, "dot", (0, i.normalizeProps)((0, i.guardReactiveProps)(f)))];
            }), tooltip: (0, i.withCtx)(function() {
              return [(0, i.renderSlot)(t.$slots, "tooltip", (0, i.normalizeProps)((0, i.guardReactiveProps)(f)))];
        ...
        g(466);
        var h = (0, i.defineComponent)({ name: "VueSliderDot", emits: ["drag-start"], props: { value: { type: [String, Number], default: 0 }, tooltip: { type: String, required: !0 }, tooltipPlacement: { type: String, validator: function(t) {
        ...
        var E, tt = $, K = function(t) {
          ...
          var r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1, o = "targetTouches" in t ? t.targetTouches[0] : t, a = ht(e), u = { x: o.pageX - a.x, y: o.pageY - a.y };
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        var Zt = (V = {}, P(V, D.VALUE, 'The type of the "value" is illegal'), P(V, D.INTERVAL, 'The prop "interval" is invalid, "(max - min)" must be divisible by "interval"'), P(V, D.MIN, 'The "value" must be greater than or equal to the "min".'), P(V, D.MAX, 'The "value" must be less than or equal to the "max".'), P(V, D.ORDER, 'When "order" is false, the parameters "minRange", "maxRange", "fixed", "enabled" are invalid.'), V), Xt = function() {
          function t(e) {
          ...
          return Yt(t, [{ key: "setValue", value: function(e) {
            ...
            return this.dotsPos.forEach(function(o, a) {
              if (a !== n) {
                var u = r.getValidPos(o + e, a), I = u.pos, f = u.inRange;
                f || (e = Math.min(Math.abs(I - o), Math.abs(e)) * (e < 0 ? -1 : 1));
              }
            ...
            return [this.minRange, this.maxRange].forEach(function(I, f) {
              if (!I) return !1;
              var M = f === 0, H = n > 0, ot = 0;
              ot = M ? H ? 1 : -1 : H ? -1 : 1;
              for (var ce = function(fe, he) {
                var Bt = Math.abs(fe - he);
            ...
            if (this.data) e = this.data.indexOf(e);
              ...
              if (e = +e, e < this.min) return this.emitError(D.MIN), 0;
              if (e > this.max) return this.emitError(D.MAX), 0;
              if (typeof e != "number" || e !== e) return this.emitError(D.VALUE), 0;
            ...
            var e = 0;
            return e = this.data ? this.data.length - 1 : new F(this.max).minus(this.min).divide(this.interval).toNumber(), e - Math.floor(e) !== 0 ? (this.emitError(D.INTERVAL), 0) : e;
...
var Oe = Tt.exports;
const Ee = /* @__PURE__ */ me(Oe), De = { class: "rv-label" }, Ae = ["innerHTML"], Re = { class: "flex flex-row pl-30" }, Ve = /* @__PURE__ */ ft({
...
}), Ce = /* @__PURE__ */ Dt(Ve, [["__scopeId", "data-v-9f0c5af5"]]), Le = { class: "rv-label text-sm pt-10" }, je = { class: "flex flex-row" }, Me = ["value", "disabled"], Be = { class: "text-xs pt-10 text-gray-600 mb-20" }, ze = /* @__PURE__ */ ft({
...
}), Ie = /* @__PURE__ */ Dt(ze, [["__scopeId", "data-v-86d3b932"]]), Ne = {
  ...
  setup(C) {
    ...
    s.value = y.layer !== void 0 && !y.layer.isRemoved, c.push(
      ...
      _(), i.push(
        j.event.on(ut.LAYER_VISIBILITYCHANGE, (h) => {
          g.value === h.layer.uid && (T.value = h.visibility);
        })
      ), i.push(
        j.event.on(ut.LAYER_OPACITYCHANGE, (h) => {
          g.value === h.layer.uid && (l.value = Math.round(h.opacity * 100));
        })
      ), i.push(
        j.event.on(ut.LAYER_RELOAD_END, (h) => {
          h.loadPromise().then(() => {
            g.value === h.uid && _();
          });
        })
      ), i.push(
        j.event.on(ut.LAYER_REMOVE, (h) => {
          g.value === h.uid && y.panel.close();
        })
      );
    }), Et(() => {
      i.forEach((h) => j.event.off(h)), c.forEach((h) => h());
    });
    const S = (h) => {
      ...
      return m && (m.controls || m.disabledControls) ? j.geo.shared.controlAvailable(h, m) : y.layer.controlAvailable(h);
    }, O = (h) => {
      y.layer.visibility = h, T.value = h;
    }, A = (h) => {
      y.layer.opacity = h / 100, l.value = h;
    }, q = (h) => {
      y.layer.identify = h, d.value = h;
    }, _ = () => {
      s.value = y.layer !== void 0 && !y.layer.isRemoved;
      const h = y.layer.uid;
      y.layer.loadPromise().then(() => {
        h === y.layer.uid && (T.value = y.layer.visibility, l.value = Math.round(y.layer.opacity * 100), d.value = y.layer.identify, U.value = y.layer.name);
      });
    };
    return (h, x) => {
...
}), Ke = /* @__PURE__ */ Dt(Ge, [["__scopeId", "data-v-72efbdd5"]]);
export {
  Ke as default
};
//# sourceMappingURL=screen-DhaRQWCw.js.map
