import { cE as mt, cF as bt, cA as v, cG as Rn, ex as ce, jN as jn } from "./main-n1d2W0Ts.js";
import { l as ue, t as Hn } from "./dom-BHTTQ4_z.js";
import { u as Xt, I as Gt } from "./interactive-CoK8hSSo.js";
import { c as $n } from "./observers-X2ZOvJBq.js";
import { M as Bn } from "./resources4-Bi43yZeq.js";
import { u as zn, a as Xn } from "./utils3-BXkH82WC.js";
import { s as Yt, a as Ut, c as Wt } from "./loadable-DHg7a56u.js";
import { u as Kt, s as qt, c as Vt, d as Zt } from "./t9n-D3N8cevx.js";
import { c as Qt, d as Jt, n as wt } from "./locale-Ksjr9aYY.js";
import { S as Dt, i as vt, r as Gn, b as yt, f as Yn, a as Un, c as en, d as tn } from "./debounce-27Hmkkyg.js";
import { d as nn } from "./icon-CffnFU39.js";
import { a as rn, b as an, d as on } from "./input2-DQlzgMim.js";
import { d as Wn } from "./loader-DcRZn3Xd.js";
import { d as Kn } from "./scrim-bc7c-gsP.js";
function xt(t, e) {
  var n = Object.keys(t);
...
function _(t, e, n, i, r) {
  if (!(!t.getBoundingClientRect && t !== window)) {
    var a, o, s, l, c, f, d;
    if (t !== window && t.parentNode && t !== Y() ? (a = t.getBoundingClientRect(), o = a.top, s = a.left, l = a.bottom, c = a.right, f = a.height, d = a.width) : (o = 0, s = 0, l = window.innerHeight, c = window.innerWidth, f = window.innerHeight, d = window.innerWidth), (e || n) && t !== window && (r = r || t.parentNode, !Z))
      do
...
function ie(t, e) {
  if (!t || !t.getBoundingClientRect) return Y();
  var n = t, i = !1;
  do
    if (n.clientWidth < n.scrollWidth || n.clientHeight < n.scrollHeight) {
      var r = h(n);
      if (n.clientWidth < n.scrollWidth && (r.overflowX == "auto" || r.overflowX == "scroll") || n.clientHeight < n.scrollHeight && (r.overflowY == "auto" || r.overflowY == "scroll")) {
        if (!n.getBoundingClientRect || n === document.body) return Y();
        if (i || e) return n;
        i = !0;
      }
    }
...
var u, x, g, w, de, Xe, D, ne, me, j, Fe, te, Re, A, ge = !1, Ke = !1, qe = [], se, z, nt, it, Ot, Lt, De, he, Oe, Le = !1, je = !1, Ge, F, rt = [], ut = !1, Ve = [], Qe = typeof document < "u", He = sn, Pt = ke || Z ? "cssFloat" : "float", si = Qe && !ln && !sn && "draggable" in document.createElement("div"), mn = function() {
  if (Qe) {
    if (Z)
      return !1;
    ...
    if (!g) {
      ...
      if (He) {
        for (F = e; h(F, "position") === "static" && h(F, "transform") === "none" && F !== document; )
          F = F.parentNode;
        F !== document.body && F !== document.documentElement ? (F === document && (F = Y()), n.top += F.scrollTop, n.left += F.scrollLeft) : F = Y(), rt = Ft(F);
      }
  ...
  _onDragOver: function(e) {
    ...
    if (Ke = !1, c && !s.disabled && (f ? d || (o = x !== w) : A === this || (this.lastPutMode = Re.checkPull(this, c, u, e)) && l.checkPut(this, c, u, e))) {
      ...
      if (!M || pi(e, y, this) && !M.animated) {
        ...
        a = _(i);
        var G = 0, ae, Ee = u.parentNode !== n, N = !li(u.animated && u.toRect || r, i.animated && i.toRect || a, y), Se = y ? "top" : "left", Q = At(i, "top", "top") || At(u, "top", "top"), Ie = Q ? Q.scrollTop : void 0;
        he !== i && (ae = a[Se], Le = !1, je = !N && s.invertSwap || Ee), G = gi(e, i, a, y, N ? 1 : s.swapThreshold, s.invertedSwapThreshold == null ? s.swapThreshold : s.invertedSwapThreshold, je, he === i);
        var K;
        if (G !== 0) {
          var oe = H(u);
          do
            oe -= G, K = x.children[oe];
        ...
        if (Ne !== !1)
          return (Ne === 1 || Ne === -1) && (J = Ne === 1), ut = !0, setTimeout(fi, 30), W(), J && !Ce ? n.appendChild(u) : i.parentNode.insertBefore(u, J ? Ce : i), Q && hn(Q, 0, Ie - Q.scrollTop), x = u.parentNode, ae !== void 0 && !je && (Ge = Math.abs(ae - _(i)[Se])), B(), O(!0);
      }
      if (n.contains(u))
        return O(!1);
    }
  ...
  return t.prototype = {
    ...
    _handleAutoScroll: function(n, i) {
      ...
      if (Ze = n, i || this.options.forceAutoScrollFallback || ke || Z || _e) {
        ...
        if (!this.options.bubbleScroll || ie(s, !0) === Y()) {
          Ue();
          return;
        }
...
var lt = fn(function(t, e, n, i) {
  if (e.scroll) {
    var r = (t.touches ? t.touches[0] : t).clientX, a = (t.touches ? t.touches[0] : t).clientY, o = e.scrollSensitivity, s = e.scrollSpeed, l = Y(), c = !1, f;
    ht !== n && (ht = n, Ue(), xe = e.scroll, f = e.scrollFn, xe === !0 && (xe = ie(n, !0)));
    var d = 0, m = xe;
    do {
      var y = m, E = _(y), b = E.top, $ = E.bottom, W = E.left, O = E.right, B = E.width, M = E.height, re = void 0, G = void 0, ae = y.scrollWidth, Ee = y.scrollHeight, N = h(y), Se = y.scrollLeft, Q = y.scrollTop;
      y === l ? (re = B < ae && (N.overflowX === "auto" || N.overflowX === "scroll" || N.overflowX === "visible"), G = M < Ee && (N.overflowY === "auto" || N.overflowY === "scroll" || N.overflowY === "visible")) : (re = B < ae && (N.overflowX === "auto" || N.overflowX === "scroll"), G = M < Ee && (N.overflowY === "auto" || N.overflowY === "scroll"));
      var Ie = re && (Math.abs(O - r) <= o && Se + B < ae) - (Math.abs(W - r) <= o && !!Se), K = G && (Math.abs($ - a) <= o && Q + M < Ee) - (Math.abs(b - a) <= o && !!Q);
      if (!T[d])
...
var _n = Object.prototype, Yi = _n.hasOwnProperty, Ui = _n.propertyIsEnumerable, Wi = Rt(/* @__PURE__ */ function() {
  return arguments;
}()) ? Rt : function(t) {
  return vt(t) && Yi.call(t, "callee") && !Ui.call(t, "callee");
};
const Ki = Wi;
function qi() {
  return !1;
}
var An = typeof exports == "object" && exports && !exports.nodeType && exports, jt = An && typeof module == "object" && module && !module.nodeType && module, Vi = jt && jt.exports === An, Ht = Vi ? Gn.Buffer : void 0, Zi = Ht ? Ht.isBuffer : void 0, Qi = Zi || qi;
const Ji = Qi;
...
var Fn = typeof exports == "object" && exports && !exports.nodeType && exports, Pe = Fn && typeof module == "object" && module && !module.nodeType && module, xr = Pe && Pe.exports === Fn, ct = xr && Yn.process, Tr = function() {
  try {
...
const Gr = {
  ...
  async componentWillLoad() {
    Yt(this), this.updateFiltered(zt(this.items ?? [], this.value, this.filterProps)), await qt(this);
  }
  connectedCallback() {
    Qt(this), Vt(this);
  }
  ...
  render() {
    ...
    return v(Gt, { key: "c4a624e52409ed90839b506f5d99ab623767260e", disabled: e }, v("div", { key: "1f2ef99156489719dd2f938bc5ce8a05185866bf", class: Gr.container }, v("label", { key: "6fe8c6cf73f554908be38299263d23380a4ed089" }, v("calcite-input", { key: "6765e00d208d6898221540769865d84aa1c64974", clearable: !0, disabled: e, icon: Yr.search, label: this.messages.label, messageOverrides: { clear: this.messages.clear }, onCalciteInputInput: this.inputHandler, onKeyDown: this.keyDownHandler, placeholder: this.placeholder, ref: (i) => {
      this.textInput = i;
...
//# sourceMappingURL=calcite-list-Dz0jIYYp.js.map
