import { O as T, n as _, t as g, s as m, a as y, r as W } from "./WhereClause-35G35EJ6.js";
import { D as ee, ap as c, aq as k, ar as L, as as x, at as O, au as U, av as te, aw as ne, ax as re, ay as ae, az as F, aA as se, aB as ie, aC as B, aD as H, aE as Z } from "./arcadeUtils-DX3YxXnM.js";
import { n as G, m as le, a as z } from "./TimeOnly-FGdb-oHx.js";
import { kR as oe, bv as ue, cU as ce, eC as Y } from "./main-n1d2W0Ts.js";
import { union as he, geodesicArea as de, planarArea as pe, geodesicLength as fe, planarLength as _e, relate as ge, crosses as me, touches as ye, within as Se, overlaps as we, contains as Te, intersects as K } from "./geometryEngineAsync-BUYItMMD.js";
class E {
  constructor() {
...
function h(a, e, t, n = null, r = null) {
  ...
  switch (a.type) {
    case "interval":
      return Ee(h(a.value, e, t, n, r), a.qualifier, a.op);
...
class p {
  ...
  async distinct(e, t = 1e3, n = null, r) {
    ...
    return v(s, n), this.calculateStatistic("distinct", s, t, this._defaultTracker(r));
  }
  async min(e, t = null, n) {
    await this.load();
    const r = T.create(e, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return v(r, t), this.calculateStatistic("min", r, -1, this._defaultTracker(n));
  }
  async max(e, t = null, n) {
    await this.load();
    const r = T.create(e, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return v(r, t), this.calculateStatistic("max", r, -1, this._defaultTracker(n));
  }
  async avg(e, t = null, n) {
    await this.load();
    const r = T.create(e, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return v(r, t), this.calculateStatistic("avg", r, -1, this._defaultTracker(n));
  }
  async sum(e, t = null, n) {
    await this.load();
    const r = T.create(e, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return v(r, t), this.calculateStatistic("sum", r, -1, this._defaultTracker(n));
  }
  async stdev(e, t = null, n) {
    await this.load();
    const r = T.create(e, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return v(r, t), this.calculateStatistic("stdev", r, -1, this._defaultTracker(n));
  }
  async variance(e, t = null, n) {
    await this.load();
    const r = T.create(e, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return v(r, t), this.calculateStatistic("variance", r, -1, this._defaultTracker(n));
  }
  async count(e) {
...
//# sourceMappingURL=SpatialFilter-mEs1zM43.js.map
