import { cE as y, cF as k, cC as C, cB as w, cA as e, cG as z } from "./main-n1d2W0Ts.js";
import { a as E, t as p } from "./dom-BHTTQ4_z.js";
import { u as I, I as L } from "./interactive-CoK8hSSo.js";
import { s as T, a as S, c as M } from "./loadable-DHg7a56u.js";
import { c as O, d as F } from "./locale-Ksjr9aYY.js";
import { c as $ } from "./observers-X2ZOvJBq.js";
import { g as A } from "./component-CWGf1hug.js";
import { u as H, c as R, s as W, d as j } from "./t9n-D3N8cevx.js";
import { d as D } from "./icon-CffnFU39.js";
import { d as V } from "./loader-DcRZn3Xd.js";
const i = {
  button: "button",
  ...
  disconnectedCallback() {
    F(this), j(this), this.mutationObserver?.disconnect();
  }
  componentDidRender() {
    I(this);
  }
  ...
  renderIconContainer() {
    const { loading: t, icon: n, scale: o, el: a, iconFlipRtl: s, indicator: l } = this, d = o === "l" ? "l" : "m", u = t ? e("calcite-loader", { inline: !0, label: this.messages.loading, scale: d }) : null, c = n ? e("calcite-icon", { class: { [i.indicatorWithIcon]: l }, flipRtl: s, icon: n, scale: A(this.scale) }) : null, r = u || c, b = r || a.children?.length, h = e("div", { class: {
      [i.slotContainer]: !0,
...
//# sourceMappingURL=action-BPkv5_IO.js.map
