import { dh as Me, aH as Ie, iC as Be, q7 as Re, nP as Te, aI as ot, aJ as ie, bU as A, lA as $, lB as N, O as i, P as s, c5 as ce, Q as m, bV as g, e7 as st, jg as j, aO as k, V as c, bE as de, aP as le, q8 as ae, ad as te, bv as Ee, q9 as Pe, D, K as rt, di as nt, qa as lt, a6 as fe, jT as at, ki as pt, dl as ut, dY as ct, dK as dt, dL as yt, dM as ht, dN as mt, dZ as gt, d_ as vt, oU as ft, a1 as bt, s as be, b8 as Oe, dv as W, iR as St, eX as Ce, jK as ke, dQ as xt, dR as wt, dO as qe, W as Vt, m$ as jt, dX as $t } from "./main-n1d2W0Ts.js";
import { L as Nt } from "./SceneService-B9sKm52f.js";
import { j as zt } from "./persistable-DQhANZ99.js";
import { I as Se, x as It } from "./quat-7UY_HF03.js";
import { e as me } from "./quatf64-DxbQqBtW.js";
const v = ot(), De = me(), Ae = me(), Le = me(), Ue = ie(0, 0, 1), Rt = ie(0, 1, 0), Tt = ie(1, 0, 0);
function J(e) {
  Me(v, e), Ie(v, v);
...
function ye(e, t) {
  return Se(Ae, Ue, Te(e - 270)), Se(Le, Rt, Te(t - 90)), It(De, Ae, Le), Me(v, Tt), Be(v, v, De), Ie(v, v), [v[0], v[1], v[2]];
}
...
i([s({ type: Number, range: { min: 0, max: 1 }, json: { default: 0.5, write: !0 } })], G.prototype, "diffuseFactor", void 0), i([s({ type: Number, range: { min: 0, max: 1 }, json: { default: 0.5, write: !0 } })], G.prototype, "specularFactor", void 0), G = i([m("esri.layers.voxel.VoxelSimpleShading")], G);
const We = G;
...
i([s({ type: k, json: { type: [j], write: { enabled: !0, isRequired: !0 } } })], Q.prototype, "color", void 0), i([s({ type: Number, json: { write: { enabled: !0, isRequired: !0 } } })], Q.prototype, "position", void 0), Q = i([m("esri.layers.voxel.VoxelColorStop")], Q);
const we = Q;
let Y = class extends A(g) {
  constructor() {
    super(...arguments), this.opacity = 1, this.position = 0;
  }
};
i([s({ type: Number, json: { name: "alpha", write: { enabled: !0, isRequired: !0 } } })], Y.prototype, "opacity", void 0), i([s({ type: Number, json: { write: { enabled: !0, isRequired: !0 } } })], Y.prototype, "position", void 0), Y = i([m("esri.layers.voxel.VoxelOpacityStop")], Y);
const Ve = Y;
let H = class extends A(g) {
  constructor() {
    super(...arguments), this.enabled = !1, this.range = null;
  }
};
i([s({ type: Boolean, json: { default: !1, write: !0 } })], H.prototype, "enabled", void 0), i([s({ type: [Number], json: { write: !0 } })], H.prototype, "range", void 0), H = i([m("esri.layers.voxel.VoxelRangeFilter")], H);
const qt = H;
var w;
(function(e) {
    ...
    if (this.opacityStops.length === 0) for (const p of o) t.push({ color: p.color, position: p.position });
      ...
      for (let u = 0; u < p; ++u) {
        ...
        if (d.type !== w.Both) if (d.type === w.Color) {
          ...
          if (h !== -1 && f !== p) {
            const y = (d.position - o[h].position) / (o[f].position - o[h].position), L = o[h].color, oe = o[f].color;
            pe.forEach((F) => {
...
} } } })], T.prototype, "opacityStops", null), i([s({ type: qt, json: { write: !0 } })], T.prototype, "rangeFilter", void 0), i([s({ type: [k], clonable: !1, json: { read: !1 } })], T.prototype, "rasterizedTransferFunction", null), T = i([m("esri.layers.voxel.VoxelTransferFunctionStyle")], T);
const Dt = T, pe = ["r", "g", "b"];
let O = class extends A(g) {
  constructor() {
...
let M = je = class extends g {
  constructor(e) {
    super(e), this.variableId = 0, this.label = "", this.transferFunction = null, this.uniqueValues = null, this.isosurfaces = null, this.uniqueValues = new (c.ofType(Ze))(), this.isosurfaces = new (c.ofType(Je))();
  }
  clone() {
...
i([s({ type: j, json: { write: { enabled: !0, isRequired: !0 } } })], M.prototype, "variableId", void 0), i([s({ type: String, json: { write: !0 } })], M.prototype, "label", void 0), i([s({ type: Dt, json: { write: { enabled: !0, overridePolicy() {
  return { enabled: !this.uniqueValues || this.uniqueValues.length < 1 };
} } } })], M.prototype, "transferFunction", void 0), i([s({ type: c.ofType(Ze), json: { write: { enabled: !0, overridePolicy() {
...
function _e(e) {
  ...
  const [, o, r, n, l, p, u, d, h, f, y, L, oe] = t;
  let F = "seconds";
  ...
  let ve = 1, E = 0, U = 0;
  if (y && (ve = y === "-" ? -1 : 1), L) {
    if (E = parseInt(L, 10), Number.isNaN(E) || E < 0) return { didParse: !1 };
    if (E !== 0) {
      const X = ve * E;
  ...
  const Qe = `${Z}`.padStart(4, "0"), Ye = `${z}`.padStart(2, "0"), He = `${B}`.padStart(2, "0"), et = `${se}`.padStart(2, "0"), tt = `${re}`.padStart(2, "0"), it = `${ne}`.padStart(2, "0");
  let K = "Z";
  return E === 0 && U === 0 || (K = ve > 0 ? "+" : "-", K += `${E}`.padStart(2, "0"), K += ":", K += `${U}`.padStart(2, "0")), { didParse: !0, unit: F, reference: /* @__PURE__ */ new Date(`${Qe}-${Ye}-${He}T${et}:${tt}:${it}.000${K}`) };
}
...
i([s({ type: At, json: { write: !0 } })], S.prototype, "irregularSpacing", void 0), i([s({ type: Boolean, json: { write: !0 } })], S.prototype, "isPositiveUp", void 0), i([s({ type: Boolean, json: { write: !0 } })], S.prototype, "isWrappedDateLine", void 0), i([s({ type: String, json: { write: !0 } })], S.prototype, "label", void 0), i([s({ type: String, json: { write: !0 } })], S.prototype, "name", void 0), i([s({ type: String, json: { write: !0 } })], S.prototype, "quantity", void 0), i([s({ type: Lt, json: { write: !0 } })], S.prototype, "regularSpacing", void 0), i([s({ type: Number, json: { write: !0 } })], S.prototype, "size", void 0), i([s({ type: String, json: { write: !0 } })], S.prototype, "unit", void 0), i([s({ type: Boolean, json: { read: !1 } })], S.prototype, "isRegular", null), S = i([m("esri.layers.voxel.VoxelDimension")], S);
const Ft = S;
    ...
    if (o.didParse) {
      if (e.isRegular) {
        ...
        for (let l = 0; l < e.size; ++l) {
          const p = r + n * l;
          t.push(Pe(o.reference, p, o.unit));
        }
        ...
        t.push(Pe(o.reference, n, o.unit));
      }
    }
    return t;
  }
...
i([s({ type: Boolean, json: { default: !0, write: !0 } })], P.prototype, "enabled", void 0), i([s({ type: String, json: { write: !0 } })], P.prototype, "label", void 0), i([s({ type: Number, json: { read: !1 }, clonable: !1, range: { min: 0, max: 360 } }), ce((e) => $.normalize(N(e), 0, !0))], P.prototype, "orientation", null), i([s({ type: Number, json: { read: !1 }, clonable: !1, range: { min: 0, max: 360 } }), ce((e) => $.normalize(N(e), 0, !0))], P.prototype, "tilt", null), i([s({ type: [Number], json: { write: !0 } })], P.prototype, "normal", void 0), i([s({ type: [Number], json: { write: !0 } })], P.prototype, "point", void 0), P = i([m("esri.layers.voxel.VoxelDynamicSection")], P);
const Ne = P;
var ze;
...
i([s({ type: ["Voxel"] })], a.prototype, "operationalLayerType", void 0), i([s(xt)], a.prototype, "legendEnabled", void 0), i([s({ json: { write: !0 } })], a.prototype, "title", void 0), i([s(wt)], a.prototype, "url", null), i([s({ type: c.ofType(xe), json: { origins: { "web-scene": { name: "layerDefinition.sections", write: !0 } } } })], a.prototype, "sections", void 0), i([s({ type: j, json: { origins: { "web-scene": { name: "layerDefinition.style.currentVariableId", write: { enabled: !0, isRequired: !0, ignoreOrigin: !0 } }, service: { name: "style.currentVariableId" } } } })], a.prototype, "currentVariableId", void 0), i([s({ type: c.ofType(Ge), json: { origins: { "web-scene": { name: "layerDefinition.style.volumeStyles", write: !0 }, service: { name: "style.volumeStyles" } } } })], a.prototype, "volumeStyles", void 0), i([s({ type: ["volume", "surfaces"], json: { origins: { "web-scene": { name: "layerDefinition.style.renderMode", write: !0 }, service: { name: "style.renderMode" } } } })], a.prototype, "renderMode", void 0), i([s({ type: c.ofType(Ke), json: { origins: { "web-scene": { name: "layerDefinition.style.variableStyles", write: !0 }, service: { name: "style.variableStyles" } } } })], a.prototype, "variableStyles", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSlices", write: !0 }, service: { name: "style.enableSlices" } } } })], a.prototype, "enableSlices", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSections", write: !0 }, service: { name: "style.enableSections" } } } })], a.prototype, "enableSections", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableDynamicSections", write: !0 }, service: { name: "style.enableDynamicSections" } } } })], a.prototype, "enableDynamicSections", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableIsosurfaces", write: !0 }, service: { name: "style.enableIsosurfaces" } } } })], a.prototype, "enableIsosurfaces", void 0), i([s({ type: We, json: { origins: { "web-scene": { name: "layerDefinition.style.shading", write: !0 }, service: { name: "style.shading" } } } })], a.prototype, "shading", void 0), i([s({ type: ["show", "hide"] })], a.prototype, "listMode", void 0), i([s({ type: Number, range: { min: 0, max: 1 }, nonNullable: !0, json: { read: !1, write: !1, origins: { "web-scene": { read: !1, write: !1 }, "portal-item": { read: !1, write: !1 } } } })], a.prototype, "opacity", void 0), i([s({ type: c.ofType(Pt) })], a.prototype, "variables", void 0), i([s({ type: c.ofType(Xe) })], a.prototype, "volumes", void 0), i([s({ type: _t })], a.prototype, "index", void 0), i([s({ type: Number, json: { name: "layerDefinition.minScale", write: !0, origins: { service: { read: !1, write: !1 } } } })], a.prototype, "minScale", void 0), i([s({ type: Number, json: { name: "layerDefinition.maxScale", write: !0, origins: { service: { read: !1, write: !1 } } } })], a.prototype, "maxScale", void 0), i([s({ json: { read: !1 }, readOnly: !0 })], a.prototype, "type", void 0), i([s({ readOnly: !0, json: { name: "serviceVersion" } })], a.prototype, "version", void 0), i([qe("service", "version")], a.prototype, "readVersion", null), i([s({ type: Oe })], a.prototype, "fullExtent", void 0), i([qe("service", "fullExtent", ["fullExtent"])], a.prototype, "readFullExtent", null), i([s({ readOnly: !0, clonable: !1, json: { read: !1 } })], a.prototype, "voxelFields", null), i([s({ type: Boolean, json: { name: "disablePopup", read: { reader: (e, t) => !t.disablePopup }, write: { enabled: !0, ignoreOrigin: !0, writer(e, t, o) {
  t[o] = !e;
...
//# sourceMappingURL=VoxelLayer-DEOGEyjl.js.map
