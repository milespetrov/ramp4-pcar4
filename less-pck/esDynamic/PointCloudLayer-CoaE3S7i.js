import { O as r, P as i, Q as y, bV as B, jg as S, dB as v, ad as u, dY as _, dK as N, dL as V, dM as L, dN as O, dZ as E, d_ as A, dv as g, er as k, a1 as D, iR as K, m_ as C, s as l, b3 as M, a2 as G, D as x, iX as U, W as Q, dO as X, e4 as Z, dQ as z, ek as W, j0 as Y, dX as H } from "./main-n1d2W0Ts.js";
import { L as J, C as P } from "./SceneService-B9sKm52f.js";
import { c as j, d as ee, b as te, a as re } from "./PointCloudUniqueValueRenderer-CVe9ClpP.js";
import { $ as T, Z as ie, w as oe } from "./elevationInfoUtils-qr7mcYhl.js";
...
const de = h, F = { key: "type", base: j, typeMap: { "point-cloud-class-breaks": ee, "point-cloud-rgb": de, "point-cloud-stretch": te, "point-cloud-unique-value": re }, errorContext: "renderer" }, R = Y();
let o = class extends J(_(N(V(L(O(E(A(H)))))))) {
  constructor(...e) {
  ...
  async queryCachedStatistics(e, t) {
    ...
    for (const s of this.attributeStorageInfo) if (s.name === n.name) {
      ...
      return G(a, { query: { f: "json", ...this.customParameters, token: this.apiKey }, responseType: "json", signal: t ? t.signal : null }).then((q) => q.data);
    }
...
r([i({ type: ["PointCloudLayer"] })], o.prototype, "operationalLayerType", void 0), r([i(U)], o.prototype, "popupEnabled", void 0), r([i({ type: Q, json: { name: "popupInfo", write: !0 } })], o.prototype, "popupTemplate", void 0), r([i({ readOnly: !0, json: { read: !1 } })], o.prototype, "defaultPopupTemplate", null), r([i({ readOnly: !0, json: { write: !1, read: !1, origins: { "web-document": { write: !1, read: !1 } } } })], o.prototype, "opacity", void 0), r([i({ type: ["show", "hide"] })], o.prototype, "listMode", void 0), r([i({ types: [le], json: { origins: { service: { read: { source: "filters" } } }, name: "layerDefinition.filters", write: !0 } })], o.prototype, "filters", void 0), r([i({ type: [g] })], o.prototype, "fields", void 0), r([i(R.fieldsIndex)], o.prototype, "fieldsIndex", void 0), r([X("service", "fields", ["fields", "attributeStorageInfo"])], o.prototype, "readServiceFields", null), r([i(R.outFields)], o.prototype, "outFields", void 0), r([i({ readOnly: !0 })], o.prototype, "attributeStorageInfo", void 0), r([i(Z)], o.prototype, "elevationInfo", null), r([i({ type: String, json: { origins: { "web-scene": { read: !0, write: !0 }, "portal-item": { read: !0, write: !0 } }, read: !1 } })], o.prototype, "path", void 0), r([i(z)], o.prototype, "legendEnabled", void 0), r([i({ types: F, json: { origins: { service: { read: { source: "drawingInfo.renderer" } } }, name: "layerDefinition.drawingInfo.renderer", write: { target: { "layerDefinition.drawingInfo.renderer": { types: F }, "layerDefinition.drawingInfo.transparency": { type: Number } } } } })], o.prototype, "renderer", void 0), r([W("renderer")], o.prototype, "writeRenderer", null), r([i({ json: { read: !1 }, readOnly: !0 })], o.prototype, "type", void 0), o = r([y("esri.layers.PointCloudLayer")], o);
const fe = o;
export {
  fe as default
};
//# sourceMappingURL=PointCloudLayer-CoaE3S7i.js.map
