import { O as i, P as r, Q as b, jK as q, eX as C, m$ as te, bV as D, iQ as G, dF as se, V as U, b5 as E, bp as ie, dn as Q, kI as re, dO as w, bi as ae, f9 as oe, p as ne, a2 as B, ad as le, s as p, b3 as de, jt as pe, dY as ue, dK as ce, dL as ye, dM as he, dN as fe, dZ as me, d_ as ge, bU as we, cU as ve, ju as be, iP as V, n0 as k, D as m, a1 as Ie, t as Le, f0 as Fe, n1 as Se, _ as $e, iR as Te, eY as K, n2 as _e, n3 as je, a6 as Oe, n4 as xe, j7 as J, ei as A, M as Ee, j9 as Ae, n5 as Pe, n6 as Re, n7 as De, e4 as Ue, iT as Ne, iU as qe, iV as z, dQ as Ce, n8 as Ge, iZ as Qe, iX as Ve, W as ke, i_ as Ke, mF as Je, j0 as ze, dX as Me } from "./main-n1d2W0Ts.js";
import { $ as We } from "./Mesh-DYGRp2Vu.js";
import { i as He, m as Ze } from "./uploadAssetErrors-Dv_dCLZD.js";
import { L as Be, C as M } from "./SceneService-B9sKm52f.js";
import { s as Xe } from "./associatedFeatureServiceUtils-Ce0GpeV_.js";
import { s as Ye } from "./capabilities-xlBnI7Aq.js";
import { p as X, a as et, y as tt, m as st } from "./I3SLayerDefinitions-DcNr_0Ew.js";
import { a as it } from "./fetchService-RtHnGpiQ.js";
import { j as rt } from "./persistable-DQhANZ99.js";
import { $ as W, P as at, w as ot } from "./elevationInfoUtils-qr7mcYhl.js";
import { $ as nt } from "./I3SUtil-CdyzHhWR.js";
import { n as lt, p as dt } from "./popupUtils-DssuW32c.js";
...
i([r({ type: String })], L.prototype, "endTimeField", void 0), i([r({ type: String })], L.prototype, "startTimeField", void 0), L = i([b("esri.layers.mixins.TemporalSceneLayer.SceneServiceTimeInfo")], L);
  ...
  toJSON(e) {
    ...
    return t ? this.toArray().map((s) => {
      if (!t.equals(s.spatialReference)) {
        if (!ie(s.spatialReference, t)) return e?.messages && e.messages.push(new Q("scenefilter:unsupported", "Scene filters with incompatible spatial references are not supported", { modification: this, spatialReference: e.layer.spatialReference, context: e })), null;
        const n = new E();
        re(s, n, t), s = n;
      }
      const o = s.toJSON(e);
      return delete o.spatialReference, o;
    }).filter((s) => s != null) : (e?.messages && e.messages.push(new Q("scenefilter:unsupported", "Writing Scene filters without context layer is not supported", { modification: this, spatialReference: e.layer.spatialReference, context: e })), this.toArray().map((s) => s.toJSON(e)));
  }
  static fromJSON(e, t) {
    const s = new $();
...
P = $ = i([b("esri.layers.support.PolygonCollection")], P);
const T = P;
var R;
let v = R = class extends D {
  ...
  clone() {
    const e = new R({ geometries: le(this.geometries), spatialRelationship: this.spatialRelationship });
    return e._geometriesSource = this._geometriesSource, e;
  }
};
i([r({ type: ["disjoint", "contains"], nonNullable: !0, json: { write: !0 } })], v.prototype, "spatialRelationship", void 0), i([r({ type: T, nonNullable: !0, json: { write: !0 } }), rt({ origins: ["web-scene", "portal-item"], type: "resource", prefix: "geometries", contentAddressed: !0 })], v.prototype, "geometries", void 0), i([w(["web-scene", "portal-item"], "geometries")], v.prototype, "readGeometries", null), v = R = i([b("esri.layers.support.SceneFilter")], v);
const ut = v;
...
const ft = /* @__PURE__ */ new Set(["3DObject", "Point"]), H = ze();
let a = class extends pt(pe(Be(ue(ce(ye(he(fe(me(ge(we(Me))))))))))) {
  ...
  async applyEdits(e, t) {
    const { applyEdits: s } = await import("./editingSupport-DOC8Eybw.js");
    let o = t;
    await this.load();
    ...
    return K(n.url) && d && e.deleteFeatures != null && l != null && (o = { ...o, globalIdToObjectId: await _e(n, e.deleteFeatures, l) }), s(this, n.source, e, o);
  }
  ...
  _applyAssociatedLayerPopupOverrides() {
    ...
    const e = ["popupTemplate", "popupEnabled"], t = J(this);
  ...
  _applyAssociatedLayerExtentOverride() {
    ...
    k() && this.associatedLayer?.infoFor3D != null && e && K(this.associatedLayer?.url) && Y(this) && J(this).setAtOrigin("fullExtent", e.clone(), A.SERVICE);
  }
  ...
  async _setAssociatedFeatureLayer(e) {
    if (["mesh-pyramids", "points"].includes(this.profile)) try {
      const { serverUrl: t, layerId: s, portalItem: o } = await Xe(`${this.url}/layers/${this.layerId}`, { sceneLayerItem: this.portalItem, customParameters: this.customParameters, apiKey: this.apiKey, signal: e }), n = await it.FeatureLayer();
...
i([r({ types: { key: "type", base: Pe, typeMap: { selection: Re } }, json: { origins: { "web-scene": { name: "layerDefinition.featureReduction", write: !0 }, "portal-item": { name: "layerDefinition.featureReduction", write: !0 } } } })], a.prototype, "featureReduction", void 0), i([r({ type: [g], json: { read: !1, origins: { "web-scene": { name: "layerDefinition.rangeInfos", write: !0 }, "portal-item": { name: "layerDefinition.rangeInfos", write: !0 } } } })], a.prototype, "rangeInfos", void 0), i([r({ json: { read: !1 } })], a.prototype, "associatedLayer", void 0), i([r({ type: ["show", "hide"] })], a.prototype, "listMode", void 0), i([r({ type: ["ArcGISSceneServiceLayer"] })], a.prototype, "operationalLayerType", void 0), i([r({ json: { read: !1 }, readOnly: !0 })], a.prototype, "type", void 0), i([r({ ...H.fields, readOnly: !0, json: { read: !1, origins: { service: { read: !0 } } } })], a.prototype, "fields", void 0), i([r()], a.prototype, "types", null), i([r()], a.prototype, "typeIdField", null), i([r()], a.prototype, "templates", null), i([r()], a.prototype, "formTemplate", null), i([r({ readOnly: !0, clonable: !1 })], a.prototype, "fieldsIndex", null), i([r({ type: De, json: { read: { source: "layerDefinition.floorInfo" }, write: { target: "layerDefinition.floorInfo" } } })], a.prototype, "floorInfo", void 0), i([r(H.outFields)], a.prototype, "outFields", void 0), i([r({ type: X, readOnly: !0, json: { read: !1 } })], a.prototype, "nodePages", void 0), i([w("service", "nodePages", ["nodePages", "pointNodePages"])], a.prototype, "readNodePages", null), i([r({ type: [et], readOnly: !0 })], a.prototype, "materialDefinitions", void 0), i([r({ type: [tt], readOnly: !0 })], a.prototype, "textureSetDefinitions", void 0), i([r({ type: [st], readOnly: !0 })], a.prototype, "geometryDefinitions", void 0), i([r({ readOnly: !0 })], a.prototype, "serviceUpdateTimeStamp", void 0), i([r({ readOnly: !0 })], a.prototype, "attributeStorageInfo", void 0), i([r({ readOnly: !0 })], a.prototype, "statisticsInfo", void 0), i([r({ type: U.ofType(Number), nonNullable: !0, json: { origins: { service: { read: !1, write: !1 } }, name: "layerDefinition.excludeObjectIds", write: { enabled: !0 } } })], a.prototype, "excludeObjectIds", void 0), i([r({ type: String, json: { origins: { service: { read: !1, write: !1 } }, name: "layerDefinition.definitionExpression", write: { enabled: !0, allowNull: !0 } } })], a.prototype, "definitionExpression", void 0), i([r({ type: ut, json: { name: "layerDefinition.polygonFilter", write: { enabled: !0, allowNull: !0 }, origins: { service: { read: !1, write: !1 } } } })], a.prototype, "filter", void 0), i([r({ type: String, json: { origins: { "web-scene": { read: !0, write: !0 } }, read: !1 } })], a.prototype, "path", void 0), i([r(Ue)], a.prototype, "elevationInfo", null), i([r({ readOnly: !0, json: { read: !1 } })], a.prototype, "effectiveCapabilities", null), i([r({ readOnly: !0 })], a.prototype, "effectiveEditingEnabled", null), i([r({ type: String })], a.prototype, "geometryType", null), i([r(Ne)], a.prototype, "labelsVisible", void 0), i([r({ type: [qe], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: { reader: z }, write: !1 } }, name: "layerDefinition.drawingInfo.labelingInfo", read: { reader: z }, write: !0 } })], a.prototype, "labelingInfo", void 0), i([r(Ce)], a.prototype, "legendEnabled", void 0), i([r({ type: Number, json: { origins: { "web-document": { default: 1, write: { enabled: !0, target: { opacity: { type: Number }, "layerDefinition.drawingInfo.transparency": { type: Number } } }, read: { source: ["opacity", "layerDefinition.drawingInfo.transparency"], reader(e, t) {
  if (typeof e == "number" && e >= 0 && e <= 1) return e;
  const s = t.layerDefinition?.drawingInfo?.transparency;
  return s !== void 0 ? Ge(s) : void 0;
} } }, "portal-item": { write: !0 }, service: { read: !1 } } } })], a.prototype, "opacity", void 0), i([r({ type: ["Low", "High"], readOnly: !0, json: { read: !1, origins: { service: { read: !0 } } } })], a.prototype, "priority", void 0), i([r({ type: ["Labels"], readOnly: !0, json: { read: !1, origins: { service: { read: !0 } } } })], a.prototype, "semantic", void 0), i([r({ types: Qe, json: { origins: { service: { read: { source: "drawingInfo.renderer" } } }, name: "layerDefinition.drawingInfo.renderer", write: !0 }, value: null })], a.prototype, "renderer", null), i([r({ json: { read: !1 } })], a.prototype, "cachedDrawingInfo", void 0), i([w("service", "cachedDrawingInfo")], a.prototype, "readCachedDrawingInfo", null), i([r({ readOnly: !0, json: { read: !1 } })], a.prototype, "capabilities", null), i([r({ type: Boolean, json: { read: !1 } })], a.prototype, "editingEnabled", null), i([r({ readOnly: !0, json: { write: !1, read: !1 } })], a.prototype, "infoFor3D", null), i([r({ readOnly: !0, json: { write: !1, read: !1 } })], a.prototype, "relationships", null), i([r(Ve)], a.prototype, "popupEnabled", void 0), i([r({ type: ke, json: { name: "popupInfo", write: !0 } })], a.prototype, "popupTemplate", void 0), i([r({ readOnly: !0, json: { read: !1 } })], a.prototype, "defaultPopupTemplate", null), i([r({ type: String, json: { read: !1 } })], a.prototype, "objectIdField", void 0), i([w("service", "objectIdField", ["objectIdField", "fields"])], a.prototype, "readObjectIdField", null), i([r({ type: String, json: { read: !1 } })], a.prototype, "globalIdField", void 0), i([w("service", "globalIdField", ["globalIdField", "fields"])], a.prototype, "readGlobalIdField", null), i([r({ readOnly: !0, type: String, json: { read: !1 } })], a.prototype, "displayField", null), i([r({ type: String, json: { read: !1 } })], a.prototype, "profile", void 0), i([w("service", "profile", ["store.profile"])], a.prototype, "readProfile", null), i([r({ readOnly: !0, type: String, json: { origins: { service: { read: { source: "store.normalReferenceFrame" } } }, read: !1 } })], a.prototype, "normalReferenceFrame", void 0), i([r(Ke)], a.prototype, "screenSizePerspectiveEnabled", void 0), i([r({ json: { read: !1, origins: { service: { read: !0 } } } })], a.prototype, "serviceItemId", void 0), i([r(Je)], a.prototype, "useViewTime", null), a = i([b("esri.layers.SceneLayer")], a);
...
//# sourceMappingURL=SceneLayer-DqfvWBsY.js.map
