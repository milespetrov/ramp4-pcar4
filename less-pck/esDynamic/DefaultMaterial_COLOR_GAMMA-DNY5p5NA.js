import { c7 as re, oA as oe, oB as ne, oC as se, nR as H, dm as ae, oD as k, a2 as ie, kP as ue, a1 as le, s as l, oE as fe, aj as ce, c4 as de, cg as pe, oF as me, oG as he, g4 as Te, dc as ye, oH as z, oI as $, D as E, oJ as we } from "./main-n1d2W0Ts.js";
import { e as q, r as A } from "./mat4f64-Dn1WEGBx.js";
import { D as O, L as R, C as f, E as y } from "./enums-DDkmfb-t.js";
import { v as ge } from "./quat-7UY_HF03.js";
import { e as be } from "./quatf64-DxbQqBtW.js";
import { c as D, u as K, F as xe, w as _e, q as Se, A as Ee, V as Oe, B as Re, g as Ne, d as Ae, i as N, x as ve, L as Ce, O as Ie, E as Me } from "./BufferView-k2-IUvEL.js";
import { n as Le, t as Fe, o as Be, r as Ue } from "./resourceUtils-BCkesTE3.js";
import { l as $e, i as De } from "./Indices-C7JuNIeG.js";
function Pe(r, e) {
...
const x = { MAGIC: 1179937895, CHUNK_TYPE_JSON: 1313821514, CHUNK_TYPE_BIN: 5130562, MIN_HEADER_LENGTH: 20 };
class h {
  constructor(e, o, t, n) {
  ...
  static _isGLBData(e) {
    if (e == null) return !1;
    const o = new P(e);
    return o.remainingBytes() >= 4 && o.readUint32() === x.MAGIC;
  }
  ...
  static async _parseGLBData(e) {
    ...
    if (t !== x.MAGIC) throw new l("gltf-loader-error", "Magic first 4 bytes do not fit to expected glb value.");
    ...
    for (; o.remainingBytes() >= 8; ) {
      ...
      if (u === 0) {
        if (p !== x.CHUNK_TYPE_JSON) throw new l("gltf-loader-error", "First glb chunk must be JSON.");
        if (c < 0) throw new l("gltf-loader-error", "No JSON data found.");
        a = await Le(o.readUint8Array(c));
      } else if (u === 1) {
        if (p !== x.CHUNK_TYPE_BIN) throw new l("gltf-loader-unsupported-feature", "Second glb chunk expected to be BIN.");
  ...
  async getTextureCoordinates(e, o) {
    ...
    if (t.componentType === f.FLOAT) return m(K, t);
  ...
  getNodeTransform(e) {
    ...
    if (!o) {
      ...
      n.matrix ? o = pe(q(), t, n.matrix) : n.translation || n.rotation || n.scale ? (o = A(t), n.translation && me(o, o, n.translation), n.rotation && (_[3] = ge(_, n.rotation), he(o, o, _[3], _)), n.scale && Te(o, o, n.scale)) : o = A(t), this._nodeTransformCache.set(e, o);
    }
    return o;
  }
  _resolveUri(e) {
  ...
  async getLoadedBuffersSize() {
    ...
    const e = await $(Array.from(this._bufferLoaders.values())), o = await $(Array.from(this._textureLoaders.values()));
    return e.reduce((t, n) => t + (n?.byteLength ?? 0), 0) + o.reduce((t, n) => t + (n ? Ue(n) ? n.data.byteLength : n.width * n.height * 4 : 0), 0);
  }
}
const et = fe(q(), Math.PI / 2), tt = new z(2, 0, "glTF"), _ = be(), rt = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 }, ot = { [f.BYTE]: 1, [f.UNSIGNED_BYTE]: 1, [f.SHORT]: 2, [f.UNSIGNED_SHORT]: 2, [f.HALF_FLOAT]: 2, [f.FLOAT]: 4, [f.INT]: 4, [f.UNSIGNED_INT]: 4 };
function nt(r) {
  switch (r.componentType) {
    ...
    case f.FLOAT:
      return new K(r.raw, r.byteOffset, r.byteStride, r.byteOffset + r.byteStride * r.entryCount);
  }
}
function m(r, e) {
...
async function Nt(r, e, o = {}, t = !0) {
  ...
  await lt(n, async (d, w, T, v) => {
    ...
    let U = null;
    a.meta?.ESRI_lod != null && a.meta.ESRI_lod.metric === "screenSpaceRadius" && (U = a.meta.ESRI_lod.thresholds[T]), a.lods[T] = a.lods[T] || { parts: [], name: v, lodThreshold: U }, a.lods[T].parts[C] = te;
  });
...
function pt(r) {
  return typeof r == "number" ? $e(r) : we(r) ? new Uint16Array(r) : r;
}
function mt(r) {
...
//# sourceMappingURL=DefaultMaterial_COLOR_GAMMA-DNY5p5NA.js.map
