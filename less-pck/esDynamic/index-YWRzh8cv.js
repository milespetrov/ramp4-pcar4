import { fw as T, fx as R, fO as j, fA as N, fB as J, fE as p, fF as x, fG as V, fH as A, fK as E, fM as L, fY as C, kK as G, fI as h, oP as te, fP as k, fT as ne, fU as Q, fV as Z, fC as P, fD as H, ik as ee, hL as oe, ho as F, oQ as ae, oR as se, fL as re, fy as ie, jX as D, fS as le, hA as pe, fN as w, fJ as B, fW as q, gZ as U, hM as X, oS as ce, bW as ue, f_ as fe } from "./main-n1d2W0Ts.js";
class W {
  id;
  /**
...
const de = ["innerHTML"], O = /* @__PURE__ */ T({
  ...
  setup(y) {
    const { t: a } = R(), n = j("iApi"), o = y, f = N(() => n?.panel.get(o.panelId)?.button), l = () => {
      o.minimize ? n?.panel.toggleMinimize(o.panelId) : n?.panel.toggle(o.panelId);
    };
    return (e, $) => {
      const u = J("appbar-button");
      return f.value ? (p(), x(u, {
        key: 0,
        onClickFunction: l,
        tooltip: L(a)(f.value.tooltip),
        id: y.panelId
      }, {
        default: V(() => [
          A("div", {
            class: E(["default fill-current w-24 h-24 ml-8 sm:ml-20", { "ml-20": y.overflow }]),
            innerHTML: f.value.icon
          }, null, 10, de)
        ]),
        _: 1
      }, 8, ["tooltip", "id"])) : C("", !0);
...
const Y = /* @__PURE__ */ G(ve, [["render", he], ["__scopeId", "data-v-5d32b715"]]);
var be = {
  name: "maxSize",
  enabled: !0,
  phase: "main",
  ...
  fn: function(a) {
    var n = a.state, o = a.name, f = a.options, l = te(n, f), e = n.modifiersData.preventOverflow || {
      x: 0,
      y: 0
    }, $ = e.x, u = e.y, c = n.rects.popper, m = c.width, S = c.height, _ = n.placement.split("-"), I = _[0], v = I === "left" ? "left" : "right", s = I === "top" ? "top" : "bottom";
    n.modifiersData[o] = {
      width: m - l[v] - $,
      height: S - l[s] - u
    };
...
const ge = ["content", "aria-label"], ye = /* @__PURE__ */ T({
  ...
  setup(y, { expose: a, emit: n }) {
    const { t: o } = R(), f = j("iApi"), l = y, e = n;
    function $() {
      e("updateParent");
    }
    const u = k(!1), c = k(0), m = k(), S = k(), _ = k();
    function I() {
      $(), F(() => {
        v(), u.value = !u.value;
      });
    ...
    const v = () => {
      u.value = !u.value;
      const s = f.$vApp.$el.querySelector(".inner-shell"), b = {
        name: "applyMaxSize",
        enabled: !0,
        phase: "beforeWrite",
        requires: ["maxSize"],
        fn({ state: d }) {
          const { width: r } = d.modifiersData.maxSize;
          d.styles.popper = {
            ...d.styles.popper,
            maxWidth: `${r}px`,
          ...
          d.styles.popper.height = `${g}px`, _?.value?.offsetHeight && (_.value.style.height = `${g}px`), d.styles.popper.overflowY = "auto", d.styles.popper.overflowX = "hidden";
        }
      };
    ...
    return Q(() => {
      ...
      const d = P("focus-item"), r = P("tippy");
      return p(), h("div", {
...
}), $e = /* @__PURE__ */ G(ye, [["__scopeId", "data-v-93661050"]]), _e = {
  key: 0,
  class: "number absolute top-1 right-2 text-white w-18 rounded-full"
}, we = /* @__PURE__ */ T({
  __name: "appbar-button",
  setup(y) {
    const a = se(), { t: n } = R(), o = j("iApi"), f = N(() => a.notificationNumber), l = () => {
      o.panel.toggle("notifications");
    };
    return (e, $) => {
      const u = J("appbar-button", !0);
      return p(), x(u, {
        onClickFunction: l,
        ...
        default: V(() => [
          ...
          f.value && f.value > 0 ? (p(), h("span", _e, re(f.value), 1)) : C("", !0)
        ]),
        _: 1
      }, 8, ["tooltip"]);
    };
  }
}), xe = /* @__PURE__ */ G(we, [["__scopeId", "data-v-787da765"]]), ke = ["content"], Ie = /* @__PURE__ */ T({
  __name: "appbar",
  setup(y) {
    const a = ie(), n = D(), o = k(0), f = k(0), l = N(() => n.visible), e = N(() => n.temporary), { t: $ } = R(), u = k(!1), c = k({}), m = k(), S = () => {
      F(() => {
        U()?.proxy?.$forceUpdate();
      });
    }, _ = () => {
    ...
    return Q(() => {
      m.value?.addEventListener("blur", _), m.value?.addEventListener("keyup", I);
    }), le(() => {
      const v = U();
      window.addEventListener("resize", () => v?.proxy?.$forceUpdate());
    }), Z(() => {
      const v = U();
      window.removeEventListener("resize", () => v?.proxy?.$forceUpdate()), m.value?.removeEventListener("blur", _), m.value?.removeEventListener("keyup", I);
    }), pe(() => {
      F(() => {
        const v = m.value;
        let s, b = [...v.children], d = b[b.length - 2].getBoundingClientRect().top;
        a.mobileView || (d = v.getBoundingClientRect().bottom - 38);
        let r = v.querySelector("#dropdown");
        for (let i = b.length - 4; i >= 0; i--) {
          let z = b[i].getBoundingClientRect().bottom;
          if (d && r && (z > d || u.value && z + 56 > d))
            b[i].classList.forEach((M) => {
              M.includes("identifier") && (s = M.slice(11));
            }), s && (c.value[s] = !0, s.includes("divider") || o.value++, f.value++), u.value || (u.value = !0);
          else if (z !== 0)
            break;
        }
        let g = v.querySelector("#more"), t = g.getBoundingClientRect().bottom;
        if (s = void 0, u.value && d && g && r && t !== 0 && (t <= d - 56 || r.childElementCount == 1 && t <= d)) {
        ...
        Object.keys(c.value).forEach((i) => {
          v.querySelector(`.identifier-${i}`) || (delete c.value[i], i.includes("divider") || (o.value = Math.max(0, o.value - 1)), f.value++);
        });
      });
    }), (v, s) => {
      const b = P("focus-list"), d = P("tippy");
      return H((p(), h("div", {
        ...
        (p(!0), h(w, null, B(l.value, (r, g) => (p(), h(w, null, [
          (p(!0), h(w, null, B(r, (t, i) => (p(), h(w, null, [
            ...
            }, null, 8, ["panelId", "class"])) : c.value[`${t}-${i}`] !== !0 ? (p(), x(X(t.componentId), {
              key: `${t}-${i}-custom`,
              options: t.options,
              class: E(["appbar-item h-48", `identifier-${t}-${i}`]),
              id: t.id
          ...
          c.value[`divider-${g}`] !== !0 ? (p(), x(Y, {
            class: E(["appbar-item", `identifier-divider-${g}`]),
            key: `${r}-${g}-default`
          }, null, 8, ["class"])) : C("", !0)
        ], 64))), 256)),
        (p(!0), h(w, null, B(e.value?.filter((r) => c.value[`${r}-temp`] !== !0), (r) => (p(), x(O, {
          panelId: r,
          minimize: !0,
          key: `${r}-temp`,
            ...
            (p(!0), h(w, null, B(l.value, (r, g) => (p(), h(w, { key: g }, [
              (p(!0), h(w, null, B(r, (t, i) => (p(), h(w, null, [
                typeof t == "string" && c.value[`${t}-${i}`] ? (p(), x(O, {
                  ...
                  overflow: ""
                }, null, 8, ["panelId", "class"])) : c.value[`${t}-${i}`] ? (p(), x(X(t.componentId), {
                  key: `${t}-${i}-custom`,
                  options: t.options,
                  id: t.id,
                  class: E(["appbar-item h-48", `identifier-${t}-${i}`])
              ...
              c.value[`divider-${g}`] ? (p(), x(Y, {
                key: 0,
                class: E(["border-black my-4", `identifier-divider-${g}`])
              }, null, 8, ["class"])) : C("", !0)
            ], 64))), 128)),
            (p(!0), h(w, null, B(e.value?.filter((r) => c.value[`${r}-temp`]), (r) => (p(), x(O, {
              panelId: r,
              minimize: !0,
              key: `${r}-temp`,
...
class Ee extends ue {
  ...
  _parseConfig(a) {
    ...
    o.forEach((l) => {
      f.push(
        l.map((e) => typeof e == "string" ? e : new W(e))
      );
    }), n.items = f.flat().reduce((l, e) => (l[e instanceof W ? e.id : e] = e, l), {}), n.order = f.map(
      (l) => l.map((e) => e instanceof W ? e.id : e)
    ), this._validateItems();
  }
  /**
...
class ze extends Ee {
  ...
  async added() {
    ...
    const f = this.$vApp.$watch(
      () => this.config,
      (e) => this._parseConfig(e)
    ), l = [];
    l.push(
      this.$iApi.event.on(fe.COMPONENT, () => {
        this._parseConfig(this.config);
      })
    ), this.removed = () => {
      const e = D(this.$vApp.$pinia);
      f(), l.forEach((c) => this.$iApi.event.off(c));
...
//# sourceMappingURL=index-YWRzh8cv.js.map
