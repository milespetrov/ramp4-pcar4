import { a3 as cn, a2 as W, eB as d, b8 as j, b6 as A, a6 as x, b5 as S, b7 as z, ey as B, C as H, fc as fn, bo as ln } from "./main-n1d2W0Ts.js";
import { a0 as o, a as h, X as V, v as K, w as Q, m as M, b as i, r as s, U as g, Q as P, Z as L, B as T, P as w, af as X, ag as D, ah as k, g as R, F as on, ai as dn, aj as wn, E, ak as hn, N, A as O, al as mn, am as yn, I as _, an as pn, ao as U } from "./arcadeUtils-DX3YxXnM.js";
import { c as I, r as C, b as y } from "./TimeOnly-FGdb-oHx.js";
import { l as G } from "./portalUtils-B3_HZ--B.js";
import { disjoint as vn, intersects as gn, touches as Pn, crosses as In, within as An, contains as Fn, overlaps as Rn, equals as bn, relate as xn, intersect as Nn, union as On, difference as Sn, symmetricDifference as jn, clip as Dn, cut as Cn, planarArea as Y, geodesicArea as $, planarLength as Z, geodesicLength as q, distance as Ln, densify as nn, geodesicDensify as en, generalize as Tn, buffer as Un, geodesicBuffer as Zn, offset as Jn, rotate as rn, simplify as tn, isSimple as Mn, convexHull as kn, nearestCoordinate as En, nearestVertex as qn } from "./geometryEngineAsync-BUYItMMD.js";
async function an(a, e, r) {
  ...
  if (r && (f.query.returnUserLicenseTypeExtensions = !0), e === "") {
    const t = await W(a.restUrl + "/community/self", f);
    if (t.data) {
      const u = t.data;
  ...
  const n = await W(a.restUrl + "/community/users/" + e, f);
  if (n.data) {
    const t = n.data;
...
function Kn(a) {
  a.mode === "async" && (a.functions.disjoint = function(e, r) {
    ...
    return a.standardFunctionAsync(e, r, (c, f, n) => (h(n, 2, 2, e, r), n[0] === n[1] || (n[0] instanceof d && n[1] instanceof d ? bn(n[0], n[1]) : (V(n[0]) && V(n[1]) || !!(K(n[0]) && K(n[1]) || Q(n[0]) && Q(n[1]))) && n[0].equals(n[1]))));
    ...
    return a.standardFunctionAsync(e, r, (c, f, n) => {
      ...
      return l.addPath([t, u]), q(l, y(w(n[2], -1)));
    });
    ...
    return a.standardFunctionAsync(e, r, (c, f, n) => {
      ...
      return t instanceof x ? L(I(t), e.spatialReference) : t instanceof S ? t.centroid : t instanceof A ? dn(t) : t instanceof z ? wn(t) : t instanceof j ? t.center : null;
    });
    ...
    return a.standardFunctionAsync(e, r, (c, f, n) => {
      ...
      if (E(n[1] === !1)) throw new i(e, s.InvalidParameter, r);
      const u = hn(t, n[1]);
    ...
    return a.standardFunctionAsync(e, r, async (c, f, n) => {
      ...
      if (t instanceof S) {
        ...
        for (let m = 0; m < t.rings.length; m++) if (t.isClockwise(t.rings[m])) {
          const p = B({ rings: [t.rings[m]], hasZ: t.hasZ === !0, hasM: t.hasM === !0, spatialReference: t.spatialReference.toJSON() });
          u.push(p);
      ...
      if (t instanceof A) {
        ...
        for (let l = 0; l < t.paths.length; l++) {
          const m = B({ paths: [t.paths[l]], hasZ: t.hasZ === !0, hasM: t.hasM === !0, spatialReference: t.spatialReference.toJSON() });
          u.push(m);
        }
        return u;
      }
    ...
    return a.standardFunctionAsync(e, r, async (c, f, n) => {
      ...
      if (t = t === !0 || t === !1 ? "" : M(t), n.length === 0 || n[0] instanceof _) {
        let m;
        m = e.services?.portal ? e.services.portal : H.getDefault(), n.length > 0 && (m = G(n[0], m));
      ...
      if (T(n[0]) && (l = n[0]), l) {
        ...
        let p;
        p = e.services?.portal ? e.services.portal : H.getDefault(), p = G(new _(m), p);
...
//# sourceMappingURL=geomasync-DLgWrUTk.js.map
