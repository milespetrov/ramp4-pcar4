import { O as u, P as f, iK as _t, ek as Dt, dO as Pt, Q as z, bV as ve, e8 as _e, c2 as Ae, bU as Et, aO as Ke, c5 as De, D as le, ad as be, s as oe, ge as Ut, lg as F, bo as Wt, nd as zt, fo as he, pF as ce, pG as Ht, bz as Vt, pH as kt, b8 as Qe, a7 as Bt, di as Gt, dl as Yt, aI as S, aJ as Se, jz as et, dm as we, a6 as O, R as Xt, pI as Zt, oI as qt, lV as Jt, o9 as Kt, lz as Qt, V as er, bi as tr, cd as Re, aH as rr, pJ as tt, o5 as nr, cf as $e, cg as rt, pK as nt, g4 as ot, pL as st, pM as it, cc as or, lf as sr, e0 as ir, dk as ar, eP as lr, ma as cr, S as ur, b5 as pr, pN as hr, eB as fr } from "./main-n1d2W0Ts.js";
import { u as Pe, y as mr, h as dr, b as at, N as se, c as lt, d as fe, k as ct, w as gr } from "./MeshTransform-mbyl_DYz.js";
import { c as yr } from "./imageUtils-DShRxA6f.js";
import { c as xr, l as me } from "./MeshVertexAttributes-B1Ld5IvK.js";
import { a as Me, i as de } from "./MeshLocalVertexSpace-h0SqnZHL.js";
import { a as ie, s as ge, g as ut, u as Ee } from "./meshVertexSpaceUtils-BSZfC57T.js";
import { i as vr } from "./earcut-DK0MCelY.js";
import { a as wr, e as $r, t as pt } from "./DoubleArray-DzeMZxkj.js";
import { t as ht } from "./Indices-C7JuNIeG.js";
import { E as br, F as Tr, X as Ar } from "./plane-fUOqQtDL.js";
import { e as Ue } from "./deduplicate-Bl0flx-L.js";
import { project as Sr, logProjectionError as b, loadProjectErrorMessage as E, projectToPCPF as ft, projectNormalToPCPF as mt, projectTangentToPCPF as dt, projectFromPCPF as gt, projectNormalFromPCPF as yt, projectTangentFromPCPF as xt } from "./projection-aThzGnG_.js";
import { c as _, M as Fe, X as Rr, N as vt } from "./vertexSpaceConversion-DpZAFo-9.js";
import { e as wt } from "./mat3f64-Dh9_zhFu.js";
import { e as Le } from "./mat4f64-Dn1WEGBx.js";
import { I as Mr } from "./quat-7UY_HF03.js";
import { e as Fr, o as Ir } from "./quatf64-DxbQqBtW.js";
import { a as $t } from "./spatialReferenceEllipsoidUtils-BRPBRXx9.js";
import { u as Cr } from "./computeTranslationToOriginAndRotation-BQ5vrujS.js";
var G;
const Te = /* @__PURE__ */ new WeakMap();
let Nr = 0, L = G = class extends ve {
  constructor(e) {
  ...
  get contentHash() {
    ...
    return this.url != null ? t(this.url) : this.data != null ? this.data instanceof HTMLImageElement || this.data instanceof HTMLVideoElement ? t(this.data.src) : (Te.has(this.data) || Te.set(this.data, ++Nr), t(Te.get(this.data))) : t();
  }
  get memoryUsage() {
    let e = 0;
...
let j = ee = class extends ve {
  ...
  castMaterial(e) {
    return Ae(e && typeof e == "object" && ("metallic" in e || "roughness" in e || "metallicRoughnessTexture" in e) ? Lr : je, e);
  }
  clone() {
...
u([f({ json: { write: !0 } })], j.prototype, "faces", void 0), u([De("faces")], j.prototype, "castFaces", null), u([f({ type: je, json: { write: !0 } })], j.prototype, "material", void 0), u([De("material")], j.prototype, "castMaterial", null), u([f()], j.prototype, "name", void 0), u([f({ type: String, json: { write: !0 } })], j.prototype, "shading", void 0), u([f({ type: Boolean })], j.prototype, "trustSourceNormals", void 0), j = ee = u([z("esri.geometry.support.MeshComponent")], j);
const J = j, jr = "Mesh must be loaded before applying operations", Or = "Provided component is not part of the list of components", _r = "Expected polygon to be a Polygon instance", te = "Expected location to be a Point instance";
...
async function Zr(e, t, n) {
  const { source: r } = t, { loadGLTFMesh: o } = await et(import("./loadGLTFMesh-DNWoyddE.js"), n), s = await Jr(r, n);
  we(n);
  const i = o(new O({ x: 0, y: 0, z: 0, spatialReference: e.spatialReference }), s.url, { resolveFile: qr(s), signal: n?.signal, expectedType: s.type });
...
function qr(e) {
  const t = Xt(e.url);
  return (n) => {
    const r = Zt(n, t, t), o = r ? r.replace(/^ *\.\//, "") : null;
...
async function en(e, t) {
  const n = await qt(e.map(async (r) => {
    const o = await Kr(r);
...
const Mt = /^model\/gltf\+json$/, Ft = /^model\/gltf-binary$/, Ne = /\.gltf$/i, tn = /\.glb$/i;
function It(e) {
  const t = /* @__PURE__ */ new Map();
  let n, r = null;
  for (const { name: o, mimeType: s, source: i } of e) r === null && (Mt.test(s) || Ne.test(o) ? (r = i.url, n = "gltf") : (Ft.test(s) || tn.test(o)) && (r = i.url, n = "glb")), t.set(o, i.url), i.files.forEach((a, c) => t.set(c, a));
...
function Ct(e, t) {
  return Mt.test(t) || Ne.test(e) ? "gltf" : Ft.test(t) || Ne.test(e) ? "glb" : void 0;
}
...
function dn(e, t, n) {
  ...
  Mr(Ze, fe(t), lt(t));
  const d = tt(Ge, Ze, $e, nr, h), { localMatrix: m } = o, p = rt(Ge, d, m);
...
function gn(e, t, n) {
  ...
  const m = Ye;
  Re(fe(Ye), fe(t), Xe), m[3] = t[3], ft(i, r, l) && (a == null || h == null || mt(a, i, l, r, h)) && (c == null || d == null || dt(c, i, l, r, d)) ? (q(l, m, 3, s), gt(l, i, r) && (a == null || h == null || (q(h, m, 3), yt(h, i, l, r, a))) && (c == null || d == null || (q(d, m, 4), xt(d, i, l, r, c))) ? e.vertexAttributesChanged() : b(U(), o, r)) : b(U(), r, o);
}
function yn(e, t, n) {
  const r = Nt;
  if (!_(n, r, e.spatialReference)) {
  ...
  q(e.vertexAttributes.position, t, 3, r), q(e.vertexAttributes.normal, t, 3), q(e.vertexAttributes.tangent, t, 4), e.vertexAttributesChanged();
}
function q(e, t, n, r = $e) {
  if (e != null) {
    sr(xe, lt(t), fe(t));
...
const X = S(), Ge = Le(), Ye = at(), xe = Le(), Xe = wt(), Nt = S(), Ze = Fr(), W = () => le.getLogger("esri.geometry.support.meshUtils.scale");
function xn(e, t, n) {
  if (!e.vertexAttributes?.position) return;
...
function vn(e, t, n) {
  e.transform ??= new se();
  const { vertexSpace: r, transform: o, spatialReference: s } = e, [i, a, c] = r.origin, l = new O({ x: i, y: a, z: c, spatialReference: s }), h = Z;
  if (l.equals(n)) he(h, 0, 0, 0);
  else if (!vt(h, n, e)) return void b(W(), n.spatialReference, s, E);
  const d = he(bn, t, t, t), m = tt(qe, Ir, $e, d, h), { localMatrix: p } = o, g = rt(qe, m, p);
  o.scale = nt(S(), g), ot(g, g, st(Z, o.scale));
...
function Lt(e, t, n = $e) {
  if (e) for (let r = 0; r < e.length; r += 3) {
    for (let o = 0; o < 3; o++) Z[o] = e[r + o] - n[o];
    ar(Z, Z, t);
    for (let o = 0; o < 3; o++) e[r + o] = Z[o] + n[o];
  }
}
const Z = S(), bn = S(), qe = Le(), jt = S();
var M;
...
let $ = M = class extends lr.LoadableMixin(cr(fr)) {
  ...
  load(e) {
    ...
    return t && this.addResolvingPromise(Zr(this, t, e)), Promise.resolve(this);
  }
  ...
  async toBinaryGLTF(e) {
    const [{ toBinaryGLTF: t }] = await Promise.all([import("./gltfexport-CfjbjRgo.js"), this.load(e)]);
  ...
  _checkIfLoaded(e) {
    return !!this.loaded || (N().error(e, jr), !1);
  }
  static createBox(e, t) {
    if (!(e instanceof O)) return N().error(".createBox()", te), null;
    const n = new M(pe(rn(), e, t));
    return t?.imageFace && t.imageFace !== "all" ? nn(n, t.imageFace) : n;
  }
  static createSphere(e, t) {
    return e instanceof O ? new M(pe(on(t?.densificationFactor || 0), e, t)) : (N().error(".createSphere()", te), null);
  }
  static createCylinder(e, t) {
    return e instanceof O ? new M(pe(sn(t?.densificationFactor || 0), e, t)) : (N().error(".createCylinder()", te), null);
  }
  static createPlane(e, t) {
    if (!(e instanceof O)) return N().error(".createPlane()", te), null;
    const n = t?.facing ?? "up", r = an(n, t?.size);
    return new M(pe(ln(n), e, { ...t, size: r }));
  }
  static createFromPolygon(e, t) {
    if (!(e instanceof pr)) return N().error(".createFromPolygon()", _r), null;
    const n = Er(e);
  ...
  static async createFromGLTF(e, t, n) {
    if (!(e instanceof O)) {
      const o = new Ve();
      throw N().error(".createfromGLTF()", o.message), o;
    }
    const { loadGLTFMesh: r } = await et(import("./loadGLTFMesh-DNWoyddE.js"), n);
    return new M(await r(e, t, n));
  }
  static async createFromFiles(e, t, n) {
    hr(N(), "`Mesh.createFromFiles` is deprecated in favor of 'SceneLayer.convertMesh'", { replacement: "SceneLayer.convertMesh", version: "4.29" });
    const r = (o) => N().error(".createFromFiles()", o.message);
    if (!(e instanceof O)) {
      const o = new Ve();
      throw r(o), o;
    }
...
//# sourceMappingURL=Mesh-DYGRp2Vu.js.map
