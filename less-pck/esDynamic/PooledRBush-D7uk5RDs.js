import { bQ as w, bR as F, bS as H, bT as I } from "./main-n1d2W0Ts.js";
class T {
  constructor(t = 9, i) {
    this._compareMinX = R, this._compareMinY = j, this._toBBox = (n) => n, this._maxEntries = Math.max(4, t || 9), this._minEntries = Math.max(2, Math.ceil(0.4 * this._maxEntries)), i && (typeof i == "function" ? this._toBBox = i : this._initFormat(i)), this.clear();
  }
  destroy() {
  ...
  _build(t, i, n, s) {
    ...
    v(t, i, n, c, this._compareMinX);
    for (let l = i; l <= n; l += c) {
      const u = Math.min(l + c - 1, n);
      v(t, l, u, o, this._compareMinY);
      for (let p = l; p <= u; p += o) {
        const D = Math.min(p + o - 1, u);
        r.children.push(this._build(t, p, D, s - 1));
      }
    }
  ...
  _chooseSplitAxis(t, i, n) {
    const s = t.leaf ? this._compareMinX : R, h = t.leaf ? this._compareMinY : j;
...
//# sourceMappingURL=PooledRBush-D7uk5RDs.js.map
