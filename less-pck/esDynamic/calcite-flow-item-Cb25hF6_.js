import { cE as A, cF as F, ex as m, cA as t, cG as B } from "./main-n1d2W0Ts.js";
import { l as d, u as S, o as X, t as x, g as Y } from "./dom-BHTTQ4_z.js";
import { u as z, I as H } from "./interactive-CoK8hSSo.js";
import { s as P, a as L, c as I } from "./loadable-DHg7a56u.js";
import { c as T, d as M } from "./locale-Ksjr9aYY.js";
import { c as O, s as D, d as R, u as $ } from "./t9n-D3N8cevx.js";
import { c as Z } from "./observers-X2ZOvJBq.js";
import { d as _, a as j, b as N, S as ee, H as te } from "./action-menu-DTL460SV.js";
import { d as U } from "./action-BPkv5_IO.js";
import { d as W } from "./icon-CffnFU39.js";
import { d as K } from "./loader-DcRZn3Xd.js";
import { d as G } from "./scrim-bc7c-gsP.js";
const s = {
  ...
  disconnectedCallback() {
    M(this), R(this), this.resizeObserver?.disconnect();
  }
   ...
   */
  async setFocus() {
    await I(this), X(this.containerEl);
  }
  /**
  ...
  renderHeaderActionsEnd() {
    ...
    l === "up" && b.reverse();
    const u = r ? t("calcite-action", { "aria-expanded": x(!i), "aria-label": f, icon: i ? b[0] : b[1], id: E.collapse, onClick: this.collapse, scale: this.scale, text: f, title: i ? p : f }) : null, C = a ? t("calcite-action", { "aria-label": g, icon: v.close, id: E.close, onClick: this.handleUserClose, scale: this.scale, text: g, title: g }) : null, y = t("slot", { name: o.headerActionsEnd, onSlotchange: this.handleHeaderActionsEndSlotChange }), V = e || u || C || h;
    return t("div", { class: { [s.headerActionsEnd]: !0, [s.headerActions]: !0 }, hidden: !V, key: "header-actions-end" }, y, this.renderMenu(), u, C);
  }
  renderMenu() {
...
const se = {
  ...
  footerEnd: "footer-end",
  footerStart: "footer-start"
}, ie = ":host{box-sizing:border-box;background-color:var(--calcite-color-foreground-1);color:var(--calcite-color-text-2);font-size:var(--calcite-font-size--1)}:host *{box-sizing:border-box}:host([disabled]){cursor:default;-webkit-user-select:none;user-select:none;opacity:var(--calcite-opacity-disabled)}:host([disabled]) *,:host([disabled]) ::slotted(*){pointer-events:none}:host{position:relative;display:flex;inline-size:100%;flex:1 1 auto;overflow:hidden}:host([disabled]) ::slotted([calcite-hydrated][disabled]),:host([disabled]) [calcite-hydrated][disabled]{opacity:1}.interaction-container{display:contents}.back-button{border-width:0px;border-style:solid;border-color:var(--calcite-color-border-3);border-inline-end-width:1px}calcite-panel{--calcite-panel-footer-padding:var(--calcite-flow-item-footer-padding);--calcite-panel-header-border-block-end:var(--calcite-flow-item-header-border-block-end)}:host([hidden]){display:none}[hidden]{display:none}", le = ie, J = /* @__PURE__ */ A(class extends F {
  constructor() {
...
//# sourceMappingURL=calcite-flow-item-Cb25hF6_.js.map
