import { k1 as c, bv as d, dv as p, k2 as f, c_ as m, k3 as y, k4 as _, k5 as g } from "./main-n1d2W0Ts.js";
let b = class {
  constructor(t, e, s) {
...
function l(i, t, e, s) {
  switch (e) {
    case 0:
      return h(i, t + s, 0);
    case 1:
      return i.originPosition === "lowerLeft" ? h(i, t + s, 1) : k(i, t + s, 1);
  }
}
function u(i, t, e, s) {
...
function k({ translate: i, scale: t }, e, s) {
  return i[s] - e * t[s];
}
class M {
  constructor(t) {
  ...
  _deriveApplyTransform(t) {
    ...
    return e && s ? A : e ? u : s ? v : l;
  }
}
class T {
  _parseFeatureQuery(t) {
    const e = new M(t.options), s = g(t.buffer, e), r = { ...s, spatialReference: s.spatialReference?.toJSON(), fields: s.fields ? s.fields.map((n) => n.toJSON()) : void 0, missingAttributes: e.missingAttributes };
...
//# sourceMappingURL=PBFDecoderWorker-DS_6lY8P.js.map
