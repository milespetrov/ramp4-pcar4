import { _ as a } from "./screen.vue_vue_type_script_setup_true_lang-0VHLSwbl.js";
import { bW as i, jW as s, hk as n, jX as o } from "./main-n1d2W0Ts.js";
...
class g extends f {
  added() {
    ...
    this.removed = () => {
      e(), this.$iApi.fixture.exists("appbar") && o(this.$vApp.$pinia).removeButton("areas-of-interest"), this.$iApi.panel.remove("areas-of-interest"), s(this.$vApp.$pinia).$reset();
    };
  }
}
export {
...
//# sourceMappingURL=index-DC0_ZrOD.js.map
