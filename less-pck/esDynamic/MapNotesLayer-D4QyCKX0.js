import { dv as x, O as o, P as a, Q as C, dW as G, dT as B, dV as v, el as F, dI as k, dM as W, dK as z, dL as K, dN as A, bv as b, V as O, em as V, ad as w, cS as I, en as N, eo as h, ep as M, eq as $, _ as q, s as H, er as Q, K as U, bp as X, bl as Z, bm as Y, bn as ee, al as te, dn as L, dO as c, ek as re, b8 as oe, es as le, et as R, dX as ie } from "./main-n1d2W0Ts.js";
...
let i = class extends k(W(z(K(A(ie))))) {
  constructor(t) {
  ...
  writeSublayers(t, e, r, l) {
    ...
    if (!this.capabilities.operations.supportsMapNotesEditing) return void (y && l?.messages?.push(new H("map-notes-layer:editing-not-supported", "New map notes cannot be added to this layer")));
    const p = [];
  ...
  async beforeSave() {
    ...
    for (const l of this.sublayers) for (const s of l.graphics) if (s.geometry != null) {
      const n = s.geometry;
      t ? U(n.spatialReference, t) || (X(n.spatialReference, t) || Z() || await Y(), s.geometry = ee(n, t)) : t = n.spatialReference, e.push(s);
    }
...
//# sourceMappingURL=MapNotesLayer-D4QyCKX0.js.map
