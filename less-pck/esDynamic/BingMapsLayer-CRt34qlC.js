import { dI as f, dM as j, dJ as x, f8 as b, bv as h, b8 as U, aR as B, a2 as c, iH as M, s as u, O as r, P as s, Q as T, iI as P, dX as R, eO as k, dK as I, dN as _, a6 as O, iJ as a } from "./main-n1d2W0Ts.js";
var m;
const y = new P("0/0/0", 0, 0, 0, void 0);
let d = m = class extends f(j(x(R))) {
  constructor() {
  ...
  async fetchImageBitmapTile(e, t, i, l = {}) {
    ...
    const p = this.getTileUrl(e, t, i) ?? "", g = { responseType: "blob", signal: n, query: { ...this.refreshParameters } }, { data: v } = await c(p, g);
    return M(v, e, t, i, n);
  }
  getTileUrl() {
...
let o = class extends f(I(_(L))) {
  ...
  _getMetadata() {
    ...
    return c(`${z}/REST/v1/Imagery/Metadata/${e}`, { responseType: "json", query: { include: "ImageryProviders", uriScheme: "https", key: this.key, suppressStatus: !0, output: "json", culture: this.culture, userRegion: this.region } }).then((t) => {
      const i = t.data;
...
//# sourceMappingURL=BingMapsLayer-CRt34qlC.js.map
