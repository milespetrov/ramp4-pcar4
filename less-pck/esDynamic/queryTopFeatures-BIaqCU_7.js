import { cx as p, I as m, al as F, cv as f, a2 as x, b3 as E, cy as j, cz as d } from "./main-n1d2W0Ts.js";
...
function i(o, n, r, t = {}, e = {}) {
  ...
  return t.responseType = "json", F(s, null, t).then((l) => {
    ...
    return x(E(u.path, "queryTopFeatures"), { ...t, query: { ...c, ...t.query } });
  });
}
export {
  R as c,
...
//# sourceMappingURL=queryTopFeatures-BIaqCU_7.js.map
