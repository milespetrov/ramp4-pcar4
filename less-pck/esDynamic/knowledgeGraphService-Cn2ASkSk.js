import { O as i, P as s, Q as _, dH as L, bV as O, bv as z, ac as Ue, f3 as ge, s as d, eB as se, b7 as Ie, a6 as Re, b6 as pe, b5 as le, D as J, a2 as N, a3 as qe } from "./main-n1d2W0Ts.js";
import { m as Se, p as be, t as Ye, c as He } from "./GraphQueryStreaming-DGwftPd5.js";
...
const Qe = M, _e = "esri/rest/knowledgeGraph/wasmInterface/";
let W;
async function S() {
  const e = W;
  if (e) return e;
...
async function Be(e) {
  if (e) {
    const { default: t } = await import("./arcgis-knowledge-client-core-simd-RVFZCYhj.js").then((n) => n.a);
    return t({ locateFile: (n) => ge(_e + n) });
  }
  const { default: r } = await import("./arcgis-knowledge-client-core-lHbB8vK_.js").then((t) => t.a);
...
function De(e) {
  return { name: e.name, alias: e.alias, role: H[e.role.value] ? H[e.role.value] : null, strict: e.strict, properties: pt(e.properties), fieldIndexes: lt(e.field_indexes) };
}
function it(e) {
  return e.deleteLater(), new xe({ alias: e.alias, name: e.name, fieldType: Q[e.field_type.value] ? Q[e.field_type.value] : null, geometryType: B[e.geometry_type.value] ? B[e.geometry_type.value] : null, hasM: e.has_m, hasZ: e.has_z, nullable: e.nullable, editable: e.editable, required: e.required, defaultVisibility: e.default_visibility, systemMaintained: e.system_maintained, role: oe[e.role.value], defaultValue: e.default_value });
}
function at(e) {
  e.deleteLater();
  const r = De(e), t = [];
...
//# sourceMappingURL=knowledgeGraphService-Cn2ASkSk.js.map
