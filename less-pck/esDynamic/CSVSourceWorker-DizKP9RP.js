import { d2 as I, cX as D, s as F, cY as j, M as P, D as R, I as V, a2 as A, cU as _, bg as b, cW as L, K as G, ar as M, iz as Q, iA as Y, bv as Z, d4 as U, d5 as J, cT as B, o as K } from "./main-n1d2W0Ts.js";
import { e as W, n as z } from "./date-CID61X27.js";
import { t as H } from "./json-BI97KiBB.js";
import { m as X } from "./FeatureStore-DHN1QKiy.js";
import { x as ee } from "./timeSupport-BajsmNHb.js";
import { $ as te } from "./QueryEngine-CQ5A0Pnd.js";
import { c as ie } from "./number-DJ-35r7C.js";
import { i as ne, o as se } from "./clientSideDefaults-D1T7exSR.js";
  ...
  e: for (const y of n) {
    ...
    for (const p of f) if (a += o + p, o = "", l += k(p), l % 2 == 0) {
      if (l > 0) {
        ...
        c[i[d]] = h[1].replaceAll(E, '"'), d++;
      } else c[i[d]] = a, d++;
      a = "", l = 0;
    } else o = e;
    l === 0 ? (yield c, c = t(), d = 0) : o = S;
  }
}
function v(r, i) {
...
function ae(r, i, e) {
  ...
  return { longitudeFieldName: n || r[t.indexOf(de.find((o) => t.includes(o)))], latitudeFieldName: a || r[t.indexOf(ue.find((o) => t.includes(o)))] };
}
function le(r, i, e, t, n) {
  ...
  for (let c = 0; c < e.length; c++) {
    ...
    if (d === n.longitudeFieldName || d === n.latitudeFieldName) a.push({ name: d, type: "esriFieldTypeDouble", alias: y });
      ...
      a.push({ name: d, type: f, alias: y, length: D(f) });
    }
  }
  return a;
}
...
}(), ue = ["lat", "latitude", "latitude83", "latdecdeg", "lat_dd", "y", "ycenter", "point_y"], de = ["lon", "lng", "long", "longitude", "longitude83", "longdecdeg", "long_dd", "x", "xcenter", "point_x"], fe = se("esriGeometryPoint"), me = ["csv"], pe = [0, 0];
class he {
  constructor(i, e) {
    this.x = i, this.y = e;
  }
...
class Te {
  ...
  async _fetch(i) {
    ...
    const n = V(e);
    return (await A(n.path, { query: { ...n.query, ...t }, responseType: "text", signal: i })).data;
  }
  ...
  async _createFeatures(i) {
    ...
    const p = C(i, d, this._delimiter, ne(f, n));
    for (const s of p) {
      ...
      if (g != null && u != null && !isNaN(u) && !isNaN(g)) {
        ...
        for (const m in s) if (m !== e && m !== t) {
          if (a.isDateField(m)) s[m] = z(s[m]);
          else if (a.isNumericField(m)) {
            const x = N(s[m]);
            isNaN(x) ? s[m] = null : s[m] = x;
          }
        }
        s[n] = y, y++, l.push(new he(g, u)), c.push(s);
      }
    }
    if (!G({ wkid: 4326 }, o)) if (M(o)) for (const s of l) [s.x, s.y] = Q(s.x, s.y, pe);
    else l = Y(H, l, Z.WGS84, o, null, null);
    const h = [];
    for (let s = 0; s < l.length; s++) {
      const { x: u, y: g } = l[s], m = c[s];
      m[n] = s + 1, h.push(new U(new J([], [u, g]), m, null, m[n]));
    }
    return h;
  }
...
function ye(r, i) {
  ...
  const { delimiter: c, locationInfo: d } = oe(o, l, e);
...
//# sourceMappingURL=CSVSourceWorker-DizKP9RP.js.map
