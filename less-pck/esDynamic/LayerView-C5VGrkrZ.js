import { O as e, P as t, Q as d, bV as R, ey as $, eB as A, b8 as P, b5 as O, V as C, bE as q, aN as x, s as _, S as l, j8 as o, bi as E, dG as T, ma as V, cP as H, dH as I, mb as j, D as N, Z as U } from "./main-n1d2W0Ts.js";
import { h as L } from "./Container-CIcYD8jS.js";
...
const D = p;
var m;
const k = { base: A, key: "type", typeMap: { extent: P, polygon: O } };
...
e([t({ types: k, json: { read: $, write: !0 } })], c.prototype, "geometry", void 0), c = m = e([d("esri.views.layers.support.Geometry")], c);
const z = c;
...
const B = y, v = C.ofType({ key: "type", base: null, typeMap: { rect: D, path: B, geometry: z } }), Z = (i) => {
...
let n = class extends T(V(H.EventedMixin(I))) {
  constructor(i) {
    super(i), this._updatingHandles = new j(), this.layer = null, this.parent = null;
  }
  initialize() {
    this.when().catch((i) => {
      if (i.name !== "layerview:create-error") {
        const s = this.layer && this.layer.id || "no id", r = this.layer?.title || "no title";
        N.getLogger(this).error("#resolve()", `Failed to resolve layer view (layer title: '${r}', id: '${s}')`, i);
      }
    });
  }
  destroy() {
...
//# sourceMappingURL=LayerView-C5VGrkrZ.js.map
