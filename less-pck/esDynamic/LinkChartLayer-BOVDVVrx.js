import { f3 as _e, dI as Pe, dM as Ge, V as fe, b8 as me, s as ee, D as O, d5 as Le, cZ as W, dm as Se, c4 as He, a6 as Ce, b6 as ke, O as v, P as A, Q as Oe, dX as $e } from "./main-n1d2W0Ts.js";
import { M as Be, h as Fe, a as le, w as I, b as te, c as ae, D as E, I as Ue } from "./KnowledgeGraphSublayer-Ct76JsGd.js";
import { R as ze } from "./knowledgeGraphService-Cn2ASkSk.js";
var ie;
(function(e) {
...
let he, p = null;
function Qe() {
  return he || (he = import("./lclayout-BIXB0EDn.js").then((e) => e.l).then(({ default: e }) => e({ locateFile: (a) => _e(`esri/libs/linkchartlayout/${a}`) })).then((e) => {
    je(e);
  }), he);
}
function je(e) {
...
function j(e, a, s, t, i, n) {
  ...
  try {
    ...
    const [q, J, K, r, u] = d();
    return s.set(q), t.set(J), i.set(K), n.set(r), a.set(u), { success: S, links: M, graphics: P };
  } finally {
...
let T = class extends Pe(Ge($e)) {
      ...
      ze(this.url).then((s) => {
        if (this._initializeLayerProperties({ knowledgeGraph: s, inclusionModeDefinition: this._originalInclusionList }), this.dataManager.inclusionModeDefinition?.namedTypeDefinitions?.size || (this.dataManager.inclusionModeDefinition = { generateAllSublayers: !1, namedTypeDefinitions: /* @__PURE__ */ new Map() }, this.dataManager.knowledgeGraph.dataModel.entityTypes?.forEach((t) => {
          ...
          t.useAllData = !1, t.members?.forEach((i) => {
            let n;
            n = i.linkChartLocation instanceof Le ? i.linkChartLocation : i.linkChartLocation ? W(i.linkChartLocation) : null, n && n.coords.length === 2 && n.lengths.length === 0 ? this.entityLinkChartDiagramLookup.set(i.id, n) : this.relationshipLinkChartDiagramLookup.set(i.id, n);
  ...
  async calculateLinkChartLayout(e = "RADIAL_TREE", a) {
    ...
    for (let r = 0; r < h.length; r++) {
      ...
      const u = W(h[r].feature.attributes[E]);
    ...
    const P = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Set();
    for (let r = 0; r < i.length; r++) {
      ...
      if (!K.has(G)) {
        if (K.add(G), M.types[G] === ne.Recursive) {
      ...
      const xe = P.get(w);
      q.has(w) || (q.set(w, /* @__PURE__ */ new Map()), J.set(w, /* @__PURE__ */ new Map()));
      const se = q.get(w), re = J.get(w);
      ...
      const Re = W(l.feature.attributes[E]);
      this.relationshipLinkChartDiagramLookup.set(l.feature.attributes[I], l.feature.attributes[E] ? Re : null);
    }
    for (const r of i) r.feature.attributes[Ue] = J.get(r.feature.attributes[te] + "-" + r.feature.attributes[ae])?.get(r.typeName) ?? null;
  ...
  async _initializeDiagram() {
    this.defaultLinkChartConfig ? this.defaultLinkChartConfig.doNotRecalculateLayout ? (this.dataManager.inclusionModeDefinition?.namedTypeDefinitions?.forEach((e, a) => {
      ...
      e.name && this.dataManager.sublayerCaches.get(e.name)?.forEach((a) => {
        ...
        if (s && t) {
          const i = W(new ke({ paths: [[s.coords[0], s.coords[1]], [t.coords[0], t.coords[1]]] }));
...
//# sourceMappingURL=LinkChartLayer-BOVDVVrx.js.map
