import { ae as I, af as $, ag as v, ad as E, s as n, ah as S, ai as w, D as R, aj as O, ak as k, al as L, _ as U, am as j, an as G, ao as T, ap as B, K as V, aq as y, ar as D, V as W } from "./main-n1d2W0Ts.js";
function F(e) {
...
async function x(e, t, r) {
  ...
  if (u) {
    ...
    d.addFeatures.forEach((h) => Z(h, l));
  }
  return d.addFeatures.forEach((l) => C(l, e, u, c)), d.updateFeatures.forEach((l) => N(l, e, u, c)), d.deleteFeatures.forEach((l) => _(l, e, u, c)), d.addAttachments.forEach((l) => m(l, e)), d.updateAttachments.forEach((l) => m(l, e)), p && await P(d, e), { edits: await K(d), options: i };
}
function f(e, t, r, a) {
  if (r) {
...
//# sourceMappingURL=editingSupport-DOC8Eybw.js.map
