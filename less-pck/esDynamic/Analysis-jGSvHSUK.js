import { dF as n, bU as r, dG as l, $ as o, O as s, P as i, Q as p, dH as d } from "./main-n1d2W0Ts.js";
let y = 0, t = class extends n(r(l(d))) {
  constructor(a) {
    super(a), this.id = `${Date.now().toString(16)}-analysis-${y++}`, this.title = null;
  }
  get parent() {
...
//# sourceMappingURL=Analysis-jGSvHSUK.js.map
