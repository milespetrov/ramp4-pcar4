import { a0 as L, s as g, q as m, r as f } from "./main-n1d2W0Ts.js";
import { s as w } from "./associatedFeatureServiceUtils-Ce0GpeV_.js";
import { b as v, i as S, a as I } from "./fetchService-RtHnGpiQ.js";
class M {
  constructor() {
...
async function _(e, a) {
  return await X(e, a) ? { className: "TileLayer" } : { className: "MapImageLayer" };
}
async function $(e, a) {
  const t = await N(e, a);
  if (typeof t == "object") {
...
//# sourceMappingURL=portalLayers-NilFeXwF.js.map
