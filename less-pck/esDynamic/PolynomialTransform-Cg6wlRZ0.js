import { O as l, P as m, Q as P, bV as $e, c5 as os, pl as vs, kj as w, rd as ot, re as H, rf as As, eO as it, rg as Ts, dB as J, ad as L, mm as Ps, ey as Fs, rh as Ns, dO as St, ri as Wt, rj as $s, rk as is, rl as as, rm as Be, rn as Is, ek as Mt, ro as Cs, dv as tt, rp as Rs, rq as Ie, rr as Zt, rs as ks, rt as us, pj as Jt, ru as ls, rv as _s, rw as Q, rx as Bs, ry as jt, rz as js, rA as Ss, rB as Ms, rC as Os, rD as Yt, rE as Ds, rF as Gs, rG as Es, s as Ot, ov as je, a6 as Se, b8 as zs } from "./main-n1d2W0Ts.js";
...
let Pt = Qt = class extends D {
  ...
  clone() {
    return new Qt({ raster: this.raster, raster2: this.raster2, operation: this.operation });
  }
};
l([m({ json: { write: !0 } })], Pt.prototype, "operation", void 0), l([m({ json: { write: !0 } })], Pt.prototype, "raster2", void 0), l([m({ readOnly: !0 })], Pt.prototype, "rasters", null), Pt = Qt = l([P("esri.layers.support.rasterFunctions.ArithmeticFunctionArguments")], Pt);
...
function bn(i, t, e) {
  return Re(i, t, e, Math.log10);
}
function wn(i, t, e) {
  return Re(i, t, e, Math.log2);
}
function vn(i, t, e) {
  return Re(i, t, e, Math.log);
}
function An(i, t, e) {
  const [s, n] = i, r = s.length, a = w.createEmptyBand(e, r);
  for (let o = 0; o < r; o++) t && !t[o] || (a[o] = s[o] > n[o] ? 1 : 0);
...
function Ln(i, t) {
  ...
  switch (s) {
    ...
    case "gemi":
      ...
      break;
    case "pvi":
      o = Zn(a, r[n[0]], r[n[1]], n[2] + 1, n[3] + 1);
      break;
    case "gvitm":
      o = Qn(a, [r[n[0]], r[n[1]], r[n[2]], r[n[3]], r[n[4]], r[n[5]]]);
      break;
    case "sultan":
...
const lr = Nt;
var ne;
const Ze = new it({ 1: "outside", 2: "inside" }, { useNumericKeys: !0 });
...
l([m({ types: Ps, json: { read: Fs, write: !0 } })], Et.prototype, "clippingGeometry", void 0), l([m({ json: { read: Ze.read, write: Ze.write } })], Et.prototype, "clippingType", void 0), Et = ne = l([P("esri.layers.support.rasterFunctions.ClipFunctionArguments")], Et);
const cr = Et;
...
let $t = class extends G {
  ...
  _processPixels(t) {
    const { pixelBlocks: e } = t;
    return e ? e?.[0] == null ? null : Cs(e) : null;
  }
  _getWebGLParameters() {
  ...
  _updateAttributeTable(t, e, s) {
    ...
    for (let v = 0; v < b; v++) {
      ...
      for (let T = 0; T < A; T++) {
        ...
        const C = x.clone();
        C.attributes = { OID: I++, Value: v * A + T, ClassName: N === F ? N : `${N} -> ${F}`, Class_From: N, Class_To: F }, g && (C.attributes.Red = d[0][v][0] + d[1][T][0] >> 1, C.attributes.Green = d[0][v][1] + d[1][T][1] >> 1, C.attributes.Blue = d[0][v][2] + d[1][T][2] >> 1), y.push(C);
      }
    }
    if (u === "changed") {
      const v = x.clone();
...
let pt = class extends G {
  ...
  _bindSourceRasters() {
    ...
    return this.lookup = Rs(n, r), { success: !0, supportsGPU: !0 };
  }
  _processPixels(t) {
    const e = t.pixelBlocks?.[0];
...
function Gr(i, t, e, s = !0) {
  ...
  for (let x = 0; x < c; x++) {
    let y = Qe(n[x], r, a, d, u, t, !0);
    y = Qe(y, r, a, g, u, e, !1), s && _e(y, r, a, h, f), p.push(y);
  }
...
j.set(R.none, [0, 0, 0, 0, 1, 0, 0, 0, 0]), j.set(R.lineDetectionHorizontal, [-1, -1, -1, 2, 2, 2, -1, -1, -1]), j.set(R.lineDetectionVertical, [-1, 2, -1, -1, 2, -1, -1, 2, -1]), j.set(R.lineDetectionLeftDiagonal, [2, -1, -1, -1, 2, -1, -1, -1, 2]), j.set(R.lineDetectionRightDiagonal, [-1, -1, 2, -1, 2, -1, 2, -1, -1]), j.set(R.gradientNorth, [-1, -2, -1, 0, 0, 0, 1, 2, 1]), j.set(R.gradientWest, [-1, 0, 1, -2, 0, 2, -1, 0, 1]), j.set(R.gradientEast, [1, 0, -1, 2, 0, -2, 1, 0, -1]), j.set(R.gradientSouth, [1, 2, 1, 0, 0, 0, -1, -2, -1]), j.set(R.gradientNorthEast, [0, -1, -2, 1, 0, -1, 2, 1, 0]), j.set(R.gradientNorthWest, [-2, -1, 0, -1, 0, 1, 0, 1, 2]), j.set(R.smoothArithmeticMean, [0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111]), j.set(R.smoothing3x3, [0.0625, 0.125, 0.0625, 0.125, 0.25, 0.125, 0.0625, 0.125, 0.0625]), j.set(R.smoothing5x5, [1, 1, 1, 1, 1, 1, 4, 4, 4, 1, 1, 4, 12, 4, 1, 1, 4, 4, 4, 1, 1, 1, 1, 1, 1]), j.set(R.sharpening3x3, [-1, -1, -1, -1, 9, -1, -1, -1, -1]), j.set(R.sharpening5x5, [-1, -3, -4, -3, -1, -3, 0, 6, 0, -3, -4, 6, 21, 6, -4, -3, 0, 6, 0, -3, -1, -3, -4, -3, -1]), j.set(R.laplacian3x3, [0, -1, 0, -1, 4, -1, 0, -1, 0]), j.set(R.laplacian5x5, [0, 0, -1, 0, 0, 0, -1, -2, -1, 0, -1, -2, 17, -2, -1, 0, -1, -2, -1, 0, 0, 0, -1, 0, 0]), j.set(R.sobelHorizontal, [-1, -2, -1, 0, 0, 0, 1, 2, 1]), j.set(R.sobelVertical, [-1, 0, 1, -2, 0, 2, -1, 0, 1]), j.set(R.sharpen, [0, -0.25, 0, -0.25, 2, -0.25, 0, -0.25, 0]), j.set(R.sharpen2, [-0.25, -0.25, -0.25, -0.25, 3, -0.25, -0.25, -0.25, -0.25]), j.set(R.pointSpread, [-0.627, 0.352, -0.627, 0.352, 2.923, 0.352, -0.627, 0.352, -0.627]);
var ue;
let ht = ue = class extends D {
  ...
  set convolutionType(i) {
    ...
    const t = j.get(i);
    if (!t || i === R.userDefined || i === R.none) return;
...
let mt = class extends G {
  ...
  _bindSourceRasters() {
    ...
    if (!Object.values(R).includes(t)) return { success: !1, supportsGPU: !1, error: `convolution-function: the specified kernel type is not supported ${t}` };
    if (t !== R.none && e * s !== n.length) return { success: !1, supportsGPU: !1, error: "convolution-function: the specified rows and cols do not match the length of the kernel" };
    ...
    const o = [R.none, R.sharpen, R.sharpen2, R.sharpening3x3, R.sharpening5x5];
  ...
  _processPixels(t) {
    const e = t.pixelBlocks?.[0];
    if (e == null || this.functionArguments.convolutionType === R.none) return e;
...
let ft = class extends G {
  ...
  _processPixels(t) {
    const e = t.pixelBlocks?.[0];
    if (e == null) return null;
    const { zFactor: s, curvatureType: n } = this.functionArguments, { extent: r, primaryPixelSizes: a } = t, o = a?.[0], u = o ?? (r ? { x: r.width / e.width, y: r.height / e.height } : { x: 1, y: 1 }), c = this.isGCS && s >= 1 ? s * Zt : s;
    return ks(e, { zFactor: c, curvatureType: n, resolution: u });
  }
  _getWebGLParameters() {
    const { zFactor: t, curvatureType: e } = this.functionArguments;
    return { curvatureType: e, zFactor: this.isGCS && t >= 1 ? t * Zt : t };
  }
};
...
l([m({ json: { write: !0 } })], Z.prototype, "bandIds", void 0), l([m({ json: { write: !0 } })], Z.prototype, "bandNames", void 0), l([m({ json: { write: !0 } })], Z.prototype, "bandWavelengths", void 0), l([J({ 0: "name", 1: "wavelength", 2: "id" })], Z.prototype, "method", void 0), l([m({ json: { write: !0 } })], Z.prototype, "missingBandAction", void 0), l([m({ json: { write: !0 } })], Z.prototype, "wavelengthMatchTolerance", void 0), Z = ce = l([P("esri.layers.support.rasterFunctions.ExtractBandFunctionArguments")], Z);
const Wr = Z;
let Ct = class extends G {
  constructor() {
...
l([m({ json: { write: !0, name: "rasterFunction" } })], Ct.prototype, "functionName", void 0), l([m({ type: Wr, json: { write: !0, name: "rasterFunctionArguments" } })], Ct.prototype, "functionArguments", void 0), l([m()], Ct.prototype, "rasterArgumentNames", void 0), Ct = l([P("esri.layers.support.rasterFunctions.ExtractBandFunction")], Ct);
const qr = Ct;
function Hr(i, t) {
...
l([m({ json: { write: !0, name: "rasterFunction" } })], Rt.prototype, "functionName", void 0), l([m({ type: Qr, json: { write: !0, name: "rasterFunctionArguments" } })], Rt.prototype, "functionArguments", void 0), l([m()], Rt.prototype, "rasterArgumentNames", void 0), Rt = l([P("esri.layers.support.rasterFunctions.LocalFunction")], Rt);
const to = Rt;
var me;
...
let xt = class extends G {
  ...
  _bindSourceRasters() {
    ...
    return { success: !0, supportsGPU: (!s || s.length <= 2 * Q) && (!n || a && n[0].length <= Q) };
  }
  _processPixels(t) {
    const e = t.pixelBlocks?.[0];
    if (e == null) return null;
  ...
  _getWebGLParameters() {
    const { includedRanges: t, normalizedNoDataValues: e } = this.functionArguments, s = new Float32Array(Q);
    s.fill(jt), e?.[0]?.length && s.set(e[0]);
    const n = new Float32Array(Q);
...
let bt = class extends G {
  ...
  _bindSourceRasters() {
    ...
    return this.rasterInfo = t, this.lookup = n ? null : js({ srcPixelType: e, inputRanges: a, outputValues: r, noDataRanges: o, allowUnmatched: n, isLastInputRangeInclusive: u, outputPixelType: this.outputPixelType }), { success: !0, supportsGPU: (!r || r.length <= Q) && (!o || o.length <= Q) };
  }
  _processPixels(t) {
    const e = t.pixelBlocks?.[0];
    if (e == null) return null;
  ...
  _getWebGLParameters() {
    const { allowUnmatched: t, noDataRanges: e, isLastInputRangeInclusive: s } = this.functionArguments, n = new Float32Array(3 * Q), r = 1e-5, a = this.functionArguments.inputRanges ?? [], o = this.functionArguments.outputValues ?? [], u = o.length;
    for (let p = 0; p < Q; p++) n[3 * p] = a[2 * p] ?? jt - 1, n[3 * p + 1] = a[2 * p + 1] ?? jt, n[3 * p + 2] = o[p] ?? 0, p < u && (p > 0 && (n[3 * p] -= r), (p < u - 1 || !s) && (n[3 * p + 1] -= r));
...
let wt = class extends G {
  ...
  _getWebGLParameters() {
    ...
    return { zFactor: this.isGCS && t >= 1 ? t * Zt : t, slopeType: e, pixelSizeFactor: s ?? 0, pixelSizePower: n ?? 0 };
  }
};
...
function co(i, t) {
  ...
  for (let T = 0; T < r; T++) {
    const F = T * n;
    let C = 0, k = 0, _ = 0;
    for (let B = 0; B < p; B++) a && !a[F + B] || (C += s[F + B], h && (k += s[F + B] ** 2), _++);
    d[F] = C, g[F] = k, x[F] = _;
    for (let B = 1; B <= n - p; B++) {
      const W = F + B - 1, Dt = W + p;
      a ? (a[W] && (_--, C -= s[W], h && (k -= s[W] ** 2)), a[Dt] && (_++, C += s[Dt], h && (k += s[Dt] ** 2))) : (C -= s[W], C += s[Dt], h && (k -= s[W] ** 2, k += s[Dt] ** 2)), d[F + B] = C, x[F + B] = _, h && (g[F + B] = k);
    }
  }
  ...
  for (let T = 0; T <= n - p; T++) {
    ...
    for (let _ = 1; _ <= r - c; _++) {
      ...
      F -= d[B], F += d[W], k -= x[B], k += x[W], h && (C -= g[B], C += g[W]), y[_ * n + T] = F, b[_ * n + T] = C, A[_ * n + T] = k;
    }
  }
  ...
  for (let T = v; T < r - v; T++) {
    const F = T * n;
    for (let C = N; C < n - N; C++) {
      const k = (T - v) * n + C - N, _ = A[k];
      if (_ === 0 || e && (!a || a[F + C])) continue;
...
function mo(i, t) {
  ...
  for (let y = p; y < r - p; y++) {
    ...
    for (let A = h; A < n - h; A++) {
      ...
      for (let F = 0; F < u; F++) for (let C = 0; C < c; C++) {
        const k = b + A + (F - p) * n + C - h;
        if (a && !a[k]) continue;
        const _ = s[k];
...
function fo(i, t) {
  ...
  for (let v = 0; v < c; v++) {
    ...
    s && T.set(N);
    const F = o?.[v] ?? e, C = F?.slice() ?? null, k = { band: N, width: r, height: a, mask: C, outBand: T };
    switch (g) {
      case "min":
      case "max":
        po(k, t);
    ...
    x && !s && _e(T, r, a, f, d), h.push(T), C && b.push(C);
  }
  let A = b[0] ?? e;
...
//# sourceMappingURL=PolynomialTransform-Cg6wlRZ0.js.map
