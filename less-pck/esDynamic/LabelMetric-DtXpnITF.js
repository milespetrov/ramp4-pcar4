import { s as g, D as U, bL as b, nc as Y, aQ as L } from "./main-n1d2W0Ts.js";
import "./enums-BsbtGCGp.js";
import { s as B, e as R, c as H } from "./Texture-BEktkrFS.js";
...
const C = (r) => {
  ...
  if (!d.has(r)) {
    const e = v(t), n = { strides: z(e), bufferLayouts: e, attributes: C(t) };
    d.set(r, n);
  }
  return d.get(r);
...
class w {
  ...
  static deserialize(t) {
    const e = t.readInt32(), n = t.readF32(), s = t.readF32(), i = t.readF32(), a = t.readF32(), o = t.readF32(), c = t.readF32(), l = t.readF32(), _ = t.readF32(), A = t.readF32(), N = S(t, O) ?? [];
    return new w(e, n, s, i, a, o, c, { size: l, offsetX: _, offsetY: A }, N);
  }
}
export {
  st as M,
...
//# sourceMappingURL=LabelMetric-DtXpnITF.js.map
