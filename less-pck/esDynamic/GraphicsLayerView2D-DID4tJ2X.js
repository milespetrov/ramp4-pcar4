import { Z as p, _ as o, V as n, $ as l, J as r, O as g, P as c, Q as d } from "./main-n1d2W0Ts.js";
import { t as u } from "./highlightReasons-Dsv5EcIv.js";
import { f as w, y as m } from "./LayerView-C5VGrkrZ.js";
import { t as y } from "./GraphicContainer-DzrxXGZT.js";
import { V } from "./GraphicsView2D-S_gbPE0B.js";
import { e as f } from "./HighlightCounter-CabsWs2K.js";
let a = class extends w(m) {
  ...
  highlight(i, t = "highlight") {
    let e;
    typeof i == "number" ? e = [i] : i instanceof o ? e = [i.uid] : Array.isArray(i) && i.length > 0 ? e = typeof i[0] == "number" ? i : i.map((s) => s && s.uid) : n.isCollection(i) && i.length > 0 && (e = i.map((s) => s && s.uid).toArray());
    const h = e?.filter(l);
...
//# sourceMappingURL=GraphicsLayerView2D-DID4tJ2X.js.map
