import { dI as n, dJ as y, dK as p, dL as d, dM as u, dN as h, o as c, a1 as S, a2 as m, aq as g, a4 as f, O as o, P as s, dO as v, b8 as b, dP as C, dQ as G, dR as P, Q as w, dS as a, dT as R, dU as _, dV as x, dW as k, dX as $ } from "./main-n1d2W0Ts.js";
const j = ["atom", "xml"], F = { base: a, key: "type", typeMap: { "simple-line": R }, errorContext: "symbol" }, E = { base: a, key: "type", typeMap: { "picture-marker": _, "simple-marker": x }, errorContext: "symbol" }, M = { base: a, key: "type", typeMap: { "simple-fill": k }, errorContext: "symbol" };
let t = class extends n(y(p(d(u(h($)))))) {
  constructor(...e) {
...
o([s()], t.prototype, "description", void 0), o([s()], t.prototype, "featureCollections", void 0), o([v("service", "featureCollections", ["featureCollection.layers"])], t.prototype, "readFeatureCollections", null), o([s({ type: b, json: { name: "lookAtExtent" } })], t.prototype, "fullExtent", void 0), o([s(C)], t.prototype, "id", void 0), o([s(G)], t.prototype, "legendEnabled", void 0), o([s({ types: F, json: { write: !0 } })], t.prototype, "lineSymbol", void 0), o([s({ type: ["show", "hide"] })], t.prototype, "listMode", void 0), o([s({ types: E, json: { write: !0 } })], t.prototype, "pointSymbol", void 0), o([s({ types: M, json: { write: !0 } })], t.prototype, "polygonSymbol", void 0), o([s({ type: ["GeoRSS"] })], t.prototype, "operationalLayerType", void 0), o([s(P)], t.prototype, "url", void 0), o([s({ json: { origins: { service: { read: { source: "name", reader: (e) => e || void 0 } } } } })], t.prototype, "title", null), o([s({ readOnly: !0, json: { read: !1 }, value: "geo-rss" })], t.prototype, "type", void 0), t = o([w("esri.layers.GeoRSSLayer")], t);
const O = t;
export {
  O as default
};
//# sourceMappingURL=GeoRSSLayer-DRZ2GrD4.js.map
