import { O as h, P as f, Q as H, _ as ve, dH as Xe, ac as g, dO as lt, U as _e, bv as ut, aQ as ct, N as X, aR as dt, s as O, D as F, mb as pt, dm as de, ag as he, ez as ht, cP as ft, kB as yt, qm as q, aP as Ye, qn as mt, cN as G, eJ as xe, dW as et, dV as gt, dT as bt, qo as St, qp as vt, kC as _t, ad as se, eY as me, fs as ee, nD as wt, qq as $e, qr as Vt, S as we, j8 as xt, bi as qe, bk as Te, n1 as Ae, f0 as fe, qs as Me, cM as It, qt as Pe, qu as Ft, qv as ke, qw as Et, qx as Rt, mo as ne, qy as be, qz as Ot, o9 as Ne, eI as Z, ai as Ct, f6 as Ue, k3 as zt, V as $t, $ as qt, J as Be, b8 as Tt, T as At, Z as Mt, d1 as Le, qA as De, M as Je, qB as Pt } from "./main-n1d2W0Ts.js";
import { b as je, E as oe, R as L, a as kt, N as Qe, c as Nt } from "./Container-CIcYD8jS.js";
import { i as Ut } from "./timeSupport-DF4UhURY.js";
import { t as Bt } from "./highlightReasons-Dsv5EcIv.js";
import { f as Lt, y as Dt } from "./LayerView-C5VGrkrZ.js";
import { i as He, r as Ge, a as Jt } from "./TechniqueInstance-BAi6YOio.js";
import { t as tt } from "./CircularArray-DaQg3PQl.js";
import { b as jt } from "./WGLContainer-C_1Nh_ee.js";
import { o as Qt } from "./tileUtils-DrLrf-3T.js";
import { b as W, r as Ht, v as Gt, x as Wt } from "./UpdateTracking2D-BihgDBEV.js";
import { i as J, o as le } from "./enums-BsbtGCGp.js";
import { l as Kt } from "./SDFHelper-BF_aOxha.js";
import "./LabelMetric-DtXpnITF.js";
import { G as ue } from "./definitions-Doe0g1C2.js";
import { n as ye, h as v, M as E, e as ce, f as A, g as te, i as Ie, x as ge, d as Fe, m as M, j as Zt, c as Xt } from "./FeatureCommandQueue-CfZSbiLY.js";
import { e as Yt } from "./HighlightCounter-CabsWs2K.js";
import { p as Se, n as ei } from "./popupUtils-DssuW32c.js";
import { i as ti } from "./RefreshableLayerView-Cnvcf2a1.js";
...
function it(i, e) {
  switch (e.transformationType) {
    ...
    case q.Constant:
      return fi(e, i);
    case q.ClampedLinear:
      return yi(i, e);
    case q.Proportional:
      return mi(i, e);
    case q.Stops:
      return gi(i, e);
    case q.RealWorldSize:
      return bi(i, e);
    case q.Identity:
      return i;
    case q.Unknown:
...
let ji = class {
  ...
  getLabelingDeconflictionInfo(e) {
    const t = this.layer, r = T(t);
    return [{ vvEvaluators: { 0: P(t.renderer) }, deconflictionEnabled: r }];
  }
...
let Hi = class {
  ...
  getLabelingDeconflictionInfo(e) {
    const t = this.layer, r = K(t, e) ?? T(t);
    return [{ vvEvaluators: { 0: P(t.renderer) }, deconflictionEnabled: r }];
  }
  async createServiceOptions(e) {
...
class rr {
  ...
  getLabelingDeconflictionInfo(e) {
    return [{ vvEvaluators: {}, deconflictionEnabled: this.layer.sublayers.every((t) => T(t)) }];
  }
  async createServiceOptions(e) {
...
const lr = (i) => {
  let e = class extends i {
    ...
    initialize() {
      ...
      }, () => this._handleRequiredFieldsChange(), xt), qe(() => this.view?.floors, "change", () => this._handleRequiredFieldsChange()), qe(() => {
        const t = this.layer;
    ...
    get availableFields() {
      ...
      return "outFields" in t && t.outFields ? Te(r, [...Ae(r, t.outFields), ...s]) : Te(r, s);
    }
    get featureEffect() {
    ...
    async _updateRequiredFields() {
      ...
      const t = this.view.type === "3d", { layer: r, layer: { fieldsIndex: s, objectIdField: a } } = this, n = "renderer" in r && r.renderer, o = "orderBy" in r && r.orderBy, u = "featureReduction" in r ? r.featureReduction : null, l = /* @__PURE__ */ new Set(), c = await Promise.allSettled([n ? n.collectRequiredFields(l, s) : null, Pe(l, r), t && "elevationInfo" in r ? Ft(l, r) : null, this.filter != null ? ke(l, r, this.filter) : null, t || this.featureEffect == null ? null : ke(l, r, this.featureEffect.filter), !t && u ? Et(l, r, u) : null, !t && o ? Rt(l, r, o) : null]);
      if ("timeInfo" in r && r.timeInfo && this.timeExtent && ne(l, r.fieldsIndex, [r.timeInfo.startField, r.timeInfo.endField]), "floorInfo" in r && r.floorInfo && ne(l, r.fieldsIndex, [r.floorInfo.floorField]), r.type === "feature" && t && r.infoFor3D != null && (r.globalIdField == null && F.getLogger(this).error("globalIdField missing on 3DObjectFeatureLayer"), ne(l, r.fieldsIndex, [r.globalIdField])), r.type === "subtype-group") {
        ...
        const p = r.sublayers.map((y) => Promise.all([y.renderer?.collectRequiredFields(l, s), Pe(l, y)]));
...
let _ = class extends lr(ti(Lt(Dt))) {
  ...
  async queryExtent(i, e) {
    ...
    return { count: r.count, extent: Tt.fromJSON(r.extent) };
  }
...
`);
  ...
  _getEffectiveAvailableFields(i) {
    ...
    return this._lastAvailableFields = e, Pt(this.layer.fieldsIndex, e);
  }
...
//# sourceMappingURL=FeatureLayerView2D-pGhKWMED.js.map
