import { o as G } from "./floatRGBA-C4nHHOjw.js";
import { aM as U } from "./main-n1d2W0Ts.js";
import { t as $ } from "./UpdateTracking2D-BihgDBEV.js";
...
function z(n) {
  switch (n.type) {
    case "CIMPointSymbol": {
      ...
      const r = t[0];
      return r.type !== "CIMVectorMarker" ? null : z(r);
    }
...
function T(n) {
  return n ? n.rings ? V(n.rings) : n.paths ? V(n.paths) : U(n) ? [n.xmin, n.ymin, n.xmax, n.ymax] : null : null;
}
...
function X(n) {
  const t = B(n.geom), r = E(t), o = j, s = q, l = Math.floor(0.5 * (0.5 * o - s)), e = (o - 2 * (l + s)) / Math.max(r.width, r.height), f = Math.round(r.width * e) + 2 * l, u = Math.round(r.height * e) + 2 * l, a = [];
  ...
  const i = H(a, f, u, l);
  return n.asFill && J(a, f, u, l, i), [K(i, l), f, u];
}
function H(n, t, r, o) {
...
//# sourceMappingURL=SDFHelper-BF_aOxha.js.map
