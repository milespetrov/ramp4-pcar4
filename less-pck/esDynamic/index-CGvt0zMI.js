import { fw as c, fO as h, fB as u, fF as b, fG as l, fE as m, fH as e, hq as v, fX as i, fx as z, fL as p, fM as d, bW as _, hk as g } from "./main-n1d2W0Ts.js";
const G = /* @__PURE__ */ c({
...
}), S = { class: "flex flex-col items-center" }, B = /* @__PURE__ */ c({
  __name: "p1-screen-2",
  props: {
    panel: {
      type: Object,
...
}), C = { class: "flex flex-row justify-center items-center mt-16" }, j = { class: "mt-16" }, k = /* @__PURE__ */ c({
  __name: "p2-screen-2",
  props: {
  ...
  setup(o) {
    ...
    return (f, a) => {
      const w = u("panel-screen");
      return m(), b(w, { panel: o.panel }, {
        header: l(() => a[2] || (a[2] = [
...
}), O = { class: "flex flex-col items-center mt-16" }, T = { class: "ml-32 font-bold" }, D = { class: "ml-32 font-bold" }, E = { class: "ml-32 font-bold" }, N = /* @__PURE__ */ c({
  __name: "p2-screen-3",
  props: {
    panel: { type: Object, required: !0 }
  },
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => new Promise(
              (s) => setTimeout(
                () => import("./p2-screen-1-uHMuGyMn.js").then((n) => {
                  s(n);
                }),
                2e3
              )
...
//# sourceMappingURL=index-CGvt0zMI.js.map
