import { bW as u, kJ as a, k_ as y, k$ as g, l0 as m, l1 as h, l2 as f, fw as L, fx as v, fO as b, fB as I, fF as x, fG as A, fM as $, fE as w, fH as c, hk as S, jX as _, jY as E } from "./main-n1d2W0Ts.js";
class M extends u {
  /**
   ...
   */
  _parseConfig(e) {
    const l = e?.headerControls?.slice() ?? [
      "wizard",
      "layerReorder",
      "groupToggle",
      "visibilityToggle"
    ];
    if (a(this.$vApp.$pinia).headerControls = l, !e || !e.root.children)
      return;
    a(this.$vApp.$pinia).multilineItems = e.multilineItems?.enabled ?? !0;
    const t = [1, 2, 3, 4, 5, 6];
    !e.multilineItems?.maxLines || !t.includes(e.multilineItems?.maxLines) ? a(this.$vApp.$pinia).maxLines = 3 : a(this.$vApp.$pinia).maxLines = e.multilineItems.maxLines, this.handlePanelWidths(["legend"]), this.handlePanelTeleports(["legend"]);
  ...
  createItem(e, l) {
    let t;
    e.layerId === void 0 ? t = new y(this.$iApi, e, l) : (e.sublayerIndex !== void 0 && (e.layerId = `${e.layerId}-${e.sublayerIndex}`), t = new g(this.$iApi, e, l));
    const n = e.children;
    return n && n.forEach((r) => {
      e.layerLegendConfigs !== void 0 && (r.layerLegendConfigs = e.layerLegendConfigs), t.children.push(this.createItem(r, t));
    }), t;
  }
  /**
   ...
   */
  addItem(e, l) {
    const t = e instanceof m ? e : this.createItem(e, l);
    return this._insertItem(t, l), t;
  }
  /**
  ...
  async addLayerItem(e, l) {
    ...
    return this._insertItem(t, l), this.updateLegend(e), t;
  }
  // Read
  /**
   ...
   */
  getItem(e) {
    const l = this.getLegend();
    let t;
    return l.some((n) => (t = this.searchTreeFirst(n, (r) => r.uid === e), t !== void 0)), t;
  }
  /**
  ...
  getLayerItem(e) {
    let l, t, n;
    return typeof e == "string" ? (t = e, l = e) : (t = e.id, l = e.uid), this.getLegend().some((i) => (n = this.searchTreeFirst(
      i,
      (s) => s instanceof g && (s.layerId === t || s.uid === l)
    ), n !== void 0)), n;
  }
  /**
  ...
  getAllExpanded(e) {
    const l = e ?? !0;
    return this.searchLegend((t) => t.children.length > 0 && t.expanded === l);
  }
  /**
  ...
  getAllVisible(e) {
    const l = e ?? !0;
    return this.searchLegend((t) => t.visibility === l);
  }
  /**
  ...
  getLayerBoundItems(e) {
    let l = "";
    const t = e instanceof h ? e : this.$iApi.geo.layer.getLayer(e);
    if (t)
      l = t.isSublayer ? t.parentLayer?.id || "" : t.id;
    else
      return [];
    return this.searchLegend(
      (n) => n instanceof g && (n.layerId === l || n.parentLayerId === l)
    );
  }
  // Update
  /**
  ...
  updateLegend(e) {
    const l = (t, n) => {
      const r = this.getLayerItem(t);
      n ? (r && t instanceof h && (r.layer = t), r?.error()) : r?.load(t instanceof h ? t : void 0);
    };
    e.loadPromise().then(() => {
      ...
      if (e.layerType === f.MAPIMAGE) {
        const n = (r) => {
          if (r.isLayerRoot && !r.isLogicalLayer)
            t = this.getLayerItem(e), l(e, !1), t && !t.treeGrown && (r.children.map((i) => this._treeWalker(e, i)).map((i) => this.addItem(i, t)), t.treeGrown = !0), r.children.forEach((i) => n(i));
          else if (!r.isLayerRoot && !r.isLogicalLayer) {
            if (t = this.getLayerItem(`${e.id}-${r.layerIdx}`), t) {
              const i = t.getConfig();
              ...
              this._replaceItem(t, d);
            }
            r.children.forEach((i) => n(i));
          } else r.isLogicalLayer && l(this._treeWalker(e, r).layer, !1);
        };
        n(e.getLayerTree());
      } else
        l(e, !1);
    }).catch(() => {
      l(e, !0), e.supportsSublayers && e.config.sublayers.forEach((t) => {
        l(`${e.id}-${t.index}`, !0);
      });
    });
  }
   ...
   */
  expandItems(e, l) {
    const t = this.getLegend(), n = l === void 0 ? t : l.children;
    l !== void 0 && this._toggleState(l, { expanded: e }), n.forEach((r) => {
  ...
  showItems(e, l) {
    const t = this.getLegend(), n = l === void 0 ? t : l.children;
    l !== void 0 && this._toggleState(l, { visibility: e }), n.forEach((r) => {
   ...
   */
  reloadLayerItem(e) {
    const l = this.getLayerBoundItems(e);
    return l.forEach((t) => t.reload()), l.length > 0;
  }
  // Delete
  /**
   ...
   */
  removeItem(e) {
    const l = typeof e == "string" ? this.getItem(e) : e;
    return l !== void 0 ? this._deleteItem(l) : !1;
  }
  /**
  ...
  searchTreeFirst(e, l) {
    ...
    {
      let t;
      return e.children.some((n) => (t = this.searchTreeFirst(n, l), t !== void 0)), t;
    }
  }
  /**
  ...
  searchTreeAll(e, l) {
    ...
    for (; n.length > 0; ) {
      const r = n.shift();
      r && l(r) && t.push(r), r && n.push(...r.children);
    }
    return t;
  }
  /**
   ...
   */
  searchLegend(e) {
    return this.getLegend().map((l) => this.searchTreeAll(l, e)).flat();
  }
  /**
   ...
   */
  _toggleState(e, l) {
    const t = l.visibility, n = l.expanded;
    t !== void 0 && e.toggleVisibility(t), n !== void 0 && e.children.length > 0 && e.toggleExpanded(n), e.children && e.children.length > 0 && e.children.forEach((r) => {
      this._toggleState(r, l);
    });
  }
  /**
   ...
   */
  _insertItem(e, l) {
    a(this.$vApp.$pinia).addItem({ item: e, parent: l });
  }
  /**
   ...
   */
  _deleteItem(e) {
    const l = a(this.$vApp.$pinia), t = (n) => {
      n.children.length > 0 && n.children.forEach((r) => {
        t(r);
      }), n instanceof g && n.handlers.forEach((r) => this.$iApi.event.off(r)), l.removeItem(n);
    };
    return t(e), !0;
  }
  _replaceItem(e, l) {
    a(this.$vApp.$pinia).replaceItem({ oldItem: e, newItem: l });
  }
  ...
  _treeWalker(e, l, t) {
    ...
    return l.isLayerRoot && !l.isLogicalLayer ? (i.layer = r, i.name = r.name, i.children = l.children.map((s) => this._treeWalker(e, s, t))) : !l.isLayerRoot && !l.isLogicalLayer ? (i.name = l.name, i.children = l.children.map((s) => this._treeWalker(e, s, t))) : l.isLogicalLayer && (i.layer = r, i.name = r.name, i.layerId = r.id, i.sublayerIndex = e.isSublayer ? e.layerIdx : void 0), { ...i, ...t };
  }
}
const k = /* @__PURE__ */ L({
  __name: "nav-button",
  setup(p) {
    const { t: e } = v(), l = b("iApi"), t = () => {
      l.panel.toggle("legend");
    };
    return (n, r) => {
...
class G extends M {
  added() {
    this.$iApi.component("legend-nav-button", k), this.$iApi.panel.register(
      {
        legend: {
          screens: {
            "legend-screen": () => S(import("./screen-qhJVpUR7.js"))
          },
          style: {
            width: "350px"
          },
    ...
    const e = this.$vApp.$watch(
      () => this.config,
      (l) => this._parseConfig(l !== void 0 ? JSON.parse(JSON.stringify(l)) : void 0)
    );
    this.removed = () => {
      e(), this.$iApi.fixture.exists("appbar") && _(this.$vApp.$pinia).removeButton("legend"), this.$iApi.fixture.exists("mapnav") && E(this.$vApp.$pinia).removeItem("legend"), a().$reset(), this.$iApi.panel.remove("legend");
    };
  }
}
export {
...
//# sourceMappingURL=index-Bevh5qq_.js.map
