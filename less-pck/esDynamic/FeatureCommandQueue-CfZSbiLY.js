import { J as w, K as S, L as Dt, P as ne, M as Lt, N as Z, R as _, T as ee, U as ve, V as l, X as H, Y as V, _ as Bt, a0 as kt, a1 as A, a2 as v, a3 as U, a4 as lt, a5 as Si, a6 as ze, a7 as Y, a8 as ge, a9 as Be, aa as ke, ab as Oe, ac as Ze, ad as yt, ae as ut, e as B, af as Nt, ag as Vi, ah as _i, ai as zi, aj as $i, ak as Mi, al as Ti, am as Pi, an as J, ao as bt, ap as ct, aq as Ke, ar as vt, as as gt, at as xt, au as D, av as Ut, aw as Ht, ax as Ye, ay as Ri, az as oe, aA as wt, aB as Qe, aC as Gt, aD as Ai, aE as _e, aF as St, aG as Fi, aH as qt, aI as qe, aJ as Ci, aK as Ii, F as Oi, H as Ei, aL as Wt, aM as jt, aN as Xt, aO as Zt, aP as Kt, aQ as Yt, aR as pt, aS as Qt, aT as Di, aU as Vt, aV as Je, aW as Jt, aX as et, aY as Li, aZ as Bi, D as ki, E as Ni, q as Ui, a_ as Hi, a$ as Gi, b0 as qi, b1 as Wi, b2 as ji, b3 as Xi, b4 as Zi, b5 as Ki, b6 as ie, b7 as ce, b8 as se, p as we, b9 as Yi, b as Qi, d as Ji } from "./UpdateTracking2D-BihgDBEV.js";
import { O as c, rc as F, mZ as es, s as Pe, fh as _t, D as ei, aQ as ts, nD as dt, lx as zt, cN as be, bo as is, qn as ss, r4 as as, $ as rs, oT as os, eI as ns } from "./main-n1d2W0Ts.js";
import { a as N, J as $t, K as ls, c as Mt, U as us, p as cs } from "./definitions-Doe0g1C2.js";
import { E as le, S as ue, f as tt, p as M, y as E, d as C, M as L, e as ps, g as G, w as Ne, L as Me } from "./Container-CIcYD8jS.js";
...
import { c as Rt, s as hs, i as ii, E as si } from "./Program-BD12nHqb.js";
import { o as ms } from "./ProgramTemplate-_svae3vh.js";
import { t as ys } from "./VertexElementDescriptor-BAy1DPb3.js";
import { a as ai } from "./LabelMetric-DtXpnITF.js";
import { e as De, c as ri } from "./Texture-BEktkrFS.js";
import { o as bs } from "./constants-DVpDF9P6.js";
import { c as At } from "./WGLContainer-C_1Nh_ee.js";
let vs = class {
  constructor() {
...
class fe extends Lt {
  vertex(e) {
    const t = new Z(1, 0, 0, 0, -1, 0, 0, 1, 1).multiply(new _(e.pos.xy.divide(N), 1)), i = ee(this.draw.locations, t.xy), a = ve(this.instance.dotSize.divide(2), new l(1));
    let r = new l(0);
...
let me = class extends ke {
  ...
  vertex(e) {
    const t = new Z(2 / N, 0, 0, 0, -2 / N, 0, -1, 1, 1).multiply(new _(e.pos, 1)), i = this.clip(e.id), a = new V(t.xy, i, 1), r = this.storage.getVVData(e.id).multiply(this.instance.isActive.get(0)).multiply(e.inverseArea), o = this.storage.getDataDrivenData0(e.id).multiply(this.instance.isActive.get(1)).multiply(e.inverseArea), n = this.draw.tileZoomFactor.multiply(N).divide(this.draw.pixelRatio), u = this._dotThreshold(r, this.instance.dotValue, this.draw.tileDotsOverArea), p = this._dotThreshold(o, this.instance.dotValue, this.draw.tileDotsOverArea), d = e.pos.add(0.5).divide(n);
  ...
  fragment(e) {
    ...
    if (this.blending) {
      const d = H(new l(0), r), f = H(new l(0), o), h = Ze(d, r).add(Ze(f, o)), m = H(h, new l(0)), b = new l(1).subtract(m), y = h.add(m), g = r.multiply(d).divide(y), x = o.multiply(f).divide(y), T = u.multiply(g).add(p.multiply(x));
      n = b.multiply(T);
    } else {
  ...
  constructor(e, t) {
    ...
    for (const r of t.groups) {
      ...
      for (const h of r.attributes) {
        const { name: m, count: b, type: y, offset: g, normalized: x, divisor: T, stride: q, vertex: K, location: P } = h, $ = `vertex-buffer-${K}`;
        let R = p[$];
        R || (R = p[$] = []);
        const I = new ys(m, b, y, g, q, x, T);
        R.push(I), u.set(m, P), d[$] = i[K];
      }
...
let ft = class extends ne {
  ...
  getVVRotationMat3(e) {
    return J(bt(e), Z.identity(), () => {
      const t = this._getNormalizedAngle(e).multiply(vt), i = gt(t), a = xt(t);
      return new Z(a, i, 0, i.multiply(new l(-1)), a, 0, 0, 0, 1);
    });
  }
  _getNormalizedAngle(e) {
    const t = ct(this.rotationType, new l(Ke.Arithmatic));
...
let Ns = class extends ze {
  ...
  vertex(e, t) {
    ...
    let f = e.offset, h = new l(1), m = Z.identity(), b = new v(0);
    if (this.isLabel) {
    ...
    const T = this.isLabel ? Ai(_e(x, new l(1)), ct(u, new l(0))) : new St(!1), q = new V(d.xy.add(g.xy), x, 1), K = e.textureUV.divide(this.mosaicInfo.size);
    let P = new l(0);
    return this.isHaloPass && (P = e.haloFontSize.divide(o).divide(Fi)), { glPosition: q, color: p, size: o, textureUV: K, antialiasingWidth: new l(0.105 * wt).divide(r).divide(this.view.pixelRatio), haloDistanceOffset: P, ...this.maybeRunHittest(e, t, { vvSizeAdjustment: h, vvRotation: m, labelOffset: b, labelClipped: T }) };
  }
...
class j extends ke {
  ...
  vertex(e, t) {
    ...
    const T = ve(x, new l(1)), q = Ye(x, new l(1)), K = Z.fromRotation(o.multiply(ji)), P = Gt(this, e.id), $ = this._getViewRotationMatrix(u).multiply(P).multiply(K).multiply(new _(g.xy, 0)), R = this.clip(e.id, e.zoomRange), I = new V(m.xy.add($.xy), R, 1), z = e.textureUV.divide(this.mosaicInfo.size), He = e.outlineColor.multiply(q), Ge = oe(e.bitset, we.bitset.overrideOutlineColor), mt = e.sizeRatio.multiply(y).multiply(0.5);
    return { glPosition: I, color: h, textureUV: z, outlineColor: He, outlineSize: T, distanceToPx: mt, isSDF: n, overrideOutlineColor: Ge, ...this.maybeRunHittest(e, t, { pos: e.pos, size: y, sizeCorrection: b, isMapAligned: u, vvRotationMat3: P, placementMat3: K, outlineSize: T, distanceToPx: mt, isSDF: n }) };
  }
  fragment(e) {
  ...
  _getSDFColor(e, t) {
    const i = ee(this.mosaicInfo.texture, e), a = new l(0.5).subtract(Jt(i)).multiply(t.distanceToPx).multiply(Zi), r = et(new l(0.5).subtract(a), new l(0), new l(1)), o = t.color.multiply(r);
    let n = t.outlineSize;
  ...
  _hittestSmallMarker(e, t, i) {
    ...
    return Ki(d, a).subtract(f).add(n);
  }
...
function pa(s) {
  return { rotationType: s.rotationType === "geographic" ? Ke.Geographic : Ke.Arithmatic };
}
function Xe(s) {
  if (!s.stops?.length) return null;
...
//# sourceMappingURL=FeatureCommandQueue-CfZSbiLY.js.map
