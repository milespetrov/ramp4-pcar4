import { dy as Y, c4 as st, dm as y, nd as it, ne as nt, ad as N, aQ as j, O as h, P as d, Q as O, dH as H, aR as X, cY as $, nf as M, fn as z, m4 as D, ng as U, nh as rt, ni as A, mb as R, h as at, f9 as tt, fi as ot, eY as lt, nj as ut, f0 as v, b8 as ct, a1 as ht, D as dt, J as ft, nk as pt, nl as _t, nm as gt, lv as yt, nn as mt, no as Et, eq as Ft, np as Ct, nq as q, cR as Tt, nr as St, f8 as w, ns as bt, nt as B, nu as et, iI as vt, cP as It, ag as k, bv as b, jf as wt, S as V, j9 as Ot, ey as xt } from "./main-n1d2W0Ts.js";
import { m as $t } from "./FeatureStore-DHN1QKiy.js";
import { $ as At } from "./QueryEngine-CQ5A0Pnd.js";
import { o as Rt } from "./BoundsStore-CfsLIBur.js";
function J(e = !1, t) {
  if (e) {
...
let zt = class {
  constructor(t, s) {
    this._elevationInfo = t, this._alignPointsInFeatures = s, this._alignmentsCache = new Y(Ht), this._cacheVersion = 0;
  }
  async alignCandidates(t, s, i) {
...
let Zt = class {
  constructor(t) {
    this._getSymbologyCandidates = t, this._candidatesCache = new Y(Gt), this._cacheVersion = 0;
  }
  async fetch(t, s) {
...
class Wt {
  ...
  _gotoFetchFeatures(t, s) {
    return { type: u.FETCH_FEATURES, previous: t, task: $(async (i) => {
      ...
      this.state.type === u.FETCH_FEATURES && (this.state = Yt(this.state, n.ok ? n.value : []));
    }) };
  }
  _goToDone(t, s) {
...
let p = class extends H {
  ...
  _initializeFetchExtent() {
    ...
    const t = $(async (s) => {
      try {
        const i = await ut(this.url, new v({ where: "1=1", outSpatialReference: this.spatialReference, cacheHint: this.capabilities.query.supportsCacheHint ?? void 0 }), { query: this._configuration.customParameters, signal: s });
  ...
  _createBaseQuery(t) {
    const s = new v({ returnZ: this.hasZ, returnM: !1, geometry: this.tileInfo != null && t != null ? Ft(t.data.extent, this.tileInfo.spatialReference) : void 0 }), i = this._configuration.filter;
  ...
  _setPagingParameters(t, s, i) {
    ...
    const { supportsMaxRecordCountFactor: n, supportsCacheHint: r, tileMaxRecordCount: a, maxRecordCount: o, supportsResultType: l } = this.capabilities.query, c = n ? v.MAX_MAX_RECORD_COUNT_FACTOR : 1, f = c * ((l || r) && a ? a : o || Xt);
...
const Xt = 2e3, x = 6e5, te = 1e6, ee = 25, se = 1;
class ie {
  constructor() {
...
let F = class extends H {
  constructor(e) {
    super(e), this.tileInfo = null, this.extent = null, this.maximumByteSize = 10 * Ct.MEGABYTES, this._tileBounds = new Rt(), this._tiles = new ie(), this._refCounts = /* @__PURE__ */ new Map(), this._tileFeatureCounts = /* @__PURE__ */ new Map(), this._tmpBoundingRect = X();
  }
  add(e, t) {
  ...
  _createTileTree(e, t) {
    ...
    return t.updateTileInfo(s, w.ExtrapolateOptions.POWER_OF_TWO), this._tileBounds.forEachInBounds(e.extent, (i) => {
  ...
  _populateChildren(e, t, s, i) {
    ...
    if (c != null) this._populateChildren(c, t, s, i);
      ...
      s.updateTileInfo(f, w.ExtrapolateOptions.POWER_OF_TWO), e.children[l] = f, this._populateChildren(f, t, s, i);
    }
  }
  _simplify(e, t, s, i, n) {
    const r = n * n;
...
function ae(e) {
  return 32 + oe(e.geometry) + bt(e.attributes);
}
function oe(e) {
  if (e == null) return 0;
...
let T = class extends It.EventedAccessor {
  ...
  async setup(e) {
    ...
    const { geometryType: t, objectIdField: s, timeInfo: i, fieldsIndex: n } = e.serviceInfo, { hasZ: r } = e, a = b.fromJSON(e.spatialReference);
    this._spatialReference = a, this._featureStore = new $t({ ...e.serviceInfo, hasZ: r, hasM: !1 }), this._queryEngine = new At({ spatialReference: e.spatialReference, featureStore: this._featureStore, geometryType: t, fieldsIndex: n, hasZ: r, hasM: !1, objectIdField: s, timeInfo: i }), this._featureFetcher = new p({ store: new F({ featureStore: this._featureStore }), url: e.serviceInfo.url, objectIdField: e.serviceInfo.objectIdField, globalIdField: e.serviceInfo.globalIdField, capabilities: e.serviceInfo.capabilities, spatialReference: a, sourceSpatialReference: b.fromJSON(e.serviceInfo.spatialReference), customParameters: e.configuration.customParameters });
    const o = e.configuration.viewType === "3d";
    return this._elevationAligner = J(o, { elevationInfo: e.elevationInfo != null ? wt.fromJSON(e.elevationInfo) : null, alignPointsInFeatures: this._alignPointsInFeatures }), this._elevationFilter = Q(o), this.addHandles([V(() => this._featureFetcher.availability, (l) => this.emit("notify-availability", { availability: l }), tt), V(() => this.updating, () => this._notifyUpdating())]), this._whenSetup.resolve(), this._isInitializing = !1, this.configure(e.configuration);
  }
  async configure(e) {
  ...
  async fetchCandidates(e, t) {
    ...
    y(i);
    const r = await this._elevationAligner.alignCandidates(n.candidates, b.fromJSON(e.point.spatialReference) ?? b.WGS84, i);
    y(i);
  ...
  async updateTiles(e, t) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), y(t), this._featureFetcher.tileSize = e.tileSize, this._featureFetcher.tilesOfInterest = e.tiles, this._featureFetcher.tileInfo = e.tileInfo != null ? w.fromJSON(e.tileInfo) : null, E;
  }
  async refresh(e, t) {
  ...
  _updateFeatureFetcherConfiguration(e) {
    this._featureFetcher.filter = e.filter != null ? v.fromJSON(e.filter) : null, this._featureFetcher.customParameters = e.customParameters;
  }
  _notifyUpdating() {
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-CTMoOdQ7.js.map
