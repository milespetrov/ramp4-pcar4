import { aj as m, aL as d, a2 as u, M as w, s as p } from "./main-n1d2W0Ts.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-BfNTYwuC.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-DohN3Wic.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-DShRxA6f.js.map
