import { s as L, a2 as P, c4 as _, aO as v, ca as z, cb as B, cc as D, ld as G, aJ as U, d$ as N } from "./main-n1d2W0Ts.js";
import { e as C } from "./mat3f64-Dh9_zhFu.js";
import { w as q, m as J, h as K, c as Q } from "./Mesh-DYGRp2Vu.js";
import { l as V } from "./MeshVertexAttributes-B1Ld5IvK.js";
import { s as M } from "./meshVertexSpaceUtils-BSZfC57T.js";
import { c as O, x as F, L as k, O as S, i as I, E as H, T as W, u as X } from "./BufferView-k2-IUvEL.js";
import { t as Y, r as Z, u as ee, n as E } from "./vec3-CQg9d0_-.js";
import { f as te, o as re, u as R } from "./vec4-DJ8xUbM1.js";
import { e as ne } from "./types-ChhhI6OU.js";
import { n as oe, l as se, o as ae, f as le, a as h, b as ue, c as ie, e as ce, d as fe, g as me } from "./DefaultMaterial_COLOR_GAMMA-DNY5p5NA.js";
import { M as pe } from "./vertexSpaceConversion-DpZAFo-9.js";
import { r as de } from "./resourceUtils-BCkesTE3.js";
...
async function Ue(e, t, r) {
  ...
  o.textures.forEach((x, y) => c.set(y, he(x))), o.materials.forEach((x, y) => l.set(y, we(x, c)));
  const s = ye(a);
  for (const x of s.parts) be(s, x, l);
  const { position: m, normal: i, tangent: n, color: f, texCoord0: p } = s.vertexAttributes, g = M(e, r), j = e.spatialReference.isGeographic ? M(e) : g, b = pe({ vertexAttributes: { position: m.typedBuffer, normal: i?.typedBuffer, tangent: n?.typedBuffer }, vertexSpace: j, spatialReference: e.spatialReference }, g, { allowBufferReuse: !0, sourceUnit: "meters" });
  if (!b) throw new L("loadGLTFMesh()", "Failed to load mesh from glTF due to projection errors");
  return { transform: null, vertexSpace: g, components: s.components, spatialReference: e.spatialReference, vertexAttributes: new V({ ...b, color: f?.typedBuffer, uv: p?.typedBuffer }) };
}
function $e(e) {
...
function ye(e) {
  ...
  for (const c of e.parts) {
    ...
    `;
    let p = !1;
    const g = _(o, f, () => (p = !0, { start: t, length: l.count }));
    p && (t += l.count), s && (r.normal = !0), m && (r.color = !0), i && (r.tangent = !0), n && (r.texCoord0 = !0), a.push({ gltf: c, writeVertices: p, region: g });
  }
  return { vertexAttributes: { position: $(W, t), normal: r.normal ? $(I, t) : null, tangent: r.tangent ? $(O, t) : null, color: r.color ? $(F, t) : null, texCoord0: r.texCoord0 ? $(X, t) : null }, parts: a, components: [] };
}
function he(e) {
  return new q({ data: (de(e.data), e.data), wrap: Ce(e.parameters.wrap) });
}
function we(e, t) {
  const r = new v(Me(e.color, e.opacity)), u = e.emissiveFactor ? new v(Se(e.emissiveFactor)) : null, o = (a) => a ? new Q({ scale: a.scale ? [a.scale[0], a.scale[1]] : [1, 1], rotation: N(a.rotation ?? 0), offset: a.offset ? [a.offset[0], a.offset[1]] : [0, 0] }) : null;
  return new J({ color: r, colorTexture: t.get(e.textureColor), normalTexture: t.get(e.textureNormal), emissiveColor: u, emissiveTexture: t.get(e.textureEmissive), occlusionTexture: t.get(e.textureOcclusion), alphaMode: Be(e.alphaMode), alphaCutoff: e.alphaCutoff, doubleSided: e.doubleSided, metallic: e.metallicFactor, roughness: e.roughnessFactor, metallicRoughnessTexture: t.get(e.textureMetallicRoughness), colorTextureTransform: o(e.colorTextureTransform), normalTextureTransform: o(e.normalTextureTransform), occlusionTextureTransform: o(e.occlusionTextureTransform), emissiveTextureTransform: o(e.emissiveTextureTransform), metallicRoughnessTextureTransform: o(e.metallicRoughnessTextureTransform) });
}
function be(e, t, r) {
...
function ve(e, t) {
  ...
  if (s.texCoord0 != null && c != null ? ue(c.slice(l, i), s.texCoord0) : c != null && ie(c, 0, 0, { dstIndex: l, count: i }), s.color != null && a != null) {
    ...
    if (n.elementCount === 4) n instanceof O ? R(f, n, 255) : n instanceof F ? ce(f, n) : n instanceof k && R(f, n, 1 / 256);
      ...
      n instanceof I ? E(p, n, 255) : n instanceof S ? fe(p, n) : n instanceof H && E(p, n, 1 / 256);
    }
...
//# sourceMappingURL=loadGLTFMesh-DNWoyddE.js.map
