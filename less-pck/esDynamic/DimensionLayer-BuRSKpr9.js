import { dF as P, aO as d, O as t, P as n, jg as h, lx as w, ly as q, Q as m, lz as N, a6 as v, c5 as S, lA as z, lB as D, V as R, bF as E, S as j, j8 as $, bE as k, lC as A, b8 as b, dK as C, dN as _, ek as L, dX as T } from "./main-n1d2W0Ts.js";
import { c as F } from "./Analysis-jGSvHSUK.js";
let r = class extends P(N) {
  constructor(e) {
...
const H = [y.Horizontal, y.Vertical, y.Direct];
...
t([n({ type: ["length"], json: { write: { isRequired: !0 } } })], l.prototype, "type", void 0), t([n({ type: v, json: { write: !0 } })], l.prototype, "startPoint", void 0), t([n({ type: v, json: { write: !0 } })], l.prototype, "endPoint", void 0), t([n({ type: H, nonNullable: !0, json: { write: { isRequired: !0 } } })], l.prototype, "measureType", void 0), t([n({ type: Number, nonNullable: !0, json: { write: { isRequired: !0 } } })], l.prototype, "offset", void 0), t([n({ type: Number, nonNullable: !0, json: { write: { isRequired: !0 } } }), S((e) => z.normalize(D(e), 0, !0))], l.prototype, "orientation", void 0), l = t([m("esri.analysis.LengthDimension")], l);
...
let a = class extends F {
  ...
  initialize() {
    this.addHandles(j(() => this._computeExtent(), (e) => {
...
let s = class extends C(_(T)) {
  ...
  initialize() {
    this.addHandles([j(() => this.source, (e, i) => {
