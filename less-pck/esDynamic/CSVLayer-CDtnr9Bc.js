import { O as i, P as r, Q as c, eP as v, eG as w, U as S, b8 as O, ez as F, ac as b, dO as I, e7 as q, iK as N, em as _, bv as P, a1 as J, I as C, f0 as l, s as h } from "./main-n1d2W0Ts.js";
import { l as j } from "./clientSideDefaults-D1T7exSR.js";
let a = class extends v {
  ...
  async _startWorker(e) {
    ...
    const { url: t, delimiter: s, fields: n, latitudeField: y, longitudeField: p, spatialReference: m, timeInfo: f } = this.loadOptions, u = await this._connection.invoke("load", { url: t, customParameters: this.customParameters, parsingOptions: { delimiter: s, fields: n?.map((g) => g.toJSON()), latitudeField: y, longitudeField: p, spatialReference: m?.toJSON(), timeInfo: f?.toJSON() } }, { signal: e });
...
//# sourceMappingURL=CSVLayer-CDtnr9Bc.js.map
