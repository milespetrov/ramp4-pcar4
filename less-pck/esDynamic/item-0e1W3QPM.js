import { fw as Y, fx as ae, fP as V, fU as ce, fC as q, fE as l, fI as a, fD as w, fH as o, fM as t, iv as x, it as ie, fK as C, l0 as Le, k$ as u, nV as ke, fO as ge, fy as me, fA as G, nW as b, h_ as M, fB as ye, fW as xe, fG as de, fX as A, fL as p, f_ as K, kK as oe, fN as le, fJ as ne, hq as we, fY as v, nX as pe, kJ as Ce, fT as Me, nY as I, nZ as Z, gL as re, fF as U, k_ as Se, n_ as j, hM as Te, n$ as ze, o0 as ee } from "./main-n1d2W0Ts.js";
...
const Ee = ["type", "aria-label", "checked", "disabled", "content"], te = /* @__PURE__ */ Y({
  ...
  setup(e) {
    ...
    const f = (s) => !s.symbologyStack.some((d) => d.visibility), $ = () => {
    ...
    return (s, d) => {
      ...
      return l(), a("div", {
        ...
        w(o("input", {
          ...
          onClick: d[0] || (d[0] = x((P) => $(), ["stop"])),
          checked: e.checked && m.value,
          onKeypress: d[1] || (d[1] = ie(x(() => {
          }, ["prevent"]), ["enter"])),
          onKeyup: d[2] || (d[2] = ie(x((P) => $(), ["stop"]), ["enter"])),
          class: C([[
  ...
  setup(e) {
    const { t: y } = ae(), i = ge("iApi"), m = V(), f = V(!1), $ = me(), s = V($.mobileView), d = e, T = () => {
      ...
      O.value && (M(d.legendItem.layer).reload(), m.value.open = !1);
    }, O = G(() => d.legendItem.layerControlAvailable(b.Reload) && d.legendItem instanceof u && M(d.legendItem.layer)?.canReload), X = (z) => {
      f.value = !0, setTimeout(() => {
        f.value && (s.value || z._tippy?.show());
      }, 300);
    }, B = (z) => {
      try {
        ...
        xe(L, {
          ...
          default: de(() => [
            ...
            w((l(), a("a", {
              ...
              content: O.value ? "" : t(y)("legend.layer.controls.reloadDisabled"),
              onMouseover: c[0] || (c[0] = x((E) => X(E.currentTarget), ["stop"])),
              onMouseout: c[1] || (c[1] = (E) => (
                //@ts-ignore
                (s.value || E.currentTarget?._tippy?.hide(), f.value = !1)
              )),
              onClick: D,
              role: "button",
...
}), Pe = /* @__PURE__ */ oe(Re, [["__scopeId", "data-v-9590866e"]]), De = { key: 0 }, Oe = {
  key: 0,
  class: "relative left-3"
}, je = ["innerHTML"], qe = ["src"], Ne = {
  key: 1,
  ...
  setup(e) {
    ...
    return ce(() => {
    ...
    }), (m, f) => e.visible ? (l(), a("div", Ke, f[0] || (f[0] = [
      o("svg", {
      ...
      i.value.length > 1 ? (l(), a("div", Oe, [
        (l(!0), a(le, null, ne(i.value.slice(0, 3).reverse(), ($, s) => (l(), a("div", {
          ...
          }, null, 8, je)) : i.value[s].imgUrl ? (l(), a("img", {
            key: 1,
            class: "symbologyIcon w-28 h-28",
...
}), Je = /* @__PURE__ */ oe(Ye, [["__scopeId", "data-v-34dfeccd"]]), Xe = { class: "relative" }, Qe = ["content"], _e = {
  key: 0,
  ...
  key: 8,
  class: "relative"
}, vt = ["content", "aria-label"], bt = { class: "flex p-5" }, ft = {
  key: 0,
  ...
  key: 1,
  class: "symbologyIcon"
}, Zt = ["innerHTML"], Ut = { class: "flex-1 ml-15" }, Gt = { key: 1 }, Rt = { class: "flex p-5 ml-48" }, Pt = {
  key: 0,
  class: "relative animate-spin spinner h-20 w-20 mr-10 pt-2"
}, Dt = { class: "flex-1 text-gray-500" }, Ot = {
  key: 1,
  ...
  setup(e) {
    const y = pe(), i = me(), { t: m } = ae(), f = ge("iApi"), $ = V(), s = e, d = Ce(), T = d.multilineItems, P = (s.legendItem instanceof u && s.legendItem.maxLines) ?? d.maxLines, N = V(i.mobileView), J = G(() => y.layerConfigs), H = V([]), F = V(!1), D = V(!1), O = G(() => s.legendItem instanceof u ? M(s.legendItem.layer)?.layerType : ""), X = G(() => s.legendItem instanceof u && M(s.legendItem.layer)?.canModifyLayer), B = G(() => {
      if (s.legendItem instanceof u) {
        const r = M(s.legendItem.layer);
        return r ? r.canReload : !0;
      } else
        return !1;
    }), z = G(() => f.animate), c = G(() => s.legendItem.children.length > 0 || // TODO: Determine why Vue reactivity isn't picking updates to the children property of the parent.
    ...
    s.legendItem instanceof u && M(s.legendItem.layer)?.sublayers.length > 0), L = (r) => r === Z.Expand || r === Z.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), R = (r) => Ve(r), E = () => {
      s.legendItem.children.length === 0 || !L(Z.Expand) || (s.legendItem.toggleExpanded(), f.updateAlert(m(`legend.alert.group${s.legendItem.expanded ? "Expanded" : "Collapsed"}`)));
    }, Q = () => {
      if (L(b.Symbology)) {
        const r = s.legendItem.toggleSymbology();
        f.updateAlert(m(`legend.alert.symbology${r ? "Expanded" : "Collapsed"}`));
      }
    }, ue = () => {
      L(b.Datatable) && W() && f.event.emit(K.GRID_TOGGLE, s.legendItem.layer);
    }, ve = (r) => {
      ...
      if (r.type === I.Error) {
        ...
        const h = setInterval(() => {
          const k = r.layer;
          (k && (k.layerExists || k.initiationState === ee.NEW || k.initiationState === ee.TERMINATING || k.initiationState === ee.TERMINATED) || n > 1200) && (clearInterval(h), k && f.geo.map.removeLayer(k), y.removeLayerConfig(r.layerId), f.fixture.get("legend")?.removeLayerItem(r.layerId)), n++;
        }, 250);
      } else {
        s.legendItem.error();
        const h = setInterval(() => {
          const k = r.parentLayerId || r.layerId, S = f.geo.layer.getLayer(k);
          S && (clearInterval(h), S.cancelLoad(), (f.fixture.get("legend")?.getLayerBoundItems(S) || []).forEach((g) => g.error())), n > 1200 && clearInterval(h), n++;
        }, 50);
      }
    }, se = () => {
        ...
        o("div", Xe, [
          w((l(), a("div", {
            class: C(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              ...
              c.value && L(t(Z).Expand) || !c.value && e.legendItem instanceof t(u) && L(t(b).Datatable) && W() && e.legendItem.type === t(I).Item ? "cursor-pointer" : "cursor-default",
            ...
            onClick: n[11] || (n[11] = () => {
              !c.value && e.legendItem instanceof t(u) && L(t(b).Datatable) && W() && e.legendItem.type === t(I).Item ? ue() : c.value && E();
            }),
            content: c.value && L(t(Z).Expand) ? t(m)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(u) && e.legendItem.type === t(I).Item && L(t(b).Datatable) && W() ? t(m)("legend.layer.data") : "",
            "truncate-trigger": ""
          }, [
            e.legendItem.type !== t(I).Item ? (l(), a("div", _e, [
              e.legendItem.type === t(I).Placeholder ? (l(), a("svg", et, n[12] || (n[12] = [
            ...
            e.legendItem.type === t(I).Item && e.legendItem instanceof t(u) && e.legendItem.layer.legend.length > 0 ? (l(), a("div", {
              key: 1,
            ...
            e.legendItem instanceof t(u) && t(T) ? w((l(), a("div", {
              ...
              e.legendItem.infoType === t(j).Title && e.legendItem.content ? (l(), a("h3", it, p(e.legendItem.content), 1)) : e.legendItem.infoType === t(j).Title ? (l(), a("h3", dt, p(e.legendItem.name), 1)) : e.legendItem.infoType === t(j).Text ? (l(), a("p", rt, p(e.legendItem.content), 1)) : e.legendItem.infoType === t(j).Image ? (l(), a("img", {
                key: 3,
                src: e.legendItem.content,
                alt: "InfoType image not found :("
              }, null, 8, ct)) : e.legendItem.infoType === t(j).Markdown ? (l(), a("div", {
                key: 4,
                class: "ramp-markdown",
                innerHTML: R(e.legendItem.content)
              }, null, 8, gt)) : (l(), U(Te(`${e.legendItem.uid}-info-section`), { key: 5 }))
            ])) : v("", !0),
            e.legendItem.type === t(I).Error && B.value ? (l(), a("div", mt, [
              w((l(), a("button", {
                type: "button",
            ...
            (e.legendItem.type === t(I).Item || e.legendItem.type === t(I).Placeholder && t(T)) && e.legendItem instanceof t(u) ? (l(), U(Pe, {
              key: 7,
              class: C({
            ...
            e.legendItem.type !== t(I).Item && e.legendItem instanceof t(u) ? (l(), a("div", ut, [
              w((l(), a("button", {
                type: "button",
                class: "text-gray-500 hover:text-black",
                content: e.legendItem.type === t(I).Error ? t(m)("legend.layer.controls.remove") : t(m)("legend.layer.controls.cancel"),
                onMouseover: n[2] || (n[2] = x(() => {
                }, ["stop"])),
                onClick: x(Ie, ["stop"]),
                "aria-label": e.legendItem.type === t(I).Error ? t(m)("legend.layer.controls.remove") : t(m)("legend.layer.controls.cancel")
              }, [
                o("div", bt, [
                  e.legendItem.type === t(I).Placeholder ? (l(), a("svg", ft, n[16] || (n[16] = [
                    o("path", { d: "M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" }, null, -1)
                  ]))) : (l(), a("svg", It, n[17] || (n[17] = [
            ...
            e.legendItem.type === t(I).Item && e.legendItem instanceof t(u) && e.legendItem.layerOffscale ? w((l(), a("div", {
              key: 9,
            ...
            e.legendItem.type === t(I).Item && e.legendItem instanceof t(u) && !e.legendItem.layer?.mapLayer ? w((l(), a("div", {
              key: 10,
              class: "relative p-4 cursor-default",
            ...
            e.legendItem.type === t(I).Item && e.legendItem instanceof t(u) && e.legendItem.layerOffscale ? (l(), a("div", kt, [
              w((l(), a("button", {
                type: "button",
                class: "p-4",
            ...
            ])) : e.legendItem.type === t(I).Item && L(t(Z).Visibility) ? (l(), U(te, {
              key: 12,
          ...
          e.legendItem.type === t(I).Placeholder || e.legendItem instanceof t(u) && e.legendItem.layerRedrawing && e.legendItem.visibility ? (l(), a("div", wt, n[21] || (n[21] = [
        ...
        e.legendItem instanceof t(u) && e.legendItem.symbologyExpanded ? w((l(), a("div", pt, [
          H.value.length > 0 ? (l(), a("div", Ct, [
            ...
            (l(!0), a(le, null, ne(H.value, (g) => (l(), a("div", {
              ...
              g.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !g.imgUrl && O.value === "ogc-wms" ? (l(), a("div", St, [
                g.imgUrl ? (l(), a("div", Tt, [
                  o("img", {
                    class: "max-w-full",
                    src: g.imgUrl
                ...
                X.value && e.legendItem.layer.supportsFeatures && (!g.imgUrl && H.value.length > 1 || g.imgUrl && g.definitionClause) ? (l(), U(te, {
                  key: 2,
                  value: g,
                  legendItem: e.legendItem,
                  checked: g.visibility,
...
}), Ft = /* @__PURE__ */ oe(jt, [["__scopeId", "data-v-b1261e08"]]);
export {
  Ft as default
};
//# sourceMappingURL=item-0e1W3QPM.js.map
