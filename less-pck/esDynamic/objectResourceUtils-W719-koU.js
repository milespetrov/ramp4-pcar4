...
import { c6 as wi, sI as ea, sJ as ta, bJ as Zr, c7 as ra, mG as ia, bQ as Mi, aJ as Ge, dg as Nt, lj as gr, aI as C, li as oa, k4 as Ci, di as Ae, kf as he, aF as wr, fo as V, dl as ue, dk as me, sK as aa, e0 as we, f3 as na, D as Mr, s as St, cP as sa, ed as Kr, nR as la, iB as ht, oJ as mt, dm as Qr, sL as ca, lU as da, o9 as ua, fh as Bt, ob as ha, k3 as Et, kM as Ne, eC as ma, q8 as fa, aP as Oi, sM as pa, bz as va, e3 as it, sN as ga, sO as xa, dh as Dt, aH as qt, kg as Ze, ke as zt, sP as Ri, sQ as Ii, a8 as Ta, cf as Yt, oF as xr, O as m, ca as $i, au as oe, k0 as Cr, ld as Or, P as G, Q as Rr, dH as Pi, sR as Li, S as Ni, T as _a, fk as Ve, fg as Xt, le as ba, b2 as Ct, jT as Tr, aE as Sa, cd as Ea, ac as ya, sS as Aa, kP as Di, a2 as wa, a1 as Fi, oH as Bi, sT as zi, lF as Gt, cb as ei, cc as Ma, cl as Ca, qa as ti } from "./main-n1d2W0Ts.js";
import { t as sr, e as yt, o as ct } from "./mat3f64-Dh9_zhFu.js";
import { o as Vt, r as Oa, e as Jt } from "./mat4f64-Dn1WEGBx.js";
import { x as Zt, c as _r, y as Ra, u as Ia, q as $a, i as Ut, L as Pa, O as La, E as Na } from "./BufferView-k2-IUvEL.js";
import { e as Da, f as Fa, l as ri, o as ii } from "./vec3-CQg9d0_-.js";
import { n as Ba, s as oi } from "./vec4-DJ8xUbM1.js";
import { l as za, n as Ga, g as ke, o as Va, h as Ua, t as ja, i as Ha } from "./DefaultMaterial_COLOR_GAMMA-DNY5p5NA.js";
import { r as lr } from "./resourceUtils-BCkesTE3.js";
import { t as Wa } from "./NestedMap-CJlcHrNH.js";
import { t as ka, l as Gi } from "./Indices-C7JuNIeG.js";
import { t as Vi } from "./requestImageUtils-CU-H28Oe.js";
import { I as qa, L as Ya, t as Xe } from "./orientedBoundingBox-CfoEyULk.js";
import { t as Xa, u as vt, a as br, i as Ja, N as Me, s as X, O as Ui, e as Ce, n as At } from "./basicInterfaces-Dnf5pTeQ.js";
import { s as W } from "./Util-D-9umDoA.js";
import { s as ji, _ as Hi, V as Ee } from "./sphere-C-09q0LQ.js";
import { v as Za } from "./lineSegment-FPBx0bds.js";
import "./plane-fUOqQtDL.js";
...
import { c as ot, a as rn, e as Wi, d as on } from "./Texture-BEktkrFS.js";
import { H as an } from "./InterleavedLayout-GBDER6W8.js";
import { n as Te, a as Z, t as Kt, o as z, b as cr, r as dr } from "./NormalAttribute.glsl-YQp0_0tc.js";
import { o as s, n as wt } from "./interfaces-Aq8q9x0N.js";
import { l as ki, S as Ir, _ as $r, h as nn, o as sn } from "./renderState-DjM_esgh.js";
...
let Ji = class Zi extends Pr {
  constructor(e, r, i = null, a = Se.Mesh, o = null, n = -1) {
    ...
    for (const [c, l] of r) this._attributes.set(c, { ...l, indices: ka(l.indices) }), c === p.POSITION && (this.edgeIndicesLength = this.edgeIndicesLength < 0 ? this._attributes.get(c).indices.length : this.edgeIndicesLength);
  }
  instantiate(e = {}) {
...
let oo = class extends Pr {
  ...
  _loadFromImage(e, r) {
    ...
    if (!(i instanceof HTMLVideoElement)) {
      ...
      i = this._parameters.downsampleUncompressed ? qn(i, n) : Yn(i, n);
    }
    const a = ao(i);
...
const us = ki(ye.SRC_ALPHA, ye.ONE, ye.ONE_MINUS_SRC_ALPHA, ye.ONE_MINUS_SRC_ALPHA), hs = ki(ye.ONE, ye.ZERO, ye.ONE, ye.ONE_MINUS_SRC_ALPHA);
function ms(t) {
...
function Ss(t, e, r, i, a, o, n, c, l, u, d) {
  ...
  for (let M = r; M < i; ++M) {
    ...
    const qr = ar * Re - Oe * nr, Yr = nr * K - Re * He, Xr = He * Oe - K * ar, Mt = g * qr + S * Yr + x * Xr;
    if (le > 0) {
      if (Mt < 0 || We + Mt > le) continue;
    } else if (Mt > 0 || We + Mt < le) continue;
    const Jr = (Ie * qr + $e * Yr + ve * Xr) / le;
...
function Ms(t, e, r, i, a, o, n) {
  return V(jt, t, e, r), V(Ht, i, a, o), wr(n, jt, Ht), qt(n, n), n;
}
function Cs(t) {
  return it(jt, t[1], t[0]), it(Ht, t[2], t[0]), wr(ft, jt, Ht), qt(ft, ft), ft;
}
const jt = C(), Ht = C();
function Os(t, e) {
...
let Ds = class {
  constructor(e = 0) {
    this.componentLocalOriginLength = 0, this._totalOffset = 0, this._offset = 0, this._tmpVertex = C(), this._tmpMbs = Hi(), this._tmpObb = new qa(), this._resetOffset(e);
  }
  _resetOffset(e) {
...
let Ys = class {
  ...
  write(e, r, i, a, o) {
    ks(i, this.vertexBufferLayout, e, r, a, o);
  }
};
function Dr(t) {
...
}`), e.textureCoordinateType !== q.None && (t.include(no, e), r.uniforms.add(e.pbrTextureBindType === F.Pass ? new Q("normalTexture", (i) => i.textureNormal) : new gt("normalTexture", (i) => i.textureNormal)), e.hasNormalTextureTransform && (r.uniforms.add(new st("scale", (i) => i.scale ?? Li)), r.uniforms.add(new pe("normalTextureTransformMatrix", (i) => i.normalTextureTransformMatrix ?? ct))), r.code.add(s`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
let Lo = class k {
  ...
  add(e, r, i) {
    ...
    switch (r) {
      case "float":
        a = k._numberToFloatStr(i);
        break;
      case "int":
        a = k._numberToIntStr(i);
        break;
      case "bool":
        a = i.toString();
        break;
      case "vec2":
        a = `vec2(${k._numberToFloatStr(i[0])},                            ${k._numberToFloatStr(i[1])})`;
        break;
      case "vec3":
        a = `vec3(${k._numberToFloatStr(i[0])},                            ${k._numberToFloatStr(i[1])},                            ${k._numberToFloatStr(i[2])})`;
        break;
      case "vec4":
        a = `vec4(${k._numberToFloatStr(i[0])},                            ${k._numberToFloatStr(i[1])},                            ${k._numberToFloatStr(i[2])},                            ${k._numberToFloatStr(i[3])})`;
        break;
      case "ivec2":
        a = `ivec2(${k._numberToIntStr(i[0])},                             ${k._numberToIntStr(i[1])})`;
        break;
      case "ivec3":
        a = `ivec3(${k._numberToIntStr(i[0])},                             ${k._numberToIntStr(i[1])},                             ${k._numberToIntStr(i[2])})`;
        break;
      case "ivec4":
        a = `ivec4(${k._numberToIntStr(i[0])},                             ${k._numberToIntStr(i[1])},                             ${k._numberToIntStr(i[2])},                             ${k._numberToIntStr(i[3])})`;
        break;
      case "mat2":
      case "mat3":
      case "mat4":
        a = `${r}(${Array.prototype.map.call(i, (o) => k._numberToFloatStr(o)).join(", ")})`;
    }
...
function Wl(t) {
  t.fragment.uniforms.add(new te("projInfo", (e, r) => kl(r.camera))), t.fragment.uniforms.add(new st("zScale", (e, r) => ql(r.camera))), t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
...
m([G()], qe.prototype, "consumes", void 0), m([G()], qe.prototype, "produces", void 0), m([G({ constructOnly: !0 })], qe.prototype, "techniques", void 0), m([G({ constructOnly: !0 })], qe.prototype, "isEnabled", void 0), qe = m([Rr("esri.views.3d.webgl-engine.effects.ssao.SSAO")], qe);
const Xl = 0.5;
function Vr(t, e) {
  const r = t.fragment;
...
function Ho(t, e) {
  e.receiveShadows && (t.fragment.uniforms.add(new tc("shadowMapMatrix", (r, i) => i.shadowMap.getShadowMapMatrices(r.origin), 4)), ko(t));
}
function Wo(t, e) {
  e.receiveShadows && (t.fragment.uniforms.add(new ec("shadowMapMatrix", (r, i) => i.shadowMap.getShadowMapMatrices(r.origin), 4)), ko(t));
}
function ko(t) {
  const e = t.fragment;
...
function ic(t, e) {
  e.hasNormalTextureTransform && e.textureCoordinateType !== q.None ? (t.vertex.uniforms.add(new pe("normalTextureTransformMatrix", (r) => r.normalTextureTransformMatrix ?? ct)), t.varyings.add("normalUV", "vec2"), t.vertex.code.add(s`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)) : t.vertex.code.add(s`void forwardNormalUV(){}`);
}
function oc(t, e) {
  e.hasEmissionTextureTransform && e.textureCoordinateType !== q.None ? (t.vertex.uniforms.add(new pe("emissiveTextureTransformMatrix", (r) => r.emissiveTextureTransformMatrix ?? ct)), t.varyings.add("emissiveUV", "vec2"), t.vertex.code.add(s`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)) : t.vertex.code.add(s`void forwardEmissiveUV(){}`);
}
function ac(t, e) {
  e.hasOcclusionTextureTransform && e.textureCoordinateType !== q.None ? (t.vertex.uniforms.add(new pe("occlusionTextureTransformMatrix", (r) => r.occlusionTextureTransformMatrix ?? ct)), t.varyings.add("occlusionUV", "vec2"), t.vertex.code.add(s`void forwardOcclusionUV(){
occlusionUV = (occlusionTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)) : t.vertex.code.add(s`void forwardOcclusionUV(){}`);
}
function nc(t, e) {
  e.hasMetallicRoughnessTextureTransform && e.textureCoordinateType !== q.None ? (t.vertex.uniforms.add(new pe("metallicRoughnessTextureTransformMatrix", (r) => r.metallicRoughnessTextureTransformMatrix ?? ct)), t.varyings.add("metallicRoughnessUV", "vec2"), t.vertex.code.add(s`void forwardMetallicRoughnessUV(){
...
}, kr = class Xo extends Br {
  initializeConfiguration(e, r) {
    r.spherical = e.viewingMode === zt.Global, r.doublePrecisionRequiresObfuscation = e.rctx.driverTest.doublePrecisionRequiresObfuscation.result, r.textureCoordinateType = r.hasColorTexture || r.hasMetallicRoughnessTexture || r.hasEmissionTexture || r.hasOcclusionTexture || r.hasNormalTexture ? q.Default : q.None, r.objectAndLayerIdColorInstanced = r.instanced;
  }
  initializeProgram(e) {
...
kr.shader = new er(lc, () => Promise.resolve().then(() => Bc));
...
let kt = class extends ds {
  ...
  beginSlot(e) {
    ...
    return V(r.origin, i[3], i[7], i[11]), this._material.setParameters(this.textureBindParameters), this.ensureTechnique(r.treeRendering ? or : kr, e);
  }
};
class fc extends cc {
  constructor() {
...
function Ac(t, e) {
  ...
  for (let g = 0; g < u.length; g++) {
    ...
    if (b == null) {
      ...
      e?.materialParameters && Object.assign(K, e.materialParameters), b = new kt(K), o.set(A, N, b);
    }
    a.push(b);
    const R = new Ji(b, M);
...
function Ic(t, e, r, i) {
  ...
  return a.lods.forEach((d, h) => {
    ...
    d.parts.forEach((g) => {
      const S = v ? new kt({}) : $c(a, g, f, e, r, n, c), { geometry: x, vertexCount: P } = Pc(g, S ?? new kt({})), M = x.boundingInfo;
  ...
  for (let r = 0; r < t.model.lods.length; ++r) {
    ...
    for (const a of i.parts) {
      ...
      for (let x = 0; x < c; x++) {
        ...
        ti(d, d, e.radius), f !== null && we(d, d, f), qt(d, d), r + 1 !== t.model.lods.length && t.model.lods.length > 1 && gr(d, d, l, P > -1 ? 0.2 : Math.min(-4 * P - 3.8, 1)), v[g] = d[0], v[g + 1] = d[1], v[g + 2] = d[2], g += 3, h[S] = 255 * I, h[S + 1] = 255 * I, h[S + 2] = 255 * I, h[S + 3] = 255, S += 4;
      }
...
//# sourceMappingURL=objectResourceUtils-W719-koU.js.map
