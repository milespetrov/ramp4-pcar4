import { cN as z, dm as W, bG as F, D as Y, ge as G, oq as mt, bM as B, bK as I, bN as tt, O as f, P as y, Q as et, dH as at, M as pt, a6 as ft, b8 as _t, or as j, S as E, _ as yt, os as Z, ot as J, bI as gt, bL as O, f5 as vt, bJ as wt } from "./main-n1d2W0Ts.js";
import { c as A } from "./Program-BD12nHqb.js";
import { C as p, R as v, E as P, F as D, G as xt, D as St, O as st, I as L } from "./enums-DDkmfb-t.js";
import { e as bt, c as At } from "./Texture-BEktkrFS.js";
import { o as k } from "./ProgramTemplate-_svae3vh.js";
import { t as w } from "./VertexElementDescriptor-BAy1DPb3.js";
import { t as it, n as Dt } from "./WGLContainer-C_1Nh_ee.js";
import { E as Mt, s as rt } from "./Container-CIcYD8jS.js";
import { b as Rt } from "./LabelMetric-DtXpnITF.js";
function zt(s) {
...
const Ot = { geometry: [new w("a_position", 2, p.UNSIGNED_SHORT, 0, 8), new w("a_texcoord", 2, p.UNSIGNED_SHORT, 4, 8)] }, Ut = { vsPath: "raster/flow/imagery", fsPath: "raster/flow/imagery", attributes: C };
class It {
  constructor(t, e) {
    this._flowData = t, this._values = e;
  }
  attach(t) {
    const { context: e } = t, { width: a, height: i } = this._flowData, r = A.createVertex(e, D.STATIC_DRAW, new Uint16Array([0, 0, 0, 1, a, 0, 1, 1, 0, i, 0, 0, a, i, 1, 0])), o = new k(e, C, Ot, { geometry: r }), n = [];
    ...
    const T = new At(e, g, l);
    this.vertexArray = o, this.program = c, this.texture = T, this.min = h, this.max = m, this._flowData = null;
  }
  detach() {
...
const Bt = 4, jt = 1, Zt = 0.5, Jt = !0, Kt = !0, Qt = 2.3;
function Xt(s, t) {
  const { flowSpeed: e, trailLength: a } = s, i = zt(s);
  let r = null;
  const o = { opacity: Tt(s), size: q(s) };
  let n = Vt(s);
...
let _ = class extends at {
  ...
  attach() {
    ...
    "multidimensionalDefinition" in s ? this.addHandles(E(() => s.multidimensionalDefinition, t)) : this.addHandles([E(() => s.mosaicRule, t), E(() => s.rasterFunction, t), E(() => s.definitionExpression, t)]), this.container = new te(), this._strategy = new ie({ flowContainer: this.container }), this._updateVisualization();
  }
  detach() {
...
class xe extends it {
  ...
  _drawTriangles(t, e, a, i) {
    ...
    r.useProgram(l);
    const { coordScale: g, opacity: T, transforms: d } = e;
    l.setUniform2fv("u_coordScale", g), l.setUniform1f("u_opacity", T), l.setUniformMatrix3fv("u_dvsMat3", d.displayViewScreenMat3);
...
class Se extends rt {
      ...
      if (this._vaoInvalidated = !1, this.source != null && this.vaoData == null) {
        ...
        switch (e) {
          ...
          case "simple_scalar":
            ...
            break;
          case "wind_speed": {
            const a = Z(this.source, this.symbolizerParameters), i = this._createVectorFieldVAO(t.context, a), r = J(this.source, this.symbolizerParameters), o = this._createVectorFieldVAO(t.context, r);
  ...
  setTransform(t) {
    ...
    I(e, e, O(a, i)), I(e, e, O(o / 2, n / 2)), tt(e, e, -c), I(e, e, O(-o / 2, -n / 2)), vt(e, e, O(o, n)), wt(this.transforms.displayViewScreenMat3, t.displayViewMat3, e);
  }
  onAttach() {
    this.invalidateVAO();
  }
...
//# sourceMappingURL=RasterVFDisplayObject-CcjO7Zco.js.map
