import { dC as S, dD as y, dm as v, s as $, dE as E } from "./main-n1d2W0Ts.js";
import { getSiblingOfSameTypeI as b, contentToBlob as m } from "./resourceUtils-CdUvI8DJ.js";
...
async function w(s, t, o) {
  ...
  for (const e of t.resources.toUpdate) if (r.delete(e.resource.path), a.has(e.resource.path) || c.has(e.resource.path)) {
    const { resource: n, content: g, finish: d } = e, i = b(n, S());
  ...
  if (p.length || h.length) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-CdUvI8DJ.js");
...
//# sourceMappingURL=resourceUtils-CCeqd0d2.js.map
