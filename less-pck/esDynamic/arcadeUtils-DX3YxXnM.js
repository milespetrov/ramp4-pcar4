import { v as sr, eC as Xe, a6 as j, dv as Ra, kR as at, b8 as ye, b5 as ie, b6 as te, b7 as Se, eB as N, bZ as or, ey as le, pF as fi, fc as pi, bv as vt, a4 as Oa, cU as Pa, c_ as La, d$ as mi, qH as Ir, bo as St, kO as Di, dC as Nt, C as ur, kH as Ua, a2 as za, ac as gi, ad as Za } from "./main-n1d2W0Ts.js";
import { m as P, a as me, n as De, h as _t, c as Be, r as Xt, b as se } from "./TimeOnly-FGdb-oHx.js";
import { t as ce } from "./ImmutableArray-CiJxhY8_.js";
import { s as Ga, p as yi } from "./number-DJ-35r7C.js";
let qt = class {
  constructor(t) {
    this.source = t;
  }
...
function He(e) {
  return !!x(e) || !!L(e) || !!V(e) || !!O(e) || !!G(e) || !!J(e) || e === null || e === C || typeof e == "number";
}
function R(e, t) {
  return e === void 0 ? t : e;
}
function hr(e) {
  return e == null ? "" : T(e) || _(e) ? "Array" : V(e) ? "Date" : G(e) ? "Time" : O(e) ? "DateOnly" : x(e) ? "String" : J(e) ? "Boolean" : L(e) ? "Number" : e?.declaredClass === "esri.arcade.Attachment" ? "Attachment" : e?.declaredClass === "esri.arcade.Portal" ? "Portal" : e?.declaredClass === "esri.arcade.Dictionary" ? "Dictionary" : dr(e) ? "KnowledgeGraph" : e instanceof qt ? "Module" : X(e) ? "Feature" : e instanceof j ? "Point" : e instanceof ie ? "Polygon" : e instanceof te ? "Polyline" : e instanceof Se ? "Multipoint" : e instanceof ye ? "Extent" : Q(e) ? "Function" : kt(e) ? "FeatureSet" : Vt(e) ? "FeatureSetCollection" : e === C ? "" : typeof e == "number" && isNaN(e) ? "Number" : "Unrecognized Type";
}
function x(e) {
  return typeof e == "string" || e instanceof String;
}
...
function mr(e, t, n) {
  ...
  if (e === C) {
    ...
    if (V(t) || G(t) || O(t)) return $(e, t.toNumber(), n);
  } else if (x(e)) {
    if (x(t)) return $(F(e), F(t), n);
    if (V(t) || G(t) || O(t)) return $(p(e), t.toNumber(), n);
    if (L(t)) return $(p(e), t, n);
    if (t === null || t === C) return $(p(e), 0, n);
    if (J(t)) return $(p(e), p(t), n);
  } else if (V(e)) {
    if (V(t)) return e.timeZone !== t.timeZone && (e.isUnknownTimeZone ? e = P.arcadeDateAndZoneToArcadeDate(e, t.timeZone) : t.isUnknownTimeZone && (t = P.arcadeDateAndZoneToArcadeDate(t, e.timeZone))), $(e.toNumber(), t.toNumber(), n);
    ...
    if (V(t)) return $(e.toNumber(), t.toNumber(), n);
    if (t === null || t === C) return $(e.toNumber(), 0, n);
    if (L(t)) return $(e.toNumber(), t, n);
    if (J(t) || x(t)) return $(e.toNumber(), p(t), n);
    if (G(t)) throw new h(null, c.CannotCompareDateAndTime, null);
    ...
    if (V(t)) throw new h(null, c.CannotCompareDateAndTime, null);
    if (t === null || t === C) return $(e.toNumber(), 0, n);
    if (L(t)) return $(e.toNumber(), t, n);
    if (J(t) || x(t)) return $(e.toNumber(), p(t), n);
...
function ke(e, t) {
  ...
  if (V(e) && V(t) || G(e) && G(t) || O(e) && O(t)) return e.equals(t);
...
function un(e, t = !1) {
  ...
  if (V(e)) return JSON.stringify(t ? e.getTime() : gn(e, ""));
...
function p(e, t) {
  return L(e) ? e : e === null || e === "" ? 0 : V(e) || O(e) || G(e) ? NaN : J(e) ? e ? 1 : 0 : T(e) || e === "" || e === void 0 ? NaN : t !== void 0 && x(e) ? (t = et(t, "‰", ""), t = et(t, "¤", ""), yi(e, { pattern: t })) : e === C ? 0 : Number(e);
}
function ue(e, t) {
  if (V(e)) return e;
  if (x(e)) {
...
function tt(e, t = null) {
  return e == null ? null : J(e) || L(e) || x(e) ? e : e instanceof N ? t?.keepGeometryType === !0 ? e : e.toJSON() : e instanceof ce ? e.toArray().map((n) => tt(n, t)) : Array.isArray(e) ? e.map((n) => tt(n, t)) : on(e) ? e : V(e) ? e.toJSDate() : G(e) ? e.toString() : O(e) ? e.toJSDate() : e !== null && typeof e == "object" && e.castAsJson !== void 0 ? e.castAsJson(t) : null;
}
...
async function gr(e, t = null, n = null) {
  ...
  if (He(e) || e instanceof N || on(e) || V(e)) return tt(e, n);
  if (Array.isArray(e)) {
    const r = [], a = [];
    for (const o of e) o === null || He(o) || o instanceof N || on(o) || V(o) ? a.push(tt(o, n)) : (a.push(null), r.push(Qa(o, t, n, a.length - 1, a)));
...
function _i(e) {
  ...
  const n = [];
  for (const r of t.fields) n.push(Ha(r));
...
let B = class rn {
  ...
  async castAsJsonAsync(t = null, n = null) {
    ...
    for (let o in this.attributes) {
      ...
      n?.keyTranslate && (o = n.keyTranslate(o)), s !== void 0 && (He(s) || s instanceof N || s instanceof P ? r[o] = tt(s, n) : a.push(this.castDictionaryValueAsJsonAsync(r, o, s, t, n)));
    }
...
let ee = class Ee {
  ...
  _fixAllFields(t) {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      if (s === void 0) {
        for (const i in this.attributes) if (i.toLowerCase() === a.toLowerCase()) {
          if (s = this.attributes[i], s !== null) {
            ...
            if (o === "timestamp-offset") {
              V(s) || (this.attributes[i] = P.fromReaderAsTimeStampOffset(s.toString()));
              break;
            }
            const u = this.isUnknownDateTimeField(i);
            s instanceof Date ? this.attributes[i] = u ? P.unknownDateJSToArcadeDate(s) : P.dateJSAndZoneToArcadeDate(s, n) : V(s) || (this.attributes[i] = u ? P.unknownEpochToArcadeDate(s) : P.epochToArcadeDate(s, n));
          }
          break;
        }
      } else if (s !== null) {
        ...
        if (o === "timestamp-offset") {
          V(s) ? this.attributes[a] = s : this.attributes[a] = P.fromReaderAsTimeStampOffset(s.toString());
          continue;
        }
        const i = this.isUnknownDateTimeField(a);
        V(s) ? this.attributes[a] = s : s instanceof Date ? this.attributes[a] = i ? P.unknownDateJSToArcadeDate(s) : P.dateJSAndZoneToArcadeDate(s, n) : this.attributes[a] = i ? P.unknownEpochToArcadeDate(s) : P.epochToArcadeDate(s, n);
      }
    }
  }
  geometry() {
  ...
  setField(t, n) {
    if (this.immutable) throw new h(null, c.Immutable, null);
    if (n instanceof Date && (n = this.isUnknownDateTimeField(t) ? P.unknownDateJSToArcadeDate(n) : P.dateJSToArcadeDate(n)), He(n) === !1) throw new h(null, c.TypeNotAllowedInFeature, null);
    const r = t.toLowerCase();
  ...
  static parseAttributesFromDictionary(t) {
    ...
    for (const r in t.attributes) {
      ...
      if (!He(a)) throw new h(null, c.InvalidParameter, null);
      n[r] = a;
    }
    return n;
  }
  static fromJson(t, n) {
    ...
    if (t.attributes !== null && t.attributes !== void 0) for (const o in t.attributes) {
      ...
      if (s === null) a[o] = s;
        ...
        if (!(x(s) || L(s) || J(s) || V(s) || G(s) || O(s))) throw new h(null, c.InvalidParameter, null);
        a[o] = s;
      }
    }
...
function Kt(e, t = []) {
  ...
  if (e.usesFeatureSet === void 0) {
    n === null && (n = Hn(e)), e.usesFeatureSet = !1;
  ...
  if (e.usesModules === void 0 && (e.usesModules = !1, zi(e).length > 0 && (e.usesModules = !0)), e.usesGeometry === void 0) {
    e.usesGeometry = !1, n === null && (n = Hn(e));
...
const Vn = Object.freeze(Object.defineProperty({ __proto__: null, registerFunctions: os }, Symbol.toStringTag, { value: "Module" }));
function us(e, t, n) {
  ...
  e.today = function(n, r) {
    ...
    return t(n, r, (a, o, s) => {
      switch (D(s, 0, 4, n, r), s.length) {
        ...
        case 1: {
          ...
          if (V(s[0])) return new De(s[0].hour, s[0].minute, s[0].second, s[0].millisecond);
    ...
    return t(n, r, (a, o, s) => {
      ...
      if (s.length === 1) {
        ...
        if (V(s[0])) return me.fromParts(s[0].year, s[0].monthJS + 1, s[0].day);
        const i = p(s[0]);
  ...
  e.ringisclockwise = function(n, r) {
    ...
    return t(n, r, (a, o, s) => {
      ...
      if (s.length === 1) if (x(s[0])) i = ee.fromJson(JSON.parse(s[0]), n.timeZone);
        ...
        for (let f = 1; f < s.length; f += 2) {
          ...
          if (!(m == null || x(m) || isNaN(m) || V(m) || L(m) || G(m) || O(m) || J(m))) throw new h(n, c.InvalidParameter, r);
          if (Q(m) || He(m) === !1) throw new h(n, c.InvalidParameter, r);
          l[d] = m === C ? null : m;
        }
        i = ee.createFromGraphicLikeObject(u, l, null, n.timeZone);
      }
    ...
    return t(n, r, (a, o, s) => {
      ...
      for (let l = 0; l < s.length; l += 2) {
        ...
        if (!(d == null || x(d) || isNaN(d) || V(d) || L(d) || J(d) || O(d) || G(d) || T(d) || _(d))) throw new h(n, c.InvalidParameter, r);
...
function Ts(e, t) {
  ...
  let a = -1, o = 0;
  const s = e.hasZ ? we : Vi, i = e.hasZ ? 3 : 2, u = 2;
  for (const l of n) {
...
function Bs(e, t) {
  ...
  let a = 0;
  const o = e.hasZ ? 3 : 2, s = 2, i = e.hasZ ? we : Vi;
  let u = -1;
...
function Yi(e, t) {
  ...
  e.disjoint = function(r, a) {
    ...
    return t(r, a, (o, s, i) => (D(i, 2, 2, r, a), i[0] === i[1] || (i[0] instanceof N && i[1] instanceof N ? z.equals(i[0], i[1]) : (V(i[0]) && V(i[1]) || G(i[0]) && G(i[1]) || !(!O(i[0]) || !O(i[1]))) && i[0].equals(i[1]))));
...
function Xi(e, t) {
  ...
  e.number = function(r, a) {
    return t(r, a, (o, s, i) => {
      ...
      if (L(u)) return u;
      if (u === null) return 0;
      if (V(u) || G(u) || O(u)) return u.toNumber();
...
function ea(e, t) {
  e.stdev = function(n, r) {
    return t(n, r, (a, o, s) => Ve("stdev", s));
  }, e.variance = function(n, r) {
    return t(n, r, (a, o, s) => Ve("variance", s));
  }, e.average = function(n, r) {
    return t(n, r, (a, o, s) => Ve("mean", s));
  }, e.mean = function(n, r) {
    return t(n, r, (a, o, s) => Ve("mean", s));
  }, e.sum = function(n, r) {
    return t(n, r, (a, o, s) => Ve("sum", s));
  }, e.min = function(n, r) {
    return t(n, r, (a, o, s) => Ve("min", s));
  }, e.max = function(n, r) {
    return t(n, r, (a, o, s) => Ve("max", s));
  }, e.distinct = function(n, r) {
    return t(n, r, (a, o, s) => Ve("distinct", s));
...
function io(e, t, n) {
  let r = "", a = null, o = null;
  const s = Vs.createFromStringAndBearing(t, e, n), i = { D: w.decimal_degrees, d: w.truncated_degrees, m: w.fractional_degree_minutes, s: w.fractional_minute_seconds, R: w.radians, G: w.gradians };
...
function ao(e, t, n) {
  ...
  const r = Hr($t(t.field("directiontype"))), a = Qs(e, Vr($t(t.field("angletype"))), r);
  ...
  const o = Hr($t(n.field("directiontype"))), s = n.hasField("angleType") ? Vr($t(n.field("angletype"))) : null, i = $t(n.field("outputType")).toUpperCase().trim();
...
function ve(e, t, n) {
  if (e !== null) if (T(e)) {
    ...
    if (V(e)) return t.updateIntArray([e.toNumber()]), void t.updateUint8Array([241]);
    ...
    if (J(e)) t.updateUint8Array([e === !0 ? 1 : 0, 113]);
      ...
      if (!(e instanceof B)) {
        ...
        throw Q(e) ? new h(n.context, c.UnsupportedHashType, n.node) : kt(e) ? new h(n.context, c.UnsupportedHashType, n.node) : Vt(e) ? new h(n.context, c.UnsupportedHashType, n.node) : e === C ? new h(n.context, c.UnsupportedHashType, n.node) : new h(n.context, c.UnsupportedHashType, n.node);
      }
...
Zi(re, Ce), ia(re, Ce), Xi(re, Ce), Hi(re, Ce), ea(re, Ce), re.iif = function(e, t) {
  try {
    return Ce(e, t, (n, r, a) => {
...
lt([Vn], "sync"), lt([Vn], "async");
let Mn = 0;
const ua = { isNumber: (e) => L(e), isArray: (e) => T(e), isImmutableArray: (e) => _(e), isFeature: (e) => X(e), isString: (e) => x(e), isDictionary: (e) => Dn(e), isGeometry: (e) => Ht(e), geometryMember: (e, t, n, r, a = 1) => Ct(e, t, n, r, a), error(e) {
...
async function Po() {
  return lt([await import("./geomasync-DLgWrUTk.js")], "async"), !0;
}
class Lt extends qt {
  constructor(t) {
...
function rr(e, t) {
  let n = Zo[e];
  return t ? n.replace(Vo, (r, a) => t[a]?.toString() ?? "") : n;
}
var Wo = class {
  constructor(e = !1) {
...
var Ko = class {
  ...
  isKeyword(t) {
    switch ((t = t.toLowerCase()).length) {
      case 2:
        return t === H.If || t === H.In;
      case 3:
        return t === H.Var || t === H.For;
      case 4:
        return t === H.Else;
      case 5:
        return t === H.Break || t === H.While;
      case 6:
        return t === H.Return || t === H.Import || t === H.Export;
      case 8:
        return t === H.Function || t === H.Continue;
      default:
        return !1;
    }
  }
...
var Yo = class {
  ...
  parseStatementListItem() {
    return this.context.isAssignmentTarget = !0, this.matchKeyword(H.Function) ? this.parseFunctionDeclaration() : this.matchKeyword(H.Export) ? this.parseExportDeclaration() : this.matchKeyword(H.Import) ? this.parseImportDeclaration() : this.parseStatement();
  }
  parseBlock() {
    let t = this.captureStartMarker();
    this.expectPunctuator("{");
  ...
  parseIfStatement() {
    ...
    return this.matchKeyword(H.Else) && (this.readNextRawToken(), s = this.parseIfClause()), this.finalize({ type: v.IfStatement, test: r, consequent: o, alternate: s, ...this.getItemLocation(t) });
  }
  parseWhileStatement() {
    let t = this.captureStartMarker();
  ...
  parseForStatement() {
    ...
    if (this.expectKeyword(H.For), this.expectPunctuator("("), this.matchPunctuator(";")) this.readNextRawToken();
    else if (this.matchKeyword(H.Var)) {
      let u = this.captureStartMarker();
      this.readNextRawToken();
      let l = this.parseVariableDeclarationList();
      l.length === 1 && this.matchKeyword(H.In) ? (l[0].init && this.throwError(A.ForInOfLoopInitializer, u), a = this.finalize({ type: v.VariableDeclaration, declarations: l, kind: "var", ...this.getItemLocation(u) }), this.readNextRawToken(), o = this.parseExpression()) : (this.matchKeyword(H.In) && this.throwError(A.InvalidLeftHandSideInForIn, u), t = this.finalize({ type: v.VariableDeclaration, declarations: l, kind: "var", ...this.getItemLocation(u) }), this.expectPunctuator(";"));
    } else {
      let u = this.context.isAssignmentTarget, l = this.captureStartMarker();
      t = this.inheritCoverGrammar(this.parseAssignmentExpression.bind(this)), this.matchKeyword(H.In) ? (this.context.isAssignmentTarget || this.tolerateError(A.InvalidLeftHandSideInForIn, l), t.type !== v.Identifier && this.throwError(A.InvalidLeftHandSideInForIn, l), this.readNextRawToken(), a = t, o = this.parseExpression(), t = null) : (this.context.isAssignmentTarget = u, this.expectPunctuator(";"));
    }
  ...
  parseContinueStatement() {
    let t = this.captureStartMarker();
    return this.expectKeyword(H.Continue), this.consumeSemicolon(), this.finalize({ type: v.ContinueStatement, ...this.getItemLocation(t) });
  }
  parseBreakStatement() {
    let t = this.captureStartMarker();
    return this.expectKeyword(H.Break), this.consumeSemicolon(), this.finalize({ type: v.BreakStatement, ...this.getItemLocation(t) });
  }
  ...
  parseImportDeclaration() {
    ...
    this.expectContextualKeyword(H.From);
...
Zi(de, Je), ia(de, Je), Xi(de, Je), Hi(de, Je), ea(de, Je), Yi(de, Je), de.iif = function(e, t) {
  try {
    const n = t.arguments;
    D(n === null ? [] : n, 3, 3, e, t);
    const r = I(e, n[0]);
...
async function ba() {
  const e = await import("./geometryEngine-nAzhgFEF.js");
  return Fa = !0, Rs(e), !0;
}
let Ln = null;
function Er() {
...
async function Ea() {
  await Po(), $e = await import("./arcadeAsyncRuntime-DZurG4fn.js");
...
async function ka() {
  await Er();
  const [e, t, n, r, a, o] = await Promise.all([import("./featureSetUtils-Dij7e9oK.js").then((s) => s.g), import("./featuresetbase-APhkBojX.js"), import("./featuresetgeom-41VrCnbm.js"), import("./featuresetstats-2_kUVT8J.js"), import("./featuresetstring-BHyjNSj8.js"), import("./knowledgegraph-BZO4fonC.js")]);
...
function Uu(e) {
  return e == null ? null : T(e) || _(e) ? "array" : V(e) ? "date" : x(e) ? "text" : J(e) ? "boolean" : L(e) ? "number" : e instanceof B ? "dictionary" : X(e) ? "feature" : e instanceof j ? "point" : e instanceof ie ? "polygon" : e instanceof te ? "polyline" : e instanceof Se ? "multipoint" : e instanceof ye ? "extent" : e instanceof me ? "dateOnly" : e instanceof De ? "time" : kt(e) ? "featureSet" : Vt(e) ? "featureSetCollection" : null;
}
function Yt(e) {
  if (!e) return null;
  try {
...
const Vl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  evalSyntaxTree: Ju,
  executeAsyncFunction: Hu,
  executeFunction: qu,
  extractFieldNames: Vu,
  getArcadeType: Uu,
  getViewInfo: Yu,
...
//# sourceMappingURL=arcadeUtils-DX3YxXnM.js.map
