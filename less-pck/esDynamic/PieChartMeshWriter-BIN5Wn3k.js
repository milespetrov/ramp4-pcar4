...
import { d5 as te, qh as ee, ac as se, aO as ie, s as re, D as oe, cN as y, qi as Mt, aP as _t, qj as Z, lo as ne, qk as ae, lp as ce, ql as ue } from "./main-n1d2W0Ts.js";
import { Q as gt, A as kt, i as Pt, g as v, C as le, q as It, B as At, S as J, w as St, j as he, m as pe, o as fe, F as de, H as xe, O as me, D as ye, E as _e, p as R } from "./UpdateTracking2D-BihgDBEV.js";
import { g as Nt, i as Dt, l as ge } from "./GeometryUtils-DE2WjoxD.js";
import { a as K, c as it, t as D, R as ke, d as Pe, e as Se, V as we, A as be } from "./definitions-Doe0g1C2.js";
import { a as ve, i as Te, c as Ee } from "./TurboLine-BekHzhbz.js";
import { a as $e, e as Me, f as Ie, g as zt } from "./LabelMetric-DtXpnITF.js";
...
function Yt(e, t, s, i, r, o, n) {
  ...
  return a && M(a, a.next) && (O(a), a = a.next), a;
}
function L(e, t = e) {
  if (!e) return e;
  let s, i = e;
  do
    if (s = !1, i.steiner || !M(i, i.next) && k(i.prev, i, i.next) !== 0) i = i.next;
    else {
...
function Rt(e, t, s, i) {
  return !!(M(e, t) && M(s, i) || M(e, i) && M(s, t)) || k(e, t, s) > 0 != k(e, t, i) > 0 && k(s, i, e) > 0 != k(s, i, t) > 0;
}
function Ge(e, t) {
  let s = e;
  do {
...
function Oe(e, t, s, i) {
  ...
  do {
    ...
    !M(o, n) && Rt(o, r, r.next, n) && W(o, n) && W(n, o) && (t.push(o.index / s + i), t.push(r.index / s + i), t.push(n.index / s + i), O(r), O(r.next), r = e = n), r = r.next;
  } while (r !== e);
  return r;
}
...
const Ve = 1e-5, $ = new Nt(0, 0, 0, 1, 0), pt = new Nt(0, 0, 0, 1, 0);
function bt(e, t, s) {
  let i = 0;
  for (let r = 1; r < s; r++) {
...
function Lt(e, t) {
  ...
  $.setPixelMargin(t), $.reset(Dt.Polygon);
  let s = 0;
  for (let n = 0; n < e.lengths.length; n++) {
    const a = e.lengths[n];
    let c = e.coords[2 * (0 + s)], l = e.coords[2 * (0 + s) + 1];
    $.moveTo(c, l);
    for (let u = 1; u < a; u++) c = e.coords[2 * (u + s)], l = e.coords[2 * (u + s) + 1], $.lineTo(c, l);
    $.close(), s += a;
  }
  const i = $.result(!1);
  if (!i) return null;
...
async function es() {
  Ct = await import("./geometryEngineJSON-BOcMOp9V.js").then((e) => e.g);
}
function Ot(e) {
  switch (e) {
    case h.BYTE:
...
let is = class Wt {
  ...
  get attributeLayout() {
    if (!this._attributeLayout) {
      const t = $e(this._attributes), s = this._attributes.map((i) => ({ name: i.name, count: i.count, offset: i.offset, type: i.type, packPrecisionFactor: i.packPrecisionFactor, normalized: i.normalized ?? !1 }));
...
class _i extends B {
  ...
  _writeTextBox(t, s, i, r, o, n, a) {
    ...
    u && (this._writeQuad(t, s, i, r, { texcoords: Es, offsets: o.main, color: g(u), ...p }), f || (this._writeQuad(t, s, i, r, { texcoords: $s, offsets: o.top, color: g(u), ...p }), this._writeQuad(t, s, i, r, { texcoords: Ms, offsets: o.bot, color: g(u), ...p }), this._writeQuad(t, s, i, r, { texcoords: Is, offsets: o.left, color: g(u), ...p }), this._writeQuad(t, s, i, r, { texcoords: As, offsets: o.right, color: g(u), ...p }))), f && (this._writeQuad(t, s, i, r, { texcoords: Et, offsets: o.top, color: g(f), ...p }), this._writeQuad(t, s, i, r, { texcoords: Et, offsets: o.bot, color: g(f), ...p }), this._writeQuad(t, s, i, r, { texcoords: $t, offsets: o.left, color: g(f), ...p }), this._writeQuad(t, s, i, r, { texcoords: $t, offsets: o.right, color: g(f), ...p }));
  }
...
//# sourceMappingURL=PieChartMeshWriter-BIN5Wn3k.js.map
