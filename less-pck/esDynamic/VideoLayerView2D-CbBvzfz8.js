import { ft as j, fg as X, fi as k, T as x, fj as B, fh as J, bn as _, b5 as K, fu as $, a6 as R, aO as Q, es as Z, _ as w, dW as ee, dT as U, dV as W, Z as q, S as V, O as C, P as M, Q as te } from "./main-n1d2W0Ts.js";
import { i as F } from "./TelemetryDisplay-CCoOt0kk.js";
import { f as ie } from "./OverlayContainer-Lb4yELyc.js";
import { s as se } from "./Container-CIcYD8jS.js";
import { a as re, f as ne, y as oe } from "./LayerView-C5VGrkrZ.js";
import { c as H } from "./Program-BD12nHqb.js";
import { D as ae, F as z, E as le } from "./enums-DDkmfb-t.js";
import { e as he, c as me } from "./Texture-BEktkrFS.js";
import { o as ye } from "./ProgramTemplate-_svae3vh.js";
import { t as ce } from "./GraphicContainer-DzrxXGZT.js";
import { V as pe } from "./GraphicsView2D-S_gbPE0B.js";
const b = 2;
class de extends se {
  constructor(e) {
    super(), this.element = e, this._handles = new j(), this.isWrapAround = !1, this.perspectiveTransform = X(), this.wrapAroundShift = 0, this.clipGeometry = null, this._handles.add(k(() => this.element, () => {
      const t = this.element;
      this.ready(), t && this._handles.add(B(t, "play", () => this.requestRender()));
    }, x));
  }
  getMesh(e) {
  ...
  destroy() {
    this._handles.destroy(), this.texture = J(this.texture), this._vao && (this._vao.dispose(), this._vao = null), this._vbo && (this._vbo.dispose(), this._vbo = null), this.texture && (this.texture.dispose(), this.texture = null);
  }
  get textureSize() {
  ...
  updateDrawCoords(e, t, r, i) {
    ...
    const { controlPoints: a, horizon: h } = n, m = Math.sqrt(a.length), p = m, { x: o, y } = e, u = this._vertices, T = a[0], O = a[m - 1], N = a[(p - 1) * m], Y = a[(p - 1) * m + m - 1], P = _(h ? h[0].mapPoint : T.mapPoint, r), G = _(h ? h[1].mapPoint : O.mapPoint, r), f = _(N.mapPoint, r), D = _(Y.mapPoint, r);
    this.clipGeometry = h ? new re({ geometry: K.fromJSON({ rings: [[[f.x, f.y], [D.x, D.y], [G.x, G.y], [P.x, P.y], [f.x, f.y]]], spatialReference: r }) }) : null;
    for (let c = 0; c < a.length; c++) {
      const L = a[c], { sourcePoint: S, mapPoint: A } = L;
      if (S == null || A == null) continue;
      const v = _(A, r);
      u[c * b + 0] = v.x - o, u[c * b + 1] = v.y - y;
    }
    let E = t;
    if (i) {
      const c = Math.min(P.x, G.x, f.x, D.x), L = Math.max(P.x, G.x, f.x, D.x), { worldWidth: S, xBounds: A } = i, [v, I] = A;
  ...
  _initializeData(e, t, r) {
    ...
    const { controlPoints: i } = t, s = Math.sqrt(i.length), n = s, a = new Float32Array(b * i.length), h = new Uint16Array(2 * i.length);
    for (let o = 0; o < i.length; o++) {
      const y = i[o], { sourcePoint: u, mapPoint: T } = y;
      if (u == null || T == null) continue;
      const O = _(T, r);
      a[o * b + 0] = O.x - e.x, a[o * b + 1] = O.y - e.y, h[2 * o + 0] = u.x, h[2 * o + 1] = u.y;
    }
...
let d = class extends ne(oe) {
  ...
  async _addOverlayMultipoint() {
    ...
    this.addAttachHandles([V(() => [this.layer.frameHorizonPoints, this.layer.groundControlPoints], () => {
...
C([M()], d.prototype, "graphicsView", void 0), C([M()], d.prototype, "layer", void 0), C([M()], d.prototype, "symbolColor", void 0), C([M({ type: F })], d.prototype, "visibleTelemetryElements", void 0), d = C([te("esri.views.2d.layers.VideoLayerView2D")], d);
const Pe = d;
export {
  Pe as default
};
//# sourceMappingURL=VideoLayerView2D-CbBvzfz8.js.map
