import { jN as Ce, cB as Xe, cA as y, cE as Ye, cF as Ge, ex as Z, cC as yt, cG as Et, mi as Pt } from "./main-n1d2W0Ts.js";
import { g as Ct, a as Qe, t as ve, o as At, q as kt, y as Ot, f as Rt } from "./dom-BHTTQ4_z.js";
import { c as Dt, d as St, e as Ze } from "./locale-Ksjr9aYY.js";
import { s as Je, a as et, c as tt } from "./loadable-DHg7a56u.js";
import { d as nt } from "./action-BPkv5_IO.js";
import { d as it } from "./icon-CffnFU39.js";
import { d as ot } from "./loader-DcRZn3Xd.js";
import { d as Lt } from "./debounce-27Hmkkyg.js";
import { d as pe, a as Ae, c as Mt, u as Tt } from "./focusTrapComponent-DbzWw8yI.js";
import { o as ke } from "./openCloseComponent-DQy26FB5.js";
import { u as Bt, c as Ht, s as It, d as Ft } from "./t9n-D3N8cevx.js";
import { c as $t } from "./observers-X2ZOvJBq.js";
import { g as zt } from "./component-CWGf1hug.js";
function Oe(t, e) {
  return (t + e) % e;
}
const st = ["top", "right", "bottom", "left"], Re = ["start", "end"], De = /* @__PURE__ */ st.reduce((t, e) => t.concat(e, e + "-" + Re[0], e + "-" + Re[1]), []), Y = Math.min, j = Math.max, oe = Math.round, ie = Math.floor, N = (t) => ({
  x: t,
  y: t
}), _t = {
  left: "right",
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const g = _(o), b = _(a) === a, w = await (c.isRTL == null ? void 0 : c.isRTL(l.floating)), E = p || (b || !m ? [re(a)] : Nt(a));
...
function ft(t) {
  const e = U(t);
  return G(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : $(e) && ne(e) ? e : ft(e);
}
function ee(t, e, n) {
  var i;
...
function an(t) {
  ...
  const u = N(0), f = $(i);
  if ((f || !f && !s) && ((Q(i) !== "body" || ne(r)) && (c = he(i)), $(i))) {
    const p = K(i);
...
function dn(t, e) {
  const n = K(t, !0, e === "fixed"), i = n.top + t.clientTop, o = n.left + t.clientLeft, s = $(t) ? X(t) : N(1), r = t.clientWidth * s.x, a = t.clientHeight * s.y, c = o * s.x, l = i * s.y;
  return {
    width: r,
    height: a,
    x: c,
...
function pt(t, e) {
  const n = U(t);
  return n === e || !L(n) || G(n) ? !1 : M(n).position === "fixed" || pt(n, e);
}
function un(t, e) {
  const n = e.get(t);
  if (n)
    return n;
  let i = ee(t, [], !1).filter((a) => L(a) && Q(a) !== "body"), o = null;
  const s = M(t).position === "fixed";
  let r = s ? U(t) : t;
  for (; L(r) && !G(r); ) {
    const a = M(r), c = ue(r);
    !c && a.position === "fixed" && (o = null), (s ? !c && !o : !c && a.position === "static" && !!o && ["absolute", "fixed"].includes(o.position) || ne(r) && !c && pt(t, r)) ? i = i.filter((u) => u !== r) : o = a, r = U(r);
  }
  return e.set(t, i), i;
}
function hn(t) {
...
function mt(t, e) {
  ...
  for (; i && tn(i) && me(i); )
    i = He(i, e);
  return i && G(i) && me(i) && !ue(i) ? n : i || nn(t) || n;
}
...
const xn = Jt, yn = Yt, En = en, Ie = Gt, Pn = Qt, Cn = qt, An = (t, e, n) => {
...
const Ne = {
  ...
  return y(
    "svg",
    { "aria-hidden": "true", class: Ne.arrow, height: i, key: e, ref: n, viewBox: `0 0 ${i} ${i + (a ? 0 : s)}`, width: i + (a ? s : 0) },
    s > 0 && y("path", { class: Ne.arrowStroke, d: c, fill: "none", "stroke-width": s + 1 }),
...
class zn {
  constructor() {
    this.registeredElements = /* @__PURE__ */ new Map(), this.registeredElementCount = 0, this.queryPopover = (e) => {
      ...
      e.defaultPrevented || (e.key === "Escape" ? this.closeAllPopovers() : Ze(e.key) && this.togglePopovers(e));
    }, this.clickHandler = (e) => {
  ...
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.calcitePopoverBeforeClose = Z(this, "calcitePopoverBeforeClose", 6), this.calcitePopoverClose = Z(this, "calcitePopoverClose", 6), this.calcitePopoverBeforeOpen = Z(this, "calcitePopoverBeforeOpen", 6), this.calcitePopoverOpen = Z(this, "calcitePopoverOpen", 6), this.mutationObserver = $t("mutation", () => this.updateFocusTrapElements()), this.guid = `calcite-popover-${Qe()}`, this.openTransitionProp = "opacity", this.hasLoaded = !1, this.setTransitionEl = (e) => {
      ...
      if (!e)
        return;
      const n = this.getId();
      "setAttribute" in e && e.setAttribute(Ue, n), je.registerElement(e, this.el), this.setExpandedAttr();
    }, this.removeReferences = () => {
      const { effectiveReferenceElement: e } = this;
      e && ("removeAttribute" in e && (e.removeAttribute(Ue), e.removeAttribute(Ve)), je.unregisterElement(e));
    }, this.hide = () => {
      this.open = !1;
    }, this.storeArrowEl = (e) => {
...
//# sourceMappingURL=action-menu-DTL460SV.js.map
