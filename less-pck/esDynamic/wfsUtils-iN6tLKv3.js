import { a2 as b, dp as U, s as c, dq as M, dr as x, ds as C, dt as h, bv as P, K as D, du as V, bn as j, dv as y, dw as L, dx as O, b8 as X, cT as Y, cX as T } from "./main-n1d2W0Ts.js";
import { u as W } from "./geojson-CqcYYCeT.js";
import { o as F, n as g } from "./xmlUtils-TLuV3CJ7.js";
const S = "xlink:href", m = "2.0.0", E = "__esri_wfs_id__", q = "wfs-layer:getWFSLayerTypeInfo-error", z = "wfs-layer:empty-service", $ = "wfs-layer:feature-type-not-found", _ = "wfs-layer:geojson-not-supported", K = "wfs-layer:kvp-encoding-not-supported", J = "wfs-layer:malformed-json", A = "wfs-layer:unknown-geometry-type", Q = "wfs-layer:unknown-field-type", H = "wfs-layer:unsupported-spatial-reference", B = "wfs-layer:unsupported-wfs-version";
...
function Z(n) {
  const t = v(n);
  fe(t), G(t);
  const e = t.firstElementChild, a = U(ae(e));
...
function re(n) {
  ...
  return { xmin: t, ymin: e, xmax: a, ymax: o, spatialReference: Y };
}
function oe(n, t, e) {
...
async function se(n, t, e, a = {}) {
  ...
  if (i && !D(i.spatialReference, s)) try {
    await V(i.spatialReference, s, void 0, a), i = j(i, s);
  } catch {
...
async function pe(n, t, e, a = {}) {
  ...
  if (u) {
    let p;
    switch (o = L.fromJSON(W(u.type)), u.type) {
      case "Point":
        p = u.coordinates;
        break;
      case "LineString":
  ...
  for (const r of o) {
    ...
    switch (i.toLowerCase()) {
      ...
      case "multigeometrypropertytype":
        ...
        break;
      default:
        t.push(new c(Q, `Unknown field type '${i}'`, { type: new XMLSerializer().serializeToString(n) }));
    }
...
async function me(n, t, e, a, o) {
  ...
  try {
    ...
    throw new c(J, "Error while parsing the response", { response: r, error: s });
  }
}
function N(n, t, e, a) {
...
function ge(n, t, e) {
  ...
  return { spatialReference: o, getFeatureSpatialReference: O(n) || o.wkid && t.supportedSpatialReferences.includes(o.wkid) ? { wkid: o.wkid } : { wkid: t.defaultSpatialReference } };
}
export {
  me as K,
  E as S,
...
//# sourceMappingURL=wfsUtils-iN6tLKv3.js.map
