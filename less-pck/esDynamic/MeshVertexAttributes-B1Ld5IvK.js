import { O as e, P as u, c5 as c, Q as f, bV as v, D as l, ad as a } from "./main-n1d2W0Ts.js";
var y;
...
function m(t, o, n, g) {
  ...
  return t.length % s != 0 ? (g.error(i, `Invalid array length, expected a multiple of ${s}`), new n([])) : t;
}
function p(t, o, n, g, i) {
  if (!t) return t;
  if (t instanceof o) return m(t, g, o, i);
  for (const s of n) if (t instanceof s) return m(new o(t), g, o, i);
  if (Array.isArray(t)) return m(new o(t), g, o, i);
  {
    const s = n.map((d) => `'${d.name}'`);
...
//# sourceMappingURL=MeshVertexAttributes-B1Ld5IvK.js.map
