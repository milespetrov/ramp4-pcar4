import { ad as p, a3 as P, by as I, a4 as w, a2 as k, bz as h, bA as S, bB as m, bC as d, bD as v, bv as x, U as E, X as O, W as F } from "./main-n1d2W0Ts.js";
...
async function L(s) {
  const r = E.fromJSON(s.featureSet).features, t = s.layerDefinition, e = O(t.drawingInfo.renderer), n = F.fromJSON(s.popupInfo), i = [];
  for (const f of r) {
...
function G(s) {
  ...
  return v(t, S) ? void 0 : { xmin: t[0], ymin: t[1], zmin: t[2], xmax: t[3], ymax: t[4], zmax: t[5], spatialReference: x.WGS84 };
}
export {
  J as S,
  L as b,
...
//# sourceMappingURL=kmlUtils-BmZHTYdz.js.map
