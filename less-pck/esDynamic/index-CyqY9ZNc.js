import { fw as h, fO as d, fP as r, fU as f, f_ as o, fV as p, fI as c, fH as t, fK as u, fE as v, kK as m, bW as _ } from "./main-n1d2W0Ts.js";
const w = /* @__PURE__ */ h({
  __name: "crosshairs",
  setup(n) {
    ...
    return f(() => {
      ...
      class: u(["crosshairs absolute duration-150 top-1/2 left-1/2 h-230 w-230", { "opacity-0": !s.value }])
    }, i[0] || (i[0] = [
      t("svg", {
...
}), M = /* @__PURE__ */ m(w, [["__scopeId", "data-v-55a2f166"]]);
class k extends _ {
  added() {
    const { destroy: e, el: s } = this.mount(M, {
      app: this.$element
    });
...
//# sourceMappingURL=index-CyqY9ZNc.js.map
