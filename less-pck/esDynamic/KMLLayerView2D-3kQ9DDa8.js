import { fa as z, bn as $, a6 as k, a2 as B, E as D, V as O, S as F, fb as N, Z as S, b8 as T, bm as W, bv as U, fc as H, fd as E, b$ as K, fe as J, O as v, P as C, Q } from "./main-n1d2W0Ts.js";
import { b as P, g as Y, d as X } from "./kmlUtils-BmZHTYdz.js";
import { g as Z, f as tt, b as et } from "./Bitmap-biJly5ra.js";
import { a as it } from "./BitmapContainer-DiRBBwpV.js";
import { f as at, y as st } from "./LayerView-C5VGrkrZ.js";
import { t as M } from "./GraphicContainer-DzrxXGZT.js";
import { V as R } from "./GraphicsView2D-S_gbPE0B.js";
import { C as rt, e as nt } from "./rasterProjectionHelper-BgoZUmrw.js";
import { a as ot } from "./WGLContainer-C_1Nh_ee.js";
import { y as lt, o as ht } from "./RenderingContext-BilNANze.js";
import { D as A, G as pt, U as ct, X as L } from "./enums-DDkmfb-t.js";
import { E as mt } from "./Program-BD12nHqb.js";
import { c as dt } from "./rasterUtils-CkBwGGcr.js";
import { e as q, c as ut } from "./Texture-BEktkrFS.js";
class p {
  constructor(t) {
    if (this._ownsRctx = !1, t) this._ownsRctx = !1, this._rctx = t;
      ...
      const i = document.createElement("canvas"), s = z(i);
  ...
  reprojectTexture(t, a, r = !1) {
    ...
    if (this._program.setUniform2f("u_srcImageSize", f, x), this._program.setUniform2fv("u_transformSpacing", g.spacing), this._program.setUniform2fv("u_transformGridSize", g.size), this._program.setUniform2f("u_targetImageSize", o, u), this._quad.draw(), this._quad.unbind(), this._rctx.useProgram(null), this._rctx.bindFramebuffer(null), w.dispose(), r) {
      ...
      const G = c.detachColorTexture(L.COLOR_ATTACHMENT0);
      return c.dispose(), { texture: G, extent: i, imageData: _ };
    }
  ...
  async loadAndReprojectBitmapData(t, a, r) {
    const i = (await B(t, { responseType: "image" })).data, s = document.createElement("canvas");
...
//# sourceMappingURL=KMLLayerView2D-3kQ9DDa8.js.map
