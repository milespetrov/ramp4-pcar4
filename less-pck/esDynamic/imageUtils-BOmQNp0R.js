import { bG as m, aR as M, O as V, Q as y } from "./main-n1d2W0Ts.js";
import { b as I } from "./Bitmap-biJly5ra.js";
import { r as T, h as _ } from "./WGLContainer-C_1Nh_ee.js";
import { E as c } from "./Container-CIcYD8jS.js";
import { i as A } from "./TileContainer-D0qjFaqb.js";
...
const z = (t) => {
  let e = class extends t {
    attach() {
      this.view.timeline.record(`${this.layer.title} (BitmapTileLayer) Attach`), this._bitmapView = new L(this._tileInfoView), this.container.addChild(this._bitmapView);
    }
    detach() {
...
function X(t, e, i, r) {
  ...
  const f = a.getXForColumn(i.col), b = a.getYForRow(i.row), l = P(e) / s[0], h = $(e) / s[1], w = Math.round(l * ((p - f) / n)), g = Math.round(h * (-(u - b) / n)), R = Math.round(l * s[0] * (o / n)), v = Math.round(h * s[1] * (o / n)), d = C(s);
...
//# sourceMappingURL=imageUtils-BOmQNp0R.js.map
