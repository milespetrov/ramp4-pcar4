import { c as b } from "./WGLContainer-C_1Nh_ee.js";
import { t as wt } from "./CircularArray-DaQg3PQl.js";
import { ac as B, cP as yt, aP as x, dH as E, O as _, P as g, Q as R, pP as ht, fu as Mt, b2 as _t, aI as pt, fo as bt, kf as xt, dk as gt, pQ as j, a6 as J, fi as vt, pR as H, pS as Tt, aJ as $t, fk as nt, pT as St, ls as Ct, pU as Dt, fg as N, pV as Vt, pW as ot, pX as zt, pY as Et, Z as O, pZ as lt } from "./main-n1d2W0Ts.js";
import { a as Rt } from "./testSVGPremultipliedAlpha-BK5DiJdu.js";
import { U, N as Lt, O as It } from "./definitions-Doe0g1C2.js";
import { t as Pt } from "./AttributeStore-GRl8PvEZ.js";
import { e as At } from "./ProgramTemplate-_svae3vh.js";
    ...
    for (const { container: e, geometryType: i, vvEvaluators: s } of t) C(e, (n, a) => {
      ...
      for (const l of a) {
        ...
        for (const f of l.bounds) {
          let W = c, K = m;
          if (u) {
            let $ = W + f.x + q, S = K + f.y + rt;
            $ = o[0] * $ + o[2] * S + o[4], S = o[1] * $ + o[3] * S + o[5], f.computedX = Math.floor($), f.computedY = Math.floor(S);
          } else {
            W = o[0] * c + o[2] * m + o[4], K = o[1] * c + o[3] * m + o[5];
            const $ = W + f.x + q, S = K + f.y + rt;
...
-> updateRequested: ${this.updateRequested}`), this.updateRequested;
  ...
  update(t) {
    ...
    e - this._lastUpdate >= kt ? (this._lastUpdate = e, this.doUpdate(t)) : this.requestUpdate();
  }
  viewChange() {
    this.requestUpdate();
  }
...
_([g()], P.prototype, "updateRequested", void 0), _([g()], P.prototype, "updating", null), _([g()], P.prototype, "view", void 0), P = _([R("esri.views.2d.LabelManager")], P);
...
let V = class extends E {
  constructor(t) {
    super(t), this.animationTime = 0, this.momentumEstimator = new qt(500, 6, 0.92), this.momentum = null, this.tmpMomentum = pt(), this.momentumFinished = !1, this.viewpoint = new j({ targetGeometry: new J(), scale: 0, rotation: 0 }), this._previousDrag = null, vt(() => this.momentumFinished, () => this.navigation.stop());
  }
  begin(t, e) {
...
const Yt = z, et = N(), mt = N();
let F = class extends E {
  constructor(r) {
    super(r), this._previousCenter = N(), this.viewpoint = new j({ targetGeometry: new J(), scale: 0, rotation: 0 });
  }
  begin(r, t) {
...
_([g()], F.prototype, "viewpoint", void 0), _([g()], F.prototype, "navigation", void 0), F = _([R("esri.views.2d.navigation.actions.Rotate")], F);
const Ht = F, D = 10, ct = 1, it = new j({ targetGeometry: new J() }), st = [0, 0], dt = 250;
let M = class extends E {
  ...
  initialize() {
    this.pan = new Ot({ navigation: this }), this.rotate = new Ht({ navigation: this }), this.pinch = new Yt({ navigation: this }), this.zoomBox = new Nt({ view: this.view, navigation: this });
  }
  destroy() {
...
const we = M, Qt = { shaders: { vertexShader: b("magnifier/magnifier.vert"), fragmentShader: b("magnifier/magnifier.frag") }, attributes: /* @__PURE__ */ new Map([["a_pos", 0]]) };
function ye(r) {
  return At(r, Qt);
}
export {
...
//# sourceMappingURL=MagnifierPrograms-CVZNyY5a.js.map
