import { D as H, s as I, iB as ee, nv as te, I as w, fe as re, a2 as x, dm as V, N as F, Z as ie, M as se, by as S, c4 as le, lV as D, lU as oe, ad as g, eb as W, b3 as T, f8 as R, nw as z, b8 as U, nx as J, ny as K, lZ as G, R as ae, nz as Y, eE as L, cT as E, nA as j, a6 as ne, iJ as ue, dI as pe, dM as ce, kL as he, dY as ye, dK as de, dL as fe, dZ as me, d_ as ge, dN as Ae, a1 as $, nB as Se, nC as xe, nD as M, cY as we, O as h, P as y, bv as ve, ek as _e, dO as N, Q as be, dX as Ie } from "./main-n1d2W0Ts.js";
import { e as Ue } from "./jsonContext-xnRvlBw_.js";
import { l as Re } from "./StyleRepository-C_SM2WyA.js";
let _ = null;
function $e(e) {
  if (_) return _;
...
class C {
  ...
  async _loadSprites(t) {
    ...
    if (r > u || i > u) {
      ...
      throw H.getLogger("esri.layers.support.SpriteSource").error(n), new I("SpriteSource", n);
    }
    let a;
...
class Oe {
  ...
  getData(t) {
    ...
    return r.push(t), oe(t, () => {
      r.every((i) => D(i)) && this._abortController.abort();
...
function De(e, t, r, i, s) {
  ...
  const u = o.path;
  return Le(S(u.replaceAll(/\{z\}/gi, t.toString()).replaceAll(/\{y\}/gi, r.toString()).replaceAll(/\{x\}/gi, i.toString()), { ...o.query }), s);
}
function Le(e, t) {
...
async function A(e, t, r, i, s) {
  ...
  const a = u?.data;
  if (Z(a)) return e.styleUrl = o || null, Ne(e, a, l, s);
...
async function Ne(e, t, r, i) {
  ...
  if (t.sources && t.sources.esri) {
    ...
    l.url ? await A(e, "esri", v(s, l.url), void 0, i) : o.push(A(e, "esri", l, s, i));
  }
  for (const l of Object.keys(t.sources)) l !== "esri" && t.sources[l].type === "vector" && (t.sources[l].url ? o.push(A(e, l, v(s, t.sources[l].url), void 0, i)) : t.sources[l].tiles && o.push(A(e, l, t.sources[l], s, i)));
  await Promise.all(o);
}
async function Q(e, t, r, i, s, o) {
  const l = r ? K(r) + "/" : Y(), u = Be(t), a = new Ee(s, S(l, o?.query ?? {}), u);
...
function Be(e) {
  ...
  if (X(e)) {
    const { bounds: p } = e;
    if (p) {
      const d = L({ x: p[0], y: p[1], spatialReference: g(E) }), f = L({ x: p[2], y: p[3], spatialReference: g(E) });
      i = { xmin: d.x, ymin: d.y, xmax: f.x, ymax: f.y, spatialReference: g(j) };
    }
  }
  i === null && (i = r);
  ...
  return { capabilities: "TilesOnly", initialExtent: i, fullExtent: r, minScale: a, maxScale: n, tiles: e.tiles, tileInfo: { rows: 512, cols: 512, dpi: 96, format: "pbf", origin: { x: -20037508342787e-6, y: 20037508342787e-6 }, lods: l, spatialReference: g(j) } };
}
function Ce(e) {
...
let c = class extends pe(ce(he(ye(de(fe(me(ge(Ae(Ie))))))))) {
  ...
  async _getSourceAndStyle(e, t) {
    ...
    const r = await je(e, { ...t, query: { ...this.customParameters, token: this.apiKey } });
