import { bG as g, fh as O, bH as I, bI as V, bJ as D, bK as $, bL as z, bM as C, bN as L, Z as N } from "./main-n1d2W0Ts.js";
import { i as w, r as E, a as T } from "./TechniqueInstance-BAi6YOio.js";
import { s as F, N as k } from "./Container-CIcYD8jS.js";
import { h as c } from "./FeatureCommandQueue-CfZSbiLY.js";
import { r as P } from "./vec3f32-BS0cezmI.js";
import { b as H } from "./LabelMetric-DtXpnITF.js";
import { c as b } from "./Program-BD12nHqb.js";
import { R as v, E as U, C as y, F as x } from "./enums-DDkmfb-t.js";
import { o as W } from "./ProgramTemplate-_svae3vh.js";
let q = 0;
function h(f, t) {
  return new w(E(q++), f, t);
}
...
class J extends F {
  ...
  doRender(t) {
    ...
    e.bindVAO(this._vao), e.useProgram(a), a.setUniformMatrix3fv("u_dvsMat3", this._dvsMat3), e.gl.lineWidth(1), e.drawElements(U.LINES, 8 * s.length, y.UNSIGNED_INT, 0), e.bindVAO();
  }
  _createTransforms() {
  ...
  _updateMatricesAndLocalOrigin(t) {
    const { state: e } = t, { displayMat3: s, size: a, resolution: _, pixelRatio: n, rotation: o, viewpoint: i } = e, l = j * o, { x: r, y: M } = i.targetGeometry, R = I(r, e.spatialReference);
    this._localOrigin.x = R, this._localOrigin.y = M;
    const p = n * a[0], m = n * a[1], B = _ * p, A = _ * m, u = V(this._dvsMat3);
    D(u, u, s), $(u, u, z(p / 2, m / 2)), C(u, u, P(a[0] / B, -m / A, 1)), L(u, u, -l);
  }
...
const S = () => H("bounds", { geometry: [{ location: 0, name: "a_position", count: 2, type: y.FLOAT }] });
class nt extends T {
  constructor(t) {
    super(t), this._instanceStore = new G(), this.checkHighlight = () => !0;
  }
  destroy() {
  ...
  _renderChildren(t, e) {
    ...
    for (const s of this.children) {
      ...
      s.getDisplayList(this._instanceStore, k.STRICT_ORDER)?.render(t);
    }
  }
}
export {
...
//# sourceMappingURL=AGraphicContainer-H87dzu43.js.map
