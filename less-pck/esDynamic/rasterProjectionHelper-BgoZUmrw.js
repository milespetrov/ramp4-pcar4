import { bl as V, bm as Sn, b8 as A, bn as $, bo as O, $ as Pn, b5 as mn, a6 as G, aS as Gn, bp as kn, s as Nn, bq as v, br as T, bs as en, bt as En, bu as Tn, bv as vn, bw as on } from "./main-n1d2W0Ts.js";
var Q;
function hn(n, t, i) {
  return !kn(n, t, i);
}
...
function yn(n, t, i = null, s = !0) {
  ...
  if (e === 0 || o == null || c == null) {
    ...
    if (o == null && c != null && Math.abs(r.width - c) < k(t) && V()) {
      const l = W(a);
      if (l != null && l.poleLocation === Q.None && n.width < (l.bbox[2] - l.bbox[0]) / 2) return On(n, t) || r;
    }
    return r;
  }
...
function In(n) {
  ...
  let i;
  return U.has(t) ? i = U.get(t) : (i = (n.wkid ? v.coordsys(n.wkid) : v.fromString(T.PE_TYPE_PROJCS, n.wkt2 || n.wkt)).getGeogcs().getCode(), U.set(t, i)), new vn({ wkid: i });
}
function Jn(n) {
  ...
  if (t && (e || c > X) && (hn(f, r, n.datumTransformation) && (f.isGeographic || W(f)), i = [F, F], s = H({ ...n, spacing: i }), a = { cols: s.size[0] + 1, rows: s.size[1] + 1 }, o = sn(s.offsets, a, i, X)), s.error = o, i[0] > 1 && (s.coefficients = xn(s.offsets, a, e)), n.includeGCSGrid && !f.isGeographic && !f.isWebMercator) if (r.isGeographic) s.gcsGrid = { offsets: s.offsets, coefficients: s.coefficients, spacing: i };
    ...
    if (l != null && !l.isEnvelope) {
      const w = In(f), p = yn(n.projectedExtent, w), { offsets: x } = H({ ...n, srcBufferExtent: p, spacing: i }), m = xn(x, a, e);
...
//# sourceMappingURL=rasterProjectionHelper-BgoZUmrw.js.map
