import { ac as Oe, oi as Ee, oj as Pe, U as je, jz as qe, f0 as R, ok as Ge, am as ne, an as le, s as Ue, bv as ee, eC as Be, kO as Me, _ as P, cU as We, dv as U, ef as Ce, ol as De, om as oe, em as O, on as $e, cz as Ve, a2 as q, ey as Qe, f1 as ue, a3 as de, oo as Ze, op as ze, jc as Je, eB as Ke, gf as he, dX as Xe, a0 as Ye, eP as ce } from "./main-n1d2W0Ts.js";
import { ay as te, az as b, T as He, ap as v, aq as fe, ar as pe, as as ye, at as _e, au as ge, aF as W, aG as se, aH as et, aI as $, N as tt, aJ as st, aK as Te, B as it, aL as rt, aM as me } from "./arcadeUtils-DX3YxXnM.js";
import { O as D, s as I, a as C, n as x, t as N, r as at } from "./WhereClause-35G35EJ6.js";
import { x as A, t as g, g as E, m as V, p as T, y as nt, A as lt, w as K, E as we, T as Fe, S as Se, F as ot, v as ke, a as ut, D as Q, L as dt, d as j, b as ht, f as ct, c as m } from "./SpatialFilter-mEs1zM43.js";
import { c as ft, a as pt, n as yt } from "./TimeOnly-FGdb-oHx.js";
...
async function wt(d, e, t, s) {
  const i = t?.infoFor3D;
  if (!ve(d, i) || i == null || !e.assetMaps || !e.features?.length) return je.fromJSON(e);
  const { meshFeatureSetFromJSON: r } = await qe(import("./meshFeatureSet-B4lr4f_S.js"), s);
  return r(d, i, e);
}
function Ft(d, e) {
  let t = R.from(d);
...
let St = class extends z {
  ...
  rewriteSql(e, t) {
    const s = this.evaluateNodeToWhereClause(e.parseTree, v.Standardised, this.field.name, this.codefield instanceof D ? T(this.codefield, v.Standardised) : this.codefield, e.parameters);
...
class It extends z {
  ...
  rewriteSql(e, t) {
    return { rewritten: !0, where: V(e, this.field.name, T(this._sql, v.Standardised), t.getFieldsIndex()) };
  }
  extractValue(e) {
...
function Dt(d) {
  if (d.parseTree.type === "function") {
    ...
    const e = D.create(ut(d.parseTree.args.value[0], v.Standardised, d.parameters), d.fieldsIndex, d.timeZone);
...
let kt = class Ne extends A {
  ...
  _initialiseFeatureSet() {
    ...
    for (const a of this._decodedGroupbyfield) {
      ...
      if (a.name = this._nextUniqueName(e), n.name = a.tofieldname, n.alias = n.name, Q(a.expression)) {
        const l = this._parent.getField(T(a.expression, v.Standardised));
    ...
    for (let a = 0; a < this._decodedStatsfield.length; a++) {
      ...
      const o = u.workingexpr !== null && Q(u.workingexpr) ? T(u.workingexpr, v.Standardised) : "";
  ...
  _reformulateWhereClauseWithoutStatsFields(e) {
    for (const t of this._decodedStatsfield) e = V(e, t.tofieldname, T(t.workingexpr, v.Standardised), this._parent.getFieldsIndex());
    return e;
  }
  _reformulateWhereClauseWithoutGroupByFields(e) {
    for (const t of this._decodedGroupbyfield) t.tofieldname !== t.name && (e = V(e, t.tofieldname, T(t.expression, v.Standardised), this._parent.getFieldsIndex()));
    return e;
  }
...
class Z extends A {
  ...
  async _getPhysicalPage(e, t, s) {
    const i = e.pagesDefinition.internal.lastRetrieved, r = i, a = e.pagesDefinition.internal.lastPage, n = new R();
  ...
  async _countstat(e, t, s, i) {
    const r = await this.databaseType(), a = new R();
  ...
  async _getAgregagtePhysicalPage(e, t, s) {
    ...
    const r = e.pagesDefinition.internal.lastRetrieved, a = r, n = e.pagesDefinition.internal.lastPage, l = new R();
...
let vt = class Le extends A {
  ...
  async _getFilteredSet(e, t, s, i, r) {
    ...
    if (i !== null && (a = i.constructClause(), n = !0), this.isTable() && t && e !== null && e !== "")
      return new g([], [], !0, null);
    const l = new R();
    l.returnZ = this.hasZ, l.returnM = this.hasM, l.where = s === null ? t === null ? "1=1" : "" : T(s, v.Standardised), l.spatialRelationship = this._makeRelationshipEnum(e), l.outSpatialReference = this.spatialReference, l.orderByFields = a !== "" ? a.split(",") : null, l.geometry = t === null ? null : t, l.returnGeometry = !0, l.relationParameter = this._makeRelationshipParam(e);
...
function L(d, e = null, t = null, s = !0, i = null, r = null) {
  ...
  if (Te(d)) {
    ...
    return d.url || !d.source ? new Z(a) : new vt(a);
  }
...
async function Ot(d, e, t, s = null, i = null, r = !0, a = null, n = null) {
  ...
  return new Rt({ layer: d, relatedLayer: u, relationship: e, objectId: t, spatialReference: s, outFields: i, includeGeometry: r, lrucache: a, interceptor: n });
}
...
//# sourceMappingURL=featureSetUtils-Dij7e9oK.js.map
