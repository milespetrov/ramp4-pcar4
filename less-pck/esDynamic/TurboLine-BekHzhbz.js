import { ac as Et, f3 as bt } from "./main-n1d2W0Ts.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-CeRUO5mU.js").then((i) => i.l) : await import("./libtess-3d4YLZ_G.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-BekHzhbz.js.map
