import { rW as zt, np as si, A as $e, v as Ve, aP as zi, bd as Wi, bc as $s, B as ni, ai as Es, qz as xs, D as H, cL as Ts, cM as Hi, rX as ri, rY as lt, V as Be, cu as ks, O as o, P as l, c5 as De, _ as qe, Q as P, dH as ue, S as g, T as L, s as k, on as oi, f3 as Ls, lO as J, lP as ee, bi as Ee, lQ as Le, lR as u, rZ as I, r_ as ai, r$ as li, s0 as xe, s1 as Rs, m_ as Ps, s2 as ji, aO as Zi, s3 as Os, s4 as Re, s5 as Wt, c4 as Ns, jz as Ss, dE as Te, om as Vs, f0 as yt, f1 as vt, d3 as Bs, a2 as Ds, gf as Rt, $ as pt, s6 as qs, s7 as zs, s8 as Ws, em as Hs, s9 as js, a6 as Ht, sa as Zs, sb as Ui, sc as Us, sd as di, bU as Gs, dG as Gi, eI as _t, eG as it, Z as Qs, e_ as Qi, qf as Xi, M as Pt, cP as Xs, fi as Ue, eo as Ys, se as Ks, sf as Js, sg as ye, ac as Yi, sh as en, si as tn, sj as wt, sk as sn, sl as nn, sm as rn, sn as Qe, so as Ki, f6 as on, sp as an, dW as ln, bn as dn, f9 as cn, eE as un, du as hn, dX as ci, p5 as Ke, j9 as pn } from "./main-n1d2W0Ts.js";
import { s as re } from "./substitute-CuFAuVK2.js";
import { Z as mn, N as Ji } from "./utils-DblhnyhH.js";
...
function Bn(t, e) {
  ...
  const h = d?.format;
  return typeof t == "string" && ri(s) && h ? Dn(t, h) : typeof (t = Nn(t, h)) == "string" || t == null || h == null ? Xe(t) : $e(t, n ? { ...lt(h), minimumFractionDigits: 0, maximumFractionDigits: 20 } : lt(h));
}
function Dn(t, e) {
...
function qn({ fieldName: t, graphic: e, layer: i }) {
...
function ls(t) {
  ...
  if (c) return c;
  const h = qn({ fieldName: i, graphic: a, layer: r });
  if (h) return h;
...
function Mt({ fieldInfos: t, attributes: e, layer: i, graphic: s, fieldInfoMap: n, relatedInfos: r, timeZone: a }) {
  const d = {};
  return r?.forEach((c) => Gn({ attributes: d, relatedInfo: c, fieldInfoMap: n, fieldInfos: t, layer: i, timeZone: a })), e && Object.keys(e).forEach((c) => {
    const h = e[c];
...
function Gn({ attributes: t, relatedInfo: e, fieldInfoMap: i, fieldInfos: s, layer: n, timeZone: r }) {
...
o([l()], Q.prototype, "capabilities", void 0), o([De("capabilities")], Q.prototype, "castCapabilities", null), o([l()], Q.prototype, "activeAttachmentInfo", void 0), o([l()], Q.prototype, "activeFileInfo", void 0), o([l({ readOnly: !0, type: us })], Q.prototype, "attachmentInfos", void 0), o([l()], Q.prototype, "fileInfos", void 0), o([l({ type: qe })], Q.prototype, "graphic", void 0), o([l()], Q.prototype, "mode", void 0), o([l({ readOnly: !0 })], Q.prototype, "state", null), o([l()], Q.prototype, "filesEnabled", void 0), o([l({ readOnly: !0 })], Q.prototype, "supportsResizeAttachments", null), Q = o([P("esri.widgets.Attachments.AttachmentsViewModel")], Q);
const Qt = Q;
function _i(t) {
...
let W = class extends ee {
  ...
  normalizeCtorArgs(e) {
    return e?.viewModel || (e = { viewModel: new Qt(), ...e }), e;
  }
  initialize() {
  ...
  loadDependencies() {
    return Le({ icon: () => import("./calcite-icon-BB86-9wN.js") });
  }
  get capabilities() {
...
o([l()], W.prototype, "capabilities", null), o([l()], W.prototype, "displayType", void 0), o([l({ readOnly: !0 })], W.prototype, "effectiveDisplayType", null), o([l()], W.prototype, "graphic", null), o([l()], W.prototype, "icon", null), o([l()], W.prototype, "label", null), o([l(), J("esri/widgets/Attachments/t9n/Attachments")], W.prototype, "messages", void 0), o([l(), J("esri/core/t9n/Units")], W.prototype, "messagesUnits", void 0), o([l({ readOnly: !0 })], W.prototype, "selectedFile", void 0), o([l({ readOnly: !0 })], W.prototype, "submitting", void 0), o([l({ readOnly: !0 })], W.prototype, "error", void 0), o([l({ type: Qt })], W.prototype, "viewModel", void 0), o([l()], W.prototype, "visibleElements", void 0), o([De("visibleElements")], W.prototype, "castVisibleElements", null), W = o([P("esri.widgets.Attachments")], W);
const Jn = W;
...
o([l({ readOnly: !0 })], fe.prototype, "created", void 0), o([l()], fe.prototype, "creator", void 0), o([l()], fe.prototype, "destroyer", void 0), o([l({ type: qe })], fe.prototype, "graphic", void 0), o([l({ readOnly: !0 })], fe.prototype, "state", null), fe = o([P("esri.widgets.Feature.FeatureContent.FeatureContentViewModel")], fe);
const ut = fe;
function hs(t) {
  return (e) => {
...
async function mr(t, e, i) {
  ...
  const c = s ? null : pr(n);
  return (await Promise.all(n.map(async (h, p) => ({ value: h, color: t.type === "opacity" ? await fr(h, t) : (await import("./main-n1d2W0Ts.js").then((m) => m.sZ)).getColor(t, h), label: s ? r[p] : c?.[p] ?? "" })))).reverse();
}
async function fr(t, e, i) {
  const s = new Zi(hr), n = (await import("./main-n1d2W0Ts.js").then((r) => r.sZ)).getOpacity(e, t);
...
function xr(t, e) {
  return Ds(t, { query: { f: "json" }, signal: e?.signal });
}
...
let B = class extends ue {
  ...
  _setChartValue(e) {
    ...
    if (i.fields = kn(p, f), m && (i.normalizeField = Ge(m, f)), !p.some((v) => !!(n[v] != null || ce(v) && h?.size))) return;
  ...
  _getChartOption(e) {
    ...
    const w = as(c, a), O = Ge(a, f), he = _ && n[_] !== void 0 ? n[_] : ns(w || new ji({ fieldName: O }), this.popupTemplate?.expressionInfos), oe = n[O];
    return x.tooltip = this._getTooltip({ label: he, value: oe, chartType: h }), x;
  }
};
o([l()], B.prototype, "abilities", void 0), o([De("abilities")], B.prototype, "castAbilities", null), o([l()], B.prototype, "activeMediaInfoIndex", void 0), o([l({ readOnly: !0 })], B.prototype, "activeMediaInfo", null), o([l()], B.prototype, "attributes", void 0), o([l()], B.prototype, "description", void 0), o([l()], B.prototype, "fieldInfoMap", void 0), o([l()], B.prototype, "formattedAttributes", void 0), o([l()], B.prototype, "expressionAttributes", void 0), o([l({ readOnly: !0 })], B.prototype, "formattedMediaInfos", null), o([l()], B.prototype, "isAggregate", void 0), o([l()], B.prototype, "layer", void 0), o([l({ readOnly: !0 })], B.prototype, "formattedMediaInfoCount", null), o([l()], B.prototype, "mediaInfos", void 0), o([l()], B.prototype, "popupTemplate", void 0), o([l()], B.prototype, "relatedInfos", void 0), o([l()], B.prototype, "title", void 0), B = o([P("esri.widgets.Feature.FeatureMedia.FeatureMediaViewModel")], B);
...
let U = class extends ee {
  constructor(e, i) {
    super(e, i), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new Ie(), this.messages = null, this._disposeChart = (s) => {
      ...
      if (n || !r || !s) return;
      const { createRoot: a } = await import("./chartUtilsAm5-0wjgG7iJ.js"), d = await a(s);
  ...
  async _getSeriesColors(e) {
    const { colorAm5: i } = await import("./chartCommon-COze-y16.js"), s = /* @__PURE__ */ new Map();
    return e.forEach((n) => {
      n.color && s.set(n, i(n.color.toCss(!0)));
    }), s;
  }
  async _getRendererColors() {
    const { colorAm5: e } = await import("./chartCommon-COze-y16.js"), i = /* @__PURE__ */ new Map(), s = this._getRenderer(), n = "default";
    if (!s) return i;
    const r = await yr(s);
  ...
  async _renderChart(e) {
    const { root: i, mediaInfo: s } = e, { value: n, type: r } = s, { ResponsiveThemeAm5: a, DarkThemeAm5: d, AnimatedThemeAm5: c, ColorSetAm5: h, ThemeAm5: p, esriChartColorSet: m } = await import("./chartCommon-COze-y16.js"), f = p.new(i);
  ...
  async _customizeChartTooltip(e, i = "horizontal") {
    const { colorAm5: s } = await import("./chartCommon-COze-y16.js");
  ...
  async _createPieChart(e, i) {
    const { TooltipAm5: s } = await import("./chartCommon-COze-y16.js"), { PieChartAm5: n, PieSeriesAm5: r } = await import("./pieChart-DH4GmFLF.js"), { mediaInfo: a, root: d } = e, { title: c } = a, h = 5, p = a?.altText || a?.title || "", m = d.container.children.push(n.new(d, { ariaLabel: p, focusable: !0, paddingBottom: h, paddingTop: h, paddingLeft: h, paddingRight: h })), f = `{category}: {valuePercentTotal.formatNumber('0.00')}%
 ({value})`, y = s.new(d, { labelText: f }), v = m.series.push(r.new(d, { name: c, valueField: We, categoryField: pe, tooltip: y }));
  ...
  async _createColumnChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-COze-y16.js"), { CategoryAxisAm5: a, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, ColumnSeriesAm5: p } = await import("./xyChart-BnwFHAzv.js"), { mediaInfo: m, root: f } = i, { value: y, title: v } = m;
  ...
  async _createLineChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-COze-y16.js"), { CategoryAxisAm5: a, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, LineSeriesAm5: p } = await import("./xyChart-BnwFHAzv.js"), { root: m, mediaInfo: f } = i, { value: y, title: v } = f;
    e.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e, i) {
    const { XYChartAm5: s, XYCursorAm5: n } = await import("./xyChart-BnwFHAzv.js"), { root: r, mediaInfo: a } = e, { type: d } = a, c = a?.altText || a?.title || "", h = r.container.children.push(s.new(r, { ariaLabel: c, focusable: !0, panX: !0, panY: !0 }));
...
function Br(t) {
  return typeof t == "string" ? Xe(Gt(t)) : Array.isArray(t) ? Dr(t) : t?.declaredClass === "esri.arcade.Dictionary" ? qr(t) : t;
}
function Dr(t) {
  return `<ul class="esri-widget__list">${t.map((e) => `<li>${typeof e == "string" ? Xe(Gt(e)) : e}</li>`).join("")}</ul>`;
}
function qr(t) {
  const e = t.keys().map((i) => {
    const s = t.field(i);
    return `<tr><th>${i}</th><td>${typeof s == "string" ? Xe(Gt(s)) : s}</td></tr>`;
  }).join("");
  return `<table class="${I.table}">${e}</table>`;
}
function gs() {
  return import("./arcade-DD2X1wBU.js");
}
function zr(t) {
...
o([l()], X.prototype, "_abortController", void 0), o([l({ type: js })], X.prototype, "expressionInfo", void 0), o([l({ type: qe })], X.prototype, "graphic", void 0), o([l({ readOnly: !0 })], X.prototype, "contentElement", void 0), o([l({ readOnly: !0 })], X.prototype, "contentElementViewModel", void 0), o([l()], X.prototype, "interceptor", void 0), o([l({ type: Ht })], X.prototype, "location", void 0), o([l()], X.prototype, "spatialReference", null), o([l({ readOnly: !0 })], X.prototype, "state", null), o([l()], X.prototype, "map", null), o([l()], X.prototype, "view", void 0), X = o([P("esri.widgets.Feature.FeatureExpression.FeatureExpressionViewModel")], X);
...
let rt = class extends ee {
  ...
  loadDependencies() {
    return Le({ loader: () => import("./calcite-loader-Cjd0_4jx.js") });
  }
  destroy() {
...
let G = class extends ee {
  ...
  loadDependencies() {
    return Le({ icon: () => import("./calcite-icon-BB86-9wN.js"), list: () => import("./calcite-list-Dz0jIYYp.js"), "list-item": () => import("./calcite-list-item-DB0aMt71.js"), loader: () => import("./calcite-loader-Cjd0_4jx.js"), notice: () => import("./calcite-notice-DNBa0eyt.js") });
  }
  destroy() {
    this._unobserveRelatedFeatureObserver(), this._featureElementInfo = Qs(this._featureElementInfo);
  }
  ...
  async _handleRelatedFeatureObserverChange() {
    ...
    await Qi(0), this._relatedFeatureIntersectionObserverNode && e === "ready" && i && this._relatedFeatureIntersectionObserver.observe(this._relatedFeatureIntersectionObserverNode);
  }
...
o([l()], G.prototype, "_relatedFeatureIntersectionObserverNode", void 0), o([l({ readOnly: !0 })], G.prototype, "displayShowAllButton", null), o([l({ readOnly: !0 })], G.prototype, "displayListItems", null), o([l()], G.prototype, "description", null), o([l({ readOnly: !0 })], G.prototype, "featureCountDescription", null), o([l()], G.prototype, "headingLevel", void 0), o([l()], G.prototype, "title", null), o([l({ type: Jt })], G.prototype, "viewModel", void 0), o([l(), J("esri/widgets/Feature/t9n/Feature")], G.prototype, "messages", void 0), o([l(), J("esri/t9n/common")], G.prototype, "messagesCommon", void 0), o([l()], G.prototype, "visibleElements", void 0), o([De("visibleElements")], G.prototype, "castVisibleElements", null), G = o([P("esri.widgets.Feature.FeatureRelationship")], G);
const xi = G;
let Qr = class {
  constructor(e, i) {
...
R.interceptor = new Qr(Qn, Xn), o([l()], R.prototype, "_error", void 0), o([l()], R.prototype, "_featureAbortController", void 0), o([l({ readOnly: !0 })], R.prototype, "_effectivePopupTemplate", null), o([l({ readOnly: !0 })], R.prototype, "_fieldInfoMap", null), o([l({ readOnly: !0 })], R.prototype, "_sourceLayer", null), o([l()], R.prototype, "abilities", void 0), o([De("abilities")], R.prototype, "castAbilities", null), o([l({ readOnly: !0 })], R.prototype, "content", void 0), o([l({ readOnly: !0 })], R.prototype, "contentViewModels", void 0), o([l()], R.prototype, "description", void 0), o([l({ type: Boolean })], R.prototype, "defaultPopupTemplateEnabled", void 0), o([l({ readOnly: !0 })], R.prototype, "isTable", null), o([l({ readOnly: !0 })], R.prototype, "state", null), o([l({ readOnly: !0 })], R.prototype, "formattedAttributes", void 0), o([l({ type: qe, value: null })], R.prototype, "graphic", null), o([l({ readOnly: !0 })], R.prototype, "lastEditInfo", void 0), o([l({ type: Ht })], R.prototype, "location", void 0), o([l({ readOnly: !0 })], R.prototype, "relatedInfos", void 0), o([l()], R.prototype, "spatialReference", null), o([l()], R.prototype, "timeZone", null), o([l({ readOnly: !0 })], R.prototype, "title", void 0), o([l()], R.prototype, "map", null), o([l({ readOnly: !0 })], R.prototype, "waitingForContent", null), o([l()], R.prototype, "view", void 0), R = Ze = o([P("esri.widgets.Feature.FeatureViewModel")], R);
...
let D = Bt = class extends vs(ee) {
  ...
  loadDependencies() {
    return Le({ notice: () => import("./calcite-notice-DNBa0eyt.js"), loader: () => import("./calcite-loader-Cjd0_4jx.js") });
  }
  destroy() {
...
o([l()], D.prototype, "graphic", null), o([l()], D.prototype, "defaultPopupTemplateEnabled", null), o([l()], D.prototype, "flowItems", void 0), o([l()], D.prototype, "headingLevel", void 0), o([l({ readOnly: !0 })], D.prototype, "isTable", null), o([l()], D.prototype, "icon", null), o([l()], D.prototype, "label", null), o([l(), J("esri/widgets/Feature/t9n/Feature")], D.prototype, "messages", void 0), o([l(), J("esri/t9n/common")], D.prototype, "messagesCommon", void 0), o([l()], D.prototype, "spatialReference", null), o([l()], D.prototype, "timeZone", null), o([l({ readOnly: !0 })], D.prototype, "title", null), o([l()], D.prototype, "visibleElements", void 0), o([De("visibleElements")], D.prototype, "castVisibleElements", null), o([l()], D.prototype, "map", null), o([l()], D.prototype, "view", null), o([l({ type: ei })], D.prototype, "viewModel", void 0), D = Bt = o([P("esri.widgets.Feature")], D);
const Yr = D;
...
let we = class extends ee {
  ...
  _visibleChange(e) {
    ...
    const i = Qi(this._animationDelay);
...
let be = class extends ee {
  ...
  loadDependencies() {
    return Le({ action: () => import("./calcite-action-Bsj2Wqs1.js"), "flow-item": () => import("./calcite-flow-item-Cb25hF6_.js") });
  }
  render() {
  ...
  _renderRelatedRecordsFlowItem(e) {
    ...
    }, onCalciteFlowItemClose: this._handleCloseClick }, u("calcite-action", { appearance: "transparent", bind: this, class: q.actionExit, icon: "move-up", key: "exit-related-records-action", onclick: this._handleExitClick, slot: "header-actions-start", text: a, title: a }), r ? u("calcite-action", { appearance: "transparent", bind: this, icon: "zoom-to-object", key: "open-related-feature-action", onclick: () => this._handleOpenRelatedFeature(e), slot: "header-actions-end", text: d, title: d }) : null, u("div", { class: q.container }, e.render()));
  }
...
async function Ni(t, e) {
  ...
  const { getColor: d, getOpacity: c, getAllSizes: h, getRotationAngle: p } = await import("./main-n1d2W0Ts.js").then((w) => w.sZ), m = [], f = [], y = [], v = [];
...
const Ae = Be.ofType({ key: "type", defaultKeyValue: "button", base: rn, typeMap: { button: Qe, toggle: Ki } }), Ce = new Qe({ icon: "magnifying-glass-plus", id: "zoom-to-feature", title: "{messages.zoom}", className: de.zoomInMagnifyingGlass }), Si = new Qe({ icon: "trash", id: "remove-selected-feature", title: "{messages.remove}", className: de.trash }), Se = new Qe({ icon: "magnifying-glass-plus", id: "zoom-to-clustered-features", title: "{messages.zoom}", className: de.zoomInMagnifyingGlass }), ge = new Ki({ icon: "table", id: "browse-clustered-features", title: "{messages.browseClusteredFeatures}", className: de.table, value: !1 }), so = "esri.widgets.Popup.PopupViewModel", ht = () => H.getLogger(so), no = (t) => {
  ...
  constructor(t) {
    super(t), this._pendingPromises = new eo(), this._fetchFeaturesController = null, this._highlightSelectedFeaturePromise = null, this._highlightActiveFeaturePromise = null, this._selectedClusterFeature = null, this.actions = new Ae(), this.activeFeature = null, this.autoCloseEnabled = !1, this.browseClusterEnabled = !1, this.content = null, this.defaultPopupTemplateEnabled = !1, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = !1, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = !0, this.includeDefaultActions = !0, this.selectedClusterBoundaryFeature = new qe({ symbol: new ln({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = !1, this.view = null, this.visible = !1, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = it(async (e) => {
      ...
      if (s && s !== "mesh" && i && n && this.selectedFeature) if (s !== "point") try {
        ...
        if (a = dn(a, i), tt || (tt = await import("./geometryEngineAsync-BUYItMMD.js")), !await tt.intersects(a, n)) {
...
let A = class extends vs(ee) {
  ...
  loadDependencies() {
    return Le({ action: () => import("./calcite-action-Bsj2Wqs1.js"), "action-bar": () => import("./calcite-action-bar-ovcAAKvh.js"), "action-group": () => import("./calcite-action-group-CwElafEN.js"), button: () => import("./calcite-button-DaBWyvSH.js"), flow: () => import("./calcite-flow-DRub3gy5.js"), "flow-item": () => import("./calcite-flow-item-Cb25hF6_.js"), list: () => import("./calcite-list-Dz0jIYYp.js"), "list-item": () => import("./calcite-list-item-DB0aMt71.js"), "list-item-group": () => import("./calcite-list-item-group-CvDypVwG.js"), loader: () => import("./calcite-loader-Cjd0_4jx.js") });
  }
  destroy() {
  ...
  render() {
    return u("div", { bind: this, class: this.classes(q.base, I.widget, I.panel), onkeydown: this._onMainKeydown }, this._renderHeader(), this._renderContentContainer());
  }
  _renderFeatureNavigation() {
    return [this._renderPagination(), this._renderFeatureMenuButton()];
  }
  _renderHeader() {
    return !this.featureMenuOpen && this.featureNavigationTop && this._featureNavigationVisible ? u("div", { class: q.header, key: "header-actions" }, this._renderFeatureNavigation()) : null;
  }
  _renderFooter() {
    return this.featureMenuOpen || this.featureNavigationTop || !this._featureNavigationVisible ? null : u("div", { class: q.footer, key: "footer-actions", slot: "footer" }, this._renderFeatureNavigation());
  }
  ...
  _renderPagination() {
    ...
    return u("calcite-action-bar", { class: q.paginationActionBar, expandDisabled: !0, key: "pagination-action-bar", layout: "horizontal", overflowActionsDisabled: !0, scale: "s" }, u("calcite-action-group", { scale: "s" }, u("calcite-action", { appearance: "solid", class: q.paginationPrevious, icon: "chevron-left", iconFlipRtl: !0, label: e, onclick: this._previousFeature, scale: "s", text: e, title: e }), u("calcite-action", { appearance: "solid", icon: "chevron-right", iconFlipRtl: !0, label: i, onclick: this._nextFeature, scale: "s", text: i, title: i })));
  }
  ...
  _groupResultsByLayer() {
    ...
    return e.forEach((s) => {
      const n = s?.graphic;
      if (!n) return;
      const { layer: r, sourceLayer: a } = n, d = (Di(r) ? r : null) || (Di(a) ? a : null), c = i.get(d) ?? [];
      i.set(d, [...c, s]);
    }), i;
  }
  _renderFeatureMenu() {
  ...
  _renderContentFeature() {
    ...
    return u("calcite-flow-item", { afterCreate: this._storeRootFlowItemNode, afterUpdate: this._focusRootFlowItemNode, bind: this, class: this.classes({ [q.contentFeature]: !0, [q.flowItemCollapsed]: s }), closable: i.closeButton, closed: !d, collapsed: s, collapseDirection: r ? "down" : "up", collapsible: n, headingLevel: e, key: "root-flow-item", onCalciteFlowItemClose: this.close, onCalciteFlowItemToggle: this._handleCollapseToggle }, c ? u(Yt, { class: this.classes(q.featuresHeading, I.heading), innerHTML: c, key: "header-content", level: this.headingLevel, slot: "header-content" }) : null, this._renderHeaderActions(), this._renderActionBar(), s ? null : u("div", { class: this.classes(q.container, q.contentContainer) }, this._renderContent()), this._renderFooter());
  }
  _renderFeatureMenuContainer() {
    ...
    } }, d > 0 ? u("calcite-loader", { class: q.loader, inline: !0, key: "feature-menu-loader", label: n.loading, slot: "header-actions-end" }) : null, u("div", { class: q.container }, this._renderFeatureMenu()), u("div", { afterCreate: this._featureMenuIntersectionObserverCreated, bind: this, class: q.featureMenuObserver }), u("calcite-button", { appearance: "transparent", onclick: this._handleFeatureMenuBack, slot: "footer-actions", width: "full" }, n.back)) : null;
  }
  _renderContentContainer() {
  ...
  _getFallbackIcon(e) {
    ...
    if (s) return null;
    const n = gn({ action: e, feature: this.selectedFeature }), r = { [q.icon]: !!i, [q.actionImage]: !!n };
    return i && (r[i] = !0), n || i ? u("span", { "aria-hidden": "true", class: this.classes(q.icon, r), key: "icon", styles: fn(n) }) : null;
  }
  _renderActionBar() {
...
let Dt = class extends ii {
  constructor(t) {
    super(t);
  }
};
Dt = o([P("esri.widgets.Popup.PopupViewModel")], Dt);
const Is = Dt;
...
const qt = ne, qi = { buttonEnabled: !0, position: "auto", breakpoint: { width: 544 } };
let $ = class extends ee {
  constructor(t, e) {
    super(t, e), this._dockAction = new Qe({ id: "popup-dock-action" }), this._featuresWidget = new yo({ responsiveActionsEnabled: !0 }), this._containerNode = null, this._mainContainerNode = null, this._pointerOffsetInPx = 16, this.alignment = "auto", this.dockEnabled = !1, this.headingLevel = 2, this.messages = null, this.viewModel = new Is(), this.visibleElements = new qt();
  }
  initialize() {
  ...
  normalizeCtorArgs(t) {
    const e = { ...t };
    return t?.visibleElements != null && (e.visibleElements = new qt(t.visibleElements), t.collapseEnabled != null && (e.visibleElements.collapseButton = t.collapseEnabled), t.spinnerEnabled != null && (e.visibleElements.spinner = t.spinnerEnabled)), e;
  }
  destroy() {
  ...
  get dockOptions() {
    return this._get("dockOptions") || qi;
  }
  set dockOptions(t) {
    const e = { ...qi }, i = this.viewModel?.view?.breakpoints, s = {};
