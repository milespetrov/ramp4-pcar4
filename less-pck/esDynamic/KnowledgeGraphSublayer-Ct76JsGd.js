import { cZ as fe, ey as ge, d4 as ee, s as O, a2 as Te, c4 as j, O as a, P as l, Q as X, dH as we, D as V, f0 as A, du as de, cT as U, bn as K, b8 as Z, my as te, b5 as ye, j0 as be, iM as Ie, iN as Ee, dI as De, iL as Ne, iO as Me, dM as Se, dJ as Le, dN as Re, mz as $e, dv as W, dw as q, iP as _e, X as H, bv as ke, iR as ve, U as Ce, b6 as je, ad as R, mA as Oe, mB as xe, mC as qe, mD as Ae, iT as Fe, iU as Ge, iV as Qe, dQ as Pe, jh as Ue, ji as Je, iW as Be, mE as Ye, iX as Ve, W as We, iY as He, ek as ze, mF as Ke, ei as Ze, dX as Xe } from "./main-n1d2W0Ts.js";
import { m as et } from "./FeatureStore-DHN1QKiy.js";
import { $ as tt } from "./QueryEngine-CQ5A0Pnd.js";
import { l as it, o as z } from "./clientSideDefaults-D1T7exSR.js";
import { T as Q, r as ue } from "./knowledgeGraphService-Cn2ASkSk.js";
import { s as F } from "./GraphQueryStreaming-DGwftPd5.js";
const nt = "ESRI__DESTINATION_ID", rt = "ESRI__ORIGIN_ID";
class C {
  constructor() {
  ...
  deleteFromStore(t) {
    t.forEach((n) => {
      this._featureLookup.delete(n);
    });
  }
  readFromStoreByList(t) {
    const n = [];
    return t.forEach((i) => {
      const s = this.readFromStoreById(i);
      s && n.push(s);
    }), n;
  }
  readFromStoreById(t) {
  ...
  writeToStore(t, n, i) {
    ...
    return t.forEach((r) => {
      ...
      let p, y = null;
      if (i && r.properties[i] && (y = fe(r.properties[i])), "originId" in r && "destinationId" in r && (r.properties[rt] = r.originId, r.properties[nt] = r.destinationId), r.properties[n] = r.id, r.id && this._featureLookup.has(r.id) && this._featureLookup.get(r.id).attributes) {
        const o = this._featureLookup.get(r.id), u = JSON.parse(JSON.stringify(Object.assign(o.attributes, r.properties)));
        i && r.properties[i] && (u[i] = ge(r.properties[i])), p = new ee(y ? JSON.parse(JSON.stringify(y)) : o?.geometry ? JSON.parse(JSON.stringify(o.geometry)) : null, u, null, r.properties[n]);
      } else p = new ee(y ? JSON.parse(JSON.stringify(y)) : null, r.properties, null, r.properties[n]);
...
async function Tt(e, t) {
  const n = [], i = /* @__PURE__ */ new Map(), s = [];
  if (t.dataModel?.relationshipTypes) for (const r of t.dataModel.relationshipTypes) r.name && i.set(r.name, []);
  for (const r of e) i.has(r.typeName) && i.get(r.typeName)?.push(r.id);
  for (const [r, p] of i) {
    ...
    s.push(Q(t, y).then(async (o) => {
      ...
      for (; ; ) {
        ...
        if (D) break;
        for (const g of M) n.push({ id: g[0], typeName: g[1] }), n.push({ id: g[2], typeName: g[3] });
      }
    }));
  }
...
async function wt(e, t) {
  t ??= !1;
  const n = { generateAllSublayers: t, namedTypeDefinitions: /* @__PURE__ */ new Map() };
  return await at(e).then((i) => {
    lt(i, n);
  }), n;
}
async function bt(e) {
  const t = await ue(), n = new t.MapOfObjectIdentifierSets();
  st(n, t, e);
  const i = new t.MapOfObjectIdentifierSetsEncoder();
  try {
    i.set_map_of_identifier_sets(n), i.encode();
    const s = i.get_encoding_result();
...
function st(e, t, n) {
  for (const [i, s] of n.namedTypeDefinitions) {
    ...
    y.set_globalid_array(p), p.delete(), e.put_identifier_set(i, y), y.delete();
  }
  return e;
}
async function at(e) {
  const t = await Te(e, { responseType: "array-buffer" }), n = await t.data;
  return pt(new Uint8Array(n));
}
async function pt(e) {
  const t = new (await ue()).MapOfObjectIdentifierSetsDecoder(), n = t.decode(new Uint8Array(e)), i = /* @__PURE__ */ new Map();
  if (n.error_code !== 0) throw new O("knowledge-graph:layer-support-utils", n.error_message);
...
function lt(e, t) {
  for (const [n, i] of e) {
    const s = j(t.namedTypeDefinitions, n, () => ({ useAllData: !1, members: /* @__PURE__ */ new Map() }));
    for (const r of i) s.members.has(r) || s.members.set(r, { id: r });
  }
  return t;
}
const k = "ESRI__ID", It = "ESRI__ORIGIN_ID", Et = "ESRI__DESTINATION_ID", ce = "ESRI__LAYOUT_GEOMETRY", ae = "ESRI__AGGREGATION_COUNT";
let _ = class extends we {
  constructor(e) {
    ...
    e.knowledgeGraph.dataModel.entityTypes?.forEach((n) => {
      n.name && (t.set(n.name, "entity"), this._processingCacheUpdatesLookup.set(n.name, []), e.inclusionModeDefinition && !e.inclusionModeDefinition?.generateAllSublayers || this.entityTypeNames.add(n.name), n.properties?.forEach((i) => {
        i.geometryType && i.geometryType !== "esriGeometryNull" && this.geographicLookup.set(n.name, { name: i.name ?? "", geometryType: i.geometryType });
      }));
    }), e.knowledgeGraph.dataModel.relationshipTypes?.forEach((n) => {
      n.name && (t.set(n.name, "relationship"), this._processingCacheUpdatesLookup.set(n.name, []), e.inclusionModeDefinition && !e.inclusionModeDefinition?.generateAllSublayers || this.relationshipTypeNames.add(n.name), n.properties?.forEach((i) => {
        i.geometryType && i.geometryType !== "esriGeometryNull" && this.geographicLookup.set(n.name, { name: i.name ?? "", geometryType: i.geometryType });
      }));
    }), e.inclusionModeDefinition?.namedTypeDefinitions.forEach((n, i) => {
      if (t.get(i) === "entity") this.entityTypeNames.add(i);
      else {
        if (t.get(i) !== "relationship") return V.getLogger(this).warn(`A named type, ${i}, was in the inclusion list that wasn't in the data model and will be removed`), void e.inclusionModeDefinition?.namedTypeDefinitions.delete(i);
        this.relationshipTypeNames.add(i);
      }
      const s = /* @__PURE__ */ new Map();
      n.members?.forEach((r) => {
        j(this.memberIdTypeLookup, r.id, () => /* @__PURE__ */ new Set()).add(i);
        const p = this.getById(r.id);
        p && s.set(r.id, p);
      }), this.sublayerCaches.set(i, s);
    });
  }
  addToLayer(e) {
    e.forEach(({ typeName: t, id: n }) => {
      ...
      if (this.inclusionModeDefinition.namedTypeDefinitions.has(t)) {
        if (this.inclusionModeDefinition.namedTypeDefinitions.has(t)) {
          const i = this.inclusionModeDefinition.namedTypeDefinitions.get(t);
          i.members || (i.members = /* @__PURE__ */ new Map()), i.members.set(n, { id: n }), j(this.memberIdTypeLookup, n, () => /* @__PURE__ */ new Set()).add(t);
        }
      } else {
        const i = /* @__PURE__ */ new Map();
        i.set(n, { id: n }), this.inclusionModeDefinition.namedTypeDefinitions.set(t, { useAllData: !1, members: i }), j(this.memberIdTypeLookup, n, () => /* @__PURE__ */ new Set()).add(t);
      }
    });
  }
  getById(e) {
  ...
  async getData(e, t, n) {
    ...
    let i;
    if (i = e || new A({ where: "1=1", outFields: ["*"] }), t.parentCompositeLayer.type === "link-chart") {
      const s = t.parentCompositeLayer, r = this._processingCacheUpdatesLookup.get(t.objectType.name ?? ""), p = i.outFields;
      p && p.length === 1 && p[0] === k && i.where === "1=1" || await Promise.all(r ?? []);
    ...
    return this.retrieveDataFromService(i, t, n);
  }
  async getConnectedRecordIds(e, t) {
    ...
    if (e.forEach((p) => {
      ...
      for (const p of t) i = i + p + "|";
      i = i.slice(0, -1);
    }
    return r.forEach((p, y) => {
      let o;
      o = t && t?.length !== 0 ? `MATCH (n:${y})-[r:${i}]-(m) WHERE id(n) IN $ids RETURN id(r), type(r), id(m), labels(m)[0]` : `MATCH (n:${y})-[r]-(m) WHERE id(n) IN $ids RETURN id(r), type(r), id(m), labels(m)[0]`;
          ...
          try {
            for (; ; ) {
              ...
              for (let f = 0; f < I.length; f++) {
                const c = I[f];
                n.push({ id: c[0], typeName: c[1] }), n.push({ id: c[2], typeName: c[3] });
              }
            }
          } catch (g) {
      ...
      s.push(u);
    }), this.refreshCacheContent(), await Promise.all(s), n;
  }
  async getAttachedRelationships(e, t) {
    const n = [], i = "MATCH (n)-[r]->(m) WHERE id(n) IN $nodeIds AND id(m) in $nodeIds AND NOT id(r) IN $relationshipExclusionIds return id(r), type(r)", s = (await Q(this.knowledgeGraph, new F({ openCypherQuery: i, bindParameters: { nodeIds: e, relationshipExclusionIds: t } }))).resultRowsStream.getReader();
    try {
      for (; ; ) {
  ...
  async refreshCacheContent(e, t, n, i = !0) {
        ...
        (async () => {
          ...
          for (; ; ) {
            ...
            for (let w = 0; w < b.length; w++) {
              ...
              let v = 0, J = 0;
              const L = { properties: {} };
              for (L.id = G[v], v++, J++, E && (L.originId = G[v], v++, J++, L.destinationId = G[v], v++, J++, j(this.nodeConnectionsLookup, L.originId, () => /* @__PURE__ */ new Set()).add(L.id), j(this.nodeConnectionsLookup, L.destinationId, () => /* @__PURE__ */ new Set()).add(L.id), j(this.relationshipConnectionsLookup, L.id, () => [L.originId, L.destinationId])); v < G.length; v++) L.properties[f[v - J]] = G[v];
              T.push(L);
            }
            const h = s.writeToStore(T, k, this.geographicLookup.get(o)?.name);
            this.sublayerCaches.has(o) || this.sublayerCaches.set(o, /* @__PURE__ */ new Map()), i && !this.inclusionModeDefinition?.namedTypeDefinitions.has(o) && this.inclusionModeDefinition?.namedTypeDefinitions.set(o, { useAllData: !1, members: /* @__PURE__ */ new Map() }), i && !this.inclusionModeDefinition?.namedTypeDefinitions.get(o).members && (this.inclusionModeDefinition.namedTypeDefinitions.get(o).members = /* @__PURE__ */ new Map());
            const x = this.sublayerCaches.get(o);
            h.forEach((w) => {
              x?.set(w.attributes[k], w), i && !this.inclusionModeDefinition?.namedTypeDefinitions.get(o).members.has(w.attributes[k]) && (this.inclusionModeDefinition?.namedTypeDefinitions.get(o).members.set(w.attributes[k], { id: w.attributes[k] }), j(this.memberIdTypeLookup, w.attributes[k], () => /* @__PURE__ */ new Set()).add(o));
            });
          }
        })().then(() => {
          M(null);
  ...
  removeFromLayer(e) {
    const t = /* @__PURE__ */ new Set(), n = new Set(e.map((i) => i.id));
    for (const i of e) t.add(i.typeName), this.memberIdTypeLookup.get(i.id)?.size === 1 ? this.memberIdTypeLookup.delete(i.id) : this.memberIdTypeLookup.get(i.id)?.delete(i.typeName), this.inclusionModeDefinition?.namedTypeDefinitions.forEach((s, r) => {
      r === i.typeName && s.members?.has(i.id) && s.members.delete(i.id);
    });
    t.forEach((i) => {
      this.sublayerCaches.get(i)?.forEach((s, r) => {
        n.has(r) && this.sublayerCaches.get(i)?.delete(r);
      });
    });
  }
  async retrieveDataFromService(e, t, n) {
    const i = C.getInstance(), s = /* @__PURE__ */ new Set(), r = [];
    let p, y = "", o = [];
    ...
    if (e.outFields != null) {
      ...
      f.includes("*") ? t.fields.forEach((c) => {
        ...
        c !== k && c !== t.geometryFieldName && s.add(c);
      });
    }
    if (e.geometry != null) {
      const f = e.geometry;
      ...
      if (e.where != null && e.where !== "1=1") {
        ...
        const T = (h) => {
          ...
          if (h.type === "binary-expression" && h.operator === "LIKE") {
            let x = "";
            if (h.left.type === "function" && h.left.args.value[0].type === "column-reference") x += `lower(n.${h.left.args.value[0].column})`;
            else {
              if (h.left.type !== "column-reference") return b = !0, "";
              x += `lower(n.${h.left.column})`;
            }
            if (x += " CONTAINS (", h.right.type !== "string") return b = !0, "";
            {
              let w = h.right.value;
              w.charAt(0) === "%" && (w = w.slice(1)), w.charAt(w.length - 1) === "%" && (w = w.slice(0, -1)), x += `'${w.toLowerCase()}')`;
            }
            return x;
          }
          return b = !0, "";
    ...
    const I = (await Q(t.parentCompositeLayer.dataManager.knowledgeGraph, p, n)).resultRowsStream.getReader();
    for (; ; ) {
      ...
      o = o.concat(i.writeToStore(N, k, t.parentCompositeLayer.dataManager.geographicLookup.get(t.objectType.name)?.name));
    }
    return o;
  }
};
a([l()], _.prototype, "knowledgeGraph", void 0), a([l()], _.prototype, "inclusionModeDefinition", void 0), a([l()], _.prototype, "entityTypeNames", void 0), a([l()], _.prototype, "relationshipTypeNames", void 0), a([l()], _.prototype, "geographicLookup", void 0), a([l()], _.prototype, "sublayerCaches", void 0), a([l()], _.prototype, "nodeConnectionsLookup", void 0), a([l()], _.prototype, "relationshipConnectionsLookup", void 0), a([l()], _.prototype, "memberIdTypeLookup", void 0), _ = a([X("esri.layers.knowledgeGraph.KnowledgeGraphLayerDataManager")], _);
const pe = be(), dt = (e) => {
...
function yt(e) {
  const { target: t, writer: n, overridePolicy: i, ...s } = e;
  return function(r, p) {
...
function he(e, t) {
  const n = !!this.geometryType;
  let i = { enabled: n };
  return n && (i = { ...i, ...me.call(this, e, t) }), i;
}
function me(e, t) {
  return { ignoreOrigin: this.originIdOf(t) > Ze.DEFAULTS };
}
let d = class extends dt(Ie(Ee(De(Ne(Me(Se(Le(Re(Xe))))))))) {
  constructor(e) {
    super(e), this.blendMode = "normal", this.capabilities = it(!1, !1), this.charts = null, this.definitionExpression = null, this.displayField = "", this.effect = null, this.elevationInfo = null, this.featureEffect = null, this.graphType = null, this.labelsVisible = !0, this.labelingInfo = null, this.layerType = null, this.legendEnabled = !0, this.maxScale = 0, this.minScale = 0, this.objectIdField = k, this.objectType = null, this.opacity = 1, this.orderBy = null, this.parentCompositeLayer = null, this.persistenceEnabled = !0, this.popupEnabled = !0, this.popupTemplate = null, this.refreshInterval = 0, this.source = { openPorts: () => this.load().then(() => {
      const t = new MessageChannel();
      return new $e(t.port1, { channel: t, client: { queryFeatures: (n, i = {}) => {
        const s = A.fromJSON(n);
        return this.queryFeaturesJSON(s, i);
      } } }), [t.port2];
  ...
  get fields() {
    ...
    return this.objectType?.properties?.forEach((t) => {
      const n = t.fieldType === "esriFieldTypeOID" ? "esriFieldTypeInteger" : t.fieldType;
      e.push(W.fromJSON({ name: t.name, type: n, alias: t.alias, defaultValue: t.defaultValue, editable: t.editable, nullable: t.nullable }));
    }), e.push(W.fromJSON({ name: this.objectIdField, type: "esriFieldTypeString", alias: this.objectIdField, editable: !1 }), W.fromJSON({ name: ae, type: "esriFieldTypeInteger", alias: ae, editable: !1 })), e;
  }
  get geometryType() {
    ...
    return t && t !== "esriGeometryNull" ? q.fromJSON(t) : null;
  }
  ...
  set renderer(e) {
    _e(e, this.fieldsIndex), this._set("renderer", e);
  }
  get renderer() {
    return this._isOverridden("renderer") ? this._get("renderer") : this.parentCompositeLayer?.type === "link-chart" ? this.graphType === "relationship" ? H(z(q.toJSON("polyline")).renderer) : H(z(q.toJSON("point")).renderer) : H(z(q.toJSON(this.geometryType)).renderer);
  }
  get spatialReference() {
    return this.parentCompositeLayer?.dataManager?.knowledgeGraph?.dataModel?.spatialReference ?? ke.WGS84;
  }
  writeTitle(e, t) {
    t.title = e ?? "Layer";
  }
  ...
  createQuery() {
    return new A({ where: "1=1", outFields: ["*"] });
  }
  getField(e) {
  ...
  async queryFeatures(e, t) {
    const { resolvedQuery: n, queryEngine: i } = await this._setupQueryObjects(e), s = Ce.fromJSON(await i.executeQuery(n.toJSON(), t?.signal));
    return s.features.forEach((r) => {
      r.sourceLayer = this;
    }), s;
  }
  async queryFeaturesJSON(e, t) {
    const { resolvedQuery: n, queryEngine: i } = await this._setupQueryObjects(e);
    return await i.executeQuery(n.toJSON(), t?.signal);
  }
  async queryFeatureCount(e, t) {
    const { resolvedQuery: n, queryEngine: i } = await this._setupQueryObjects(e);
    return i.executeQueryForCount(n.toJSON(), t?.signal);
  }
  async queryExtent(e = {}, t) {
    const n = { ...e, returnGeometry: !0 }, { resolvedQuery: i, queryEngine: s } = await this._setupQueryObjects(n), r = await s.executeQueryForExtent(i.toJSON(), t?.signal);
    let p;
  ...
  async queryObjectIds(e, t) {
    const n = A.from(e);
    let i;
    if (this.parentCompositeLayer.type === "link-chart" && this._cachedQueryEngine) i = this._cachedQueryEngine;
    else {
      const s = await this.parentCompositeLayer.dataManager.getData(n, this, t);
      i = this.loadQueryEngine(s);
    }
    return i.executeQueryForIds(n.toJSON(), t?.signal);
  }
  loadQueryEngine(e) {
    const t = new et({ geometryType: q.toJSON(this.geometryType), hasM: this.hasM, hasZ: this.hasZ }), n = new tt({ fieldsIndex: this.fieldsIndex.toJSON(), geometryType: q.toJSON(this.geometryType), hasM: this.hasM, hasZ: this.hasZ, objectIdField: this.objectIdField, spatialReference: this.spatialReference.toJSON(), timeInfo: null, featureStore: t });
    return n.featureStore.addMany(e), n;
  }
  async refreshCachedQueryEngine() {
    const e = await this.parentCompositeLayer.dataManager.getData(new A({ where: "1=1", outFields: [k] }), this);
    this._cachedQueryEngine = this.loadQueryEngine(e);
  }
  async _setupQueryObjects(e, t) {
    const n = A.from(e), i = n.geometry;
    let s;
    if (i && !i.spatialReference?.isWGS84 && (await de(i.spatialReference, U), n.geometry = K(i instanceof ye || i instanceof je ? i : i.extent, U)), this.parentCompositeLayer.type === "link-chart" && this._cachedQueryEngine) s = this._cachedQueryEngine;
    else {
      const r = await this.parentCompositeLayer.dataManager.getData(n, this, t);
      s = this.loadQueryEngine(r);
    }
    return { resolvedQuery: n, queryEngine: s };
  }
};
a([l($(R(Oe)))], d.prototype, "blendMode", void 0), a([l()], d.prototype, "capabilities", void 0), a([l({ json: { origins: { "web-scene": { write: !1 } }, write: P() } })], d.prototype, "charts", void 0), a([l({ readOnly: !0 })], d.prototype, "defaultPopupTemplate", null), a([l({ type: String, json: { origins: { service: { read: !1 } }, name: "layerDefinition.definitionExpression", write: { ignoreOrigin: !0 } } })], d.prototype, "definitionExpression", void 0), a([l()], d.prototype, "displayField", void 0), a([l($(R(xe)))], d.prototype, "effect", void 0), a([l()], d.prototype, "elevationInfo", void 0), a([l($(R(qe)))], d.prototype, "featureEffect", void 0), a([l($(R(Ae)))], d.prototype, "featureReduction", null), a([l()], d.prototype, "fields", null), a([l()], d.prototype, "geometryType", null), a([l()], d.prototype, "geometryFieldName", null), a([l({ type: ["entity", "relationship"], nonNullable: !0, json: { write: { isRequired: !0, ignoreOrigin: !0 } } })], d.prototype, "graphType", void 0), a([l({ type: String, nonNullable: !0, json: { write: { isRequired: !0, ignoreOrigin: !0 } } })], d.prototype, "graphTypeName", null), a([l()], d.prototype, "hasM", null), a([l()], d.prototype, "hasZ", null), a([l({ type: String, json: { origins: { service: { read: !1 }, "portal-item": { read: !1 } }, write: { ignoreOrigin: !0 } } })], d.prototype, "id", void 0), a([l($(R(Fe)))], d.prototype, "labelsVisible", void 0), a([l({ type: [Ge], json: { name: "layerDefinition.drawingInfo.labelingInfo", read: Qe, write: P() } })], d.prototype, "labelingInfo", void 0), a([l({ readOnly: !0, json: { read: !1, write: { writer(e, t) {
  t.layerType = this.geometryType ? "KnowledgeGraphSubLayer" : "KnowledgeGraphSubTable";
}, isRequired: !0, ignoreOrigin: !0, writerEnsuresNonNull: !0 } } })], d.prototype, "layerType", void 0), a([l($(R(Pe)))], d.prototype, "legendEnabled", void 0), a([l($(R(Ue)))], d.prototype, "maxScale", void 0), a([l($(R(Je)))], d.prototype, "minScale", void 0), a([l()], d.prototype, "objectIdField", void 0), a([l()], d.prototype, "objectType", void 0), a([l($(R(Be)))], d.prototype, "opacity", void 0), a([l($(R(Ye)))], d.prototype, "orderBy", void 0), a([l()], d.prototype, "parentCompositeLayer", void 0), a([l($(R(Ve)))], d.prototype, "popupEnabled", void 0), a([l({ type: We, json: { name: "popupInfo", write: { ignoreOrigin: !0 } } })], d.prototype, "popupTemplate", void 0), a([l({ type: Number, json: { write: { overridePolicy: me } } })], d.prototype, "refreshInterval", void 0), a([l({ types: He, json: { name: "layerDefinition.drawingInfo.renderer", write: P() } })], d.prototype, "renderer", null), a([l()], d.prototype, "source", void 0), a([l()], d.prototype, "spatialReference", null), a([l({ type: String, json: { write: { isRequired: !0, ignoreOrigin: !0, writerEnsuresNonNull: !0 } } })], d.prototype, "title", void 0), a([ze("title")], d.prototype, "writeTitle", null), a([l({ json: { read: !1 } })], d.prototype, "type", void 0), a([l($(R(Ke)))], d.prototype, "useViewTime", void 0), a([l({ type: Boolean, json: { name: "visibility", write: P() } })], d.prototype, "visible", void 0), d = a([X("esri.layers.knowledgeGraph.KnowledgeGraphSublayer")], d);
const Dt = d;
export {
  ce as D,
  bt as E,
...
//# sourceMappingURL=KnowledgeGraphSublayer-Ct76JsGd.js.map
