import { O as t, P as s, q3 as V, Q as A, bV as j, dV as Z, q4 as fe, q5 as et, dT as he, dW as tt, dB as R, dO as N, ek as G, s as M, c0 as me, a2 as X, ny as be, z as rt, b$ as Fe, D as Ue, eO as Ee, a6 as Ge, _ as K, b6 as Te, b8 as qe, U as x, bv as q, $ as We, al as ot, q6 as st, bU as $e, mm as it, ey as nt, c2 as at, V as O, dI as lt, dM as ut, dK as pt, dL as ct, dN as yt, bi as dt, er as mt, b7 as ft, cT as Le, a4 as Ie, oU as ht, I as vt, a0 as wt, C as gt, f as St, M as bt, jd as Tt, W as Bt, du as Nt, bn as Pt, g5 as $t, dX as Rt } from "./main-n1d2W0Ts.js";
import { i as At } from "./originUtils-BLsWtgV9.js";
import { a as H, D as Re, o as Ot, q as Lt, b as Ve, d as Ae, P as It, n as jt, e as Dt, f as Mt, R as Ct, M as je, l as _t, U as kt, r as Jt, g as xt, m as Ft, c as pe, y as ce, C as re, T as oe, j as se, w as ie, S as ve, h as Ut } from "./Stop-Cs7jGZ9Q.js";
let U = class extends j {
  constructor(r) {
    super(r), this.break = new Z({ color: [255, 255, 255], size: 12, outline: { color: [0, 122, 194], width: 3 } }), this.first = new Z({ color: [0, 255, 0], size: 20, outline: { color: [255, 255, 255], width: 4 } }), this.unlocated = new Z({ color: [255, 0, 0], size: 12, outline: { color: [255, 255, 255], width: 3 } }), this.last = new Z({ color: [255, 0, 0], size: 20, outline: { color: [255, 255, 255], width: 4 } }), this.middle = new Z({ color: [51, 51, 51], size: 12, outline: { color: [0, 122, 194], width: 3 } }), this.waypoint = new Z({ color: [255, 255, 255], size: 12, outline: { color: [0, 122, 194], width: 3 } });
  }
};
t([s({ types: V })], U.prototype, "break", void 0), t([s({ types: V })], U.prototype, "first", void 0), t([s({ types: V })], U.prototype, "unlocated", void 0), t([s({ types: V })], U.prototype, "last", void 0), t([s({ types: V })], U.prototype, "middle", void 0), t([s({ types: V })], U.prototype, "waypoint", void 0), U = t([A("esri.layers.support.RouteStopSymbols")], U);
const Ze = U;
let k = class extends j {
  constructor(r) {
    super(r), this.directionLines = new he({ color: [0, 122, 194], width: 6 }), this.directionPoints = new Z({ color: [255, 255, 255], size: 6, outline: { color: [0, 122, 194], width: 2 } }), this.pointBarriers = new Z({ style: "x", size: 10, outline: { color: [255, 0, 0], width: 3 } }), this.polygonBarriers = new tt({ color: [255, 170, 0, 0.6], outline: { width: 7.5, color: [255, 0, 0, 0.6] } }), this.polylineBarriers = new he({ width: 7.5, color: [255, 85, 0, 0.7] }), this.routeInfo = new he({ width: 8, color: [20, 89, 127] }), this.stops = new Ze();
  }
};
t([s({ types: fe })], k.prototype, "directionLines", void 0), t([s({ types: V })], k.prototype, "directionPoints", void 0), t([s({ types: V })], k.prototype, "pointBarriers", void 0), t([s({ types: et })], k.prototype, "polygonBarriers", void 0), t([s({ types: fe })], k.prototype, "polylineBarriers", void 0), t([s({ types: fe })], k.prototype, "routeInfo", void 0), t([s({ type: Ze })], k.prototype, "stops", void 0), k = t([A("esri.layers.support.RouteSymbols")], k);
const ze = k;
...
t([s({ type: Number })], W.prototype, "buildTime", void 0), t([s({ type: String })], W.prototype, "name", void 0), t([s({ type: [Et] })], W.prototype, "networkAttributes", void 0), t([s()], W.prototype, "networkSources", void 0), t([s({ type: String })], W.prototype, "state", void 0), W = t([A("esri.rest.support.NetworkDataset")], W);
const Gt = W;
let $ = class extends j {
  constructor(r) {
...
async function Ke(e, r, o) {
  ...
  const i = me({ f: "json", token: r }, o), { data: n } = await X(e, i), y = n.currentVersion >= 10.4 ? Kt(e, r, o) : zt(e, o), { defaultTravelMode: u, supportedTravelModes: d } = await y;
  return n.defaultTravelMode = u, n.supportedTravelModes = d, qt.fromJSON(n);
}
async function zt(e, r) {
  const o = me({ f: "json" }, r), { data: i } = await X(e.replace(/\/rest\/.*$/i, "/info"), o);
  if (!i?.owningSystemUrl) return { supportedTravelModes: [], defaultTravelMode: null };
  const { owningSystemUrl: n } = i, y = be(n) + "/sharing/rest/portals/self", { data: u } = await X(y, o), d = rt("helperServices.routingUtilities.url", u);
  if (!d) return { supportedTravelModes: [], defaultTravelMode: null };
  const g = Fe(n), h = /\/solve$/i.test(g.path) ? "Route" : /\/solveclosestfacility$/i.test(g.path) ? "ClosestFacility" : "ServiceAreas", a = me({ f: "json", serviceName: h }, r), b = be(d) + "/GetTravelModes/execute", P = await X(b, a), T = [];
  let m = null;
...
async function Kt(e, r, o) {
  try {
    const i = me({ f: "json", token: r }, o), n = be(e) + "/retrieveTravelModes", { data: { supportedTravelModes: y, defaultTravelMode: u } } = await X(n, i);
...
const De = new Ee({ esriJobMessageTypeInformative: "informative", esriJobMessageTypeProcessDefinition: "process-definition", esriJobMessageTypeProcessStart: "process-start", esriJobMessageTypeProcessStop: "process-stop", esriJobMessageTypeWarning: "warning", esriJobMessageTypeError: "error", esriJobMessageTypeEmpty: "empty", esriJobMessageTypeAbort: "abort" });
let Y = class extends j {
  constructor(r) {
    super(r), this.description = null, this.type = null;
  }
};
t([s({ type: String, json: { write: !0 } })], Y.prototype, "description", void 0), t([s({ type: String, json: { read: De.read, write: De.write } })], Y.prototype, "type", void 0), Y = t([A("esri.rest.support.GPMessage")], Y);
const Ht = Y, Me = new Ee({ 0: "informative", 1: "process-definition", 2: "process-start", 3: "process-stop", 50: "warning", 100: "error", 101: "empty", 200: "abort" });
...
t([s({ json: { read: { source: "string" } } })], ee.prototype, "text", void 0), t([R(It, { name: "stringType" })], ee.prototype, "type", void 0), ee = t([A("esri.rest.support.DirectionsString")], ee);
const He = ee;
...
t([s({ type: Date, json: { read: { source: "arriveTimeUTC" } } })], E.prototype, "arriveTime", void 0), t([s()], E.prototype, "arriveTimeOffset", void 0), t([N("arriveTimeOffset", ["arriveTimeUTC", "ETA"])], E.prototype, "readArriveTimeOffset", null), t([s({ type: Ge })], E.prototype, "geometry", void 0), t([N("geometry", ["point"])], E.prototype, "readGeometry", null), t([s({ type: [He] })], E.prototype, "strings", void 0), E = t([A("esri.rest.support.DirectionsEvent")], E);
const Xt = E;
function Yt(e) {
...
let Q = class extends K {
  ...
  readGeometry(e, r) {
    const o = Yt(r.compressedGeometry);
    return o != null ? Te.fromJSON(o) : null;
  }
};
t([s({ type: [Xt] })], Q.prototype, "events", void 0), t([N("geometry", ["compressedGeometry"])], Q.prototype, "readGeometry", null), t([s({ type: [He] })], Q.prototype, "strings", void 0), Q = t([A("esri.rest.support.DirectionsFeature")], Q);
const er = Q;
function tr(e, r) {
...
t([s({ type: qe, json: { read: { source: "summary.envelope" } } })], I.prototype, "extent", void 0), t([s({ nonNullable: !0 })], I.prototype, "features", void 0), t([N("features")], I.prototype, "readFeatures", null), t([s()], I.prototype, "geometryType", void 0), t([s({ readOnly: !0 })], I.prototype, "mergedGeometry", null), t([s()], I.prototype, "routeId", void 0), t([s()], I.prototype, "routeName", void 0), t([s({ value: null, readOnly: !0 })], I.prototype, "strings", null), t([s({ json: { read: { source: "summary.totalDriveTime" } } })], I.prototype, "totalDriveTime", void 0), t([s({ json: { read: { source: "summary.totalLength" } } })], I.prototype, "totalLength", void 0), t([s({ json: { read: { source: "summary.totalTime" } } })], I.prototype, "totalTime", void 0), I = t([A("esri.rest.support.DirectionsFeatureSet")], I);
const rr = I;
...
t([s({ type: [Qt] })], _.prototype, "messages", void 0), t([s({ type: [K] })], _.prototype, "pointBarriers", void 0), t([N("pointBarriers", ["barriers"])], _.prototype, "readPointBarriers", null), t([s({ type: [K] })], _.prototype, "polylineBarriers", void 0), t([N("polylineBarriers")], _.prototype, "readPolylineBarriers", null), t([s({ type: [K] })], _.prototype, "polygonBarriers", void 0), t([N("polygonBarriers")], _.prototype, "readPolygonBarriers", null), t([s({ type: [or] })], _.prototype, "routeResults", void 0), _ = t([A("esri.rest.support.RouteSolveResult")], _);
const sr = _;
function ae(e) {
...
async function ir(e, r, o) {
  ...
  const a = { ...o, query: { ...d.query, ...Dt(r), f: "json" } }, b = g.endsWith("/solve") ? g : `${g}/solve`, { data: P } = await X(b, a);
  return nr(P);
}
function nr(e) {
...
t([s({ type: Boolean, json: { write: !0 } })], J.prototype, "doNotLocateOnRestrictedElements", void 0), t([s({ types: it, json: { read: nt, write: !0 } })], J.prototype, "geometry", void 0), t([R(Mt)], J.prototype, "geometryType", void 0), t([s({ type: String, json: { name: "layerName", write: !0 } })], J.prototype, "name", void 0), t([R(Ct, { name: "spatialRel" })], J.prototype, "spatialRelationship", void 0), t([s({ type: String, json: { write: !0 } })], J.prototype, "type", void 0), t([s({ type: String, json: { write: !0 } })], J.prototype, "where", void 0), J = t([A("esri.rest.support.DataLayer")], J);
const lr = J;
var Be;
...
function gr(e, r, o) {
  ...
  if (y == null) return void Xe().warn("route-layer:missing-travel-mode", "The routing service must have a default travel mode or one must be specified in the route parameter.");
...
let v = class extends lt(ut(pt(ct(yt(Rt))))) {
  ...
  get url() {
    return Ie.routeServiceUrl;
  }
  set url(e) {
    e != null ? this._set("url", ht(e, Xe())) : this._set("url", Ie.routeServiceUrl);
  }
  load(e) {
  ...
  _getNetworkFeatures(e, r, o, i) {
    ...
    const { layerDefinition: u, popupInfo: d, featureSet: g } = y, h = u.drawingInfo.renderer, { features: a } = g, b = g.spatialReference ?? u.spatialReference ?? u.extent.spatialReference ?? Le, P = h && Tt(h), T = q.fromJSON(b), m = a.map((f) => {
