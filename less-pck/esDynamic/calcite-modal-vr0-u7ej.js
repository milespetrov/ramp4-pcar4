import { jM as M, cE as T, cF as F, ex as r, cA as o, cG as S } from "./main-n1d2W0Ts.js";
import { c as $, d as L } from "./conditionalSlot-CGS4uFm7.js";
import { n as c, l as f, o as B, p as g } from "./dom-BHTTQ4_z.js";
import { d, a as v, c as D, u as H } from "./focusTrapComponent-DbzWw8yI.js";
import { s as I, a as A, c as V } from "./loadable-DHg7a56u.js";
import { c as x } from "./observers-X2ZOvJBq.js";
import { o as W } from "./openCloseComponent-DQy26FB5.js";
import { c as P, d as j } from "./locale-Ksjr9aYY.js";
import { s as _, c as U, d as q, u as G } from "./t9n-D3N8cevx.js";
import { g as R, c as J } from "./component-CWGf1hug.js";
import { d as K } from "./icon-CffnFU39.js";
import { d as Q } from "./loader-DcRZn3Xd.js";
import { d as X } from "./scrim-bc7c-gsP.js";
...
const z = /* @__PURE__ */ T(class extends F {
  constructor() {
  ...
  async componentWillLoad() {
    await _(this), I(this), this.open && this.openModal();
  }
  componentDidLoad() {
    A(this);
  }
  connectedCallback() {
    this.mutationObserver?.observe(this.el, { childList: !0, subtree: !0 }), this.cssVarObserver?.observe(this.el, { attributeFilter: ["style"] }), this.updateSizeCssVars(), this.updateFooterVisibility(), $(this), P(this), U(this), D(this);
  }
  disconnectedCallback() {
    this.removeOverflowHiddenClass(), this.mutationObserver?.disconnect(), this.cssVarObserver?.disconnect(), L(this), d(this), j(this), q(this), this.embedded = !1;
  }
  render() {
    return o(S, { key: "f92cd77f4a5ad4a245ca50fe2b2bfcf9966d4ca8", "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, o("div", { key: "a9d348a67842162f1bc17ec8422c07963aed412d", class: {
      [t.container]: !0,
  ...
  renderCloseButton() {
    return this.closeButtonDisabled ? null : o("button", { "aria-label": this.messages.close, class: t.close, key: "button", onClick: this.handleCloseClick, ref: (e) => this.closeButtonEl = e, title: this.messages.close }, o("calcite-icon", { icon: ee.close, scale: R(this.scale) }));
  }
  renderStyle() {
  ...
  async openModal() {
    await J(this.el), this.el.addEventListener("calciteModalOpen", this.openEnd), this.opened = !0;
...
//# sourceMappingURL=calcite-modal-vr0-u7ej.js.map
