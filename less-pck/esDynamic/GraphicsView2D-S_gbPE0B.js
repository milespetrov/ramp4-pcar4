import { cy as V, cZ as L, lm as W, d5 as x, m0 as z, m1 as N, m2 as B, aR as g, m3 as X, aM as A, ac as _, bH as Q, m4 as Y, m5 as J, aS as K, aZ as ee, cN as M, dG as te, cU as se, S as re, $ as ie, eI as oe, dm as ae, aY as ne, m6 as he, aX as de, m7 as ce, m8 as le, m9 as ue, kO as pe, O as m, P as y, Q as me, dH as ye } from "./main-n1d2W0Ts.js";
import { l as k, $ as _e, u as O, Z as q, d as ge, W as fe, b as be } from "./UpdateTracking2D-BihgDBEV.js";
import { a as S, S as we, T as Ie, W as Se, N as ve } from "./definitions-Doe0g1C2.js";
import { b as xe } from "./WGLContainer-C_1Nh_ee.js";
import { M as Re, p as Te, b as Me, l as Ge, a as $e, n as Ce } from "./AttributeStore-GRl8PvEZ.js";
import { t as ze, y as Oe, z as Ue, a as Pe, p as ke, b as qe, u as Ee, x as E, c as je, d as Ve } from "./FeatureCommandQueue-CfZSbiLY.js";
import { a as Ae } from "./normalizeUtilsSync-D4n7itZU.js";
import { x as Fe, j as De } from "./timeSupport-BajsmNHb.js";
async function He(r, e, t) {
  const s = [], i = { scaleInfo: ze(r), scaleExpression: null };
  for (const o of e) switch (o.type) {
    case "marker":
      s.push(...Ee(t.instances.marker, o, E, i));
      break;
    case "fill":
      o.spriteRasterizationParam == null ? s.push(...ke(t.instances.fill, o, i)) : s.push(...qe(t.instances.complexFill, o, !1, i));
      break;
    case "line":
      o.spriteRasterizationParam ? s.push(...Ue(t.instances.texturedLine, o, !1, i)) : s.push(...Pe(t.instances.line, o, !1, i));
      break;
    case "text":
      s.push(...Oe(t.instances.text, o, E, i));
  }
  return s;
}
class G extends Re {
  ...
  get geometryType() {
    const e = V(this._current.geometry);
  ...
  copy() {
    const e = new G(this._items, this._tile, this.metadata);
...
class U {
  static fromGraphic(e, t, s, i) {
    return new U(e.geometry, t, { ...e.attributes }, e.visible, e.uid, s, i);
  }
  ...
  async projectAndNormalize(e) {
    ...
    t.type === "extent" && (t = k(t)), await Fe(t.spatialReference, e);
    const s = Ae(t);
    if (!s) return;
    const i = De(s, t.spatialReference, e);
    i && X(i), this.projectedGeometry = A(i) ? k(i) : i;
  }
}
class Ze {
  constructor(e, t, s) {
...
class We {
  ...
  async update(e, t, s) {
    ...
    return await Promise.all(l), this._index = null, new Ze(i, o, a);
  }
  updateLevel(e) {
  ...
  hitTest(e, t, s, i, o) {
    ...
    const f = 0.5 * i * (l + O), b = this._searchIndex(e - f, t - f, e + f, t + f);
    if (!b || b.length === 0) return [];
    const w = [], P = g(), R = g();
    for (const I of b) {
      if (!I.visible) continue;
      const { projectedGeometry: C, symbolResource: T } = I;
      this._getSymbolBounds(P, T, C, R, o), R[3] = R[2] = R[1] = R[0] = 0, Y(P, h) && w.push(I);
    }
    if (w.length === 0) return [];
    const F = this._hittestDrawHelper, $ = [];
    for (const I of w) {
      const { projectedGeometry: C, symbolResource: T } = I;
      if (!T) continue;
      const { textInfo: D, symbolInfo: H } = T, Z = H.cimSymbol;
      F.hitTest(u, Z.symbol, C, D, o, i) && $.push(I);
    }
    return $.sort(Le), $.map((I) => I.objectId);
  }
  queryItems(e) {
  ...
  _searchForItems(e) {
    ...
    if (i && t.isWrappable) {
      const [o, a] = i.valid, n = Math.abs(s[2] - a) < j, l = Math.abs(s[0] - o) < j;
      if ((!n || !l) && (n || l)) {
        const d = e.resolution;
        let h;
        h = g(n ? [o, s[1], o + d * O, s[3]] : [a - d * O, s[1], a, s[3]]);
...
class v {
  ...
  get reader() {
    return this._reader || (this._reader = G.from(this.addedOrModified, this.tile, this.metadata)), this._reader;
  }
}
let p = class extends te(ye) {
  constructor(r) {
    super(r), this._attached = !1, this._tiles = /* @__PURE__ */ new Map(), this._controller = new AbortController(), this._hashToSymbolInfo = /* @__PURE__ */ new Map(), this._lastCleanup = performance.now(), this._cleanupRequired = !0, this.lastUpdateId = -1, this.renderer = null, this._updateTracking = new ge({ debugName: "GraphicsView2D" }), this.updateRequested = !1, this.defaultPointSymbolEnabled = !0, this._commandQueue = new je({ process: (e) => {
  ...
  initialize() {
    this._initAttributeStore(), this._metadata = Ge.create(this.view.spatialReference), this._resourceProxy = new $e({ fetch: (e) => Promise.all(e.map((t) => this.view.stage.textureManager.rasterizeItem(t))), fetchDictionary: (e) => {
      ...
      this.addHandles([this.graphics.on("change", () => this._pushUpdate())]), this._graphicStore = new We(this.view.spatialReference, this._cimResourceManager, this.view.featuresTilingScheme, this.view.state.scale, this._attributeStore), this._attached = !0, this.requestUpdate(), this._pushUpdate();
  ...
  async _createMeshWriters(r, e) {
    ...
    const t = this.container.instanceStore, s = this.view.stage.meshWriterRegistry, i = await He(r, e, t);
...
//# sourceMappingURL=GraphicsView2D-S_gbPE0B.js.map
