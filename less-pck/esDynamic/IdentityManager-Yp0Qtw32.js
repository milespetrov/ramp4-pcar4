import { O as u, P as _, lO as Z, Q as M, lP as de, lQ as ue, lR as T, lS as pe, bV as ie, cP as oe, lT as ne, I as B, ag as D, lU as C, s as A, lV as _e, dr as b, lW as R, a2 as P, fd as q, lX as z, fj as F, fe as $, lY as fe, kG as ee, a4 as H, lZ as ge, l_ as me, z as j, dc as te, by as ve, a3 as N, l$ as we } from "./main-n1d2W0Ts.js";
import { s as Se } from "./substitute-CuFAuVK2.js";
...
let x = class extends de {
  ...
  loadDependencies() {
    return ue({ button: () => import("./calcite-button-DaBWyvSH.js"), input: () => import("./calcite-input-Csrxvg9D.js"), label: () => import("./calcite-label-duyHkokf.js"), modal: () => import("./calcite-modal-vr0-u7ej.js"), notice: () => import("./calcite-notice-DNBa0eyt.js") });
  }
  get title() {
...
class he extends oe {
  ...
  initialize(e) {
    ...
    if (s) {
      const i = [];
      s.forEach((n) => {
        n.server && n.tokenServiceUrl && i.push(n.declaredClass ? n : new K(n));
  ...
  getCredential(e, s) {
    ...
    if (a) !a.hasPortal && a.server && a.owningSystemUrl && this._hasSameServerInstance(a.server, a.owningSystemUrl) && (a.hasPortal = !0), !a.hasServer && this._isServerRsrc(e) && (a._restInfoPms = this._getTokenSvcUrl(e), a.hasServer = !0);
      ...
      a = new K(), a.server = this._getServerInstanceRoot(e), typeof f == "string" ? (a.tokenServiceUrl = f, a.hasPortal = !0) : (a._restInfoPms = f, a.hasServer = !0), this.registerServers([a]);
    }
  ...
  _doSignIn(e) {
    ...
    p ? p.promise.then((o) => {
      const l = e.sinfo_;
      if (l._restInfoPms) {
        l.adminTokenServiceUrl = l._restInfoPms.adminUrl, l._restInfoPms = null, l.tokenServiceUrl = (j("authInfo.tokenServicesUrl", o) || j("authInfo.tokenServiceUrl", o) || j("tokenServiceUrl", o)) ?? null, l.shortLivedTokenValidity = j("authInfo.shortLivedTokenValidity", o) ?? null, l.currentVersion = o.currentVersion, l.owningTenant = o.owningTenant;
...
//# sourceMappingURL=IdentityManager-Yp0Qtw32.js.map
