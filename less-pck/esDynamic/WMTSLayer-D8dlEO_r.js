import { O as o, P as n, b8 as A, f8 as Q, Q as N, bV as Y, dO as R, V as G, s as _, lH as Z, a6 as fe, iJ as ge, lI as K, lJ as we, $ as pe, dI as xe, dJ as ve, dM as Se, dK as Me, dL as Ie, dN as Te, S as re, f9 as j, bi as ie, a1 as se, z as Le, lK as Ee, lL as Pe, lM as be, a2 as B, iH as le, ad as ae, I as J, fe as Ce, ek as Re, dX as Oe } from "./main-n1d2W0Ts.js";
...
o([n({ type: A, json: { read: { source: "fullExtent" } } })], $.prototype, "fullExtent", void 0), o([n({ type: String, json: { read: { source: "id" } } })], $.prototype, "id", void 0), o([n({ type: Q, json: { read: { source: "tileInfo" } } })], $.prototype, "tileInfo", void 0), $ = H = o([N("esri.layers.support.TileMatrixSet")], $);
const Ae = $;
var q;
let E = q = class extends Y {
  constructor(e) {
...
o([n({ json: { read: { source: "id" } } })], E.prototype, "id", void 0), o([n({ json: { read: { source: "title" } } })], E.prototype, "title", void 0), o([n({ json: { read: { source: "abstract" } } })], E.prototype, "description", void 0), o([n({ json: { read: { source: "legendUrl" } } })], E.prototype, "legendUrl", void 0), o([n({ json: { read: { source: "isDefault" } } })], E.prototype, "isDefault", void 0), o([n({ json: { read: { source: "keywords" } } })], E.prototype, "keywords", void 0), E = q = o([N("esri.layers.support.WMTSStyle")], E);
const $e = E;
var z;
...
function Fe(e, t) {
  ...
  m?.length && m.some((L) => {
    ...
    return !T || F("AllowedValues", "Value", v, T) ? (x = L.attributes[0].nodeValue, !0) : (!T || F("AllowedValues", "Value", "RESTful", T) || F("AllowedValues", "Value", "REST", T) ? I = L.attributes[0].nodeValue : T && !F("AllowedValues", "Value", "KVP", T) || (g = L.attributes[0].nodeValue), !1);
...
function Ue(e, t, r, i, s) {
  ...
  return { id: e, fullExtent: ke(t), fullExtents: We(t), description: a, formats: l, styles: De(t, i), title: h("Title", t), tileMatrixSets: Ke(s, t, r) };
}
function me(e, t) {
...
function Ke(e, t, r) {
  return C("TileMatrixSetLink", t).map((i) => Be(e, i, r));
}
function Be(e, t, r) {
  ...
  const m = h("SupportedCRS", a).toLowerCase(), y = Je(a, m), p = y.spatialReference, g = f("TileMatrix", a), I = [parseInt(h("TileWidth", g), 10), parseInt(h("TileHeight", g), 10)], v = [];
  s.length ? s.forEach((S, M) => {
    const b = F("TileMatrix", "Identifier", S, a);
    v.push(ue(b, m, M, i, c));
  }) : C("TileMatrix", a).forEach((S, M) => {
    v.push(ue(S, m, M, i, c));
  });
  const x = Ge(e, a, y, I, v[0]).toJSON(), P = new Q({ dpi: 96, spatialReference: p, size: I, origin: y, lods: v }).toJSON();
...
function Ge(e, t, r, i, s) {
  ...
  return He(e, r.spatialReference, r) ? new A(y, c, p, m, r.spatialReference) : new A(c, y, m, p, r.spatialReference);
}
function He(e, t, r) {
...
function ye(e, t, r) {
  let i;
  return i = K.hasOwnProperty("" + e) ? K.values[K[e]] : r === "default028mm" ? 6370997 * Math.PI / 180 : we(e).metersPerDegree, 7 * t / 25e3 / i;
}
(function(e) {
...
let d = X = class extends xe(ve(Se(Me(Ie(Te(Oe)))))) {
  ...
  async fetchTile(e, t, r, i = {}) {
    const { signal: s } = i, a = this.getTileUrl(e, t, r), { data: l } = await B(a, { responseType: "image", signal: s });
    return l;
  }
  async fetchImageBitmapTile(e, t, r, i = {}) {
    ...
    const a = this.getTileUrl(e, t, r), { data: l } = await B(a, { responseType: "blob", signal: s });
    return le(l, e, t, r, s);
  }
  findSublayerById(e) {
  ...
  async _fetchService(e) {
    ...
    this.resourceInfo ? t.data = Ve(t.data) : t.data = Fe(t.data, { serviceMode: this.serviceMode, url: this.url }), t.data && this.read(t.data, { origin: "service" });
  }
  async _getCapabilities(e, t) {
    const r = this._getCapabilitiesUrl(e);
    return await B(r, { ...t, responseType: "text" });
  }
  ...
  _appendParameters(e, t) {
    const r = J(e), i = { ...r.query, ...t }, s = Ce(i);
    return s === "" ? r.path : `${r.path}?${s}`;
  }
  _getCapabilitiesUrl(e) {
    this.url = J(this.url).path;
    let t = this.url;
    switch (e) {
      case "KVP":
