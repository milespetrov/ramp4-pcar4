import { s as g, ad as G, cM as L, C as M, _ as P, U as I, em as J } from "./main-n1d2W0Ts.js";
import { n as T, a as F, m as $ } from "./TimeOnly-FGdb-oHx.js";
...
function N(e, o, a = {}) {
  const n = e instanceof I ? new J({ source: e.features, geometryType: e.geometryType, fields: e.fields, spatialReference: e.spatialReference }) : e;
...
function R(e, o, a, n, r) {
  const { spatialReference: s, interceptor: l, lruCache: c, console: t, abortSignal: f, timeZone: u, services: S = { portal: M.getDefault() } } = a, m = { vars: {}, spatialReference: s, interceptor: l, timeZone: u, lrucache: c, useAsync: r, services: S, console: t, abortSignal: f };
  return o && w(m.vars, e.variables, o, n, a), m;
}
function v(e, o) {
...
async function Q(e, o, a = {}) {
  ...
  const S = r.extractFieldNames(u), m = n.scriptTouchesGeometry(u), C = t.map((i) => i.name.toLowerCase()).filter((i) => l(u, i)), p = c(u, f);
  await s(u, p, f);
  ...
  return { execute: (i, y = {}) => {
    ...
    const d = x(R(o, i, { lruCache: A, ...y }, k, p));
    return y.rawOutput ? d : v(d, r);
  }, executeAsync: async (i, y = {}) => {
    const d = await x(R(o, i, { lruCache: A, services: j, ...y }, k, p));
    return y.rawOutput ? d : v(d, r);
  }, isAsync: p, variablesUsed: C, fieldsUsed: S, geometryUsed: m, syntaxTree: u };
}
export {
  Q as createArcadeExecutor,
  K as createArcadeProfile
};
//# sourceMappingURL=arcade-DD2X1wBU.js.map
