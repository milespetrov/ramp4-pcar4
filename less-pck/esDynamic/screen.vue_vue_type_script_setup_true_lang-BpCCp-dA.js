import { fw as C, fx as $, fy as O, fz as k, fA as h, fB as z, fC as R, fD as V, fE as i, fF as L, fG as d, fH as e, fI as w, fJ as j, fK as y, fL as _, fM as l, fN as A, fO as N, fP as b, fQ as q, fR as D, fS as P, fT as F, fU as T, fV as H, fW as I, fX as U, fY as W } from "./main-n1d2W0Ts.js";
const G = ["onClick", "aria-label"], J = { class: "md-icon-small inline" }, K = /* @__PURE__ */ C({
  ...
  setup(v) {
    const { t: m } = $(), n = O(), u = k(), g = h(() => n.mobileView ? "top-end" : "left-end"), o = (r) => {
    ...
    return (r, a) => {
      ...
      return V((i(), L(x, {
        ...
        default: d(() => [
          (i(!0), w(A, null, j(v.componentSelectedState, (s) => (i(), w("a", {
            key: s.name,
            onClick: (S) => o(s),
            href: "javascript:;",
            ...
            e("div", J, [
              ...
              e("span", {
                class: y(`inline ${s.selectable ? "" : "text-gray-300"}
                    `)
              }, _(l(m)(`export.menu.component.${s.name}`)), 3)
            ])
          ], 10, G))), 128))
        ]),
        _: 1
  ...
  setup(v) {
    const m = v, { t: n } = $(), u = N("iApi"), g = k(), o = b(), r = b(void 0), a = b(void 0), x = b([]), p = q("componentEl"), s = h(() => g.componentSelectedState), S = h(() => {
      let c = {};
    ...
    }), B = h(() => !!o.value?.customRendererFunc), f = D(300, () => {
      if (!o.value || !p.value)
        return;
    ...
    return P(() => {
      m.panel.exportMake = f, x.value.push(
      ...
      o.value = u.fixture.get("export"), r.value = new ResizeObserver(f), a.value = new ResizeObserver(f), r.value.observe(u?.$vApp.$root?.$el), a.value.observe(u?.$vApp.$root?.$el.querySelector('[data-cy="export"]'));
    }), H(() => {
        ...
        I(E, {
          ...
          footer: d(() => [
            e("div", X, [
              ...
              }, _(l(n)("export.download")), 9, Y),
              e("button", {
                type: "button",
                onClick: t[1] || (t[1] = (M) => l(f)()),
                class: "py-8 px-4 sm:px-16",
                "aria-label": l(n)("export.refresh")
              }, _(l(n)("export.refresh")), 9, Z),
              B.value ? W("", !0) : (i(), L(K, {
                key: 0,
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-BpCCp-dA.js.map
