import { fw as k, kJ as _, fx as E, fO as A, fA as B, fB as I, fC as M, fE as f, fI as h, fH as e, fD as i, ik as d, fM as l, fW as m, fG as p, fL as c, f_ as w, kK as L } from "./main-n1d2W0Ts.js";
const R = { class: "relative legend-header flex align-middle" }, j = ["content", "aria-label"], D = ["content", "aria-label"], G = /* @__PURE__ */ k({
  __name: "header",
  setup(H) {
    const x = _(), { t: s } = E(), a = A("iApi"), r = B(() => a.fixture.get("legend")), y = () => {
    ...
    return (o, t) => {
      const u = I("dropdown-menu"), g = M("tippy");
      return f(), h("div", R, [
        e("div", null, [
          i((f(), h("button", {
            type: "button",
...
}), O = /* @__PURE__ */ L(G, [["__scopeId", "data-v-e8031c30"]]);
export {
  O as default
};
//# sourceMappingURL=header-CGH4bSf6.js.map
