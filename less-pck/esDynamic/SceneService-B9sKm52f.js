import { a2 as y, s as c, O as n, P as p, dP as j, bv as _, dO as h, b8 as S, kx as O, dR as L, ek as U, Q as K, eG as V, jv as k, d as C, ky as M, kz as q, D as w, kA as z, I as F, a0 as J, C as D } from "./main-n1d2W0Ts.js";
import { i as A } from "./originUtils-BLsWtgV9.js";
import { o as $ } from "./jsonContext-xnRvlBw_.js";
import { p as B, n as Z } from "./resourceUtils-CCeqd0d2.js";
import { i as P } from "./saveAPIKeyUtils-CjfTVcTh.js";
import { t as G } from "./saveUtils-K00XaDiv.js";
async function H(a, o, t, e, i, r, s) {
  let l = null;
  if (t != null) {
    const u = `${a}/nodepages/`, N = u + Math.floor(t.rootIndex / t.nodesPerPage);
    try {
      return { type: "page", rootPage: (await y(N, { query: { f: "json", ...e, token: i }, responseType: "json", signal: s })).data, rootIndex: t.rootIndex, pageSize: t.nodesPerPage, lodMetric: t.lodSelectionMetricType, urlPrefix: u };
    } catch (E) {
...
const oe = (a) => {
  let o = class extends a {
    ...
    readTitleService(t, e) {
      ...
      if (this.sublayerTitleMode === "item-title") return this.url ? k(this.url, e.name) : e.name;
      let r = e.name;
      if (!r && this.url) {
        const s = C(this.url);
        s != null && (r = s.title);
    ...
    async _fetchIndexAndUpdateExtent(t, e) {
      this.indexInfo = H(this.parsedUrl?.path ?? "", this.rootNode, t, this.customParameters, this.apiKey, w.getLogger(this), e), this.fullExtent == null || this.fullExtent.hasZ || this._updateExtent(await this.indexInfo);
    }
    _updateExtent(t) {
      if (t?.type === "page") {
    ...
    async _save(t) {
      ...
      if (P(this.portalItem), this.portalItem.type !== b) throw new c("sceneservice:portal-item-wrong-type", `Portal item needs to have type "${b}"`);
      await this._ensureLoadBeforeSave();
      const i = $(this.portalItem, "portal-item", !0), r = { layers: [this.write({}, i)] };
      return await Promise.all(i.resources.pendingOperations ?? []), await this._validateAgainstJSONSchema(r, i, e), this.url && (this.portalItem.url = this.url), this.portalItem.title || (this.portalItem.title = this.title), R(this.portalItem, e, m.existingItem), await Z(this.portalItem, r, this.resourceReferences, i), A(i), this.portalItem;
    }
    async _validateAgainstJSONSchema(t, e, i) {
      const r = i?.validationOptions;
      G(e, { errorName: "sceneservice:save" }, { ignoreUnsupported: r?.ignoreUnsupported, supplementalUnsupportedErrors: ["scenemodification:unsupported"] });
      const s = r?.enabled, l = W();
      if (s && l) {
...
const b = "Scene Service", T = { getTypeKeywords: () => [], portalItemLayerType: "unknown", validationOptions: { enabled: !0, ignoreUnsupported: !1, failPolicy: "throw" } };
var g;
(function(a) {
...
//# sourceMappingURL=SceneService-B9sKm52f.js.map
