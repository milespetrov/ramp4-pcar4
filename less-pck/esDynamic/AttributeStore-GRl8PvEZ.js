import { s as ae, t as P, M as oe, d as he } from "./LabelMetric-DtXpnITF.js";
import { aQ as ee, D as S, qb as ue, qc as de, b9 as le, B as ce, bd as _e, d3 as fe, A as pe, qd as ye, my as me, s as w, qe as V, aR as ge, f0 as be, aZ as xe, cU as Y, bv as Ie, ac as m, kO as we, c_ as R, k2 as Z, ey as Se, qf as Te, qg as Fe, d5 as T, d4 as Ee, q1 as Ae } from "./main-n1d2W0Ts.js";
import { n as c, g as Ce, h as ve, s as ze, k as Be, f as x } from "./UpdateTracking2D-BihgDBEV.js";
import { m as F, n as H, a as X } from "./TimeOnly-FGdb-oHx.js";
import { b as De, v as Me, t as Re, n as Oe } from "./timeSupport-BajsmNHb.js";
import { l as O } from "./highlightReasons-Dsv5EcIv.js";
...
let je = class {
  constructor(e, t, r = 0) {
    const i = Ve * r * Uint32Array.BYTES_PER_ELEMENT, s = ke * r * t.stride, a = t.stride / 4, o = t.attributes.find((h) => h.name === "pos" || h.name === "position");
  ...
  _getVertexWriter(e, t) {
    ...
    return r.has(e) || r.set(e, new je(e, t, this._sizeHint)), r.get(e);
  }
}, Ne = class {
}, Et = class extends Ne {
  constructor(e) {
...
const K = () => S.getLogger("esri.views.2d.layers.features.support.ComputedAttributeStorage"), b = 4294967295;
function A(n, e, t) {
...
let zt = class {
  ...
  createBitset() {
    ...
    return this._bitsets.push(j.create(this._allocatedSize, c)), e + 1;
  }
...
class N {
  ...
  _setTimeFilter(e) {
    if (this.timeExtent = this._timeOperator = null, e?.timeExtent) if (this._serviceInfo.timeInfo) this.timeExtent = e.timeExtent, this._timeOperator = Re(this._serviceInfo.timeInfo, e.timeExtent, k.Shared);
    else {
...
class Xe {
  constructor(e) {
    this._valid = j.create(e), this._data = new Array(e);
  }
  has(e) {
...
const B = m("featurelayer-simplify-thresholds") ?? [0.5, 0.5, 0.5, 0.5], Je = B[0], qe = B[1], Ke = B[2], Qe = B[3], L = m("featurelayer-simplify-payload-size-factors") ?? [1, 2, 4], et = L[0], tt = L[1], rt = L[2], it = m("featurelayer-simplify-mobile-factor") ?? 2, st = m("esri-mobile"), Q = 4294967295;
function nt(n, e, t) {
  if (!(n.length > e)) for (; n.length <= e; ) n.push(t);
}
class Rt {
  ...
  getAreaSimplificationThreshold(e, t) {
    ...
    let s = 0;
    return e > 4e3 ? s = Qe * r : e > 2e3 ? s = Ke * r : e > 100 ? s = qe : e > 15 && (s = Je), s;
  }
  ...
  _removeAtIndex(e) {
    this._deleted == null && (this._deleted = j.create(this.getSize())), this._deleted.set(e);
  }
}
...
//# sourceMappingURL=AttributeStore-GRl8PvEZ.js.map
