import { U as h, bv as d, _ as y, b8 as S, a6 as D, c3 as N, c4 as m, D as M } from "./main-n1d2W0Ts.js";
import { $ as g } from "./Mesh-DYGRp2Vu.js";
import { N as w, o as F, i as T } from "./MeshTransform-mbyl_DYz.js";
...
function C(t, e, r) {
  ...
  const a = x(e, r.assetMaps), i = t.sourceSpatialReference ?? d.WGS84, f = r.globalIdFieldName, { outFields: o } = t, l = o != null && o.length > 0 ? b(o.includes("*") ? null : new Set(o)) : () => ({});
  for (const u of n) {
    const c = L(u, f, i, e, a);
...
function L(t, e, r, n, s) {
  ...
  const f = O(t, r, n), o = S.fromJSON(t.geometry);
  o.spatialReference = r;
  const l = $(t.attributes, n), u = r.isGeographic ? "local" : "georeferenced", c = A(i);
...
export {
  x as assetMapFromAssetMapsJSON,
  L as extractMesh,
  C as meshFeatureSetFromJSON
};
//# sourceMappingURL=meshFeatureSet-B4lr4f_S.js.map
