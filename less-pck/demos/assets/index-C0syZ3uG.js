const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-BrbpvIG7.js","./preload-helper-dJJaZANz.js","./main-3BNeFVQJ.js","./main-CRG1_KF0.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bZ as FixtureInstance, kN as useLegendStore, l2 as SectionItem, l3 as LayerItem, l4 as LegendItem, l5 as LayerInstance, l6 as LayerType, fA as defineComponent, fB as useI18n, fS as inject, fF as resolveComponent, fJ as createBlock, fK as withCtx, fQ as unref, fI as openBlock, fL as createBaseVNode, ho as markRaw, j$ as useAppbarStore, k0 as useMapnavStore } from './main-3BNeFVQJ.js';
    ...
    this.$iApi.panel.register(
      {
        legend: {
          screens: {
            "legend-screen": () => markRaw(__vitePreload(() => import('./screen-BrbpvIG7.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url))
          },
          style: {
            width: "350px"
          },
