const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-DgLR8s_6.js","./main-3BNeFVQJ.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./vue.runtime.esm-bundler-DCS4EjMs.js","./screen-snAB63kG.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bZ as FixtureInstance, lc as APIScope, l6 as LayerType, ld as axios, le as UrlWrapper, ho as markRaw, lf as useWizardStore } from './main-3BNeFVQJ.js';
    ...
    this.$iApi.panel.register(
      {
        wizard: {
          screens: {
            "wizard-screen": () => markRaw(__vitePreload(() => import('./screen-DgLR8s_6.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          button: {
