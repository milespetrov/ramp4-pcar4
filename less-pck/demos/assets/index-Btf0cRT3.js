const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-BzcBm0jZ.js","./main-3BNeFVQJ.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./screen-WF2bDSVh.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bZ as FixtureInstance, fA as defineComponent, fB as useI18n, fS as inject, fF as resolveComponent, fJ as createBlock, fK as withCtx, fQ as unref, fI as openBlock, fL as createBaseVNode, l0 as useGeosearchStore, ho as markRaw, j$ as useAppbarStore, k0 as useMapnavStore } from './main-3BNeFVQJ.js';
    ...
    this.$iApi.panel.register(
      {
        ...
        config: {
          screens: {
            "geosearch-component": () => markRaw(__vitePreload(() => import('./screen-BzcBm0jZ.js'),true?__vite__mapDeps([0,1,2,3,4]):void 0,import.meta.url))
          },
          button: {
