const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-XxmIwpdj.js","./main-3BNeFVQJ.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./vue.runtime.esm-bundler-DCS4EjMs.js","./screen-t9ccKkK1.css"])))=>i.map(i=>d[i]);
    ...
    this.$iApi.panel.register(
      {
        "layer-reorder": {
          screens: {
            "layer-reorder-screen": () => markRaw(__vitePreload(() => import('./screen-XxmIwpdj.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "350px"
          },
