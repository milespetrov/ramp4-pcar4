const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./p2-screen-1-DZbdh_Dh.js","./main-3BNeFVQJ.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { fA as defineComponent, fS as inject, fF as resolveComponent, fJ as createBlock, fK as withCtx, fI as openBlock, fL as createBaseVNode, hu as normalizeStyle, f$ as createTextVNode, fB as useI18n, fP as toDisplayString, fQ as unref, bZ as FixtureInstance, ho as markRaw } from './main-3BNeFVQJ.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-DZbdh_Dh.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((data) => {
                    resolve(data);
                  }),
                  2e3
                )
