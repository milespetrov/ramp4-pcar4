const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-C82YzClJ.js","./main-3BNeFVQJ.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./vue.runtime.esm-bundler-DCS4EjMs.js","./toggle-switch-control-KEgnNqnu.js","./toggle-switch-control-RR_UmW76.css","./screen-C2yJe0zE.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bZ as FixtureInstance, ho as markRaw, j$ as useAppbarStore } from './main-3BNeFVQJ.js';
    ...
    this.$iApi.panel.register(
      {
        settings: {
          screens: {
            "settings-screen-content": () => markRaw(__vitePreload(() => import('./screen-C82YzClJ.js'),true?__vite__mapDeps([0,1,2,3,4,5,6,7]):void 0,import.meta.url))
          },
          style: {
            width: "350px"
          },
