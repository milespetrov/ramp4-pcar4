const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-B_3ja4rM.js","./main-3BNeFVQJ.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./marked.esm-DcwJ8j7Z.js","./screen-D4JCpknB.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bZ as FixtureInstance, l1 as useHelpStore, fA as defineComponent, fS as inject, fB as useI18n, fF as resolveComponent, fJ as createBlock, fK as withCtx, fQ as unref, g2 as GlobalEvents, fI as openBlock, fL as createBaseVNode, ho as markRaw, k0 as useMapnavStore } from './main-3BNeFVQJ.js';
    ...
    this.$iApi.panel.register(
      {
        help: {
          screens: {
            "help-screen": () => markRaw(__vitePreload(() => import('./screen-B_3ja4rM.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            "flex-grow": "1",
            "max-width": "750px"
