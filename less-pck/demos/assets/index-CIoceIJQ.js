const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-ySqdQvLd.js","./main-3BNeFVQJ.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./marked.esm-DcwJ8j7Z.js","./screen-QzPpUYJy.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bZ as FixtureInstance, ho as markRaw, j$ as useAppbarStore, k2 as useMetadataStore } from './main-3BNeFVQJ.js';
    ...
    this.$iApi.panel.register(
      {
        metadata: {
          screens: {
            "metadata-screen-content": () => markRaw(__vitePreload(() => import('./screen-ySqdQvLd.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "350px"
          },
