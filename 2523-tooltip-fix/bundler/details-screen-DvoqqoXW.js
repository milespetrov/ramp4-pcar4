...
import { _ as ne, e as te, N as oe, L as Te, O as Me, G as K } from "./main-BlV_aVtB.js";
...
import { T as Ee } from "./toggle-switch-control-v2jaHqsf.js";
import "pinia";
import "screenfull";
...
const Ie = {
  ...
  setup(d) {
    ...
    return ie(() => {
      ...
      C.value.forEach((s) => s()), j.value.forEach((s) => v.event.off(s)), b.value?.removeEventListener("blur", i), b.value?.removeEventListener("keyup", c);
    }), (s, L) => {
...
}), Et = /* @__PURE__ */ ne(Mt, [["__scopeId", "data-v-988d2967"]]), It = { class: "relative h-full" }, Ct = { class: "detailsContentSection overflow-y-auto h-full" }, zt = /* @__PURE__ */ G({
