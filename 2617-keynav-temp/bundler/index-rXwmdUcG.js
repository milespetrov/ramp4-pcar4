...
import { _ as $, d as A, F as G, G as R } from "./main-Ckr7Mm0x.js";
...
const D = /* @__PURE__ */ $(q, [["render", W]]), J = /* @__PURE__ */ k({
  ...
  setup(_) {
    ...
    const o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-knvC2_hP.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-CpTJEq3K.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-ZuT2F5fe.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-C_UshF2r.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-C6aBBhwl.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-DBKCtjvR.js")))
      }), a;
    }), n = (a) => {
